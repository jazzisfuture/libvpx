...
static const arg_def_t kf_err_per_mb_factor =
    ARG_DEF(NULL, "kf-err-per-mb-factor", 1,
...
static const arg_def_t kf_max_total_boost_factor =
    ARG_DEF(NULL, "kf-max-total-boost-factor", 1,
...
static const arg_def_t rd_mult_key_qp_fac =
    ARG_DEF(NULL, "rd-mult-key-qp-fac", 1,
