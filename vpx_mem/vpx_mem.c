...
static int CheckSizeArgumentsOverflow(uint64_t nmemb, uint64_t size) {
...
void *vpx_memalign(size_t align, size_t size) {
  ...
  if (!CheckSizeArgumentsOverflow(1, total_size)) return NULL;
...
void *vpx_calloc(size_t num, size_t size) {
  ...
  if (!CheckSizeArgumentsOverflow(num, size)) return NULL;
