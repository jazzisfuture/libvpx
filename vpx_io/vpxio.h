...
int vpxio_update_enc_ctx(struct vpxio_ctx *input_ctx,
                         struct vpxio_ctx *output_ctx,
                         unsigned int fourcc);
int vpxio_update_dec_ctx(struct vpxio_ctx *input_ctx,
                         struct vpxio_ctx *output_ctx,
                         int do_md5,
                         int flipuv);
...
int vpxio_set_file_type(struct vpxio_ctx *input_ctx,
                        video_file_type_t file_type);
...
int vpxio_write_pkt(struct vpxio_ctx *output_ctx,
                    const vpx_codec_cx_pkt_t *pkt);
int vpxio_read_pkt(struct vpxio_ctx *input_ctx,
                   uint8_t **buf,
                   size_t *buf_sz,
                   size_t *buf_alloc_sz);
int vpxio_write_img(struct vpxio_ctx *output_ctx,
                    vpx_image_t *img);
