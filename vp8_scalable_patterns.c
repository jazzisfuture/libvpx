...
int main(int argc, char **argv) {
    ...
    int                  layering_mode = 0;
    int                  frames_in_layer[5] = {0};
    int                  layer_flags[MAXIMUM_PERIODICITY] = {0};
...
#else
    printf ("Exiting: application was built without multi-layer support.\n");
#endif
    return EXIT_SUCCESS;
}
