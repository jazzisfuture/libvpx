...
#if CONFIG_EXT_INTER
static PREDICTION_MODE read_interintra_mode(VP10_COMMON *cm, MACROBLOCKD *xd,
                                            vpx_reader *r, int size_group) {
  const PREDICTION_MODE ii_mode =
      (PREDICTION_MODE)vpx_read_tree(r, vp10_interintra_mode_tree,
