...
static void setup_restoration(VP10_COMMON *cm,
  ...
  if (vpx_rb_read_bit(rb)) {
    if (vpx_rb_read_bit(rb)) {
      ...
      rst->vfilter[0] = vpx_rb_read_literal(rb, 2) + 3;
      rst->vfilter[1] = vpx_rb_read_literal(rb, 4) - 23;
      rst->vfilter[2] = vpx_rb_read_literal(rb, 5) + 5;
      rst->hfilter[0] = vpx_rb_read_literal(rb, 2) + 3;
      rst->hfilter[1] = vpx_rb_read_literal(rb, 4) - 23;
      rst->hfilter[2] = vpx_rb_read_literal(rb, 5) + 5;
    }
  } else {
