...
#if CONFIG_VP9_HIGHBITDEPTH
static VP10_QUANT_FACADE quant_func_ls[3][4] = { 
...
#else
static VP10_QUANT_FACADE quant_func_ls[3][2] = { 
...
static FWD_TXFM_OPT fwd_txfm_opt_ls[3] = { FWD_TXFM_OPT_NORMAL, FWD_TXFM_OPT_NORMAL, FWD_TXFM_OPT_DC };
