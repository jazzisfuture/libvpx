...
static void fwd_txfm_8x8(const int16_t *src_diff, tran_low_t *coeff,
                         int diff_stride, TX_TYPE tx_type, FWD_TXFM_OPT fwd_txfm_opt) {
  switch (tx_type) {
    case DCT_DCT:
    case ADST_DCT:
    case DCT_ADST:
...
void fwd_txfm(const int16_t *src_diff, tran_low_t *coeff,
  ...
  switch (tx_size) {
    case TX_32X32:
      fwd_txfm_32x32(rd_transform, src_diff, coeff, diff_stride, tx_type, fwd_txfm_opt);
      break;
    case TX_16X16:
...
void highbd_fwd_txfm(const int16_t *src_diff, tran_low_t *coeff,
  ...
  switch (tx_size) {
    case TX_32X32:
      highbd_fwd_txfm_32x32(rd_transform, src_diff, coeff, diff_stride,
                            tx_type, fwd_txfm_opt);
      break;
    case TX_16X16:
