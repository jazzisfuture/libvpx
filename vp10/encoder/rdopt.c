...
static INTERP_FILTER predict_best_interp_filter(const VP10_COMP *cpi, const MACROBLOCK *x,
...
static int64_t handle_inter_mode(VP10_COMP *cpi, MACROBLOCK *x,
  ...
  best_filter = predict_best_interp_filter(cpi, x, bsize, mi_row, mi_col, single_filter);
