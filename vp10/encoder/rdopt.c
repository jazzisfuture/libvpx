...
// TODO(sarahparker) clean up this function
...
static int prune_two_for_sby(const VP10_COMP *cpi,
  ...
  // TODO(sarahparker) check style guide for this formatting
