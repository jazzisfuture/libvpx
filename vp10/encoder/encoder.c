    ...
    switch (cm->bit_depth) {
      case VPX_BITS_8:
        ...
        HIGHBD_BFP(BLOCK_128X128,
                   ...
                   vpx_highbd_variance128x128,
                   vpx_highbd_sub_pixel_variance128x128,
                   vpx_highbd_sub_pixel_avg_variance128x128,
        ...
        HIGHBD_BFP(BLOCK_128X64,
                   ...
                   vpx_highbd_variance128x64,
                   vpx_highbd_sub_pixel_variance128x64,
                   vpx_highbd_sub_pixel_avg_variance128x64,
                   NULL,
                   NULL,
        ...
        HIGHBD_BFP(BLOCK_64X128,
                   ...
                   vpx_highbd_variance64x128,
                   vpx_highbd_sub_pixel_variance64x128,
                   vpx_highbd_sub_pixel_avg_variance64x128,
                   NULL,
                   NULL,
