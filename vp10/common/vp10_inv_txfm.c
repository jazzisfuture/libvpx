...
void vp10_iadst16_c(const tran_low_t *input, tran_low_t *output) {
  ...
  x0 = WRAPLOW(check_range(s0 + s2));
  x1 = WRAPLOW(check_range(s1 + s3));
  x2 = WRAPLOW(check_range(s0 - s2));
  x3 = WRAPLOW(check_range(s1 - s3));
  x4 = WRAPLOW(dct_const_round_shift(s4 + s6));
  x5 = WRAPLOW(dct_const_round_shift(s5 + s7));
  x6 = WRAPLOW(dct_const_round_shift(s4 - s6));
  x7 = WRAPLOW(dct_const_round_shift(s5 - s7));
  x8 = WRAPLOW(check_range(s8 + s10));
  x9 = WRAPLOW(check_range(s9 + s11));
  x10 = WRAPLOW(check_range(s8 - s10));
  x11 = WRAPLOW(check_range(s9 - s11));
