...
default_inter_tx_type_prob[EXT_TX_SIZES][TX_TYPES - 1] = {
  ...
  { 12, 112, 16, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128,
    128 },
  { 4, 112, 16, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128, 128,
    128 },
};

const vpx_tree_index vp10_tx_type10_tree[TREE_SIZE(TX_TYPES_10)] = {
  -IDTX, 2,
  -DCT_DCT, 4,
  6, 12,
  8, 10,
...
static const vpx_prob
default_inter_tx_type10_prob[EXT_TX_SIZES][TX_TYPES_10 - 1] = {
  { 12, 112, 128, 128, 128, 128, 128, 128, 128 },
  { 12, 112, 128, 128, 128, 128, 128, 128, 128 },
  { 12, 112, 128, 128, 128, 128, 128, 128, 128 },
  { 4, 112, 128, 128, 128, 128, 128, 128, 128 },
};

const vpx_tree_index vp10_tx_type2_tree[TREE_SIZE(TX_TYPES_2)] = {
  -IDTX, -DCT_DCT,
};

static const vpx_prob
default_inter_tx_type2_prob[EXT_TX_SIZES][TX_TYPES_2 - 1] = {
  { 12, },
  { 12, },
  { 12, },
  { 4, },
...
static void init_mode_probs(FRAME_CONTEXT *fc) {
  ...
  vp10_copy(fc->inter_tx_type10_prob, default_inter_tx_type10_prob);
  vp10_copy(fc->inter_tx_type2_prob, default_inter_tx_type2_prob);
...
void vp10_adapt_mode_probs(VP10_COMMON *cm) {
  ...
  for (i = TX_4X4; i < EXT_TX_SIZES; ++i) {
    if (use_inter_ext_tx_type_for_tx[i]) {
      vpx_tree_merge_probs(vp10_tx_type_tree, pre_fc->inter_tx_type_prob[i],
                           counts->inter_tx_type[i],
                           fc->inter_tx_type_prob[i]);
    }
    if (use_inter_ext_tx_type10_for_tx[i]) {
      vpx_tree_merge_probs(vp10_tx_type10_tree, pre_fc->inter_tx_type10_prob[i],
                           counts->inter_tx_type10[i],
                           fc->inter_tx_type10_prob[i]);
    }
    if (use_inter_ext_tx_type2_for_tx[i]) {
      vpx_tree_merge_probs(vp10_tx_type2_tree, pre_fc->inter_tx_type2_prob[i],
                           counts->inter_tx_type2[i],
                           fc->inter_tx_type2_prob[i]);
    }
    if (use_intra_ext_tx_type_for_tx[i]) {
      for (j = 0; j < INTRA_MODES; ++j)
        vpx_tree_merge_probs(vp10_tx_type_tree,
                             pre_fc->intra_tx_type_prob[i][j],
