...
const vpx_tree_index vp10_palette_color_tree[TREE_SIZE(PALETTE_COLORS)] = {
  -PALETTE_COLOR_ONE, 2,
  -PALETTE_COLOR_TWO, 4,
...
[PALETTE_MAX_SIZE - 1][PALETTE_COLOR_CONTEXTS][PALETTE_COLORS - 1] = {
    {  // 2 colors
        ...
        { 195,  87, 128, 255,   0,   0,   0 },
        { 143, 100, 123, 255,   0,   0,   0 },
        {  94, 124, 119, 255,   0,   0,   0 },
        {  77,  91, 130, 255,   0,   0,   0 },
        {  39, 114, 178, 255,   0,   0,   0 },
        { 222,  94, 125, 255,   0,   0,   0 },
        {  44, 203, 132, 255,   0,   0,   0 },
        {  68, 175, 122, 255,   0,   0,   0 },
        { 110, 187, 124, 255,   0,   0,   0 },
        { 152,  91, 128, 255,   0,   0,   0 },
        {  70, 109, 181, 255,   0,   0,   0 },
        { 133, 113, 164, 255,   0,   0,   0 },
        {  47, 205, 133, 255,   0,   0,   0 },
        { 247,  94, 136, 255,   0,   0,   0 },
        { 205, 122, 146, 255,   0,   0,   0 },
        { 251, 100, 141, 255,   0,   0,   0 },
    }, {  // 5 colors
        { 195,  65,  84, 125, 255,   0,   0 },
        { 150,  76,  84, 121, 255,   0,   0 },
        {  94, 110,  81, 117, 255,   0,   0 },
        {  79,  85,  91, 139, 255,   0,   0 },
        {  26, 102, 139, 127, 255,   0,   0 },
        { 220,  73,  91, 119, 255,   0,   0 },
        {  38, 203,  86, 127, 255,   0,   0 },
        {  61, 186,  72, 124, 255,   0,   0 },
        { 132, 199,  84, 128, 255,   0,   0 },
        { 172,  52,  62, 120, 255,   0,   0 },
        { 102,  89, 121, 122, 255,   0,   0 },
        { 182,  48,  69, 186, 255,   0,   0 },
        {  36, 206,  87, 126, 255,   0,   0 },
        { 249,  55,  67, 122, 255,   0,   0 },
        { 218,  88,  75, 122, 255,   0,   0 },
        { 253,  64,  80, 119, 255,   0,   0 },
    }, {  // 6 colors
        { 182,  54,  64,  75, 118, 255,   0 },
        { 126,  67,  70,  76, 116, 255,   0 },
        {  79,  92,  67,  85, 120, 255,   0 },
        {  63,  61,  81, 118, 132, 255,   0 },
        {  21,  80, 105,  83, 119, 255,   0 },
        { 215,  72,  74,  74, 111, 255,   0 },
        {  50, 176,  63,  79, 120, 255,   0 },
        {  72, 148,  66,  77, 120, 255,   0 },
        { 105, 177,  57,  78, 130, 255,   0 },
        { 150,  66,  66,  80, 127, 255,   0 },
        {  81,  76, 109,  85, 116, 255,   0 },
        { 113,  81,  62,  96, 148, 255,   0 },
        {  54, 179,  69,  82, 121, 255,   0 },
        { 244,  47,  48,  67, 118, 255,   0 },
        { 198,  83,  53,  65, 121, 255,   0 },
        { 250,  42,  51,  69, 110, 255,   0 },
    }, {  // 7 colors
...
[PALETTE_MAX_SIZE - 1][PALETTE_COLOR_CONTEXTS][PALETTE_COLORS - 1] = {
    {  // 2 colors
        ...
        { 173,  88, 143, 255,   0,   0,   0 },
        { 146,  81, 127, 255,   0,   0,   0 },
        {  84, 134, 102, 255,   0,   0,   0 },
        {  69, 138, 140, 255,   0,   0,   0 },
        {  31, 103, 200, 255,   0,   0,   0 },
        { 217, 101, 139, 255,   0,   0,   0 },
        {  51, 174, 121, 255,   0,   0,   0 },
        {  64, 177, 109, 255,   0,   0,   0 },
        {  96, 179, 145, 255,   0,   0,   0 },
        { 164,  77, 114, 255,   0,   0,   0 },
        {  87,  94, 156, 255,   0,   0,   0 },
        { 105,  57, 173, 255,   0,   0,   0 },
        {  63, 158, 137, 255,   0,   0,   0 },
        { 236, 102, 156, 255,   0,   0,   0 },
        { 197, 115, 153, 255,   0,   0,   0 },
        { 245, 106, 154, 255,   0,   0,   0 },
    }, {  // 5 colors
        { 179,  64,  97, 129, 255,   0,   0 },
        { 137,  56,  88, 125, 255,   0,   0 },
        {  82, 107,  61, 118, 255,   0,   0 },
        {  59, 113,  86, 115, 255,   0,   0 },
        {  23,  88, 118, 130, 255,   0,   0 },
        { 213,  66,  90, 125, 255,   0,   0 },
        {  37, 181, 103, 121, 255,   0,   0 },
        {  47, 188,  61, 131, 255,   0,   0 },
        { 104, 185, 103, 144, 255,   0,   0 },
        { 163,  39,  76, 112, 255,   0,   0 },
        {  94,  74, 131, 126, 255,   0,   0 },
        { 142,  42, 103, 163, 255,   0,   0 },
        {  53, 162,  99, 149, 255,   0,   0 },
        { 239,  54,  84, 108, 255,   0,   0 },
        { 203,  84, 110, 147, 255,   0,   0 },
        { 248,  70, 105, 151, 255,   0,   0 },
    }, {  // 6 colors
        { 189,  50,  67,  90, 130, 255,   0 },
        { 114,  50,  55,  90, 123, 255,   0 },
        {  66,  76,  54,  82, 128, 255,   0 },
        {  43,  69,  69,  80, 129, 255,   0 },
        {  22,  59,  87,  88, 141, 255,   0 },
        { 203,  49,  68,  87, 122, 255,   0 },
        {  43, 157,  74, 104, 146, 255,   0 },
        {  54, 138,  51,  95, 138, 255,   0 },
        {  82, 171,  58, 102, 146, 255,   0 },
        { 129,  38,  59,  64, 168, 255,   0 },
        {  56,  67, 119,  92, 112, 255,   0 },
        {  96,  62,  53, 132,  82, 255,   0 },
        {  60, 147,  77, 108, 145, 255,   0 },
        { 238,  76,  73,  93, 148, 255,   0 },
        { 189,  86,  73, 103, 157, 255,   0 },
        { 246,  62,  75,  83, 167, 255,   0 },
    }, {  // 7 colors
