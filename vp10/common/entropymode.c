...
const vpx_prob default_palette_uv_size_prob[10][PALETTE_SIZES - 1] = {
...
const vpx_prob default_palette_y_mode_prob[10][3] = {
    { 240,  180,  100, },
    { 240,  180,  100, },
    { 240,  180,  100, },
    { 240,  180,  100, },
...
const vpx_prob default_palette_y_color_prob
...
const vpx_prob default_palette_uv_color_prob
[PALETTE_MAX_SIZE - 1][PALETTE_COLOR_CONTEXTS][PALETTE_COLORS - 1] = {
    {  // 2 colors
