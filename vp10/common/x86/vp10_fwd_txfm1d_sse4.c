...
void vp10_fdct4_new_sse4_1(const __m128i* input, __m128i* output,
  ...
  for (col = 0; col < col_num; col++) {
    ...
    bit = cos_bit[stage_idx];
    cospi = cospi_arr[bit - cos_bit_min];
    btf_32_sse4_1_type0(cospi[32], cospi[32], buf1[0], buf1[1], buf0[0], buf0[1],
                      bit);
    btf_32_sse4_1_type1(cospi[48], cospi[16], buf1[2], buf1[3], buf0[2], buf0[3],
                      bit);
...
void vp10_fdct16_new_sse4_1(const __m128i* input, __m128i* output,
  ...
  for (col = 0; col < col_num; col++) {
    ...
    buf1[2] = _mm_sub_epi32(buf0[1], buf0[2]);
    buf1[4] = buf0[4];
    btf_32_sse4_1_type0(-cospi[32], cospi[32], buf0[5], buf0[6], buf1[5], buf1[6],
                      bit);
    buf1[7] = buf0[7];
    ...
    btf_32_sse4_1_type1(cospi[56], cospi[8], buf0[4], buf0[7], buf1[4], buf1[7],
                      bit);
    btf_32_sse4_1_type1(cospi[24], cospi[40], buf0[5], buf0[6], buf1[5], buf1[6],
                      bit);
    ...
    buf0[6] = buf1[6];
    buf0[7] = buf1[7];
    btf_32_sse4_1_type1(cospi[60], cospi[4], buf1[8], buf1[15], buf0[8], buf0[15],
                      bit);
...
void vp10_fadst4_new_sse4_1(const __m128i* input, __m128i* output,
  ...
  for (col = 0; col < col_num; col++) {
    ...
    btf_32_sse4_1_type0(cospi[8], cospi[56], buf1[0], buf1[1], buf0[0], buf0[1],
                      bit);
    btf_32_sse4_1_type0(cospi[40], cospi[24], buf1[2], buf1[3], buf0[2], buf0[3],
                      bit);
    ...
    buf0[0] = buf1[0];
    buf0[1] = buf1[1];
    btf_32_sse4_1_type0(cospi[32], cospi[32], buf1[2], buf1[3], buf0[2], buf0[3],
                      bit);
...
void vp10_fadst8_new_sse4_1(const __m128i* input, __m128i* output,
  ...
  for (col = 0; col < col_num; col++) {
    ...
    btf_32_sse4_1_type0(cospi[4], cospi[60], buf1[0], buf1[1], buf0[0], buf0[1],
                      bit);
    btf_32_sse4_1_type0(cospi[20], cospi[44], buf1[2], buf1[3], buf0[2], buf0[3],
                      bit);
    btf_32_sse4_1_type0(cospi[36], cospi[28], buf1[4], buf1[5], buf0[4], buf0[5],
                      bit);
    btf_32_sse4_1_type0(cospi[52], cospi[12], buf1[6], buf1[7], buf0[6], buf0[7],
                      bit);
    ...
    buf0[2] = buf1[2];
    buf0[3] = buf1[3];
    btf_32_sse4_1_type0(cospi[16], cospi[48], buf1[4], buf1[5], buf0[4], buf0[5],
                      bit);
    btf_32_sse4_1_type0(-cospi[48], cospi[16], buf1[6], buf1[7], buf0[6], buf0[7],
                      bit);
    ...
    buf0[4] = buf1[4];
    buf0[5] = buf1[5];
    btf_32_sse4_1_type0(cospi[32], cospi[32], buf1[6], buf1[7], buf0[6], buf0[7],
                      bit);
...
void vp10_fadst16_new_sse4_1(const __m128i* input, __m128i* output,
  ...
  for (col = 0; col < col_num; col++) {
    ...
    btf_32_sse4_1_type0(cospi[2], cospi[62], buf1[0], buf1[1], buf0[0], buf0[1],
                      bit);
    btf_32_sse4_1_type0(cospi[10], cospi[54], buf1[2], buf1[3], buf0[2], buf0[3],
                      bit);
    btf_32_sse4_1_type0(cospi[18], cospi[46], buf1[4], buf1[5], buf0[4], buf0[5],
                      bit);
    btf_32_sse4_1_type0(cospi[26], cospi[38], buf1[6], buf1[7], buf0[6], buf0[7],
                      bit);
    btf_32_sse4_1_type0(cospi[34], cospi[30], buf1[8], buf1[9], buf0[8], buf0[9],
                      bit);
...
void vp10_fadst32_new_sse4_1(const __m128i* input, __m128i* output,
  ...
  for (col = 0; col < col_num; col++) {
    ...
    btf_32_sse4_1_type0(cospi[9], cospi[55], buf1[4], buf1[5], buf0[4], buf0[5],
                      bit);
    btf_32_sse4_1_type0(cospi[13], cospi[51], buf1[6], buf1[7], buf0[6], buf0[7],
                      bit);
    btf_32_sse4_1_type0(cospi[17], cospi[47], buf1[8], buf1[9], buf0[8], buf0[9],
                      bit);
