...
static void idct16x16_sse4_1(__m128i *in, __m128i *out, int bit) {
  ...
  for (col = 0; col < 4; ++col) {
    ...
    //u[5] = half_btf(-cospi[32], v[5], cospi[32], v[6], cos_bit[stage]);
    ...
    //u[6] = half_btf(cospi[32], v[5], cospi[32], v[6], cos_bit[stage]);
    ...
    //v[10] = half_btf(-cospi[32], u[10], cospi[32], u[13], cos_bit[stage]);
    ...
    //v[13] = half_btf(cospi[32], u[10], cospi[32], u[13], cos_bit[stage]);
    v[13] = _mm_add_epi32(x, y);
    v[13] = _mm_add_epi32(v[13], rnding);
    v[13] = _mm_srai_epi32(v[13], bit);

    //v[11] = half_btf(-cospi[32], u[11], cospi[32], u[12], cos_bit[stage]);
    ...
    //v[12] = half_btf(cospi[32], u[11], cospi[32], u[12], cos_bit[stage]);
...
static void iadst16x16_sse4_1(__m128i *in, __m128i *out, int bit) {
  ...
  for (col = 0; col < 4; ++col) {
    ...
    v[0] = u[0];
    v[1] = u[1];
    //v[2] = half_btf(cospi[32], u[2], cospi[32], u[3], cos_bit[stage]);
    //v[3] = half_btf(cospi[32], u[2], -cospi[32], u[3], cos_bit[stage]);
    ...
    v[4] = u[4];
    v[5] = u[5];
    //v[6] = half_btf(cospi[32], u[6], cospi[32], u[7], cos_bit[stage]);
    //v[7] = half_btf(cospi[32], u[6], -cospi[32], u[7], cos_bit[stage]);
    ...
    v[8] = u[8];
    v[9] = u[9];
    //v[10] = half_btf(cospi[32], u[10], cospi[32], u[11], cos_bit[stage]);
    //v[11] = half_btf(cospi[32], u[10], -cospi[32], u[11], cos_bit[stage]);
    x = _mm_mullo_epi32(u[10], cospi32);
    ...
    v[12] = u[12];
    v[13] = u[13];
    //v[14] = half_btf(cospi[32], u[14], cospi[32], u[15], cos_bit[stage]);
    //v[15] = half_btf(cospi[32], u[14], -cospi[32], u[15], cos_bit[stage]);
