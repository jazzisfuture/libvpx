...
void vp10_fdct4_new_sse2(const M128I* input, M128I* output,
...
void vp10_fdct8_new_sse2(const M128I* input, M128I* output,
                         const int8_t* cos_bit, const int8_t* stage_range) {
...
void vp10_fdct16_new_sse2(const M128I* input, M128I* output,
                          const int8_t* cos_bit, const int8_t* stage_range) {
...
void vp10_fdct32_new_sse2(const M128I* input, M128I* output,
                          const int8_t* cos_bit, const int8_t* stage_range) {
...
void vp10_fadst4_new_sse2(const M128I* input, M128I* output,
                          const int8_t* cos_bit, const int8_t* stage_range) {
  const int txfm_size = 4;
  const int num_per_128 = 4;
  const int32_t* cospi;
...
void vp10_fadst8_new_sse2(const M128I* input, M128I* output,
                          const int8_t* cos_bit, const int8_t* stage_range) {
  const int txfm_size = 8;
  const int num_per_128 = 4;
  const int32_t* cospi;
...
void vp10_fadst16_new_sse2(const M128I* input, M128I* output,
                           const int8_t* cos_bit, const int8_t* stage_range) {
  const int txfm_size = 16;
  const int num_per_128 = 4;
  const int32_t* cospi;
...
void vp10_fadst32_new_sse2(const M128I* input, M128I* output,
                           const int8_t* cos_bit, const int8_t* stage_range) {
  const int txfm_size = 32;
  const int num_per_128 = 4;
  const int32_t* cospi;
...
void vp10_fdct64_new_sse2(const M128I *input, M128I *output, const int8_t* cos_bit, const int8_t* stage_range) {
  ...
  for(col = 0; col < col_num; col++) {
    ...
    btf_32_sse2_type0(-cospi[48], -cospi[16], buf1[40], buf1[55], buf0[40], buf0[55], bit);
    btf_32_sse2_type0(-cospi[48], -cospi[16], buf1[41], buf1[54], buf0[41], buf0[54], bit);
    btf_32_sse2_type0(-cospi[48], -cospi[16], buf1[42], buf1[53], buf0[42], buf0[53], bit);
    btf_32_sse2_type0(-cospi[48], -cospi[16], buf1[43], buf1[52], buf0[43], buf0[52], bit);
    buf0[44] = buf1[44];
    buf0[45] = buf1[45];
    buf0[46] = buf1[46];
    buf0[47] = buf1[47];
    ...
    btf_32_sse2_type0(-cospi[48], -cospi[16], buf0[20], buf0[27], buf1[20], buf1[27], bit);
    btf_32_sse2_type0(-cospi[48], -cospi[16], buf0[21], buf0[26], buf1[21], buf1[26], bit);
    buf1[22] = buf0[22];
    buf1[23] = buf0[23];
    buf1[24] = buf0[24];
    buf1[25] = buf0[25];
    ...
    btf_32_sse2_type0(-cospi[56], -cospi[ 8], buf1[36], buf1[59], buf0[36], buf0[59], bit);
    btf_32_sse2_type0(-cospi[56], -cospi[ 8], buf1[37], buf1[58], buf0[37], buf0[58], bit);
    buf0[38] = buf1[38];
    buf0[39] = buf1[39];
    buf0[40] = buf1[40];
    buf0[41] = buf1[41];
    ...
    btf_32_sse2_type0(-cospi[24], -cospi[40], buf1[44], buf1[51], buf0[44], buf0[51], bit);
    btf_32_sse2_type0(-cospi[24], -cospi[40], buf1[45], buf1[50], buf0[45], buf0[50], bit);
    buf0[46] = buf1[46];
    buf0[47] = buf1[47];
    buf0[48] = buf1[48];
    buf0[49] = buf1[49];
    ...
    btf_32_sse2_type0(-cospi[56], -cospi[ 8], buf0[18], buf0[29], buf1[18], buf1[29], bit);
    buf1[19] = buf0[19];
    buf1[20] = buf0[20];
    btf_32_sse2_type0(-cospi[40],  cospi[24], buf0[21], buf0[26], buf1[21], buf1[26], bit);
    btf_32_sse2_type0(-cospi[24], -cospi[40], buf0[22], buf0[25], buf1[22], buf1[25], bit);
    buf1[23] = buf0[23];
    buf1[24] = buf0[24];
    buf1[27] = buf0[27];
    buf1[28] = buf0[28];
    ...
    btf_32_sse2_type0(-cospi[60], -cospi[ 4], buf1[34], buf1[61], buf0[34], buf0[61], bit);
    buf0[35] = buf1[35];
    buf0[36] = buf1[36];
    btf_32_sse2_type0(-cospi[36],  cospi[28], buf1[37], buf1[58], buf0[37], buf0[58], bit);
    btf_32_sse2_type0(-cospi[28], -cospi[36], buf1[38], buf1[57], buf0[38], buf0[57], bit);
    buf0[39] = buf1[39];
    buf0[40] = buf1[40];
    btf_32_sse2_type0(-cospi[20],  cospi[44], buf1[41], buf1[54], buf0[41], buf0[54], bit);
    btf_32_sse2_type0(-cospi[44], -cospi[20], buf1[42], buf1[53], buf0[42], buf0[53], bit);
    buf0[43] = buf1[43];
    buf0[44] = buf1[44];
    btf_32_sse2_type0(-cospi[52],  cospi[12], buf1[45], buf1[50], buf0[45], buf0[50], bit);
    btf_32_sse2_type0(-cospi[12], -cospi[52], buf1[46], buf1[49], buf0[46], buf0[49], bit);
    buf0[47] = buf1[47];
    buf0[48] = buf1[48];
    buf0[51] = buf1[51];
    buf0[52] = buf1[52];
