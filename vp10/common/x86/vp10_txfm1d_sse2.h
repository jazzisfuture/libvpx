...
static INLINE void transpose_32_4x4(int stride, const M128I* input, M128I* output) {
...
static INLINE void transpose_32(int txfm_size, const M128I* input, M128I* output){
