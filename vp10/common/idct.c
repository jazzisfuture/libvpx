...
void vp10_iht8x4_16_add_c(const tran_low_t *input, uint8_t *dest, int stride,
                          int tx_type) {
...
void vp10_iht4x8_16_add_c(const tran_low_t *input, uint8_t *dest, int stride,
                          int tx_type) {
...
void vp10_highbd_iht8x4_16_add_c(const tran_low_t *input, uint8_t *dest8,
                                int stride, int tx_type, int bd) {
...
void vp10_highbd_iht4x8_16_add_c(const tran_low_t *input, uint8_t *dest8,
                                int stride, int tx_type, int bd) {
