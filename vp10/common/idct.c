...
#if CONFIG_EXT_TX
static void ihaar4_c(const tran_low_t *input, tran_low_t *output) {
  int i;
  tran_low_t out[4];
  for (i = 0; i < 2; ++i) {
    out[2 * i] = input[i] + input[i + 2];
    out[2 * i + 1] = input[i] - input[i + 2];
  }
  memcpy(output, out, sizeof(*output) * 4);
}

static void ihaar8_c(const tran_low_t *input, tran_low_t *output) {
  int i;
  tran_low_t out[8];
  for (i = 0; i < 4; ++i) {
    out[2 * i] = input[i] + input[i + 4];
    out[2 * i + 1] = input[i] - input[i + 4];
  }
  for (i = 0; i < 8; ++i) {
    output[i] = (tran_low_t)dct_const_round_shift(out[i] * Sqrt2);
  }
}

static void ihaar16_c(const tran_low_t *input, tran_low_t *output) {
  int i;
  tran_low_t out[16];
  for (i = 0; i < 8; ++i) {
    out[2 * i] = 2 * (input[i] + input[i + 8]);
    out[2 * i + 1] = 2 * (input[i] - input[i + 8]);
  }
  memcpy(output, out, sizeof(*output) * 16);
}

static void ihaar32_c(const tran_low_t *input, tran_low_t *output) {
  int i;
  tran_low_t out[32];
  for (i = 0; i < 16; ++i) {
    out[2 * i] = 2 * (input[i] + input[i + 16]);
    out[2 * i + 1] = 2 * (input[i] - input[i + 16]);
  }
  for (i = 0; i < 32; ++i) {
    output[i] = (tran_low_t)dct_const_round_shift(out[i] * Sqrt2);
  }
...
static void highbd_ihaar4_c(const tran_low_t *input, tran_low_t *output,
                            int bd) {
  int i;
  tran_low_t out[4];
  (void) bd;
...
static void highbd_ihaar8_c(const tran_low_t *input, tran_low_t *output,
                            int bd) {
  int i;
  tran_low_t out[8];
  for (i = 0; i < 4; ++i) {
  ...
  for (i = 0; i < 8; ++i) {
    output[i] = (tran_low_t)highbd_dct_const_round_shift(out[i] * Sqrt2, bd);
  }
}

static void highbd_ihaar16_c(const tran_low_t *input, tran_low_t *output,
                             int bd) {
  int i;
  tran_low_t out[16];
  (void) bd;
...
static void highbd_ihaar32_c(const tran_low_t *input, tran_low_t *output,
                             int bd) {
  int i;
  tran_low_t out[32];
  for (i = 0; i < 16; ++i) {
...
void vp10_iht4x4_16_add_c(const tran_low_t *input, uint8_t *dest, int stride,
  ...
  static const transform_2d IHT_4[] = {
    ...
    { idct4_c,  ihaar4_c },  // V_DCT
    { ihaar4_c, idct4_c  },  // H_DCT
    { iadst4_c, ihaar4_c },  // V_ADST
    { ihaar4_c, iadst4_c },  // H_ADST
    { iadst4_c, ihaar4_c },  // V_FLIPADST
    { ihaar4_c, iadst4_c },  // H_FLIPADST
#endif  // CONFIG_EXT_TX
  };
...
void vp10_iht8x8_64_add_c(const tran_low_t *input, uint8_t *dest, int stride,
  ...
  static const transform_2d IHT_8[] = {
    ...
    { idct8_c,  ihaar8_c },  // V_DCT
    { ihaar8_c, idct8_c  },  // H_DCT
    { iadst8_c, ihaar8_c },  // V_ADST
    { ihaar8_c, iadst8_c },  // H_ADST
    { iadst8_c, ihaar8_c },  // V_FLIPADST
    { ihaar8_c, iadst8_c },  // H_FLIPADST
#endif  // CONFIG_EXT_TX
  };
...
void vp10_iht16x16_256_add_c(const tran_low_t *input, uint8_t *dest, int stride,
  ...
  static const transform_2d IHT_16[] = {
    ...
    { idct16_c,  ihaar16_c },  // V_DCT
    { ihaar16_c, idct16_c  },  // H_DCT
    { iadst16_c, ihaar16_c },  // V_ADST
    { ihaar16_c, iadst16_c },  // H_ADST
    { iadst16_c, ihaar16_c },  // V_FLIPADST
    { ihaar16_c, iadst16_c },  // H_FLIPADST
#endif  // CONFIG_EXT_TX
  };
...
void vp10_iht32x32_1024_add_c(const tran_low_t *input, uint8_t *dest,
  ...
  static const transform_2d IHT_32[] = {
    ...
    { idct32_c,  ihaar32_c },                // V_DCT
    { ihaar32_c, idct32_c  },                // H_DCT
    { ihalfright32_c, ihaar32_c },           // V_ADST
    { ihaar32_c, ihalfright32_c },           // H_ADST
    { ihalfright32_c, ihaar32_c },           // V_FLIPADST
    { ihaar32_c, ihalfright32_c },           // H_FLIPADST
  };
...
void vp10_highbd_iht4x4_16_add_c(const tran_low_t *input, uint8_t *dest8,
  ...
  static const highbd_transform_2d HIGH_IHT_4[] = {
    ...
    { vpx_highbd_idct4_c,      highbd_ihaar4_c },  // V_DCT
    {     highbd_ihaar4_c, vpx_highbd_idct4_c  },  // H_DCT
    { vpx_highbd_iadst4_c,     highbd_ihaar4_c },  // V_ADST
    {     highbd_ihaar4_c, vpx_highbd_iadst4_c },  // H_ADST
    { vpx_highbd_iadst4_c,     highbd_ihaar4_c },  // V_FLIPADST
    {     highbd_ihaar4_c, vpx_highbd_iadst4_c },  // H_FLIPADST
#endif  // CONFIG_EXT_TX
  };
...
void vp10_highbd_iht8x8_64_add_c(const tran_low_t *input, uint8_t *dest8,
  ...
  static const highbd_transform_2d HIGH_IHT_8[] = {
    ...
    { vpx_highbd_idct8_c,      highbd_ihaar8_c },  // V_DCT
    {     highbd_ihaar8_c, vpx_highbd_idct8_c  },  // H_DCT
    { vpx_highbd_iadst8_c,     highbd_ihaar8_c },  // V_ADST
    {     highbd_ihaar8_c, vpx_highbd_iadst8_c },  // H_ADST
    { vpx_highbd_iadst8_c,     highbd_ihaar8_c },  // V_FLIPADST
    {     highbd_ihaar8_c, vpx_highbd_iadst8_c },  // H_FLIPADST
#endif  // CONFIG_EXT_TX
  };
...
void vp10_highbd_iht16x16_256_add_c(const tran_low_t *input, uint8_t *dest8,
  ...
  static const highbd_transform_2d HIGH_IHT_16[] = {
    ...
    { vpx_highbd_idct16_c,      highbd_ihaar16_c },  // V_DCT
    {     highbd_ihaar16_c, vpx_highbd_idct16_c  },  // H_DCT
    { vpx_highbd_iadst16_c,     highbd_ihaar16_c },  // V_ADST
    {     highbd_ihaar16_c, vpx_highbd_iadst16_c },  // H_ADST
    { vpx_highbd_iadst16_c,     highbd_ihaar16_c },  // V_FLIPADST
    {     highbd_ihaar16_c, vpx_highbd_iadst16_c },  // H_FLIPADST
#endif  // CONFIG_EXT_TX
  };
...
void vp10_highbd_iht32x32_1024_add_c(const tran_low_t *input, uint8_t *dest8,
  ...
  static const highbd_transform_2d HIGH_IHT_32[] = {
    ...
    { vpx_highbd_idct32_c,    highbd_ihaar32_c       },  // V_DCT
    { highbd_ihaar32_c,       vpx_highbd_idct32_c    },  // H_DCT
    { highbd_ihalfright32_c,  highbd_ihaar32_c       },  // V_ADST
    { highbd_ihaar32_c,       highbd_ihalfright32_c  },  // H_ADST
    { highbd_ihalfright32_c,  highbd_ihaar32_c       },  // V_FLIPADST
    { highbd_ihaar32_c,       highbd_ihalfright32_c  },  // H_FLIPADST
  };
