...
void vp10_highbd_iht4x4_16_add_c(const tran_low_t *input, uint8_t *dest8,
  ...
  static const highbd_transform_2d HIGH_IHT_4[] = {
    ...
    {            idst4_c,  vpx_highbd_idct4_c  },  // DST_DCT           = 9,
    { vpx_highbd_idct4_c,             idst4_c  },  // DCT_DST           = 10,
    {            idst4_c,  vpx_highbd_iadst4_c },  // DST_ADST          = 11,
    { vpx_highbd_iadst4_c,            idst4_c  },  // ADST_DST          = 12,
    {            idst4_c,  vpx_highbd_iadst4_c },  // DST_FLIPADST      = 13,
    { vpx_highbd_iadst4_c,            idst4_c  },  // FLIPADST_DST      = 14,
    {            idst4_c,             idst4_c  },  // DST_DST           = 15
#endif  // CONFIG_EXT_TX
  };
...
void vp10_highbd_iht8x8_64_add_c(const tran_low_t *input, uint8_t *dest8,
  ...
  static const highbd_transform_2d HIGH_IHT_8[] = {
    ...
    {            idst8_c,  vpx_highbd_idct8_c  },  // DST_DCT           = 9,
    { vpx_highbd_idct8_c,             idst8_c  },  // DCT_DST           = 10,
    {            idst8_c,  vpx_highbd_iadst8_c },  // DST_ADST          = 11,
    { vpx_highbd_iadst8_c,            idst8_c  },  // ADST_DST          = 12,
    {            idst8_c,  vpx_highbd_iadst8_c },  // DST_FLIPADST      = 13,
    { vpx_highbd_iadst8_c,            idst8_c  },  // FLIPADST_DST      = 14,
    {            idst8_c,             idst8_c  },  // DST_DST           = 15
#endif  // CONFIG_EXT_TX
  };
...
void vp10_highbd_iht16x16_256_add_c(const tran_low_t *input, uint8_t *dest8,
  ...
  static const highbd_transform_2d HIGH_IHT_16[] = {
    ...
    {            idst16_c,  vpx_highbd_idct16_c  },  // DST_DCT           = 9,
    { vpx_highbd_idct16_c,             idst16_c  },  // DCT_DST           = 10,
    {            idst16_c,  vpx_highbd_iadst16_c },  // DST_ADST          = 11,
    { vpx_highbd_iadst16_c,            idst16_c  },  // ADST_DST          = 12,
    {            idst16_c,  vpx_highbd_iadst16_c },  // DST_FLIPADST      = 13,
    { vpx_highbd_iadst16_c,            idst16_c  },  // FLIPADST_DST      = 14,
    {            idst16_c,             idst16_c  },  // DST_DST           = 15
#endif  // CONFIG_EXT_TX
  };
