...
# define MAX_CU_SIZE_LOG2 7
#else
# define MAX_CU_SIZE_LOG2 6
#endif  // CONFIG_EXT_PARTITION

#define MAX_CU_SIZE (1 << MAX_CU_SIZE_LOG2)
#define MAX_CU_PIXELS (MAX_CU_SIZE * MAX_CU_SIZE)

#define MI_SIZE_LOG2 3
#define MI_SIZE (1 << MI_SIZE_LOG2)  // pixels per mi-unit

#define MI_BLOCK_SIZE_LOG2 (MAX_CU_SIZE_LOG2 - MI_SIZE_LOG2)
...
#define MAX_TX_PIXELS     (MAX_TX_SIZE * MAX_TX_SIZE)

// Number of maxium size transform blocks in the maximum size superblock
#define MAX_TX_BLOCKS_IN_MAX_CU_LOG2 \
  ((MAX_CU_SIZE_LOG2 - MAX_TX_SIZE_LOG2) * 2)
#define MAX_TX_BLOCKS_IN_MAX_CU (1 << MAX_TX_BLOCKS_IN_MAX_CU_LOG2)
...
// TODO(debargha/jingning): Is there any importance to what this value is other
// than it should be bigger than what the weights of the non-nearestmvs can
// sum to?
#if CONFIG_EXT_PARTITION
#define REF_CAT_LEVEL   9999
#else
