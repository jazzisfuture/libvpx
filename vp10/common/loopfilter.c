...
static double restoration_filters_r[RESTORATION_LEVELS + 1][RESTORATION_RANGE_SYM];
...
int vp10_loop_restoration_used(int level, int kf) {
  const restoration_params_t param = vp10_restoration_level_to_params(level, kf);
