...
int main(int argc, char **argv)
{
    ...
    vpx_codec_pts_t      frame_cnt[NUM_ENCODERS];
    ...
    while(frame_avail || got_data)
    {
        ...
        if(vpx_codec_encode_multi(&codec[NUM_ENCODERS-1], frame_avail? &raw[NUM_ENCODERS-1] : NULL, &frame_cnt[NUM_ENCODERS-1],
            1, flags, arg_deadline, NUM_ENCODERS))
