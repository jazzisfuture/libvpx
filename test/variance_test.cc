...
struct TestParams {
  ...
  // Beware of not leaving compiler-generated padding inbetween fields
  // (otherwise GTEST will print uninitialized values)
...
#if CONFIG_VP9_HIGHBITDEPTH
    // TODO(skal): remove!
    src_ = (uint8_t*)CONVERT_TO_SHORTPTR(src_);
    ref_ = (uint8_t*)CONVERT_TO_SHORTPTR(ref_);
#endif
