 ...
 * it calculates the bilinear factors directly instead of using a lookup table
 * and therefore upshifts xoff and yoff by 1. Only every other calculated value
