...
INSTANTIATE_TEST_CASE_P(
    ...
    ::testing::Values(SubpelVarianceParams(6, 6, &vpx_sub_pixel_variance64x64_mmi, 0),
...
INSTANTIATE_TEST_CASE_P(
    ...
    ::testing::Values(SubpelAvgVarianceParams(6, 6, &vpx_sub_pixel_avg_variance64x64_mmi, 0),
