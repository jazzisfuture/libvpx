...
INSTANTIATE_TEST_CASE_P(
    NEON, VP8SseTest,
    ::testing::Values(make_tuple(2, 2, get4x4sse_cs_neon, 0)));

const vp8_variance_fn_t mse16x16_neon = vp8_mse16x16_neon;
INSTANTIATE_TEST_CASE_P(
    NEON, VP8MseTest,
    ::testing::Values(make_tuple(4, 4, mse16x16_neon, 0)));
...
INSTANTIATE_TEST_CASE_P(
    C_8, VP9VarianceTest,
    ::testing::Values(make_tuple(2, 2, highbd_variance4x4_c,   8),
...
INSTANTIATE_TEST_CASE_P(
    ...
    ::testing::Values(make_tuple(2, 2, highbd_12_variance4x4_c,   12),
...
INSTANTIATE_TEST_CASE_P(
    ...
    ::testing::Values(make_tuple(2, 2, highbd_subpel_variance4x4_c,   8),
...
INSTANTIATE_TEST_CASE_P(
    ...
    ::testing::Values(make_tuple(2, 2, highbd_subpel_avg_variance4x4_c,   8),
...
INSTANTIATE_TEST_CASE_P(
    ...
    ::testing::Values(make_tuple(2, 2, highbd_12_subpel_variance4x4_c,   12),
...
INSTANTIATE_TEST_CASE_P(
    ...
    ::testing::Values(make_tuple(3, 3, highbd_variance8x8_sse2,   8),
...
INSTANTIATE_TEST_CASE_P(
    ...
    ::testing::Values(make_tuple(3, 3, highbd_12_variance8x8_sse2,   12),
...
INSTANTIATE_TEST_CASE_P(
    ...
    ::testing::Values(make_tuple(3, 2, highbd_subpel_variance8x4_sse2, 8),
                      make_tuple(3, 3, highbd_subpel_variance8x8_c, 8),
                      make_tuple(3, 4, highbd_subpel_variance8x16_c, 8),
                      make_tuple(4, 3, highbd_subpel_variance16x8_c, 8),
                      make_tuple(4, 4, highbd_subpel_variance16x16_c, 8),
...
INSTANTIATE_TEST_CASE_P(
    ...
    ::testing::Values(make_tuple(3, 2, highbd_10_subpel_variance8x4_c, 10),
                      make_tuple(3, 3, highbd_10_subpel_variance8x8_c, 10),
                      make_tuple(3, 4, highbd_10_subpel_variance8x16_c, 10),
                      make_tuple(4, 3, highbd_10_subpel_variance16x8_c, 10),
                      make_tuple(4, 4, highbd_10_subpel_variance16x16_c, 10),
...
INSTANTIATE_TEST_CASE_P(
    ...
    ::testing::Values(make_tuple(3, 2, highbd_12_subpel_variance8x4_sse2,   12),
