...
const ConvolveFunctions12Tap convolve12_c(vpx_convolve_copy_12_c,
                                          vpx_convolve_horiz_12_c,
                                          vpx_convolve_vert_12_c,
                                          vpx_convolve8_12_c, 0);
const Convolve12TapParam kArrayConvolve12_c[] = { ALL_SIZES_12TAP(
    convolve12_c) };
...
const ConvolveFunctions12Tap convolve12_avx2(vpx_convolve_copy_12_avx2,
                                             vpx_convolve_horiz_12_avx2,
                                             vpx_convolve_vert_12_avx2,
                                             vpx_convolve8_12_avx2, 0);
const Convolve12TapParam kArrayConvolve12_avx2[] = { ALL_SIZES_12TAP(
    convolve12_avx2) };

INSTANTIATE_TEST_SUITE_P(AVX2, ConvolveTest12Tap,
                         ::testing::ValuesIn(kArrayConvolve12_avx2));
#endif  // HAVE_AVX2
