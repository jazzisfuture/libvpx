...
const ConvolveParam kArrayConvolve8_c[] = { ALL_SIZES(convolve8_c) };
INSTANTIATE_TEST_CASE_P(C_8, ConvolveTest,
    ::testing::Values(kArrayConvolve8_c));
...
const ConvolveParam kArrayConvolve10_c[] = { ALL_SIZES(convolve10_c) };
INSTANTIATE_TEST_CASE_P(C_10, ConvolveTest,
    ::testing::Values(kArrayConvolve10_c));
...
const ConvolveParam kArrayConvolve12_c[] = { ALL_SIZES(convolve12_c) };
INSTANTIATE_TEST_CASE_P(C_12, ConvolveTest,
    ::testing::ValuesIn(kArrayConvolve12_c));
...
INSTANTIATE_TEST_CASE_P(C, ConvolveTest,
                        ::testing::ValuesIn(kArrayConvolve8_c));
#endif
...
const ConvolveParam kArrayConvolve8_sse2[] = { ALL_SIZES(convolve8_sse2) };
INSTANTIATE_TEST_CASE_P(SSE2_8, ConvolveTest,
    ::testing::ValuesIn(kArrayConvolve8_sse2));
const ConvolveParam kArrayConvolve10_sse2[] = { ALL_SIZES(convolve10_sse2) };
INSTANTIATE_TEST_CASE_P(SSE2_10, ConvolveTest,
    ::testing::ValuesIn(kArrayConvolve10_sse2));
const ConvolveParam kArrayConvolve12_sse2[] = { ALL_SIZES(convolve12_sse2) };
INSTANTIATE_TEST_CASE_P(SSE2_12, ConvolveTest,
    ::testing::ValuesIn(kArrayConvolve12_sse2));
#else
const ConvolveFunctions convolve8_sse2(
#if CONFIG_USE_X86INC
