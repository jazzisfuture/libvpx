...
INSTANTIATE_TEST_CASE_P(
    ...
    ::testing::Values(
        ...
        make_tuple(&vp10_fht4x4_c, &vp10_iht4x4_16_add_neon, 3, VPX_BITS_8, 16)));
...
INSTANTIATE_TEST_CASE_P(
    ...
    ::testing::Values(
        make_tuple(&vp10_fwht4x4_c, &vpx_iwht4x4_16_add_c, 0, VPX_BITS_8, 16),
        make_tuple(&vp10_fwht4x4_c, &vpx_iwht4x4_16_add_sse2, 0, VPX_BITS_8, 16)));
#endif
...
INSTANTIATE_TEST_CASE_P(
    ...
    ::testing::Values(
        ...
        make_tuple(&vp10_fht4x4_sse2, &vp10_iht4x4_16_add_c, 3, VPX_BITS_8, 16)));
#endif  // HAVE_SSE2 && CONFIG_VP9_HIGHBITDEPTH && !CONFIG_EMULATE_HARDWARE
