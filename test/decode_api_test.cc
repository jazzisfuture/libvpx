...
TEST(DecodeAPI, InvalidParams) {
  ...
  EXPECT_EQ(VPX_CODEC_INVALID_PARAM,
            vpx_codec_dec_init(nullptr, nullptr, nullptr, 0));
  EXPECT_EQ(VPX_CODEC_INVALID_PARAM,
            vpx_codec_dec_init(&dec, nullptr, nullptr, 0));
  EXPECT_EQ(VPX_CODEC_INVALID_PARAM,
            vpx_codec_decode(nullptr, nullptr, 0, nullptr, 0));
  EXPECT_EQ(VPX_CODEC_INVALID_PARAM,
            vpx_codec_decode(nullptr, buf, 0, nullptr, 0));
  EXPECT_EQ(VPX_CODEC_INVALID_PARAM,
            vpx_codec_decode(nullptr, buf, NELEMENTS(buf), nullptr, 0));
  EXPECT_EQ(VPX_CODEC_INVALID_PARAM,
            vpx_codec_decode(nullptr, nullptr, NELEMENTS(buf), nullptr, 0));
  EXPECT_EQ(VPX_CODEC_INVALID_PARAM, vpx_codec_destroy(nullptr));
  EXPECT_TRUE(vpx_codec_error(nullptr) != nullptr);
  EXPECT_TRUE(vpx_codec_error_detail(nullptr) == nullptr);
...
void TestVp9Controls(vpx_codec_ctx_t *dec) {
  ...
  ASSERT_TRUE(vpx_img_alloc(&ref_copy.img, VPX_IMG_FMT_I420, width, height,
                            1) != nullptr);
