...
// TODO: Enable test when https://bugs.chromium.org/p/webm/issues/detail?id=1614
// is fixed.
...
// TODO: Enable test when https://bugs.chromium.org/p/webm/issues/detail?id=701
// is fixed.
// Tests rollover of int64_t value in libvpx encoder interface. The rollover
// happens in the algorithm "(pts + duration) * 10000000 *
// ctx->cfg.g_timebase.num". In this test the second frame will rollover an
// int64_t and the resulting timestamp will become negative.
