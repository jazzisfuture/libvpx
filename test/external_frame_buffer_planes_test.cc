...
int get_vp9_frame_buffer_planes(
    void *priv, size_t size, vpx_codec_frame_buffer_t *fb) {
...
class ExternalFramePlanesMD5Test
 ...
 protected:
  ...
  static int GetVP9FramePlanes(void *priv, size_t size,
    ...
    fb->type = VPX_CODEC_FRAME_BUFFER_PLANES;
    return md5Test->fb_list_.GetFreeFrameBuffer(
        fb->fmt, fb->width, fb->height, fb);
  }
