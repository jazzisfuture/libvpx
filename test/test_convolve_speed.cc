...
#if HAVE_NEON
#include "vpx_dsp/arm/vpx_convolve_avg_neon.c"
#include "vpx_dsp/arm/vpx_convolve_copy_neon.c"
#include "vpx_dsp/arm/vpx_convolve8_avg_neon.c"
#include "vpx_dsp/arm/vpx_convolve8_neon.c"
#include "vpx_dsp/arm/vpx_convolve_neon.c"
#endif

namespace {

static const unsigned int kMaxDimension = 64;
static const unsigned int kNumTestFuncs = 3;
...
struct ConvolveFunctions {
  ConvolveFunctions(ConvolveFunc copyA, ConvolveFunc copyB, ConvolveFunc copyC,
                    ConvolveFunc avgA, ConvolveFunc avgB, ConvolveFunc avgC,
                    ConvolveFunc h8A, ConvolveFunc h8B, ConvolveFunc h8C,
                    ConvolveFunc h8_avgA, ConvolveFunc h8_avgB,
                    ConvolveFunc h8_avgC, ConvolveFunc v8A, ConvolveFunc v8B,
                    ConvolveFunc v8C, ConvolveFunc v8_avgA,
                    ConvolveFunc v8_avgB, ConvolveFunc v8_avgC,
                    ConvolveFunc hv8A, ConvolveFunc hv8B, ConvolveFunc hv8C,
                    ConvolveFunc hv8_avgA, ConvolveFunc hv8_avgB,
                    ConvolveFunc hv8_avgC, int bd)
      : use_highbd_(bd) {
    copy_[0][0] = copyA;
    copy_[0][1] = copyB;
    copy_[0][2] = copyC;
...
const ConvolveFunctions convolve8_neon(
    vpx_convolve_copy_neon_asm, vpx_convolve_copy_neon_org,
    vpx_convolve_copy_neon, vpx_convolve_avg_neon_asm,
    vpx_convolve_avg_neon_org, vpx_convolve_avg_neon,
    vpx_convolve8_horiz_neon_asm, vpx_convolve8_horiz_neon_org,
    vpx_convolve8_horiz_neon, vpx_convolve8_avg_horiz_neon_asm,
    vpx_convolve8_avg_horiz_neon_org, vpx_convolve8_avg_horiz_neon,
    vpx_convolve8_vert_neon_asm, vpx_convolve8_vert_neon_org,
    vpx_convolve8_vert_neon, vpx_convolve8_avg_vert_neon_asm,
    vpx_convolve8_avg_vert_neon_org, vpx_convolve8_avg_vert_neon,
    vpx_convolve8_neon_asm, vpx_convolve8_neon_org, vpx_convolve8_neon,
    vpx_convolve8_avg_neon_asm, vpx_convolve8_avg_neon_org,
...
const ConvolveFunctions convolve8_c(
    vpx_convolve_copy_c, vpx_convolve_copy_c, vpx_convolve_copy_c,
    vpx_convolve_avg_c, vpx_convolve_avg_c, vpx_convolve_avg_c,
    vpx_convolve8_horiz_c, vpx_convolve8_horiz_c, vpx_convolve8_horiz_c,
    vpx_convolve8_avg_horiz_c, vpx_convolve8_avg_horiz_c,
    vpx_convolve8_avg_horiz_c, vpx_convolve8_vert_c, vpx_convolve8_vert_c,
    vpx_convolve8_vert_c, vpx_convolve8_avg_vert_c, vpx_convolve8_avg_vert_c,
    vpx_convolve8_avg_vert_c, vpx_convolve8_c, vpx_convolve8_c, vpx_convolve8_c,
    vpx_convolve8_avg_c, vpx_convolve8_avg_c, vpx_convolve8_avg_c, 0);
