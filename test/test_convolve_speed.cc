...
struct ConvolveFunctions {
  ConvolveFunctions(ConvolveFunc copyA, ConvolveFunc copyB,
                    ConvolveFunc avgA, ConvolveFunc avgB,
                    ConvolveFunc h8A, ConvolveFunc h8B,
                    ConvolveFunc h8_avgA, ConvolveFunc h8_avgB,
                     ConvolveFunc v8A, ConvolveFunc v8B,
                     ConvolveFunc v8_avgA,
                    ConvolveFunc v8_avgB,
                    ConvolveFunc hv8A, ConvolveFunc hv8B,
...
const ConvolveFunctions convolve8_c(
    vpx_convolve_copy_c, vpx_convolve_copy_c,
    vpx_convolve_avg_c, vpx_convolve_avg_c,
    vpx_convolve8_horiz_c, vpx_convolve8_horiz_c,
    vpx_convolve8_avg_horiz_c, vpx_convolve8_avg_horiz_c,
    vpx_convolve8_vert_c, vpx_convolve8_vert_c,
    vpx_convolve8_avg_vert_c, vpx_convolve8_avg_vert_c,
    vpx_convolve8_c, vpx_convolve8_c,
    vpx_convolve8_avg_c,  vpx_convolve8_avg_c, 0);
