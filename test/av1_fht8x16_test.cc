...
typedef tuple<HbdHtFunc, int, int> HighbdHt8x16Param;

void highbd_fht8x16_ref(const int16_t *in, int32_t *out, int stride,
                        int tx_type, int bd) {
  av1_fwd_txfm2d_8x16_c(in, out, stride, tx_type, bd);
}
...
#if CONFIG_AOM_HIGHBITDEPTH
class AV1HighbdTrans8x16HT
    : public ::testing::TestWithParam<HighbdHt8x16Param> {
 public:
  virtual ~AV1HighbdTrans8x16HT() {}

  virtual void SetUp() {
    fwd_txfm_ = GET_PARAM(0);
    fwd_txfm_ref_ = highbd_fht8x16_ref;
...
void AV1HighbdTrans8x16HT::RunBitexactCheck() {
...
TEST_P(AV1HighbdTrans8x16HT, HighbdCoeffCheck) { RunBitexactCheck(); }
#endif  // CONFIG_AOM_HIGHBITDEPTH
...
const HighbdHt8x16Param kArrayHBDHt8x16Param_sse4_1[] = {
  make_tuple(&av1_fwd_txfm2d_8x16_sse4_1, 0, 10),
  make_tuple(&av1_fwd_txfm2d_8x16_sse4_1, 0, 12),
  make_tuple(&av1_fwd_txfm2d_8x16_sse4_1, 1, 10),
  make_tuple(&av1_fwd_txfm2d_8x16_sse4_1, 1, 12),
  make_tuple(&av1_fwd_txfm2d_8x16_sse4_1, 2, 10),
  make_tuple(&av1_fwd_txfm2d_8x16_sse4_1, 2, 12),
  make_tuple(&av1_fwd_txfm2d_8x16_sse4_1, 3, 10),
  make_tuple(&av1_fwd_txfm2d_8x16_sse4_1, 3, 12),
#if CONFIG_EXT_TX
  make_tuple(&av1_fwd_txfm2d_8x16_sse4_1, 4, 10),
  make_tuple(&av1_fwd_txfm2d_8x16_sse4_1, 4, 12),
  make_tuple(&av1_fwd_txfm2d_8x16_sse4_1, 5, 10),
  make_tuple(&av1_fwd_txfm2d_8x16_sse4_1, 5, 12),
  make_tuple(&av1_fwd_txfm2d_8x16_sse4_1, 6, 10),
  make_tuple(&av1_fwd_txfm2d_8x16_sse4_1, 6, 12),
  make_tuple(&av1_fwd_txfm2d_8x16_sse4_1, 7, 10),
  make_tuple(&av1_fwd_txfm2d_8x16_sse4_1, 7, 12),
  make_tuple(&av1_fwd_txfm2d_8x16_sse4_1, 8, 10),
  make_tuple(&av1_fwd_txfm2d_8x16_sse4_1, 8, 12),
#endif  // CONFIG_EXT_TX
};
INSTANTIATE_TEST_CASE_P(SSE4_1, AV1HighbdTrans8x16HT,
                        ::testing::ValuesIn(kArrayHBDHt8x16Param_sse4_1));
