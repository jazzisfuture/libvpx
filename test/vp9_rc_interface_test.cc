...
class RcInterfaceTest {
 ...
 public:
  void RunOneLayer() {
    ...
    one_layer_file.open("/usr/local/google/home/jianj/Codes/libvpx/one_layer");
    for (size_t i = 0; i < kNumFrame; i++) {
      ...
      rc_cfg_.target_bandwidth = frame_info.target_bandwidth_ / 1000;
  ...
  void RunSVC() {
    ...
    svc_file.open("/usr/local/google/home/jianj/svc_frame_info.txt");
...
int main(void) {
  RcInterfaceTest rc_interface_test;
  rc_interface_test.RunOneLayer();
  return 0;
}
