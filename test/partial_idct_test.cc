...
TEST_P(PartialIDctTest, ResultsMatch) {
  ...
  for (int i = 0; i < count_test_block; ++i) {
    ...
    memset(dst1, 0, block_size);
    memset(dst2, 0, block_size);
    memset(test_coef_block1, 0, sizeof(int16_t) * block_size);
    memset(test_coef_block2, 0, sizeof(int16_t) * block_size);
