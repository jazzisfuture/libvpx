...
class PartialIDctTest : public ::testing::TestWithParam<PartialInvTxfmParam> {
 public:
  ...
  virtual void SetUp() {
    ...
    input_block_ = (tran_low_t *)malloc(sizeof(*input_block_) * size_ * size_);
    output_block_ = (uint8_t *)malloc(sizeof(*output_block_) * size_ * size_);
    output_block_ref_ =
        (uint8_t *)malloc(sizeof(*output_block_ref_) * size_ * size_);
  }
