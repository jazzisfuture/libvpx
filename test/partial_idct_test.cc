...
class PartialIDctTest : public ::testing::TestWithParam<PartialInvTxfmParam> {
 public:
  ...
  virtual void SetUp() {
    ...
    input_block_ = new tran_low_t[size_ * size_];
    output_block_ = new uint8_t[size_ * size_];
    output_block_ref_ = new uint8_t[size_ * size_];
  }

  virtual void TearDown() {
    delete[] input_block_;
    input_block_ = NULL;
    delete[] output_block_;
    output_block_ = NULL;
    delete[] output_block_ref_;
