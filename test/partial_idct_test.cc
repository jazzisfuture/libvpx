...
TEST_P(PartialIDctTest, Speed) {
  ...
  for (int i = 0; i < (500000 * count_test_block / input_block_size_); ++i) {
    ASM_REGISTER_STATE_CHECK(Exec(full_itxfm_, output_block_ref_));
  }
...
INSTANTIATE_TEST_CASE_P(
    ...
    ::testing::Values(
        make_tuple(&vpx_highbd_fdct4x4_c, &vpx_highbd_idct4x4_16_add_c,
                   &vpx_highbd_idct4x4_16_add_neon, TX_4X4, 1, 8),
        make_tuple(&vpx_highbd_fdct4x4_c, &vpx_highbd_idct4x4_16_add_c,
                   &vpx_highbd_idct4x4_16_add_neon, TX_4X4, 1, 10),
        make_tuple(&vpx_highbd_fdct4x4_c, &vpx_highbd_idct4x4_16_add_c,
                   &vpx_highbd_idct4x4_16_add_neon, TX_4X4, 1, 12),
