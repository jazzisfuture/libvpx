...
const int kCpuUsedVectors[] = { 2 };

const int kTestModes[] = { MAX_EXTREME_MV, MIN_EXTREME_MV };
...
TEST_P(MotionVectorTestLarge, OverallTest) {
  cfg_.rc_target_bitrate = 80000;
  cfg_.g_profile = 0;
  init_flags_ = VPX_CODEC_USE_PSNR;

  testing::internal::scoped_ptr<libvpx_test::VideoSource> video;
  video.reset(new libvpx_test::YUVVideoSource(
      "niklas_640_480_30.yuv", VPX_IMG_FMT_I420, 640 * 8, 480 * 8,
        30, 1, 0, 3)); //5));
