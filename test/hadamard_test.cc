...
TEST_P(Hadamard8x8Test, DISABLED_Speed) {
  ...
  HadamardSpeedTest8x8(h_func_, 100);
  HadamardSpeedTest8x8(h_func_, 1000);
  HadamardSpeedTest8x8(h_func_, 10000);
  HadamardSpeedTest8x8(h_func_, 100000);
  HadamardSpeedTest8x8(h_func_, 1000000);
}
...
TEST_P(Hadamard16x16Test, DISABLED_Speed) {
  ...
  HadamardSpeedTest16x16(h_func_, 100);
  HadamardSpeedTest16x16(h_func_, 1000);
  HadamardSpeedTest16x16(h_func_, 10000);
  HadamardSpeedTest16x16(h_func_, 100000);
  HadamardSpeedTest16x16(h_func_, 1000000);
}
