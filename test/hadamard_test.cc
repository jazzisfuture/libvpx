...
typedef void (*HadamardFunc)(const int16_t *a, int a_stride,
                             int16_t *b);
...
class Hadamard8x8Test : public ::testing::TestWithParam<HadamardFunc> {
 public:
  virtual void SetUp() {
    h_func_ = GetParam();
...
class Hadamard16x16Test : public ::testing::TestWithParam<HadamardFunc> {
 public:
  virtual void SetUp() {
    h_func_ = GetParam();
    rnd_.Reset(ACMRandom::DeterministicSeed());
