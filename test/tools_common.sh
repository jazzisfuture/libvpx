...
# Removes strings from positional parameter one that match filter specified by
# positional parameter two.
# TODO: THis does not do what it claims it does, and it's broken on top of that!
# PAss it a list and ^DISABLED and it does what I expect
# Pass it vp8 and things go weird
# I think I'm sleepy.
filter_strings() {
  strings=$1
  filter=$2
