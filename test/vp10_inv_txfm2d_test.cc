...
TXFM_2D_CFG inv_txfm_cfg_ls[4][4] = {
...
Inv_Txfm2d_Func inv_txfm_func_ls[4] = {
...
TEST(vp10_inv_txfm2d, round_trip) {
  for (int txfm_size_idx = 0; txfm_size_idx < txfm_size_num; ++txfm_size_idx) {
    ...
    for (int txfm_type_idx = 0; txfm_type_idx < txfm_type_num;
      ...
      TXFM_2D_CFG inv_txfm_cfg = inv_txfm_cfg_ls[txfm_size_idx][txfm_type_idx];
      Fwd_Txfm2d_Func fwd_txfm_func = fwd_txfm_func_ls[txfm_size_idx];
      Inv_Txfm2d_Func inv_txfm_func = inv_txfm_func_ls[txfm_size_idx];
      ...
      double max_abs_avg_error = 0.024;
