...
const Fwd_Txfm2d_Func fwd_txfm_func_ls[4] = {vp10_fwd_txfm2d_4x4, vp10_fwd_txfm2d_8x8,
...
TEST(vp10_inv_txfm2d, round_trip) {
  for (int txfm_size_idx = 0; txfm_size_idx < txfm_size_num; ++txfm_size_idx) {
    ...
    for (int txfm_type_idx = 0; txfm_type_idx < txfm_type_num;
      ...
      const TXFM_2D_CFG inv_txfm_cfg = inv_txfm_cfg_ls[txfm_size_idx][txfm_type_idx];
