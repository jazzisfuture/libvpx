...
const SadMxNParam c_highbd_8_tests[] = {
...
const SadMxNParam c_highbd_10_tests[] = {
...
const SadMxNParam c_highbd_12_tests[] = {
...
const SadMxNAvgParam avg_c_highbd_8_tests[] = {
...
const SadMxNAvgParam avg_c_highbd_10_tests[] = {
...
const SadMxNAvgParam avg_c_highbd_12_tests[] = {
...
const SadMxNx4Param x4d_c_highbd_8_tests[] = {
...
INSTANTIATE_TEST_CASE_P(C_8, SADx4Test,
                        ::testing::ValuesIn(x4d_c_highbd_8_tests));

const SadMxNx4Param x4d_c_highbd_10_tests[] = {
...
INSTANTIATE_TEST_CASE_P(C_10, SADx4Test,
                        ::testing::ValuesIn(x4d_c_highbd_10_tests));

const SadMxNx4Param x4d_c_highbd_12_tests[] = {
...
INSTANTIATE_TEST_CASE_P(C_12, SADx4Test,
                        ::testing::ValuesIn(x4d_c_highbd_12_tests));
#endif  // CONFIG_VP9_HIGHBITDEPTH
...
const SadMxNParam sse2_highbd_8_tests[] = {
...
INSTANTIATE_TEST_CASE_P(SSE2_8, SADTest,
                        ::testing::ValuesIn(sse2_highbd_8_tests));

const SadMxNParam sse2_highbd_10_tests[] = {
...
INSTANTIATE_TEST_CASE_P(SSE2_10, SADTest,
                        ::testing::ValuesIn(sse2_highbd_10_tests));

const SadMxNParam sse2_highbd_12_tests[] = {
...
INSTANTIATE_TEST_CASE_P(SSE2_12, SADTest,
                        ::testing::ValuesIn(sse2_highbd_12_tests));
...
const SadMxNAvgParam avg_sse2_highbd_8_tests[] = {
...
INSTANTIATE_TEST_CASE_P(SSE2_8, SADavgTest,
                        ::testing::ValuesIn(avg_sse2_highbd_8_tests));

const SadMxNAvgParam avg_sse2_highbd_10_tests[] = {
...
INSTANTIATE_TEST_CASE_P(SSE2_10, SADavgTest,
                        ::testing::ValuesIn(avg_sse2_highbd_10_tests));

const SadMxNAvgParam avg_sse2_highbd_12_tests[] = {
...
INSTANTIATE_TEST_CASE_P(SSE2_12, SADavgTest,
                        ::testing::ValuesIn(avg_sse2_highbd_12_tests));
...
const SadMxNx4Param x4d_sse2_highbd_8_tests[] = {
...
INSTANTIATE_TEST_CASE_P(SSE2_8, SADx4Test,
                        ::testing::ValuesIn(x4d_sse2_highbd_8_tests));

const SadMxNx4Param x4d_sse2_highbd_10_tests[] = {
...
INSTANTIATE_TEST_CASE_P(SSE2_10, SADx4Test,
                        ::testing::ValuesIn(x4d_sse2_highbd_10_tests));

const SadMxNx4Param x4d_sse2_highbd_12_tests[] = {
...
INSTANTIATE_TEST_CASE_P(SSE2_12, SADx4Test,
                        ::testing::ValuesIn(x4d_sse2_highbd_12_tests));
#endif  // CONFIG_VP9_HIGHBITDEPTH
#endif  // CONFIG_USE_X86INC
#endif  // HAVE_SSE2
...
#if 0
// Ronald appears to have reimplemented these (faster?) in sse2:
// 02ff360b333a88ca8866b191d8928e4b980911dd
const SadMxNFunc sad16x16_sse3 = vpx_sad16x16_sse3;
const SadMxNParam sse3_tests[] = {
  make_tuple(16, 16, sad16x16_sse3, -1),
};
INSTANTIATE_TEST_CASE_P(SSE3, SADTest, ::testing::ValuesIn(sse3_tests));
#endif

#if 0
// Ronald appears to have reimplemented these (faster?) in sse2:
// c0ce2ab3490069f80b40fe5f25e76113b1cdd4bf
const SadMxNx4Func sad16x16x4d_sse3 = vpx_sad16x16x4d_sse3;
const SadMxNx4Func sad16x8x4d_sse3 = vpx_sad16x8x4d_sse3;
const SadMxNx4Func sad8x16x4d_sse3 = vpx_sad8x16x4d_sse3;
const SadMxNx4Func sad8x8x4d_sse3 = vpx_sad8x8x4d_sse3;
const SadMxNx4Func sad4x4x4d_sse3 = vpx_sad4x4x4d_sse3;
const SadMxNx4Param x4d_sse3_tests[] = {
  make_tuple(16, 16, sad16x16x4d_sse3, -1),
  make_tuple(16, 8, sad16x8x4d_sse3, -1),
  make_tuple(8, 16, sad8x16x4d_sse3, -1),
  make_tuple(8, 8, sad8x8x4d_sse3, -1),
  make_tuple(4, 4, sad4x4x4d_sse3, -1),
};
INSTANTIATE_TEST_CASE_P(SSE3, SADx4Test, ::testing::ValuesIn(x4d_sse3_tests));
#endif  // 0
#endif  // HAVE_SSE3
