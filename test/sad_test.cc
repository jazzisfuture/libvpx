...
#include "vp9/common/vp9_common.h" // CONVERT_TO
...
typedef unsigned int (*SadMxNFunc)(const uint8_t *source_ptr,
                                   int source_stride,
                                   const uint8_t *reference_ptr,
                                   int reference_stride);
typedef std::tr1::tuple<int, int, SadMxNFunc, int> SadMxNParam;
typedef uint32_t (*SadMxNAvgFunc)(const uint8_t *source_ptr,
                                  int source_stride,
                                  const uint8_t *reference_ptr,
                                  int reference_stride,
...
//------------------------------------------------------------------------------
// C functions
const SadMxNFunc sad_64x64_c = vpx_sad64x64_c;
const SadMxNFunc sad_32x32_c = vpx_sad32x32_c;
const SadMxNFunc sad_16x16_c = vpx_sad16x16_c;
const SadMxNFunc sad_8x16_c = vpx_sad8x16_c;
const SadMxNFunc sad_16x8_c = vpx_sad16x8_c;
const SadMxNFunc sad_8x8_c = vpx_sad8x8_c;
const SadMxNFunc sad_8x4_c = vpx_sad8x4_c;
const SadMxNFunc sad_4x8_c = vpx_sad4x8_c;
const SadMxNFunc sad_4x4_c = vpx_sad4x4_c;
const SadMxNParam c_tests[] = {
  make_tuple(64, 64, sad_64x64_c, -1),
  make_tuple(32, 32, sad_32x32_c, -1),
  make_tuple(16, 16, sad_16x16_c, -1),
  make_tuple(8, 16, sad_8x16_c, -1),
  make_tuple(16, 8, sad_16x8_c, -1),
  make_tuple(8, 8, sad_8x8_c, -1),
  make_tuple(8, 4, sad_8x4_c, -1),
  make_tuple(4, 8, sad_4x8_c, -1),
  make_tuple(4, 4, sad_4x4_c, -1),
};
INSTANTIATE_TEST_CASE_P(C, SADTest, ::testing::ValuesIn(c_tests));

#if 0
const SadMxNx4Func sad_64x64x4d_c = vpx_sad64x64x4d_c;
const SadMxNx4Func sad_64x32x4d_c = vpx_sad64x32x4d_c;
const SadMxNx4Func sad_32x64x4d_c = vpx_sad32x64x4d_c;
const SadMxNx4Func sad_32x32x4d_c = vpx_sad32x32x4d_c;
const SadMxNx4Func sad_32x16x4d_c = vpx_sad32x16x4d_c;
const SadMxNx4Func sad_16x32x4d_c = vpx_sad16x32x4d_c;
const SadMxNx4Func sad_16x16x4d_c = vpx_sad16x16x4d_c;
const SadMxNx4Func sad_16x8x4d_c = vpx_sad16x8x4d_c;
const SadMxNx4Func sad_8x16x4d_c = vpx_sad8x16x4d_c;
const SadMxNx4Func sad_8x8x4d_c = vpx_sad8x8x4d_c;
const SadMxNx4Func sad_8x4x4d_c = vpx_sad8x4x4d_c;
const SadMxNx4Func sad_4x8x4d_c = vpx_sad4x8x4d_c;
const SadMxNx4Func sad_4x4x4d_c = vpx_sad4x4x4d_c;
...
#endif
// TODO: add these fxns to rtcd
#if CONFIG_VP9_HIGHBITDEPTH
const SadMxNVp9Func highbd_sad_64x64_c = vpx_highbd_sad64x64_c;
const SadMxNVp9Func highbd_sad_32x32_c = vpx_highbd_sad32x32_c;
const SadMxNVp9Func highbd_sad_16x16_c = vpx_highbd_sad16x16_c;
const SadMxNVp9Func highbd_sad_8x16_c = vpx_highbd_sad8x16_c;
const SadMxNVp9Func highbd_sad_16x8_c = vpx_highbd_sad16x8_c;
const SadMxNVp9Func highbd_sad_8x8_c = vpx_highbd_sad8x8_c;
const SadMxNVp9Func highbd_sad_8x4_c = vpx_highbd_sad8x4_c;
const SadMxNVp9Func highbd_sad_4x8_c = vpx_highbd_sad4x8_c;
const SadMxNVp9Func highbd_sad_4x4_c = vpx_highbd_sad4x4_c;
const SadMxNVp9Param c_highbd_8_tests[] = {
  make_tuple(64, 64, highbd_sad_64x64_c, 8),
  make_tuple(32, 32, highbd_sad_32x32_c, 8),
  make_tuple(16, 16, highbd_sad_16x16_c, 8),
  make_tuple(8, 16, highbd_sad_8x16_c, 8),
  make_tuple(16, 8, highbd_sad_16x8_c, 8),
  make_tuple(8, 8, highbd_sad_8x8_c, 8),
  make_tuple(8, 4, highbd_sad_8x4_c, 8),
  make_tuple(4, 8, highbd_sad_4x8_c, 8),
  make_tuple(4, 4, highbd_sad_4x4_c, 8),
};
INSTANTIATE_TEST_CASE_P(C_8, SADTest,
                        ::testing::ValuesIn(c_highbd_8_tests));

const SadMxNVp9Param c_highbd_10_tests[] = {
  make_tuple(64, 64, highbd_sad_64x64_c, 10),
  make_tuple(32, 32, highbd_sad_32x32_c, 10),
  make_tuple(16, 16, highbd_sad_16x16_c, 10),
  make_tuple(8, 16, highbd_sad_8x16_c, 10),
  make_tuple(16, 8, highbd_sad_16x8_c, 10),
  make_tuple(8, 8, highbd_sad_8x8_c, 10),
  make_tuple(8, 4, highbd_sad_8x4_c, 10),
  make_tuple(4, 8, highbd_sad_4x8_c, 10),
  make_tuple(4, 4, highbd_sad_4x4_c, 10),
};
INSTANTIATE_TEST_CASE_P(C_10, SADTest,
                        ::testing::ValuesIn(c_highbd_10_tests));

const SadMxNVp9Param c_highbd_12_tests[] = {
  make_tuple(64, 64, highbd_sad_64x64_c, 12),
  make_tuple(32, 32, highbd_sad_32x32_c, 12),
  make_tuple(16, 16, highbd_sad_16x16_c, 12),
  make_tuple(8, 16, highbd_sad_8x16_c, 12),
  make_tuple(16, 8, highbd_sad_16x8_c, 12),
  make_tuple(8, 8, highbd_sad_8x8_c, 12),
  make_tuple(8, 4, highbd_sad_8x4_c, 12),
  make_tuple(4, 8, highbd_sad_4x8_c, 12),
  make_tuple(4, 4, highbd_sad_4x4_c, 12),
};
INSTANTIATE_TEST_CASE_P(C_12, SADTest,
                        ::testing::ValuesIn(c_highbd_12_tests));

const SadMxNAvgVp9Func highbd_sad8x4_avg_c = vpx_highbd_sad8x4_avg_c;
const SadMxNAvgVp9Func highbd_sad8x8_avg_c = vpx_highbd_sad8x8_avg_c;
const SadMxNAvgVp9Func highbd_sad8x16_avg_c = vpx_highbd_sad8x16_avg_c;
const SadMxNAvgVp9Func highbd_sad16x8_avg_c = vpx_highbd_sad16x8_avg_c;
const SadMxNAvgVp9Func highbd_sad16x16_avg_c = vpx_highbd_sad16x16_avg_c;
const SadMxNAvgVp9Func highbd_sad16x32_avg_c = vpx_highbd_sad16x32_avg_c;
const SadMxNAvgVp9Func highbd_sad32x16_avg_c = vpx_highbd_sad32x16_avg_c;
const SadMxNAvgVp9Func highbd_sad32x32_avg_c = vpx_highbd_sad32x32_avg_c;
const SadMxNAvgVp9Func highbd_sad32x64_avg_c = vpx_highbd_sad32x64_avg_c;
const SadMxNAvgVp9Func highbd_sad64x32_avg_c = vpx_highbd_sad64x32_avg_c;
const SadMxNAvgVp9Func highbd_sad64x64_avg_c = vpx_highbd_sad64x64_avg_c;
SadMxNAvgVp9Param avg_c_highbd_8_tests[] = {
...
INSTANTIATE_TEST_CASE_P(C_8, SADavgTest,
                        ::testing::ValuesIn(avg_c_highbd_8_tests));

SadMxNAvgVp9Param avg_c_highbd_10_tests[] = {
...
INSTANTIATE_TEST_CASE_P(C_10, SADavgTest,
                        ::testing::ValuesIn(avg_c_highbd_10_tests));

SadMxNAvgVp9Param avg_c_highbd_12_tests[] = {
...
INSTANTIATE_TEST_CASE_P(C_12, SADavgTest,
                        ::testing::ValuesIn(avg_c_highbd_12_tests));

const SadMxNx4Func highbd_sad_64x64x4d_c = vpx_highbd_sad64x64x4d_c;
const SadMxNx4Func highbd_sad_64x32x4d_c = vpx_highbd_sad64x32x4d_c;
const SadMxNx4Func highbd_sad_32x64x4d_c = vpx_highbd_sad32x64x4d_c;
const SadMxNx4Func highbd_sad_32x32x4d_c = vpx_highbd_sad32x32x4d_c;
const SadMxNx4Func highbd_sad_32x16x4d_c = vpx_highbd_sad32x16x4d_c;
const SadMxNx4Func highbd_sad_16x32x4d_c = vpx_highbd_sad16x32x4d_c;
const SadMxNx4Func highbd_sad_16x16x4d_c = vpx_highbd_sad16x16x4d_c;
const SadMxNx4Func highbd_sad_16x8x4d_c  = vpx_highbd_sad16x8x4d_c;
const SadMxNx4Func highbd_sad_8x16x4d_c  = vpx_highbd_sad8x16x4d_c;
const SadMxNx4Func highbd_sad_8x8x4d_c   = vpx_highbd_sad8x8x4d_c;
const SadMxNx4Func highbd_sad_8x4x4d_c   = vpx_highbd_sad8x4x4d_c;
const SadMxNx4Func highbd_sad_4x8x4d_c   = vpx_highbd_sad4x8x4d_c;
const SadMxNx4Func highbd_sad_4x4x4d_c   = vpx_highbd_sad4x4x4d_c;
...
#endif  // CONFIG_VP8_ENCODER
const SadMxNFunc sad_64x64_neon = vpx_sad64x64_neon;
const SadMxNFunc sad_32x32_neon = vpx_sad32x32_neon;
const SadMxNFunc sad_16x16_neon = vpx_sad16x16_neon;
const SadMxNFunc sad_8x8_neon = vpx_sad8x8_neon;
const SadMxNParam neon_tests[] = {
  make_tuple(64, 64, sad_64x64_neon, -1),
  make_tuple(32, 32, sad_32x32_neon, -1),
  make_tuple(16, 16, sad_16x16_neon, -1),
  make_tuple(8, 8, sad_8x8_neon, -1),
};
...
const SadMxNFunc sad_4x4_sse = vpx_sad4x4_sse;
const SadMxNFunc sad_4x8_sse = vpx_sad4x8_sse;
INSTANTIATE_TEST_CASE_P(SSE, SADTest, ::testing::Values(
                        make_tuple(4, 4, sad_4x4_sse, -1),
                        make_tuple(4, 8, sad_4x8_sse, -1)));

const SadMxNx4Func sad_4x8x4d_sse = vpx_sad4x8x4d_sse;
const SadMxNx4Func sad_4x4x4d_sse = vpx_sad4x4x4d_sse;
...
#if CONFIG_USE_X86INC
const SadMxNFunc sad_64x64_sse2 = vpx_sad64x64_sse2;
const SadMxNFunc sad_64x32_sse2 = vpx_sad64x32_sse2;
const SadMxNFunc sad_32x64_sse2 = vpx_sad32x64_sse2;
const SadMxNFunc sad_32x32_sse2 = vpx_sad32x32_sse2;
const SadMxNFunc sad_32x16_sse2 = vpx_sad32x16_sse2;
const SadMxNFunc sad_16x32_sse2 = vpx_sad16x32_sse2;
const SadMxNFunc sad_16x16_sse2 = vpx_sad16x16_sse2;
const SadMxNFunc sad_16x8_sse2 = vpx_sad16x8_sse2;
const SadMxNFunc sad_8x16_sse2 = vpx_sad8x16_sse2;
const SadMxNFunc sad_8x8_sse2 = vpx_sad8x8_sse2;
const SadMxNFunc sad_8x4_sse2 = vpx_sad8x4_sse2;

const SadMxNx4Func sad_64x64x4d_sse2 = vpx_sad64x64x4d_sse2;
const SadMxNx4Func sad_64x32x4d_sse2 = vpx_sad64x32x4d_sse2;
const SadMxNx4Func sad_32x64x4d_sse2 = vpx_sad32x64x4d_sse2;
const SadMxNx4Func sad_32x32x4d_sse2 = vpx_sad32x32x4d_sse2;
const SadMxNx4Func sad_32x16x4d_sse2 = vpx_sad32x16x4d_sse2;
const SadMxNx4Func sad_16x32x4d_sse2 = vpx_sad16x32x4d_sse2;
const SadMxNx4Func sad_16x16x4d_sse2 = vpx_sad16x16x4d_sse2;
const SadMxNx4Func sad_16x8x4d_sse2 = vpx_sad16x8x4d_sse2;
const SadMxNx4Func sad_8x16x4d_sse2 = vpx_sad8x16x4d_sse2;
const SadMxNx4Func sad_8x8x4d_sse2 = vpx_sad8x8x4d_sse2;
const SadMxNx4Func sad_8x4x4d_sse2 = vpx_sad8x4x4d_sse2;

#if CONFIG_VP9_HIGHBITDEPTH
const SadMxNVp9Func highbd_sad8x4_sse2 = vpx_highbd_sad8x4_sse2;
const SadMxNVp9Func highbd_sad8x8_sse2 = vpx_highbd_sad8x8_sse2;
const SadMxNVp9Func highbd_sad8x16_sse2 = vpx_highbd_sad8x16_sse2;
const SadMxNVp9Func highbd_sad16x8_sse2 = vpx_highbd_sad16x8_sse2;
const SadMxNVp9Func highbd_sad16x16_sse2 = vpx_highbd_sad16x16_sse2;
const SadMxNVp9Func highbd_sad16x32_sse2 = vpx_highbd_sad16x32_sse2;
const SadMxNVp9Func highbd_sad32x16_sse2 = vpx_highbd_sad32x16_sse2;
const SadMxNVp9Func highbd_sad32x32_sse2 = vpx_highbd_sad32x32_sse2;
const SadMxNVp9Func highbd_sad32x64_sse2 = vpx_highbd_sad32x64_sse2;
const SadMxNVp9Func highbd_sad64x32_sse2 = vpx_highbd_sad64x32_sse2;
const SadMxNVp9Func highbd_sad64x64_sse2 = vpx_highbd_sad64x64_sse2;

INSTANTIATE_TEST_CASE_P(SSE2, SADTest, ::testing::Values(
                        make_tuple(64, 64, sad_64x64_sse2, -1),
                        make_tuple(64, 32, sad_64x32_sse2, -1),
                        make_tuple(32, 64, sad_32x64_sse2, -1),
                        make_tuple(32, 32, sad_32x32_sse2, -1),
                        make_tuple(32, 16, sad_32x16_sse2, -1),
                        make_tuple(16, 32, sad_16x32_sse2, -1),
                        make_tuple(16, 16, sad_16x16_sse2, -1),
                        make_tuple(16, 8, sad_16x8_sse2, -1),
                        make_tuple(8, 16, sad_8x16_sse2, -1),
                        make_tuple(8, 8, sad_8x8_sse2, -1),
                        make_tuple(8, 4, sad_8x4_sse2, -1),
...
const SadMxNAvgVp9Func highbd_sad8x4_avg_sse2 = vpx_highbd_sad8x4_avg_sse2;
const SadMxNAvgVp9Func highbd_sad8x8_avg_sse2 = vpx_highbd_sad8x8_avg_sse2;
const SadMxNAvgVp9Func highbd_sad8x16_avg_sse2 =
  vpx_highbd_sad8x16_avg_sse2;
const SadMxNAvgVp9Func highbd_sad16x8_avg_sse2 =
  vpx_highbd_sad16x8_avg_sse2;
const SadMxNAvgVp9Func highbd_sad16x16_avg_sse2 =
  vpx_highbd_sad16x16_avg_sse2;
const SadMxNAvgVp9Func highbd_sad16x32_avg_sse2 =
  vpx_highbd_sad16x32_avg_sse2;
const SadMxNAvgVp9Func highbd_sad32x16_avg_sse2 =
  vpx_highbd_sad32x16_avg_sse2;
const SadMxNAvgVp9Func highbd_sad32x32_avg_sse2 =
  vpx_highbd_sad32x32_avg_sse2;
const SadMxNAvgVp9Func highbd_sad32x64_avg_sse2 =
  vpx_highbd_sad32x64_avg_sse2;
const SadMxNAvgVp9Func highbd_sad64x32_avg_sse2 =
  vpx_highbd_sad64x32_avg_sse2;
const SadMxNAvgVp9Func highbd_sad64x64_avg_sse2 =
  vpx_highbd_sad64x64_avg_sse2;

INSTANTIATE_TEST_CASE_P(SSE2, SADavgTest, ::testing::Values(
...
const SadMxNx4Func highbd_sad_64x64x4d_sse2 = vpx_highbd_sad64x64x4d_sse2;
const SadMxNx4Func highbd_sad_64x32x4d_sse2 = vpx_highbd_sad64x32x4d_sse2;
const SadMxNx4Func highbd_sad_32x64x4d_sse2 = vpx_highbd_sad32x64x4d_sse2;
const SadMxNx4Func highbd_sad_32x32x4d_sse2 = vpx_highbd_sad32x32x4d_sse2;
const SadMxNx4Func highbd_sad_32x16x4d_sse2 = vpx_highbd_sad32x16x4d_sse2;
const SadMxNx4Func highbd_sad_16x32x4d_sse2 = vpx_highbd_sad16x32x4d_sse2;
const SadMxNx4Func highbd_sad_16x16x4d_sse2 = vpx_highbd_sad16x16x4d_sse2;
const SadMxNx4Func highbd_sad_16x8x4d_sse2 = vpx_highbd_sad16x8x4d_sse2;
const SadMxNx4Func highbd_sad_8x16x4d_sse2 = vpx_highbd_sad8x16x4d_sse2;
const SadMxNx4Func highbd_sad_8x8x4d_sse2 = vpx_highbd_sad8x8x4d_sse2;
const SadMxNx4Func highbd_sad_8x4x4d_sse2 = vpx_highbd_sad8x4x4d_sse2;
const SadMxNx4Func highbd_sad_4x8x4d_sse2 = vpx_highbd_sad4x8x4d_sse2;
const SadMxNx4Func highbd_sad_4x4x4d_sse2 = vpx_highbd_sad4x4x4d_sse2;
...
#if HAVE_SSE3
#if CONFIG_VP8_ENCODER
const SadMxNx4Func sad_16x16x4d_sse3 = vpx_sad16x16x4d_sse3;
const SadMxNx4Func sad_16x8x4d_sse3 = vpx_sad16x8x4d_sse3;
const SadMxNx4Func sad_8x16x4d_sse3 = vpx_sad8x16x4d_sse3;
const SadMxNx4Func sad_8x8x4d_sse3 = vpx_sad8x8x4d_sse3;
const SadMxNx4Func sad_4x4x4d_sse3 = vpx_sad4x4x4d_sse3;
...
#if CONFIG_USE_X86INC
#if CONFIG_VP8_ENCODER
const SadMxNFunc sad_16x16_sse3 = vpx_sad16x16_sse3;
...
#if HAVE_AVX2
const SadMxNx4Func sad_64x64x4d_avx2 = vpx_sad64x64x4d_avx2;
const SadMxNx4Func sad_32x32x4d_avx2 = vpx_sad32x32x4d_avx2;
...
#if HAVE_NEON
const SadMxNx4Func sad_16x16x4d_neon = vpx_sad16x16x4d_neon;
const SadMxNx4Func sad_32x32x4d_neon = vpx_sad32x32x4d_neon;
const SadMxNx4Func sad_64x64x4d_neon = vpx_sad64x64x4d_neon;
