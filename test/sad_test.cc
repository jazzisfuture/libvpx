...
SadMxNVp9Param sse2_vp9_highbd_tests[] = {
...
INSTANTIATE_TEST_CASE_P(SSE2_8, SADVP9Test,
                        ::testing::ValuesIn(sse2_vp9_highbd_tests));
...
SadMxNAvgVp9Param avg_sse2_vp9_highbd_tests[] = {
...
INSTANTIATE_TEST_CASE_P(SSE2, SADavgVP9Test,
                        ::testing::ValuesIn(avg_sse2_vp9_highbd_tests));
