...
TEST_P(SubtractBlockTest, SimpleSubtract) {
  ...
  unsigned char * source = reinterpret_cast<unsigned char*>(vpx_memalign(16,
                                                  4*4*sizeof(unsigned char)));
  be.src_diff = reinterpret_cast<short*>(vpx_memalign(16, 4*4*sizeof(short)));
  bd.predictor = reinterpret_cast<unsigned char*>(vpx_memalign(16,
                                                  4*4*sizeof(unsigned char)));
