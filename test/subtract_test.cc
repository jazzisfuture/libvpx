...
#if HAVE_SSE4_1
INSTANTIATE_TEST_CASE_P(SSE4_1, VP10HBDSubtractBlockTest, ::testing::Values(
    make_tuple(4, 4, 12, vpx_highbd_subtract_block_sse4_1),
    make_tuple(4, 4, 12, vpx_highbd_subtract_block_c),
    make_tuple(4, 8, 12, vpx_highbd_subtract_block_sse4_1),
    make_tuple(4, 8, 12, vpx_highbd_subtract_block_c),
    make_tuple(8, 4, 12, vpx_highbd_subtract_block_sse4_1),
    make_tuple(8, 4, 12, vpx_highbd_subtract_block_c),
    make_tuple(8, 8, 12, vpx_highbd_subtract_block_sse4_1),
    make_tuple(8, 8, 12, vpx_highbd_subtract_block_c),
    make_tuple(8, 16, 12, vpx_highbd_subtract_block_sse4_1),
    make_tuple(8, 16, 12, vpx_highbd_subtract_block_c),
    make_tuple(16, 8, 12, vpx_highbd_subtract_block_sse4_1),
    make_tuple(16, 8, 12, vpx_highbd_subtract_block_c),
    make_tuple(16, 16, 12, vpx_highbd_subtract_block_sse4_1),
    make_tuple(16, 16, 12, vpx_highbd_subtract_block_c),
    make_tuple(16, 32, 12, vpx_highbd_subtract_block_sse4_1),
    make_tuple(16, 32, 12, vpx_highbd_subtract_block_c),
    make_tuple(32, 16, 12, vpx_highbd_subtract_block_sse4_1),
    make_tuple(32, 16, 12, vpx_highbd_subtract_block_c),
    make_tuple(32, 32, 12, vpx_highbd_subtract_block_sse4_1),
    make_tuple(32, 32, 12, vpx_highbd_subtract_block_c),
    make_tuple(32, 64, 12, vpx_highbd_subtract_block_sse4_1),
    make_tuple(32, 64, 12, vpx_highbd_subtract_block_c),
    make_tuple(64, 32, 12, vpx_highbd_subtract_block_sse4_1),
    make_tuple(64, 32, 12, vpx_highbd_subtract_block_c),
    make_tuple(64, 64, 12, vpx_highbd_subtract_block_sse4_1),
    make_tuple(64, 64, 12, vpx_highbd_subtract_block_c),
    make_tuple(64, 128, 12, vpx_highbd_subtract_block_sse4_1),
    make_tuple(64, 128, 12, vpx_highbd_subtract_block_c),
    make_tuple(128, 64, 12, vpx_highbd_subtract_block_sse4_1),
    make_tuple(128, 64, 12, vpx_highbd_subtract_block_c),
    make_tuple(128, 128, 12, vpx_highbd_subtract_block_sse4_1),
