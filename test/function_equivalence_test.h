...
template <typename T>
class FunctionEquivalenceTest : public RandomTest,
  public ::testing::WithParamInterface< std::tr1::tuple< T, T > > {
 public:
 ...
 protected:
  ...
  template<typename E, size_t n, size_t m>
  ::testing::AssertionResult BufferEqOutside(const E (&a)[n][m],
                                             const E (&b)[n][m],
                                             const size_t stride,
                                             const size_t offset,
                                             const size_t rows,
