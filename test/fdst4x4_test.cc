...
#include "vpx_config.h"
 ...
 extern "C" {
  void vpx_fdct4x4_sse2(const int16_t*, tran_low_t*, int);
  void vpx_fdct8x8_sse2(const int16_t*, tran_low_t*, int);
  void vpx_fdct16x16_sse2(const int16_t*, tran_low_t*, int);
 }
#endif
