...
namespace {
const int kTestVectorNum = 61;
const char *kTestVectors[kTestVectorNum] = { "vp80-00-comprehensive-001.ivf",
...
TEST_P(TestVectorTest, MD5Match) {
  ...
  uint8_t *const allocated_buf = new uint8_t[libvpx_test::kCodeBufferSize];
