...
class VP10HighbdInvTrans4x4HT
 ...
 public:
  ...
  virtual void SetUp() {
    ...
    // https://chromium.googlesource.com/webm/libvpx/+/nextgenv2/vp10/encoder/
    // context_tree.c, function, void alloc_mode_context().
 ...
 private:
  static int32_t ClampCoeffs(int32_t number, int bit) {
