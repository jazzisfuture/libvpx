...
static void OpenTestDataFile(std::string file_name, FILE **input_file) {
  ...
  *input_file = fopen(path_to_source.c_str(), "rb");
  ASSERT_TRUE(*input_file) << "Input file open failed.";
}
...
class CompressedVideoSource {
 public:
  ...
  virtual unsigned int frame_size() const = 0;
};
