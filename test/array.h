...
// Specialization for 1 dimensional arrays.
...
// Specialization for 2+ dimensional arrays.
...
// specializations can be inserted into collections:
//
class ArrayBase {
 public:
  virtual ~ArrayBase() = 0;
...
class Array<E[n], Align> : public ArrayBase {
 ...
 private:
  GTEST_DISALLOW_COPY_AND_ASSIGN_(Array);
