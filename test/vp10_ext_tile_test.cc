 ...
 protected:
  ...
  virtual void PreEncodeFrameHook(::libvpx_test::VideoSource * video,
    ...
    if (video->frame() == 0) {
      ...
      encoder->Control(VP10E_SET_SUPERBLOCK_SIZE, 64);
#endif

      frame_flags_ = VP8_EFLAG_NO_UPD_ENTROPY;
    }
...
TEST_P(VP10ExtTileTest, DecoderResultTest) {
  ::libvpx_test::I420VideoSource video("hantro_collage_w352h288.yuv", kImgWidth, kImgHeight,
                                       30, 1, 0, kLimit);
