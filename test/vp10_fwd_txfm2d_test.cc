...
int txfm_size_ls[4] = {4, 8, 16, 32};
TXFM_2D_CFG fwd_txfm_cfg_ls[4][4] = {
...
Fwd_Txfm2d_Func fwd_txfm_func_ls[4] = {vp10_fwd_txfm2d_4x4, vp10_fwd_txfm2d_8x8,
                                       vp10_fwd_txfm2d_16x16,
                                       vp10_fwd_txfm2d_32x32};

const int txfm_type_num = 4;
TYPE_TXFM type_ls_0[4] = {TYPE_DCT, TYPE_DCT, TYPE_ADST, TYPE_ADST};
TYPE_TXFM type_ls_1[4] = {TYPE_DCT, TYPE_ADST, TYPE_ADST, TYPE_DCT};
