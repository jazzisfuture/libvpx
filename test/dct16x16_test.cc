...
INSTANTIATE_TEST_CASE_P(
    ...
    ::testing::Values(
        ...
        make_tuple(&vp9_fdct16x16_msa,
                   &vp9_idct16x16_256_add_c, 1, VPX_BITS_8)));
INSTANTIATE_TEST_CASE_P(
    MSA, Trans16x16HT,
    ::testing::Values(
        ...
        make_tuple(&vp9_fht16x16_msa, &vp9_iht16x16_256_add_c, 0, VPX_BITS_8),
        make_tuple(&vp9_fht16x16_msa, &vp9_iht16x16_256_add_c, 1, VPX_BITS_8),
        make_tuple(&vp9_fht16x16_msa, &vp9_iht16x16_256_add_c, 2, VPX_BITS_8),
        make_tuple(&vp9_fht16x16_msa, &vp9_iht16x16_256_add_c, 3, VPX_BITS_8)));
