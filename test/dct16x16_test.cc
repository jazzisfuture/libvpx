...
INSTANTIATE_TEST_CASE_P(
    ...
    ::testing::Values(make_tuple(&idct16x16_10_add_10_c,
                      ...
                      make_tuple(&idct16x16_12, &idct16x16_256_add_12_sse2,
                                 3167, AOM_BITS_12)));
INSTANTIATE_TEST_CASE_P(
    SSE2, PartialTrans16x16Test,
    ::testing::Values(make_tuple(&aom_fdct16x16_1_sse2, AOM_BITS_8),
                      make_tuple(&aom_fdct16x16_1_sse2, AOM_BITS_10),
                      make_tuple(&aom_fdct16x16_1_sse2, AOM_BITS_12)));
#endif  // HAVE_SSE2 && CONFIG_AOM_HIGHBITDEPTH && !CONFIG_EMULATE_HARDWARE
