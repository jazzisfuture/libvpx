...
class Encoder {
 public:
  Encoder(vpx_codec_enc_cfg_t cfg, unsigned long deadline,
          unsigned long init_flags, TwopassStatsStore *stats)
  ...
  void EncodeFrame(VideoSource *video, unsigned long frame_flags);
 ...
 protected:
  ...
  // Encode an image
  void EncodeFrameInternal(const VideoSource &video, unsigned long frame_flags);
