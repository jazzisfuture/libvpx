...
class ErrorResilienceTestLargeInternalOnly : public ::libvpx_test::EncoderTest,
    public ::libvpx_test::CodecTestWithParam<libvpx_test::TestMode> {
 protected:
  ErrorResilienceTestLargeInternalOnly()
      : EncoderTest(GET_PARAM(0)),
        encoding_mode_(GET_PARAM(1)) {
    Reset();
  }

  virtual ~ErrorResilienceTestLargeInternalOnly() {}
...
TEST_P(ErrorResilienceTestLargeInternalOnly, CodecControl3TemporalLayers) {
...
VP8_INSTANTIATE_TEST_CASE(ErrorResilienceTestLargeInternalOnly,
                          ONE_PASS_TEST_MODES);
