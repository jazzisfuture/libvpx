 ...
 protected:
  void RunInvAccuracyCheck() {
    ...
    for (int ti =  0; ti < count_test_block; ++ti) {
      ...
      for (int ni = 0; ni < txfm_size_; ++ni) {
        //printf("res: %d ref: %d\n", output[ni], static_cast<tran_low_t>(round(ref_output[ni])));
        EXPECT_LE(
...
class Vp10PartialIDctTest : public ::testing::TestWithParam<PartialInvTxfmParam> {
 public:
...
INSTANTIATE_TEST_CASE_P(
    SSE2, Vp10PartialIDctTest,
    ::testing::Values(
        make_tuple(&vpx_fdct32x32_c,
                   &vp10_idct32x32_1024_add_c,
                   &vp10_idct32x32_34_add_sse2,
                   TX_32X32, 34),
        make_tuple(&vpx_fdct32x32_c,
                   &vp10_idct32x32_1024_add_c,
                   &vp10_idct32x32_1_add_sse2,
                   TX_32X32, 1),
        make_tuple(&vpx_fdct16x16_c,
                   &vp10_idct16x16_256_add_c,
                   &vp10_idct16x16_10_add_sse2,
                   TX_16X16, 10),
        make_tuple(&vpx_fdct16x16_c,
                   &vp10_idct16x16_256_add_c,
                   &vp10_idct16x16_1_add_sse2,
                   TX_16X16, 1),
        make_tuple(&vpx_fdct8x8_c,
                   &vp10_idct8x8_64_add_c,
                   &vp10_idct8x8_12_add_sse2,
                   TX_8X8, 12),
        make_tuple(&vpx_fdct8x8_c,
                   &vp10_idct8x8_64_add_c,
                   &vp10_idct8x8_1_add_sse2,
                   TX_8X8, 1),
        make_tuple(&vpx_fdct4x4_c,
                   &vp10_idct4x4_16_add_c,
                   &vp10_idct4x4_1_add_sse2,
                   TX_4X4, 1)));
#endif
}  // namespace
