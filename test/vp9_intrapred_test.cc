...
class VP9IntraPredTest : public ::testing::TestWithParam<IntraPredFunc> {
 public:
  void RunTest(uint8_t *left_col, uint8_t *above_data, uint8_t *dst,
               uint8_t *ref_dst) {
...
typedef void (*Highbd_IntraPred)(uint16_t *dst, ptrdiff_t stride,
                                 const uint16_t *above, const uint16_t *left,
                                 int bps);
struct HighbdIntraPredFunc {
  HighbdIntraPredFunc(Highbd_IntraPred pred = NULL, Highbd_IntraPred ref = NULL,
                      int block_size_value = 0, int bit_depth_value = 0)
      : pred_fn(pred), ref_fn(ref), block_size(block_size_value),
        bit_depth(bit_depth_value) {}

  Highbd_IntraPred pred_fn;
  Highbd_IntraPred ref_fn;
  int block_size;
  int bit_depth;
};

class VP9HighbdIntraPredTest
    : public ::testing::TestWithParam<HighbdIntraPredFunc> {
 public:
...
INSTANTIATE_TEST_CASE_P(
    ...
    ::testing::Values(
        HighbdIntraPredFunc(&vpx_highbd_dc_predictor_4x4_sse2,
                            &vpx_highbd_dc_predictor_4x4_c, 4, 8),
        HighbdIntraPredFunc(&vpx_highbd_dc_predictor_8x8_sse2,
                            &vpx_highbd_dc_predictor_8x8_c, 8, 8),
        HighbdIntraPredFunc(&vpx_highbd_dc_predictor_16x16_sse2,
                            &vpx_highbd_dc_predictor_16x16_c, 16, 8),
        HighbdIntraPredFunc(&vpx_highbd_dc_predictor_32x32_sse2,
                            &vpx_highbd_dc_predictor_32x32_c, 32, 8),
        HighbdIntraPredFunc(&vpx_highbd_tm_predictor_4x4_sse2,
                            &vpx_highbd_tm_predictor_4x4_c, 4, 8),
        HighbdIntraPredFunc(&vpx_highbd_tm_predictor_8x8_sse2,
                            &vpx_highbd_tm_predictor_8x8_c, 8, 8),
        HighbdIntraPredFunc(&vpx_highbd_tm_predictor_16x16_sse2,
                            &vpx_highbd_tm_predictor_16x16_c, 16, 8),
        HighbdIntraPredFunc(&vpx_highbd_tm_predictor_32x32_sse2,
                            &vpx_highbd_tm_predictor_32x32_c, 32, 8),
        HighbdIntraPredFunc(&vpx_highbd_v_predictor_4x4_sse2,
                            &vpx_highbd_v_predictor_4x4_c, 4, 8),
        HighbdIntraPredFunc(&vpx_highbd_v_predictor_8x8_sse2,
                            &vpx_highbd_v_predictor_8x8_c, 8, 8),
        HighbdIntraPredFunc(&vpx_highbd_v_predictor_16x16_sse2,
                            &vpx_highbd_v_predictor_16x16_c, 16, 8),
        HighbdIntraPredFunc(&vpx_highbd_v_predictor_32x32_sse2,
