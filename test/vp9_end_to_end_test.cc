...
static const unsigned int kFramerate = 50;
static const unsigned int kFrames = 10;
static const int kBitrate = 500;
static const int kCpuUsed = 2;
static const double psnr_threshold = 35.0;
...
static int is_extension_y4m(const char *filename) {
