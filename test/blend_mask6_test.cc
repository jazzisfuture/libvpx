...
typedef void (*F8B)(uint8_t *dst, uint32_t dst_stride_,
                      uint8_t *src0_, uint32_t src0_stride_,
                      uint8_t *src1_, uint32_t src1_stride_,
                      const uint8_t *mask_, uint32_t mask_stride_,
                      int h_, int w_, int suby_, int subx_);
...
typedef void (*FHBD)(uint8_t *dst, uint32_t dst_stride_,
                       uint8_t *src0_, uint32_t src0_stride_,
                       uint8_t *src1_, uint32_t src1_stride_,
                       const uint8_t *mask_, uint32_t mask_stride_,
                       int h_, int w_, int suby_, int subx_, int bd);
