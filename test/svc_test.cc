...
TEST_F(SvcTest, DISABLED_FirstFrameHasLayers) {
  ...
  libvpx_test::I420VideoSource video("mango.yuv", codec_enc_.g_w,
                                     codec_enc_.g_h, codec_enc_.g_timebase.den,
...
TEST_F(SvcTest, EncodeThreeFrames) {
  ...
  res_dec = _decoder->DecodeFrame((const uint8_t*)svc_get_buffer(&svc_),
