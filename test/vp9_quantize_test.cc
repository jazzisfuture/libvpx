...
class VP9QuantizeBase {
 public:
  VP9QuantizeBase(vpx_bit_depth_t bit_depth, int max_size, int is_fp)
...
INSTANTIATE_TEST_CASE_P(
    ...
    ::testing::Values(
        ...
        make_tuple(&vpx_highbd_quantize_b_32x32_sse2,
                   &vpx_highbd_quantize_b_32x32_c, VPX_BITS_8, 32, 0),
        make_tuple(&vpx_highbd_quantize_b_32x32_sse2,
                   &vpx_highbd_quantize_b_32x32_c, VPX_BITS_10, 32, 0),
        make_tuple(&vpx_highbd_quantize_b_32x32_sse2,
                   &vpx_highbd_quantize_b_32x32_c, VPX_BITS_12, 32, 0)));

#else
INSTANTIATE_TEST_CASE_P(
    SSE2, VP9QuantizeTest,
    ::testing::Values(
        make_tuple(&vpx_quantize_b_sse2, &vpx_quantize_b_c, VPX_BITS_8, 16, 0),
        make_tuple(&QuantFPWrapper<vp9_quantize_fp_sse2>,
                   &QuantFPWrapper<vp9_quantize_fp_nz_c>, VPX_BITS_8, 16, 1)));
...
INSTANTIATE_TEST_CASE_P(
    ...
    ::testing::Values(
#if ARCH_X86_64
        make_tuple(&vpx_quantize_b_ssse3, &vpx_quantize_b_c, VPX_BITS_8, 16, 0),
...
INSTANTIATE_TEST_CASE_P(
    ...
    ::testing::Values(make_tuple(&vpx_quantize_b_32x32_ssse3,
                                 &vpx_quantize_b_32x32_c, VPX_BITS_8, 32, 0),
...
INSTANTIATE_TEST_CASE_P(
    AVX, VP9QuantizeTest,
    ::testing::Values(
        make_tuple(&vpx_quantize_b_avx, &vpx_quantize_b_c, VPX_BITS_8, 16, 0),
        // Even though SSSE3 and AVX do not match the reference
        // code, we can keep them in sync with each other.
        make_tuple(&vpx_quantize_b_32x32_avx, &vpx_quantize_b_32x32_ssse3,
                   VPX_BITS_8, 32, 0)));
...
INSTANTIATE_TEST_CASE_P(
    ...
    ::testing::Values(
        make_tuple(&vpx_quantize_b_neon, &vpx_quantize_b_c, VPX_BITS_8, 16, 0),
        make_tuple(&vpx_quantize_b_32x32_neon, &vpx_quantize_b_32x32_c,
                   VPX_BITS_8, 32, 0),
        make_tuple(&QuantFPWrapper<vp9_quantize_fp_neon>,
                   &QuantFPWrapper<vp9_quantize_fp_c>, VPX_BITS_8, 16, 1),
