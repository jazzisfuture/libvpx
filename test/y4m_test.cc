...
static const string kY4m420_8_file = "park_joy_90p_8_420.y4m";
static const string kY4m420_8_md5raw = "e5406275b9fc6bb3436c31d4a05c1cab";
static const string kY4m422_8_file = "park_joy_90p_8_422.y4m";
static const string kY4m422_8_md5raw = "284a47a47133b12884ec3a14e959a0b6";
static const string kY4m444_8_file = "park_joy_90p_8_444.y4m";
static const string kY4m444_8_md5raw = "90517ff33843d85de712fd4fe60dbed0";

static const string kY4m420_10_file = "park_joy_90p_10_420.y4m";
static const string kY4m420_10_md5raw = "63f21f9f717d8b8631bd2288ee87137b";
static const string kY4m422_10_file = "park_joy_90p_10_422.y4m";
static const string kY4m422_10_md5raw = "48ab51fb540aed07f7ff5af130c9b605";
static const string kY4m444_10_file = "park_joy_90p_10_444.y4m";
static const string kY4m444_10_md5raw = "067bfd75aa85ff9bae91fa3e0edd1e3e";

static const string kY4m420_12_file = "park_joy_90p_12_420.y4m";
static const string kY4m420_12_md5raw = "9e6d8f6508c6e55625f6b697bc461cef";
static const string kY4m422_12_file = "park_joy_90p_12_422.y4m";
static const string kY4m422_12_md5raw = "b239c6b301c0b835485be349ca83a7e3";
static const string kY4m444_12_file = "park_joy_90p_12_444.y4m";
static const string kY4m444_12_md5raw = "5a6481a550821dab6d0192f5c63845e9";
...
TEST_F(Y4mVideoWriteTest, Y4m420_8) {
  Init(kY4m420_8_file, kFrames);
  HeaderChecks(8, VPX_IMG_FMT_I420);
  Md5Check(kY4m420_8_md5raw);
}

TEST_F(Y4mVideoWriteTest, Y4m422_8) {
  Init(kY4m422_8_file, kFrames);
  HeaderChecks(8, VPX_IMG_FMT_I422);
  Md5Check(kY4m422_8_md5raw);
}

TEST_F(Y4mVideoWriteTest, Y4m444_8) {
  Init(kY4m444_8_file, kFrames);
  HeaderChecks(8, VPX_IMG_FMT_I444);
  Md5Check(kY4m444_8_md5raw);
}

TEST_F(Y4mVideoWriteTest, Y4m420_10) {
  Init(kY4m420_10_file, kFrames);
  HeaderChecks(10, VPX_IMG_FMT_I42016);
  Md5Check(kY4m420_10_md5raw);
}

TEST_F(Y4mVideoWriteTest, Y4m422_10) {
  Init(kY4m422_10_file, kFrames);
  HeaderChecks(10, VPX_IMG_FMT_I42216);
  Md5Check(kY4m422_10_md5raw);
}

TEST_F(Y4mVideoWriteTest, Y4m444_10) {
  Init(kY4m444_10_file, kFrames);
  HeaderChecks(10, VPX_IMG_FMT_I44416);
  Md5Check(kY4m444_10_md5raw);
}

TEST_F(Y4mVideoWriteTest, Y4m420_12) {
  Init(kY4m420_12_file, kFrames);
  HeaderChecks(12, VPX_IMG_FMT_I42016);
  Md5Check(kY4m420_12_md5raw);
}

TEST_F(Y4mVideoWriteTest, Y4m422_12) {
  Init(kY4m422_12_file, kFrames);
  HeaderChecks(12, VPX_IMG_FMT_I42216);
  Md5Check(kY4m422_12_md5raw);
}

TEST_F(Y4mVideoWriteTest, Y4m444_12) {
  Init(kY4m444_12_file, kFrames);
  HeaderChecks(12, VPX_IMG_FMT_I44416);
  Md5Check(kY4m444_12_md5raw);
}
