...
TEST(EncodeAPI, Buganizer329088759) {
  VP9Encoder encoder(7);
  encoder.Configure444(/*threads=*/1, /*width=*/1686, /*height=*/398, VPX_VBR,
                       VPX_DL_REALTIME);
  encoder.Encode444(/*key_frame=*/true);
  encoder.Configure444(/*threads=*/1, /*width=*/1686, /*height=*/1, VPX_VBR,
                       VPX_DL_REALTIME);
  encoder.Encode444(/*key_frame=*/true);
  encoder.Configure444(/*threads=*/1, /*width=*/1482, /*height=*/113, VPX_CBR,
                       VPX_DL_REALTIME);
  encoder.Encode444(/*key_frame=*/true);
}
