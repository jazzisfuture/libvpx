...
#if CONFIG_VP9_HIGHBITDEPTH
static const int num_dct_c = 8;
#else
static const int num_dct_c = 4;
#endif
...
INSTANTIATE_TEST_CASE_P(C, TransDCT,
                        ::testing::Combine(::testing::Range(0, num_dct_c),
                                           ::testing::Values(dct_c_func_info),
                                           ::testing::Values(0),
...
#if HAVE_SSE2
#if CONFIG_VP9_HIGHBITDEPTH
static const int num_dct_sse2 = 8;
#else
static const int num_dct_sse2 = 4;
#endif
...
INSTANTIATE_TEST_CASE_P(
    SSE2, TransDCT,
    ::testing::Combine(::testing::Range(0, num_dct_sse2),
                       ::testing::Values(dct_sse2_func_info),
                       ::testing::Values(0),
...
#if CONFIG_VP9_HIGHBITDEPTH
static const int num_ht_c = 6;
#else
static const int num_ht_c = 3;
#endif
...
INSTANTIATE_TEST_CASE_P(C, TransHT,
                        ::testing::Combine(::testing::Range(0, num_ht_c),
                                           ::testing::Values(ht_c_func_info),
                                           ::testing::Range(0, 4),
                                           ::testing::Values(VPX_BITS_8,
                                                             VPX_BITS_10,
                                                             VPX_BITS_12)));
...
#if CONFIG_VP9_HIGHBITDEPTH
static const int num_ht_neon = 4;
#else
static const int num_ht_neon = 2;
#endif
...
INSTANTIATE_TEST_CASE_P(NEON, TransHT,
                        ::testing::Combine(::testing::Range(0, num_ht_neon),
                                           ::testing::Values(ht_neon_func_info),
                                           ::testing::Range(0, 4),
                                           ::testing::Values(VPX_BITS_8,
                                                             VPX_BITS_10,
                                                             VPX_BITS_12)));
