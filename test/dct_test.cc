...
INSTANTIATE_TEST_CASE_P(
    C, TransDCT,
    ::testing::Combine(::testing::Range(0, (int)(sizeof(dct_c_func_info) /
...
INSTANTIATE_TEST_CASE_P(
    SSE2, TransDCT,
    ::testing::Combine(
        ::testing::Range(0, (int)(sizeof(dct_sse2_func_info) /
...
INSTANTIATE_TEST_CASE_P(
    C, TransHT,
    ::testing::Combine(::testing::Range(0, (int)(sizeof(ht_c_func_info) /
...
INSTANTIATE_TEST_CASE_P(
    NEON, TransHT,
    ::testing::Combine(::testing::Range(0, (int)(sizeof(ht_neon_func_info) /
...
INSTANTIATE_TEST_CASE_P(
    C, TransWHT,
    ::testing::Combine(::testing::Range(0, (int)(sizeof(wht_c_func_info) /
