...
class TransTestBase {
 ...
 protected:
  ...
  void RunAccuracyCheck(int limit) {
    ...
    Buffer<int16_t> test_input_block = Buffer<int16_t>(size_, size_, 4);
    Buffer<tran_low_t> test_temp_block = Buffer<tran_low_t>(size_, size_, 0);
  ...
  void RunCoeffCheck() {
    ...
    Buffer<int16_t> input_block = Buffer<int16_t>(size_, size_, 4);
    Buffer<tran_low_t> output_ref_block = Buffer<tran_low_t>(size_, size_, 0);
    Buffer<tran_low_t> output_block = Buffer<tran_low_t>(size_, size_, 0);
  ...
  void RunMemCheck() {
    ACMRandom rnd(ACMRandom::DeterministicSeed());
    const int count_test_block = 5000;
    Buffer<int16_t> input_extreme_block = Buffer<int16_t>(size_, size_, 4);
    Buffer<tran_low_t> output_ref_block = Buffer<tran_low_t>(size_, size_, 0);
    Buffer<tran_low_t> output_block = Buffer<tran_low_t>(size_, size_, 0);
