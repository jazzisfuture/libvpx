...
INSTANTIATE_TEST_CASE_P(
    ...
    ::testing::Values(
        ...
        make_tuple(&fdct_wrapper<vpx_fdct32x32_c>,
                   &idct_wrapper<vpx_idct32x32_1024_add_c>, 32, 0, VPX_BITS_8,
                   1),
        make_tuple(&fdct_wrapper<vpx_fdct16x16_c>,
                   &idct_wrapper<vpx_idct16x16_256_add_c>, 16, 0, VPX_BITS_8,
                   1),
        make_tuple(&fdct_wrapper<vpx_fdct8x8_c>,
                   &idct_wrapper<vpx_idct8x8_64_add_c>, 8, 0, VPX_BITS_8, 1),
        make_tuple(&fdct_wrapper<vpx_fdct4x4_c>,
                   &idct_wrapper<vpx_idct4x4_16_add_c>, 4, 0, VPX_BITS_8, 1)));
...
INSTANTIATE_TEST_CASE_P(
    ...
    ::testing::Values(
#if CONFIG_VP9_HIGHBITDEPTH
        make_tuple(&fdct_wrapper<vpx_highbd_fdct32x32_sse2>,
                   &highbd_idct_wrapper<vpx_highbd_idct32x32_1024_add_sse2>, 32,
                   0, VPX_BITS_8, 2),
        make_tuple(&fdct_wrapper<vpx_highbd_fdct32x32_sse2>,
                   &highbd_idct_wrapper<vpx_highbd_idct32x32_1024_add_sse2>, 32,
                   0, VPX_BITS_10, 2),
        make_tuple(&fdct_wrapper<vpx_highbd_fdct16x16_sse2>,
                   &highbd_idct_wrapper<vpx_highbd_idct16x16_256_add_sse2>, 16,
                   0, VPX_BITS_8, 2),
        make_tuple(&fdct_wrapper<vpx_highbd_fdct16x16_sse2>,
                   &highbd_idct_wrapper<vpx_highbd_idct16x16_256_add_sse2>, 16,
                   0, VPX_BITS_10, 2),
        ...
        make_tuple(&fdct_wrapper<vpx_fdct32x32_sse2>,
                   &idct_wrapper<vpx_idct32x32_1024_add_sse2>, 32, 0,
                   VPX_BITS_8, 1),
        make_tuple(&fdct_wrapper<vpx_fdct16x16_sse2>,
                   &idct_wrapper<vpx_idct16x16_256_add_sse2>, 16, 0, VPX_BITS_8,
                   1),
        ...
        make_tuple(&fdct_wrapper<vpx_fdct4x4_sse2>,
                   &idct_wrapper<vpx_idct4x4_16_add_sse2>, 4, 0, VPX_BITS_8,
                   1)));
#endif  // HAVE_SSE2
...
INSTANTIATE_TEST_CASE_P(
    ...
    ::testing::Values(
        ...
        make_tuple(&vp9_highbd_fht8x8_c,
                   &highbd_iht_wrapper<vp9_highbd_iht8x8_64_add_c>, 8, 0,
                   VPX_BITS_8, 2),
        make_tuple(&vp9_highbd_fht8x8_c,
                   &highbd_iht_wrapper<vp9_highbd_iht8x8_64_add_c>, 8, 1,
                   VPX_BITS_8, 2),
        make_tuple(&vp9_highbd_fht8x8_c,
                   &highbd_iht_wrapper<vp9_highbd_iht8x8_64_add_c>, 8, 2,
                   VPX_BITS_8, 2),
        make_tuple(&vp9_highbd_fht8x8_c,
                   &highbd_iht_wrapper<vp9_highbd_iht8x8_64_add_c>, 8, 3,
                   VPX_BITS_8, 2),
        make_tuple(&vp9_highbd_fht8x8_c,
                   &highbd_iht_wrapper<vp9_highbd_iht8x8_64_add_c>, 8, 0,
                   VPX_BITS_10, 2),
        ...
        make_tuple(&vp9_highbd_fht4x4_c,
                   &highbd_iht_wrapper<vp9_highbd_iht4x4_16_add_c>, 4, 0,
                   VPX_BITS_8, 2),
        make_tuple(&vp9_highbd_fht4x4_c,
                   &highbd_iht_wrapper<vp9_highbd_iht4x4_16_add_c>, 4, 1,
                   VPX_BITS_8, 2),
        make_tuple(&vp9_highbd_fht4x4_c,
                   &highbd_iht_wrapper<vp9_highbd_iht4x4_16_add_c>, 4, 2,
                   VPX_BITS_8, 2),
        make_tuple(&vp9_highbd_fht4x4_c,
                   &highbd_iht_wrapper<vp9_highbd_iht4x4_16_add_c>, 4, 3,
                   VPX_BITS_8, 2),
        make_tuple(&vp9_highbd_fht4x4_c,
                   &highbd_iht_wrapper<vp9_highbd_iht4x4_16_add_c>, 4, 0,
                   VPX_BITS_10, 2),
        ...
        make_tuple(&vp9_fht8x8_c, &iht_wrapper<vp9_iht8x8_64_add_c>, 8, 0,
                   VPX_BITS_8, 1),
        make_tuple(&vp9_fht8x8_c, &iht_wrapper<vp9_iht8x8_64_add_c>, 8, 1,
                   VPX_BITS_8, 1),
        make_tuple(&vp9_fht8x8_c, &iht_wrapper<vp9_iht8x8_64_add_c>, 8, 2,
                   VPX_BITS_8, 1),
        make_tuple(&vp9_fht8x8_c, &iht_wrapper<vp9_iht8x8_64_add_c>, 8, 3,
                   VPX_BITS_8, 1),

        make_tuple(&vp9_fht4x4_c, &iht_wrapper<vp9_iht4x4_16_add_c>, 4, 0,
                   VPX_BITS_8, 1),
        make_tuple(&vp9_fht4x4_c, &iht_wrapper<vp9_iht4x4_16_add_c>, 4, 1,
                   VPX_BITS_8, 1),
        make_tuple(&vp9_fht4x4_c, &iht_wrapper<vp9_iht4x4_16_add_c>, 4, 2,
                   VPX_BITS_8, 1),
        make_tuple(&vp9_fht4x4_c, &iht_wrapper<vp9_iht4x4_16_add_c>, 4, 3,
                   VPX_BITS_8, 1)));
...
INSTANTIATE_TEST_CASE_P(
    ...
    ::testing::Values(
        ...
        make_tuple(&fdct_wrapper<vp9_highbd_fwht4x4_c>,
                   ...
                   VPX_BITS_12, 2),
#endif  // CONFIG_VP9_HIGHBITDEPTH
        make_tuple(&fdct_wrapper<vp9_fwht4x4_c>,
                   &idct_wrapper<vpx_iwht4x4_16_add_c>, 4, 0, VPX_BITS_8, 1)));
