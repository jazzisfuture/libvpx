...
typedef std::tr1::tuple<int, const char *> decode_param_t;
...
INSTANTIATE_TEST_CASE_P(VP9, InvalidFileTest,
    ::testing::Combine(
...
INSTANTIATE_TEST_CASE_P(VP9MultiThreaded, InvalidFileTest,
    ::testing::Combine(
        ::testing::Values(static_cast<const libvpx_test::CodecFactory*>(
                &libvpx_test::kVP9)),
