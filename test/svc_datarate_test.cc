...
class DatarateOnePassCbrSvc : public OnePassCbrSvc {
 ...
 protected:
  ...
  bool dynamic_drop_bottom_layer_;
...
// Check basic rate targeting for 1 pass CBR SVC with 1 spatial and 2
// temporal layers with dynamic resize and denoiser enabled.
// The resizer will resize the single layer down and back up again, as
// the bitrate goes back up.
