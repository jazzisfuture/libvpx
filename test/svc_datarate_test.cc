...
class DatarateOnePassCbrSvc : public ::libvpx_test::EncoderTest {
 ...
 protected:
  ...
  virtual void FramePktHook(const vpx_codec_cx_pkt_t *pkt) {
    ...
    if (force_intra_only_frame_ && superframe_count_ == intra_only_framecnt_)
