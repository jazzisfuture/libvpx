...
void TestSubpixelFilterBlock1d(VpxSubpixelFunc const *funcs,
    ...
    for (int i = 0; i < kNumHeights; ++i) {
      ...
      for (int k = 0; k < kNumFuncs; ++k) {
        ...
        for (int num_tests = 0; num_tests < kNumTests; ++num_tests) {
          funcs[k](s, src_stride, dst, dst_stride, height, filters);
        }
//        printf("\n");
...
//        }
        ...
        printf("             %4d ms   height: %d   MD5: %s", elapsed_time,
               height, md5.Get());
        if (!(k & 1)) {
...
#define SUBPIXEL_FILTER_TEST(arch)                                             \
  TEST(arch, TestSubpixelFilterBlock1d) {                                      \
    static const VpxSubpixelFunc funcs[kNumFuncs] = {                          \
        vpx_filter_block1d4_h8_org_ssse3,                                      \
        vpx_filter_block1d4_h8_ssse3,                                          \
        vpx_filter_block1d4_h8_avg_org_ssse3,                                  \
        vpx_filter_block1d4_h8_avg_ssse3,                                      \
        vpx_filter_block1d8_h8_org_ssse3,                                      \
        vpx_filter_block1d8_h8_ssse3,                                          \
        vpx_filter_block1d8_h8_avg_org_ssse3,                                  \
        vpx_filter_block1d8_h8_avg_ssse3,                                      \
        vpx_filter_block1d16_h8_org_ssse3,                                     \
        vpx_filter_block1d16_h8_ssse3,                                         \
        vpx_filter_block1d16_h8_avg_org_ssse3,                                 \
        vpx_filter_block1d16_h8_avg_ssse3,                                     \
        vpx_filter_block1d4_v8_org_ssse3,                                      \
        vpx_filter_block1d4_v8_ssse3,                                          \
        vpx_filter_block1d4_v8_avg_org_ssse3,                                  \
        vpx_filter_block1d4_v8_avg_ssse3,                                      \
        vpx_filter_block1d8_v8_org_ssse3,                                      \
        vpx_filter_block1d8_v8_ssse3,                                          \
        vpx_filter_block1d8_v8_avg_org_ssse3,                                  \
        vpx_filter_block1d8_v8_avg_ssse3,                                      \
        vpx_filter_block1d16_v8_org_ssse3,                                     \
        vpx_filter_block1d16_v8_ssse3,                                         \
        vpx_filter_block1d16_v8_avg_org_ssse3,                                 \
        vpx_filter_block1d16_v8_avg_ssse3,                                     \
    };                                                                         \
    static const uint32_t heights[] = {8, 9};                                  \
    TestSubpixelFilterBlock1d(funcs, heights, 2, false); /* unit test */       \
    TestSubpixelFilterBlock1d(funcs, heights, 2, true);  /* speed test */      \
  }
