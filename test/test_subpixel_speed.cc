    ...
    for (int i = 0; i < kNumHeights; ++i) {
      ...
      for (int k = 0; k < kNumFuncs; ++k) {
        ...
        if (!(k & 1)) {
          ...
          snprintf(signature, sizeof(signature), "%s", md5.Get());
          printf("\n");
        } else {
...
#define SUBPIXEL_FILTER_TEST(arch, kNumFuncs,                                  \
  ...
  TEST(arch, TestSubpixelFilterBlock1d) {                                      \
    static const VpxSubpixelFuncInfo funcInfos[kMaxNumFuncs] = {               \
        ...
        {func_d4v8_org,      "block1d4_v8      (org)"},                        \
        {func_d4v8_opt,      "block1d4_v8"},                                   \
        {func_d4v8_avg_org,  "block1d4_v8_avg  (org)"},                        \
        {func_d4v8_avg_opt,  "block1d4_v8_avg"},                               \
        {func_d8v8_org,      "block1d8_v8      (org)"},                        \
        {func_d8v8_opt,      "block1d8_v8"},                                   \
        {func_d8v8_avg_org,  "block1d8_v8_avg  (org)"},                        \
        {func_d8v8_avg_opt,  "block1d8_v8_avg"},                               \
        {func_d16v8_org,     "block1d16_v8     (org)"},                        \
        {func_d16v8_opt,     "block1d16_v8"},                                  \
        {func_d16v8_avg_org, "block1d16_v8_avg (org)"},                        \
        {func_d16v8_avg_opt, "block1d16_v8_avg"},                              \
    };                                                                         \
