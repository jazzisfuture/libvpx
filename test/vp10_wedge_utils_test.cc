...
TEST_F(WedgeUtilsSSEFuncTest, ResidualBlendingEquiv) {
  Aligned<32, uint8_buf_t> s;
  Aligned<32, uint8_buf_t> p0;
  Aligned<32, uint8_buf_t> p1;
  Aligned<32, uint8_buf_t> p;

  Aligned<32, int16_buf_t> r0;
  Aligned<32, int16_buf_t> r1;
  Aligned<32, int16_buf_t> r_ref;
  Aligned<32, int16_buf_t> r_tst;
  Aligned<32, uint8_buf_t> m;
...
class WedgeUtilsDeltaSquaresOptTest : public FunctionEquivalenceTest<FDS> {
 protected:
  ...
  Aligned<32, int16_buf_t> a;
  Aligned<32, int16_buf_t> b;
  Aligned<32, int16_buf_t> d_ref;
  Aligned<32, int16_buf_t> d_tst;
};
