...
class WedgeUtilsSSEOptTest : public FunctionEquivalenceTest<FSSE> {
 protected:
  WedgeUtilsSSEOptTest()
      : r1(aligned<int16_buf_t>(16)),
        d(aligned<int16_buf_t>(16)),
        m(aligned<uint8_buf_t>(16)) {}
...
class WedgeUtilsSignOptTest : public FunctionEquivalenceTest<FSign> {
 protected:
  ...
  WedgeUtilsSignOptTest()
      : r0(aligned<int16_buf_t>(16)),
        r1(aligned<int16_buf_t>(16)),
        ds(aligned<int16_buf_t>(16)),
        m(aligned<uint8_buf_t>(16)) {}
...
class WedgeUtilsDeltaSquaresOptTest : public FunctionEquivalenceTest<FDS> {
 protected:
  WedgeUtilsDeltaSquaresOptTest()
      : a(aligned<int16_buf_t>(16)),
        b(aligned<int16_buf_t>(16)),
        d_ref(aligned<int16_buf_t>(16)),
        d_tst(aligned<int16_buf_t>(16)) {}
