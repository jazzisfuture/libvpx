  ...
  for (int y = 0; y < h; y++) {
    for (int x = 0; x < w; x++) {
      ...
      if (!use_high_bit_depth_) {
        diff = ref[y * ref_stride + x] - src[y * src_stride + x];
        se += diff;
        sse += diff * diff;
#if CONFIG_VP9_HIGHBITDEPTH
      } else {
        diff = CONVERT_TO_SHORTPTR(ref)[y * ref_stride + x] -
               CONVERT_TO_SHORTPTR(src)[y * src_stride + x];
        se += diff;
        sse += diff * diff;
...
struct TestParams {
  TestParams(int log2w = 0, int log2h = 0,
             vpx_variance_four_fn_t function = NULL, int bit_depth_value = 0)
...
class VpxVarianceFourTest : public ::testing::TestWithParam<TestParams> {
 public:
  virtual void SetUp() {
...
void VpxVarianceFourTest::ZeroTest() {
  for (int i = 0; i <= 255; ++i) {
    if (!use_high_bit_depth()) {
...
void VpxVarianceFourTest::RefTest() {
  for (int i = 0; i < 10; ++i) {
...
void VpxVarianceFourTest::RefStrideTest() {
  for (int i = 0; i < 10; ++i) {
...
void VpxVarianceFourTest::OneQuarterTest() {
...
void VpxVarianceFourTest::SpeedTest() {
  const int half = block_size() / 2;
  if (!use_high_bit_depth()) {
    memset(src_, 255, block_size());
    memset(ref_[0], 255, half);
...
INSTANTIATE_TEST_CASE_P(
    ...
    ::testing::Values(TestParams(6, 6, &vpx_variance_four_64x64_c),
                      TestParams(6, 5, &vpx_variance_four_64x32_c),
                      TestParams(5, 6, &vpx_variance_four_32x64_c),
                      TestParams(5, 5, &vpx_variance_four_32x32_c),
                      TestParams(5, 4, &vpx_variance_four_32x16_c),
                      TestParams(4, 5, &vpx_variance_four_16x32_c),
                      TestParams(4, 4, &vpx_variance_four_16x16_c),
                      TestParams(4, 3, &vpx_variance_four_16x8_c),
                      TestParams(3, 4, &vpx_variance_four_8x16_c),
                      TestParams(3, 3, &vpx_variance_four_8x8_c),
                      TestParams(3, 2, &vpx_variance_four_8x4_c),
                      TestParams(2, 3, &vpx_variance_four_4x8_c),
                      TestParams(2, 2, &vpx_variance_four_4x4_c)));

#if CONFIG_VP9_HIGHBITDEPTH
typedef VpxVarianceFourTest VpxHBDVarianceFourTest;
...
INSTANTIATE_TEST_CASE_P(
    ...
    ::testing::Values(
        TestParams(6, 6, &vpx_highbd_12_variance_four_64x64_c, 12),
        TestParams(6, 5, &vpx_highbd_12_variance_four_64x32_c, 12),
        TestParams(5, 6, &vpx_highbd_12_variance_four_32x64_c, 12),
        TestParams(5, 5, &vpx_highbd_12_variance_four_32x32_c, 12),
        TestParams(5, 4, &vpx_highbd_12_variance_four_32x16_c, 12),
        TestParams(4, 5, &vpx_highbd_12_variance_four_16x32_c, 12),
        TestParams(4, 4, &vpx_highbd_12_variance_four_16x16_c, 12),
        TestParams(4, 3, &vpx_highbd_12_variance_four_16x8_c, 12),
        TestParams(3, 4, &vpx_highbd_12_variance_four_8x16_c, 12),
        TestParams(3, 3, &vpx_highbd_12_variance_four_8x8_c, 12),
        TestParams(3, 2, &vpx_highbd_12_variance_four_8x4_c, 12),
        TestParams(2, 3, &vpx_highbd_12_variance_four_4x8_c, 12),
        TestParams(2, 2, &vpx_highbd_12_variance_four_4x4_c, 12),
        TestParams(6, 6, &vpx_highbd_10_variance_four_64x64_c, 10),
        TestParams(6, 5, &vpx_highbd_10_variance_four_64x32_c, 10),
        TestParams(5, 6, &vpx_highbd_10_variance_four_32x64_c, 10),
        TestParams(5, 5, &vpx_highbd_10_variance_four_32x32_c, 10),
        TestParams(5, 4, &vpx_highbd_10_variance_four_32x16_c, 10),
        TestParams(4, 5, &vpx_highbd_10_variance_four_16x32_c, 10),
        TestParams(4, 4, &vpx_highbd_10_variance_four_16x16_c, 10),
        TestParams(4, 3, &vpx_highbd_10_variance_four_16x8_c, 10),
        TestParams(3, 4, &vpx_highbd_10_variance_four_8x16_c, 10),
        TestParams(3, 3, &vpx_highbd_10_variance_four_8x8_c, 10),
        TestParams(3, 2, &vpx_highbd_10_variance_four_8x4_c, 10),
        TestParams(2, 3, &vpx_highbd_10_variance_four_4x8_c, 10),
        TestParams(2, 2, &vpx_highbd_10_variance_four_4x4_c, 10),
        TestParams(6, 6, &vpx_highbd_8_variance_four_64x64_c, 8),
        TestParams(6, 5, &vpx_highbd_8_variance_four_64x32_c, 8),
        TestParams(5, 6, &vpx_highbd_8_variance_four_32x64_c, 8),
        TestParams(5, 5, &vpx_highbd_8_variance_four_32x32_c, 8),
        TestParams(5, 4, &vpx_highbd_8_variance_four_32x16_c, 8),
        TestParams(4, 5, &vpx_highbd_8_variance_four_16x32_c, 8),
        TestParams(4, 4, &vpx_highbd_8_variance_four_16x16_c, 8),
        TestParams(4, 3, &vpx_highbd_8_variance_four_16x8_c, 8),
        TestParams(3, 4, &vpx_highbd_8_variance_four_8x16_c, 8),
        TestParams(3, 3, &vpx_highbd_8_variance_four_8x8_c, 8),
        TestParams(3, 2, &vpx_highbd_8_variance_four_8x4_c, 8),
        TestParams(2, 3, &vpx_highbd_8_variance_four_4x8_c, 8),
        TestParams(2, 2, &vpx_highbd_8_variance_four_4x4_c, 8)));
#endif  // CONFIG_VP9_HIGHBITDEPTH

#if HAVE_SSE2
INSTANTIATE_TEST_CASE_P(
    SSE2, VpxVarianceFourTest,
    ::testing::Values(TestParams(6, 6, &vpx_variance_four_64x64_sse2),
                      TestParams(6, 5, &vpx_variance_four_64x32_sse2),
                      TestParams(5, 6, &vpx_variance_four_32x64_sse2),
                      TestParams(5, 5, &vpx_variance_four_32x32_sse2),
                      TestParams(5, 4, &vpx_variance_four_32x16_sse2),
                      TestParams(4, 5, &vpx_variance_four_16x32_sse2),
                      TestParams(4, 4, &vpx_variance_four_16x16_sse2),
                      TestParams(4, 3, &vpx_variance_four_16x8_sse2),
                      TestParams(3, 4, &vpx_variance_four_8x16_sse2),
                      TestParams(3, 3, &vpx_variance_four_8x8_sse2),
                      TestParams(3, 2, &vpx_variance_four_8x4_sse2),
                      TestParams(2, 3, &vpx_variance_four_4x8_sse2),
                      TestParams(2, 2, &vpx_variance_four_4x4_sse2)));

#if 0   // CONFIG_VP9_HIGHBITDEPTH
INSTANTIATE_TEST_CASE_P(
    SSE2, VpxHBDVarianceFourTest,
    ::testing::Values(
        TestParams(6, 6, &vpx_highbd_12_variance_four_64x64_sse2, 12),
        TestParams(6, 5, &vpx_highbd_12_variance_four_64x32_sse2, 12),
        TestParams(5, 6, &vpx_highbd_12_variance_four_32x64_sse2, 12),
        TestParams(5, 5, &vpx_highbd_12_variance_four_32x32_sse2, 12),
        TestParams(5, 4, &vpx_highbd_12_variance_four_32x16_sse2, 12),
        TestParams(4, 5, &vpx_highbd_12_variance_four_16x32_sse2, 12),
        TestParams(4, 4, &vpx_highbd_12_variance_four_16x16_sse2, 12),
        TestParams(4, 3, &vpx_highbd_12_variance_four_16x8_sse2, 12),
        TestParams(3, 4, &vpx_highbd_12_variance_four_8x16_sse2, 12),
        TestParams(3, 3, &vpx_highbd_12_variance_four_8x8_sse2, 12),
        TestParams(6, 6, &vpx_highbd_10_variance_four_64x64_sse2, 10),
        TestParams(6, 5, &vpx_highbd_10_variance_four_64x32_sse2, 10),
        TestParams(5, 6, &vpx_highbd_10_variance_four_32x64_sse2, 10),
        TestParams(5, 5, &vpx_highbd_10_variance_four_32x32_sse2, 10),
        TestParams(5, 4, &vpx_highbd_10_variance_four_32x16_sse2, 10),
        TestParams(4, 5, &vpx_highbd_10_variance_four_16x32_sse2, 10),
        TestParams(4, 4, &vpx_highbd_10_variance_four_16x16_sse2, 10),
        TestParams(4, 3, &vpx_highbd_10_variance_four_16x8_sse2, 10),
        TestParams(3, 4, &vpx_highbd_10_variance_four_8x16_sse2, 10),
        TestParams(3, 3, &vpx_highbd_10_variance_four_8x8_sse2, 10),
        TestParams(6, 6, &vpx_highbd_8_variance_four_64x64_sse2, 8),
        TestParams(6, 5, &vpx_highbd_8_variance_four_64x32_sse2, 8),
        TestParams(5, 6, &vpx_highbd_8_variance_four_32x64_sse2, 8),
        TestParams(5, 5, &vpx_highbd_8_variance_four_32x32_sse2, 8),
        TestParams(5, 4, &vpx_highbd_8_variance_four_32x16_sse2, 8),
        TestParams(4, 5, &vpx_highbd_8_variance_four_16x32_sse2, 8),
        TestParams(4, 4, &vpx_highbd_8_variance_four_16x16_sse2, 8),
        TestParams(4, 3, &vpx_highbd_8_variance_four_16x8_sse2, 8),
        TestParams(3, 4, &vpx_highbd_8_variance_four_8x16_sse2, 8),
        TestParams(3, 3, &vpx_highbd_8_variance_four_8x8_sse2, 8)));
#endif  // CONFIG_VP9_HIGHBITDEPTH
#endif  // HAVE_SSE2
}  // namespace
