...
class DatarateTest : public ::libvpx_test::EncoderTest,
 ...
 protected:
  ...
  virtual void PreEncodeFrameHook(::libvpx_test::VideoSource *video,
    ...
    duration_ = 0;//video->limit() * timebase_;
  }
  ...
  virtual void FramePktHook(const vpx_codec_cx_pkt_t *pkt) {
    ...
    // TODO: ( Remove these lines when the issue:
    ...
    bits_in_buffer_model_ -= pkt->data.frame.sz * 8;

    // Update the running total of bits for end of test datarate checks.
    bits_total_ += pkt->data.frame.sz * 8;
    ...
    bits_in_last_frame_ = pkt->data.frame.sz * 8;
...
TEST_P(DatarateTest, BasicBufferModel) {
  ...
  // constraints
  // TODO: ( Fix when issue http://code.google.com/p/webm/issues/detail?id=495
  // is addressed. )
