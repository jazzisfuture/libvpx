...
VP9_INSTANTIATE_TEST_CASE(DatarateTestVP9,
                          ...
                          ::testing::Range(2, 7));
//TODO(marpan): Speed 7 fails on one of these tests (likely just a threshold needs
// to be changed), so for now test up to speed 6, and start at 2 (since speeds 0,
// 1 are slow). Allow speed 7 (for real-time mode) after looking/fix failing issue.
}  // namespace
