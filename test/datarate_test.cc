...
// Run SVC encoder, with encoder created and destroyed multiple times.
// For 1 temporal layer, 2 spatial layers, with spatial scale 2x2.
TEST_P(DatarateOnePassCbrSvc, OnePassCbrSvc2SpatialLayers2x2MultipleRuns) {
  for (int i = 0; i < 10; i++) {
    cfg_.rc_buf_initial_sz = 500;
    cfg_.rc_buf_optimal_sz = 500;
    cfg_.rc_buf_sz = 1000;
    ...
    svc_params_.scaling_factor_num[0] = 640;
    ...
    cfg_.kf_min_dist = 0;
    cfg_.ss_target_bitrate[0] = 284;
    cfg_.ss_target_bitrate[1] = 1422;
    cfg_.layer_target_bitrate[0] = 284;
    cfg_.layer_target_bitrate[1] = 1422;
    cfg_.rc_target_bitrate = 1706;
...
// Run SVC encoder, with encoder created and destroyed multiple times.
// For 1 temporal layer, 2 spatial layers, with spatial scale 5x5.
