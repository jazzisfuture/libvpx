...
class DatarateOnePassCbrSvc
 ...
 protected:
  ...
  virtual void ResetModel() {
    ...
    memset(bits_in_buffer_model_, 0, VPX_MAX_LAYERS * sizeof(int64_t));
    memset(bits_total_, 0, VPX_MAX_LAYERS * sizeof(int64_t));
    memset(layer_target_avg_bandwidth_, 0, VPX_MAX_LAYERS * sizeof(int));
  }
