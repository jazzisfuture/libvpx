...
# for that example (not just them main one specified in TOOLS)
...
CLEAN-OBJS += tools.doxy samples.dox $(TOOLS:.c=.dox)
DOCS-yes += tools.doxy samples.dox
tools.doxy: samples.dox $(TOOLS:.c=.dox)
	@echo "INPUT += $^" > $@
