...
void vp8_build_1st_inter16x16_predictors_mbuv(MACROBLOCKD *xd,
  ...
  _16x16mv.as_int = xd->mode_info_context->mbmi.mv.as_int;
  ...
  if (xd->mode_info_context->mbmi.pred_filter_enabled) {
    ...
    if (_o16x16mv.as_int & 0x000f000f) {
      ...
      RECON_INVOKE(&xd->rtcd->recon, copy8x8)(uptr, pre_stride,
                                              dst_u, dst_uvstride);
      RECON_INVOKE(&xd->rtcd->recon, copy8x8)(vptr, pre_stride,
                                              dst_v, dst_uvstride);
    }
}
...
void vp8_build_2nd_inter16x16_predictors_mby(MACROBLOCKD *xd,
  ...
  _16x16mv.as_int = xd->mode_info_context->mbmi.second_mv.as_int;
