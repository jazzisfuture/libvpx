...
static inline int vpx_nobarrier_load_32(volatile atomic_int *x) {
  return atomic_load_explicit(x, memory_order_relaxed);
}

static inline void vpx_nobarrier_store_32(volatile atomic_int *x, int v) {
...
static inline int vpx_nobarrier_load_32(volatile atomic_int *x) { return *x; }
