...
specialize qw/vp8_dequant_idct_add_y_block mmx sse2 media neon-asm dspr2/;
...
specialize qw/vp8_dequant_idct_add_uv_block mmx sse2 media neon-asm dspr2/;
...
specialize qw/vp8_loop_filter_mbv mmx sse2 media neon-asm dspr2/;
...
specialize qw/vp8_loop_filter_bv mmx sse2 media neon-asm dspr2/;
...
specialize qw/vp8_loop_filter_mbh mmx sse2 media neon-asm dspr2/;
...
specialize qw/vp8_loop_filter_bh mmx sse2 media neon-asm dspr2/;
...
specialize qw/vp8_loop_filter_simple_mbv mmx sse2 media neon-asm/;
...
specialize qw/vp8_loop_filter_simple_mbh mmx sse2 media neon-asm/;
...
specialize qw/vp8_loop_filter_simple_bv mmx sse2 media neon-asm/;
...
specialize qw/vp8_loop_filter_simple_bh mmx sse2 media neon-asm/;
...
specialize qw/vp8_sub_pixel_variance8x8 mmx sse2 media neon-asm/;
...
specialize qw/vp8_sub_pixel_variance16x16 mmx sse2 ssse3 media neon-asm/;
...
specialize qw/vp8_variance_halfpixvar16x16_h mmx sse2 media neon-asm/;
...
specialize qw/vp8_variance_halfpixvar16x16_v mmx sse2 media neon-asm/;
...
specialize qw/vp8_variance_halfpixvar16x16_hv mmx sse2 media neon-asm/;
