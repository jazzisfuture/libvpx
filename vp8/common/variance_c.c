...
)
{
    ...
    return vpx_variance4x4_c(temp2, 4, dst_ptr, dst_pixels_per_line, sse);
}
...
)
{
    ...
    return vpx_variance8x8_c(temp2, 8, dst_ptr, dst_pixels_per_line, sse);
}
...
)
{
    ...
    return vpx_variance16x16_c(temp2, 16, dst_ptr, dst_pixels_per_line, sse);
}
...
)
{
    ...
    return vpx_variance16x8_c(temp2, 16, dst_ptr, dst_pixels_per_line, sse);
}
...
)
{
    ...
    return vpx_variance8x16_c(temp2, 8, dst_ptr, dst_pixels_per_line, sse);
}
