...
void vp8_dequant_idct_add_mmi(int16_t *input, int16_t *dq, unsigned char *dest,
                              int stride);
void vp8_dc_only_idct_add_mmi(int16_t input_dc, unsigned char *pred,
                              int pred_stride, unsigned char *dst_ptr,
                              int dst_stride);

void vp8_dequant_idct_add_y_block_mmi(int16_t *q, int16_t *dq, unsigned char *dst,
...
void vp8_dequant_idct_add_uv_block_mmi(int16_t *q, int16_t *dq, unsigned char *dstu,
