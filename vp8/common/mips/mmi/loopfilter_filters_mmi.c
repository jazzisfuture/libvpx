...
#define VP8_LOOP_VPSRAB_PUNPCKLBH(reg1, reg2) \
  "punpcklbh " #reg1 ", " #reg1 ", " #reg2 "                      \n\t"
#define VP8_LOOP_VPSRAB_PUNPCKHBH(reg1, reg2) \
  "punpckhbh " #reg1 ", " #reg1 ", " #reg2 "                      \n\t"
#define VP8_LOOP_VPSRAB(reg) \
  "xor       %[ftmp0],    %[ftmp0],           %[ftmp0]            \n\t" \
  "xor       %[ftmp8],    %[ftmp8],           %[ftmp8]            \n\t" \
  VP8_LOOP_VPSRAB_PUNPCKLBH(%[ftmp0], reg)                              \
  VP8_LOOP_VPSRAB_PUNPCKHBH(%[ftmp8], reg)                              \
  "psrah     %[ftmp0],    %[ftmp0],           %[ftmp7]            \n\t" \
  "psrah     %[ftmp8],    %[ftmp8],           %[ftmp7]            \n\t" \
  "packsshb  " #reg ",    %[ftmp0],           %[ftmp8]            \n\t"
...
void vp8_loop_filter_vertical_edge_mmi(unsigned char *src_ptr,
  ...
  __asm__ volatile (
    ...
    "li         %[tmp0],    0x0b                                    \n\t"
    "mtc1       %[tmp0],    %[ftmp7]                                \n\t"
    VP8_LOOP_VPSRAB(%[ftmp12])
    VP8_LOOP_VPSRAB(%[ftmp11])
...
#define VP8_MBLOOP_VPSRAB_PUNPCKLBH(reg1, reg2) \
  "punpcklbh " #reg1 ", " #reg1 ", " #reg2 "                      \n\t"
#define VP8_MBLOOP_VPSRAB_PUNPCKHBH(reg1, reg2) \
  "punpckhbh " #reg1 ", " #reg1 ", " #reg2 "                      \n\t"

#define VP8_MBLOOP_VPSRAB(reg) \
  "xor        %[ftmp7],   %[ftmp7],           %[ftmp7]            \n\t" \
  "xor        %[ftmp8],   %[ftmp8],           %[ftmp8]            \n\t" \
  VP8_MBLOOP_VPSRAB_PUNPCKLBH(%[ftmp7], reg)                            \
  VP8_MBLOOP_VPSRAB_PUNPCKHBH(%[ftmp8], reg)                            \
  "psrah      %[ftmp7],   %[ftmp7],           %[ftmp12]           \n\t" \
  "psrah      %[ftmp8],   %[ftmp8],           %[ftmp12]           \n\t" \
  "packsshb   " #reg ",   %[ftmp7],           %[ftmp8]            \n\t"
