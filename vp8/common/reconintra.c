  ...
  switch (mode) {
    case DC_PRED: {
      ...
      if (xd->up_available || xd->left_available) {
        ...
        shift = log2_bsize_min1 + xd->up_available + xd->left_available;
...
void vp8_build_intra_predictors_mby(MACROBLOCKD *xd) {
  vp8_build_intra_predictors_mby_internal(xd, xd->dst.y_buffer, xd->dst.y_stride,
                                          xd->predictor, 16,
...
void vp8_build_intra_predictors_mbuv_internal(MACROBLOCKD *xd,
                                              ...
                                              int uv_stride,
                                              int mode, int bsize) {
  vp8_build_intra_predictors_mby_internal(xd, xd->dst.u_buffer, xd->dst.uv_stride,
                                          upred_ptr, uv_stride, mode, bsize);
  vp8_build_intra_predictors_mby_internal(xd, xd->dst.v_buffer, xd->dst.uv_stride,
                                          vpred_ptr, uv_stride, mode, bsize);
}

void vp8_build_intra_predictors_mbuv(MACROBLOCKD *xd) {
  vp8_build_intra_predictors_mbuv_internal(xd, &xd->predictor[256], &xd->predictor[320], 8,
                                           xd->mode_info_context->mbmi.uv_mode, 8);
}

void vp8_build_intra_predictors_mbuv_s(MACROBLOCKD *xd) {
  vp8_build_intra_predictors_mbuv_internal(xd, xd->dst.u_buffer, xd->dst.v_buffer,
                                           xd->dst.uv_stride,
                                           xd->mode_info_context->mbmi.uv_mode, 8);
}
...
void vp8_build_intra_predictors_sbuv_s(MACROBLOCKD *xd) {
  vp8_build_intra_predictors_mbuv_internal(xd, xd->dst.u_buffer, xd->dst.v_buffer,
                                           xd->dst.uv_stride,
                                           xd->mode_info_context->mbmi.uv_mode, 16);
}
#endif
