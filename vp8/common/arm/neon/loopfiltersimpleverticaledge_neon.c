...
// Some versions of gcc4.6 do not correctly process some intrinsics. When built
// with any gcc4.6, transpose and use simpler stores.
...
#ifdef VPX_INCOMPATIBLE_GCC
// Some versions of gcc4.6 do not correctly process some intrinsics. When built
// with any gcc4.6, use simpler loads and transpose.
static INLINE
