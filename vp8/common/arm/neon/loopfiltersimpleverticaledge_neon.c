...
static INLINE
#endif
void write_2x4_even(unsigned char *dst, int pitch, const uint8x8x2_t result) {
...
static INLINE
#endif
void write_2x4_odd(unsigned char *dst, int pitch, const uint8x8x2_t result) {
...
static INLINE
#endif
uint8x8x4_t read_4x4_even(unsigned char *src, int pitch, uint8x8x4_t x) {
...
static INLINE
#endif
uint8x8x4_t read_4x4_odd(unsigned char *src, int pitch, uint8x8x4_t x) {
...
static INLINE void vp8_loop_filter_simple_vertical_edge_neon(
    ...
    src1 = s - 2;
    d0u8x4 = read_4x4_even(src1, pitch, d0u8x4);
    src1 += pitch * 4;
    d1u8x4 = read_4x4_even(src1, pitch, d1u8x4);

    src2 = s - 2 + p;
    d0u8x4 = read_4x4_odd(src2, pitch, d0u8x4);
    src2 += pitch * 4;
    d1u8x4 = read_4x4_odd(src2, pitch, d1u8x4);
    ...
    src1 = s - 1;
    write_2x4_even(src1, pitch, d2u8x2);
    src1 += pitch * 4;
    write_2x4_even(src1, pitch, d3u8x2);

    src2 = s - 1 + p;
    write_2x4_odd(src2, pitch, d2u8x2);
    src2 += pitch * 4;
    write_2x4_odd(src2, pitch, d3u8x2);
}
