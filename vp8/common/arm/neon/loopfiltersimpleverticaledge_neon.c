...
void vp8_loop_filter_simple_vertical_edge_neon(
        unsigned char *s,
        int p,
    ...
    d0u8x4 = vld4_lane_u8(src1, d0u8x4, 0); src1 += pitch;
    d0u8x4 = vld4_lane_u8(src2, d0u8x4, 1); src2 += pitch;
    d0u8x4 = vld4_lane_u8(src1, d0u8x4, 2); src1 += pitch;
    d0u8x4 = vld4_lane_u8(src2, d0u8x4, 3); src2 += pitch;
    d0u8x4 = vld4_lane_u8(src1, d0u8x4, 4); src1 += pitch;
    d0u8x4 = vld4_lane_u8(src2, d0u8x4, 5); src2 += pitch;
    d0u8x4 = vld4_lane_u8(src1, d0u8x4, 6); src1 += pitch;
    d0u8x4 = vld4_lane_u8(src2, d0u8x4, 7); src2 += pitch;

    d1u8x4 = vld4_lane_u8(src1, d1u8x4, 0); src1 += pitch;
    d1u8x4 = vld4_lane_u8(src2, d1u8x4, 1); src2 += pitch;
    d1u8x4 = vld4_lane_u8(src1, d1u8x4, 2); src1 += pitch;
    d1u8x4 = vld4_lane_u8(src2, d1u8x4, 3); src2 += pitch;
    d1u8x4 = vld4_lane_u8(src1, d1u8x4, 4); src1 += pitch;
    d1u8x4 = vld4_lane_u8(src2, d1u8x4, 5); src2 += pitch;
    ...
    src1 = s - 1;
    src2 = src1 + p;
    vst2_lane_u8(src1, d2u8x2, 0); src1 += pitch;
    vst2_lane_u8(src2, d2u8x2, 1); src2 += pitch;
    vst2_lane_u8(src1, d2u8x2, 2); src1 += pitch;
    vst2_lane_u8(src2, d2u8x2, 3); src2 += pitch;
    vst2_lane_u8(src1, d2u8x2, 4); src1 += pitch;
    vst2_lane_u8(src2, d2u8x2, 5); src2 += pitch;
    vst2_lane_u8(src1, d2u8x2, 6); src1 += pitch;
    vst2_lane_u8(src2, d2u8x2, 7); src2 += pitch;

    vst2_lane_u8(src1, d3u8x2, 0); src1 += pitch;
    vst2_lane_u8(src2, d3u8x2, 1); src2 += pitch;
    vst2_lane_u8(src1, d3u8x2, 2); src1 += pitch;
    vst2_lane_u8(src2, d3u8x2, 3); src2 += pitch;
    vst2_lane_u8(src1, d3u8x2, 4); src1 += pitch;
    vst2_lane_u8(src2, d3u8x2, 5); src2 += pitch;
