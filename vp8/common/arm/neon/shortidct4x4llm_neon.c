...
void vp8_short_idct4x4llm_neon(
    ...
    d6u32 = d7u32 = vdup_n_u32(0);

    d2 = vld1_s16(input); input += 4;
    d3 = vld1_s16(input); input += 4;
    d4 = vld1_s16(input); input += 4;
    d5 = vld1_s16(input);
    ...
    pred_ptr += pred_stride;
    d7u32 = vld1_lane_u32((const uint32_t *)pred_ptr, d7u32, 0);
    pred_ptr += pred_stride;
    d7u32 = vld1_lane_u32((const uint32_t *)pred_ptr, d7u32, 1);

    q1u16 = vaddw_u8(vreinterpretq_u16_s16(q1s16), vreinterpret_u8_u32(d6u32));
    q2u16 = vaddw_u8(vreinterpretq_u16_s16(q2s16), vreinterpret_u8_u32(d7u32));

    d1u8 = vqmovun_s16(vreinterpretq_s16_u16(q1u16));
    d2u8 = vqmovun_s16(vreinterpretq_s16_u16(q2u16));
