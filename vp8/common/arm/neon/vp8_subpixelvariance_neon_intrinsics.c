...
unsigned int vp8_sub_pixel_variance16x16_neon_func(
    ...
    uint8x16_t q0u8, q1u8, q2u8, q3u8, q4u8, q5u8, q6u8, q7u8, q8u8, q9u8, q10u8;
    ...
    if (xoffset == 0) {  // secondpass_bfilter16x16_only
        ...
        for (i = 4; i > 0; i--) {
            ...
            vst1q_u8((uint8_t *)tmpp, q1u8); tmpp += 16;
            vst1q_u8((uint8_t *)tmpp, q2u8); tmpp += 16;
            vst1q_u8((uint8_t *)tmpp, q3u8); tmpp += 16;
            vst1q_u8((uint8_t *)tmpp, q4u8); tmpp += 16;
        }
    ...
    for (i = 0; i < 8; i++) {  // sub_pixel_variance16x16_neon_loop
        q0u8 = vld1q_u8(tmpp); tmpp += 16;
        q1u8 = vld1q_u8(tmpp); tmpp += 16;
        q2u8 = vld1q_u8(dst_ptr); dst_ptr += dst_pixels_per_line;
        q3u8 = vld1q_u8(dst_ptr); dst_ptr += dst_pixels_per_line;
...
unsigned int vp8_variance_halfpixvar16x16_h_neon(
    ...
    for (i = 0; i < 4; i++) {  // vp8_filt_fpo16x16s_4_0_loop_neon
        ...
        q1u8 = vld1q_u8(src_ptr + 16); src_ptr += source_stride;
        q2u8 = vld1q_u8(src_ptr);
        q3u8 = vld1q_u8(src_ptr + 16); src_ptr += source_stride;
        q4u8 = vld1q_u8(src_ptr);
        q5u8 = vld1q_u8(src_ptr + 16); src_ptr += source_stride;
        q6u8 = vld1q_u8(src_ptr);
        q7u8 = vld1q_u8(src_ptr + 16); src_ptr += source_stride;
        q11u8 = vld1q_u8(ref_ptr); ref_ptr += recon_stride;
        q12u8 = vld1q_u8(ref_ptr); ref_ptr += recon_stride;
        q13u8 = vld1q_u8(ref_ptr); ref_ptr += recon_stride;
        q14u8 = vld1q_u8(ref_ptr); ref_ptr += recon_stride;
...
unsigned int vp8_variance_halfpixvar16x16_v_neon(
    ...
    q0u8 = vld1q_u8(src_ptr); src_ptr += source_stride;
    for (i = 0; i < 4; i++) {  // vp8_filt_fpo16x16s_4_0_loop_neon
        q2u8 = vld1q_u8(src_ptr); src_ptr += source_stride;
        q4u8 = vld1q_u8(src_ptr); src_ptr += source_stride;
        q6u8 = vld1q_u8(src_ptr); src_ptr += source_stride;
        q15u8 = vld1q_u8(src_ptr); src_ptr += source_stride;
        q1u8 = vld1q_u8(ref_ptr); ref_ptr += recon_stride;
        q3u8 = vld1q_u8(ref_ptr); ref_ptr += recon_stride;
        q5u8 = vld1q_u8(ref_ptr); ref_ptr += recon_stride;
        q7u8 = vld1q_u8(ref_ptr); ref_ptr += recon_stride;
...
unsigned int vp8_variance_halfpixvar16x16_hv_neon(
    ...
    for (i = 0; i < 4; i++) {  // vp8_filt_fpo16x16s_4_0_loop_neon
        ...
        q9u8 = vld1q_u8(src_ptr + 16); src_ptr += source_stride;
        ...
        q5u8 = vld1q_u8(ref_ptr); ref_ptr += recon_stride;
        q6u8 = vld1q_u8(ref_ptr); ref_ptr += recon_stride;
        q5u8 = vld1q_u8(ref_ptr); ref_ptr += recon_stride;
        q7u8 = vld1q_u8(ref_ptr); ref_ptr += recon_stride;
