...
static void vp8_mbloop_filter_neon(
...
void vp8_mbloop_filter_horizontal_edge_y_neon(
    ...
    q3 = vld1q_u8(src); src += pitch;
    q4 = vld1q_u8(src); src += pitch;
    q5 = vld1q_u8(src); src += pitch;
    q6 = vld1q_u8(src); src += pitch;
    q7 = vld1q_u8(src); src += pitch;
    q8 = vld1q_u8(src); src += pitch;
    q9 = vld1q_u8(src); src += pitch;
    q10 = vld1q_u8(src);
    ...
    src -= (pitch * 6);
    vst1q_u8(src, q4); src += pitch;
    vst1q_u8(src, q5); src += pitch;
    vst1q_u8(src, q6); src += pitch;
    vst1q_u8(src, q7); src += pitch;
    vst1q_u8(src, q8); src += pitch;
    vst1q_u8(src, q9);
    return;
}
...
void vp8_mbloop_filter_horizontal_edge_uv_neon(
    ...
    d6  = vld1_u8(u); u += pitch;
    d7  = vld1_u8(v); v += pitch;
    d8  = vld1_u8(u); u += pitch;
    d9  = vld1_u8(v); v += pitch;
    d10 = vld1_u8(u); u += pitch;
    d11 = vld1_u8(v); v += pitch;
    d12 = vld1_u8(u); u += pitch;
    d13 = vld1_u8(v); v += pitch;
    d14 = vld1_u8(u); u += pitch;
    d15 = vld1_u8(v); v += pitch;
    d16 = vld1_u8(u); u += pitch;
    d17 = vld1_u8(v); v += pitch;
    d18 = vld1_u8(u); u += pitch;
    d19 = vld1_u8(v); v += pitch;
    d20 = vld1_u8(u);
    d21 = vld1_u8(v);
    ...
    u -= (pitch * 6);
    v -= (pitch * 6);
    vst1_u8(u, vget_low_u8(q4));  u += pitch;
    vst1_u8(v, vget_high_u8(q4)); v += pitch;
    vst1_u8(u, vget_low_u8(q5));  u += pitch;
    vst1_u8(v, vget_high_u8(q5)); v += pitch;
    vst1_u8(u, vget_low_u8(q6));  u += pitch;
    vst1_u8(v, vget_high_u8(q6)); v += pitch;
    vst1_u8(u, vget_low_u8(q7));  u += pitch;
    vst1_u8(v, vget_high_u8(q7)); v += pitch;
    vst1_u8(u, vget_low_u8(q8));  u += pitch;
    vst1_u8(v, vget_high_u8(q8)); v += pitch;
...
void vp8_mbloop_filter_vertical_edge_y_neon(
    ...
    s1 = src - 4;
    s2 = s1 + 8 * pitch;
    d6  = vld1_u8(s1); s1 += pitch;
    d7  = vld1_u8(s2); s2 += pitch;
    d8  = vld1_u8(s1); s1 += pitch;
    d9  = vld1_u8(s2); s2 += pitch;
    d10 = vld1_u8(s1); s1 += pitch;
    d11 = vld1_u8(s2); s2 += pitch;
    d12 = vld1_u8(s1); s1 += pitch;
    d13 = vld1_u8(s2); s2 += pitch;
    d14 = vld1_u8(s1); s1 += pitch;
    d15 = vld1_u8(s2); s2 += pitch;
    d16 = vld1_u8(s1); s1 += pitch;
    d17 = vld1_u8(s2); s2 += pitch;
    d18 = vld1_u8(s1); s1 += pitch;
    d19 = vld1_u8(s2); s2 += pitch;
    d20 = vld1_u8(s1);
    d21 = vld1_u8(s2);
    ...
    vst1_u8(s1, vget_low_u8(q3));  s1 += pitch;
    vst1_u8(s2, vget_high_u8(q3)); s2 += pitch;
    vst1_u8(s1, vget_low_u8(q4));  s1 += pitch;
    vst1_u8(s2, vget_high_u8(q4)); s2 += pitch;
    vst1_u8(s1, vget_low_u8(q5));  s1 += pitch;
    vst1_u8(s2, vget_high_u8(q5)); s2 += pitch;
    vst1_u8(s1, vget_low_u8(q6));  s1 += pitch;
    vst1_u8(s2, vget_high_u8(q6)); s2 += pitch;
    vst1_u8(s1, vget_low_u8(q7));  s1 += pitch;
    vst1_u8(s2, vget_high_u8(q7)); s2 += pitch;
    vst1_u8(s1, vget_low_u8(q8));  s1 += pitch;
    vst1_u8(s2, vget_high_u8(q8)); s2 += pitch;
    vst1_u8(s1, vget_low_u8(q9));  s1 += pitch;
    vst1_u8(s2, vget_high_u8(q9)); s2 += pitch;
...
void vp8_mbloop_filter_vertical_edge_uv_neon(
    ...
    us = u - 4;
    vs = v - 4;
    d6  = vld1_u8(us); us += pitch;
    d7  = vld1_u8(vs); vs += pitch;
    d8  = vld1_u8(us); us += pitch;
    d9  = vld1_u8(vs); vs += pitch;
    d10 = vld1_u8(us); us += pitch;
    d11 = vld1_u8(vs); vs += pitch;
    d12 = vld1_u8(us); us += pitch;
    d13 = vld1_u8(vs); vs += pitch;
    d14 = vld1_u8(us); us += pitch;
    d15 = vld1_u8(vs); vs += pitch;
    d16 = vld1_u8(us); us += pitch;
    d17 = vld1_u8(vs); vs += pitch;
    d18 = vld1_u8(us); us += pitch;
    d19 = vld1_u8(vs); vs += pitch;
    d20 = vld1_u8(us);
    d21 = vld1_u8(vs);
    ...
    ud = u - 4;
    vd = v - 4;
    vst1_u8(ud, vget_low_u8(q3));  ud += pitch;
    vst1_u8(vd, vget_high_u8(q3)); vd += pitch;
    vst1_u8(ud, vget_low_u8(q4));  ud += pitch;
    vst1_u8(vd, vget_high_u8(q4)); vd += pitch;
    vst1_u8(ud, vget_low_u8(q5));  ud += pitch;
    vst1_u8(vd, vget_high_u8(q5)); vd += pitch;
    vst1_u8(ud, vget_low_u8(q6));  ud += pitch;
    vst1_u8(vd, vget_high_u8(q6)); vd += pitch;
    vst1_u8(ud, vget_low_u8(q7));  ud += pitch;
    vst1_u8(vd, vget_high_u8(q7)); vd += pitch;
    vst1_u8(ud, vget_low_u8(q8));  ud += pitch;
    vst1_u8(vd, vget_high_u8(q8)); vd += pitch;
    vst1_u8(ud, vget_low_u8(q9));  ud += pitch;
    vst1_u8(vd, vget_high_u8(q9)); vd += pitch;
