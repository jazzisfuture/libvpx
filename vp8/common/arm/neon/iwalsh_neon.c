...
void vp8_short_inv_walsh4x4_neon(
    ...
    // store
    for (i = 0; i < 4; i++) {
        vst1_lane_s16(mb_dqcoeff, vget_low_s16(q0s16),  i); mb_dqcoeff += 16;
        vst1_lane_s16(mb_dqcoeff, vget_high_s16(q0s16), i); mb_dqcoeff += 16;
        vst1_lane_s16(mb_dqcoeff, vget_low_s16(q1s16),  i); mb_dqcoeff += 16;
        vst1_lane_s16(mb_dqcoeff, vget_high_s16(q1s16), i); mb_dqcoeff += 16;
    }
    return;
}
