...
void vp8_dequant_idct_add_neon(
    ...
    // load input
    q3 = vld1q_s16(input);
    vst1q_s16(input, qEmpty); input += 8;
    q4 = vld1q_s16(input);
    vst1q_s16(input, qEmpty);

    // load dq
    q5 = vld1q_s16(dq); dq += 8;
    q6 = vld1q_s16(dq);

    // load src from dst
    dst0 = dst;
    d14 = vld1_lane_s32((const int32_t *)dst0, d14, 0); dst0 += stride;
    d14 = vld1_lane_s32((const int32_t *)dst0, d14, 1); dst0 += stride;
    d15 = vld1_lane_s32((const int32_t *)dst0, d15, 0); dst0 += stride;
    ...
    // vswp
    dLow0 = vget_low_s16(q1);
    dHigh0 = vget_high_s16(q1);
    dLow1 = vget_low_s16(q2);
    dHigh1 = vget_high_s16(q2);
    q1 = vcombine_s16(dLow0, dLow1);
    q2 = vcombine_s16(dHigh0, dHigh1);

    q3 = vqdmulhq_n_s16(q2, sinpi8sqrt2);
    q4 = vqdmulhq_n_s16(q2, cospi8sqrt2minus1);

    d12 = vqadd_s16(vget_low_s16(q1), vget_high_s16(q1));
    d13 = vqsub_s16(vget_low_s16(q1), vget_high_s16(q1));
    ...
    dst0 = dst;
    vst1_lane_s32((int32_t *)dst0, d14, 0); dst0 += stride;
    vst1_lane_s32((int32_t *)dst0, d14, 1); dst0 += stride;
    vst1_lane_s32((int32_t *)dst0, d15, 0); dst0 += stride;
