...
static const int16_t vp8_sub_pel_filters[8][6] = {
    {0,  0,  128,   0,   0, 0},  /* note that 1/8 pel positionyys are */
    {0, -6,  123,  12,  -1, 0},  /*    just as per alpha -0.5 bicubic */
...
void vp8_sixtap_predict4x4_neon(
    ...
    int8x8_t d0s8, d1s8, d2s8, d3s8, d4s8, d5s8;
    ...
    if (xoffset == 0) {  // secondpass_filter4x4_only
        ...
        d0s8 = vdup_n_s8((int8_t)vp8_sub_pel_filters[yoffset][0]);
        d1s8 = vdup_n_s8((int8_t)vp8_sub_pel_filters[yoffset][1]);
        d2s8 = vdup_n_s8((int8_t)vp8_sub_pel_filters[yoffset][2]);
        d3s8 = vdup_n_s8((int8_t)vp8_sub_pel_filters[yoffset][3]);
        d4s8 = vdup_n_s8((int8_t)vp8_sub_pel_filters[yoffset][4]);
        d5s8 = vdup_n_s8((int8_t)vp8_sub_pel_filters[yoffset][5]);
    ...
    d0s8 = vdup_n_s8((int8_t)vp8_sub_pel_filters[xoffset][0]);
    d1s8 = vdup_n_s8((int8_t)vp8_sub_pel_filters[xoffset][1]);
    d2s8 = vdup_n_s8((int8_t)vp8_sub_pel_filters[xoffset][2]);
    d3s8 = vdup_n_s8((int8_t)vp8_sub_pel_filters[xoffset][3]);
    d4s8 = vdup_n_s8((int8_t)vp8_sub_pel_filters[xoffset][4]);
    d5s8 = vdup_n_s8((int8_t)vp8_sub_pel_filters[xoffset][5]);
    d0u8 = vreinterpret_u8_s8(vabs_s8(d0s8));
    d1u8 = vreinterpret_u8_s8(vabs_s8(d1s8));
    d2u8 = vreinterpret_u8_s8(vabs_s8(d2s8));
    d3u8 = vreinterpret_u8_s8(vabs_s8(d3s8));
    ...
    q3u8 = vld1q_u8(src); src += src_pixels_per_line;
    q4u8 = vld1q_u8(src); src += src_pixels_per_line;
    q5u8 = vld1q_u8(src); src += src_pixels_per_line;
    q6u8 = vld1q_u8(src); src += src_pixels_per_line;
...
void vp8_sixtap_predict8x4_neon(
    ...
    if (xoffset == 0) {  // secondpass_filter8x4_only
        ...
        // load src data
        src = src_ptr - src_pixels_per_line * 2;
        d22u8 = vld1_u8(src); src += src_pixels_per_line;
        d23u8 = vld1_u8(src); src += src_pixels_per_line;
        d24u8 = vld1_u8(src); src += src_pixels_per_line;
        d25u8 = vld1_u8(src); src += src_pixels_per_line;
        d26u8 = vld1_u8(src); src += src_pixels_per_line;
        d27u8 = vld1_u8(src); src += src_pixels_per_line;
        d28u8 = vld1_u8(src); src += src_pixels_per_line;
        d29u8 = vld1_u8(src); src += src_pixels_per_line;
        d30u8 = vld1_u8(src);
        ...
        vst1_u8(dst_ptr, d6u8); dst_ptr += dst_pitch;
        vst1_u8(dst_ptr, d7u8); dst_ptr += dst_pitch;
        vst1_u8(dst_ptr, d8u8); dst_ptr += dst_pitch;
    ...
    if (yoffset == 0) {  // firstpass_filter8x4_only
        vst1_u8(dst_ptr, d22u8); dst_ptr += dst_pitch;
        vst1_u8(dst_ptr, d23u8); dst_ptr += dst_pitch;
        vst1_u8(dst_ptr, d24u8); dst_ptr += dst_pitch;
        vst1_u8(dst_ptr, d25u8);
        return;
    }

    // First Pass on rest 5-line data
    src += src_pixels_per_line; q3u8 = vld1q_u8(src);
    src += src_pixels_per_line; q4u8 = vld1q_u8(src);
    src += src_pixels_per_line; q5u8 = vld1q_u8(src);
    src += src_pixels_per_line; q6u8 = vld1q_u8(src);
    src += src_pixels_per_line; q7u8 = vld1q_u8(src);
...
void vp8_sixtap_predict8x8_neon(
    ...
    if (xoffset == 0) {  // secondpass_filter8x8_only
        ...
        // load src data
        src = src_ptr - src_pixels_per_line * 2;
        d18u8 = vld1_u8(src); src += src_pixels_per_line;
        d19u8 = vld1_u8(src); src += src_pixels_per_line;
        d20u8 = vld1_u8(src); src += src_pixels_per_line;
        d21u8 = vld1_u8(src); src += src_pixels_per_line;
        d22u8 = vld1_u8(src); src += src_pixels_per_line;
        d23u8 = vld1_u8(src); src += src_pixels_per_line;
        d24u8 = vld1_u8(src); src += src_pixels_per_line;
        d25u8 = vld1_u8(src); src += src_pixels_per_line;
        ...
        d28u8 = vld1_u8(src); src += src_pixels_per_line;
        d29u8 = vld1_u8(src); src += src_pixels_per_line;
        d30u8 = vld1_u8(src); src += src_pixels_per_line;
        ...
        for (i = 2; i > 0; i--) {
            ...
            vst1_u8(dst_ptr, d7u8); dst_ptr += dst_pitch;
            vst1_u8(dst_ptr, d8u8); dst_ptr += dst_pitch;
            vst1_u8(dst_ptr, d9u8); dst_ptr += dst_pitch;
        }
        return;
    }
    ...
    for (i = 2; i > 0; i--) {
        ...
        if (yoffset == 0) {  // firstpass_filter8x4_only
            ...
            vst1_u8(dst_ptr, d23u8); dst_ptr += dst_pitch;
            vst1_u8(dst_ptr, d24u8); dst_ptr += dst_pitch;
            vst1_u8(dst_ptr, d25u8); dst_ptr += dst_pitch;
        } else {
            vst1_u8(tmpp, d22u8); tmpp += 8;
            vst1_u8(tmpp, d23u8); tmpp += 8;
            vst1_u8(tmpp, d24u8); tmpp += 8;
            vst1_u8(tmpp, d25u8); tmpp += 8;
        }
    }
    if (yoffset == 0)
        return;
    ...
    tmpp = tmp;
    q9u8 = vld1q_u8(tmpp); tmpp += 16;
    q10u8 = vld1q_u8(tmpp); tmpp += 16;
    q11u8 = vld1q_u8(tmpp); tmpp += 16;
    q12u8 = vld1q_u8(tmpp);
...
void vp8_sixtap_predict16x16_neon(
    ...
    if (xoffset == 0) {  // secondpass_filter8x8_only
        ...
        for (i = 0; i < 2; i++) {
            ...
            for (j = 0; j < 4; j++) {
                ...
                vst1_u8(dst, d6u8); dst += dst_pitch;
                vst1_u8(dst, d7u8); dst += dst_pitch;
                vst1_u8(dst, d8u8); dst += dst_pitch;
                vst1_u8(dst, d9u8); dst += dst_pitch;
            }
        }
        return;
    }
    ...
    if (yoffset == 0) {  // firstpass_filter4x4_only
        ...
        for (i = 0; i < 8; i++) {
            d6u8 = vld1_u8(src);
            d7u8 = vld1_u8(src + 8);
            d8u8 = vld1_u8(src + 16); src += src_pixels_per_line;
            d9u8 = vld1_u8(src);
            d10u8 = vld1_u8(src + 8);
            d11u8 = vld1_u8(src + 16); src += src_pixels_per_line;
            ...
            vst1q_u8(dst, q3u8); dst += dst_pitch;
            vst1q_u8(dst, q4u8); dst += dst_pitch;
        }
        return;
    }
    ...
    for (i = 0; i < 7; i++) {
        ...
        d12u8 = vld1_u8(src);
        d13u8 = vld1_u8(src + 8);
        d14u8 = vld1_u8(src + 16); src += src_pixels_per_line;
        ...
        vst1_u8(tmpp, d6u8);  tmpp += 8;
        vst1_u8(tmpp, d7u8);  tmpp += 8;
        vst1_u8(tmpp, d8u8);  tmpp += 8;
        vst1_u8(tmpp, d9u8);  tmpp += 8;
        vst1_u8(tmpp, d10u8); tmpp += 8;
        vst1_u8(tmpp, d11u8); tmpp += 8;
    }
    ...
    for (i = 0; i < 2; i++) {
        dst = dst_ptr + 8 * i;
        tmpp = tmp + 8 * i;
        d18u8 = vld1_u8(tmpp); tmpp += 16;
        d19u8 = vld1_u8(tmpp); tmpp += 16;
        d20u8 = vld1_u8(tmpp); tmpp += 16;
        d21u8 = vld1_u8(tmpp); tmpp += 16;
        d22u8 = vld1_u8(tmpp); tmpp += 16;
        for (j = 0; j < 4; j++) {
            d23u8 = vld1_u8(tmpp); tmpp += 16;
            d24u8 = vld1_u8(tmpp); tmpp += 16;
            d25u8 = vld1_u8(tmpp); tmpp += 16;
            d26u8 = vld1_u8(tmpp); tmpp += 16;
