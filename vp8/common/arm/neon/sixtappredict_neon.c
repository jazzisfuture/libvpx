...
static INLINE void yonly4x4(const unsigned char *src, int src_stride,
  ...
  // Use signed again because numbers like -200 need to saturated to 0, not 255.
...
void vp8_sixtap_predict4x4_neon(unsigned char *src_ptr, int src_pixels_per_line,
  ...
  e0123 = vqaddq_s16(vreinterpretq_s16_u16(d0123), vreinterpretq_s16_u16(d0123_a));
  e4567 = vqaddq_s16(vreinterpretq_s16_u16(d4567), vreinterpretq_s16_u16(d4567_a));
