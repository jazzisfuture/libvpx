...
;void vp8_intra4x4_predict(unsigned char *input, int input_stride, int b_mode,
...
|vp8_intra4x4_predict_armv6| PROC
    ...
    cmp         r2, #10
    addlt       pc, pc, r2, lsl #2       ; position independet switch
    b           end                      ; default
    b           b_dc_pred
    b           b_tm_pred
    b           b_ve_pred
...
b_ve_pred
    ...
    and         r9, r11, r9, asr #2
    and         r4, r11, r4, asr #2
    add         r3, r3, r2              ; output + output_stride
    add         r9, r9, r4, lsl #8
...
b_ld_pred
    ...
    add         r8, r4, r5, lsl #8      ; o[3|2|1|0]
    str         r8, [r3], r0

    mov         r9, r8, lsr #8
    add         r9, r9, r6, lsl #24     ; o[4|3|2|1]
    str         r9, [r3], r0

    mov         r10, r9, lsr #8
    add         r10, r10, r7, lsl #24   ; o[5|4|3|2]
    str         r10, [r3], r0

    mov         r6, r6, lsr #16
    mov         r11, r10, lsr #8
    add         r11, r11, r6, lsl #24   ; o[6|5|4|3]
    str         r11, [r3], r0

    pop        {r4-r12, pc}

b_rd_pred
    sub         r12, r0, r1             ; Above = input - input_stride
    ...
    add         r8, r6, r7, lsl #8      ; o[6|5|4|3]
    str         r8, [r3], r0

    mov         r9, r8, lsl #8          ; o[5|4|3|-]
    uxtab       r9, r9, r4, ror #16     ; o[5|4|3|2]
    str         r9, [r3], r0

    mov         r10, r9, lsl #8         ; o[4|3|2|-]
    uxtab       r10, r10, r5            ; o[4|3|2|1]
    str         r10, [r3], r0

    mov         r11, r10, lsl #8        ; o[3|2|1|-]
    uxtab       r11, r11, r4            ; o[3|2|1|0]
    str         r11, [r3], r0
