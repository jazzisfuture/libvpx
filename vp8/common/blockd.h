...
#define VP8_BINTRAMODES (LEFT4X4)

#if CONFIG_NEWBINTRAMODES
/* The number of B_PRED intra modes that are replaced by B_CONTEXT_PRED */
#define CONTEXT_PRED_REPLACEMENTS  0
#define VP8_KF_BINTRAMODES (VP8_BINTRAMODES - 1)
#define VP8_NKF_BINTRAMODES  (VP8_BINTRAMODES - CONTEXT_PRED_REPLACEMENTS)
#else
#define VP8_KF_BINTRAMODES (VP8_BINTRAMODES)   /* 10 */
#define VP8_NKF_BINTRAMODES (VP8_BINTRAMODES)  /* 10 */
#endif
