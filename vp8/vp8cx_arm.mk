...
VP8_CX_SRCS-$(HAVE_NEON)  += encoder/arm/neon/vp8_mse16x16_neon_intrinsics.c
VP8_CX_SRCS-$(HAVE_NEON)  += encoder/arm/neon/vp8_shortwalsh4x4_neon_intrinsics.c
VP8_CX_SRCS-$(HAVE_NEON)  += encoder/arm/neon/subtract_neon_intrinsics.c
