                                   ...
                                   const unsigned char *decrypt_key)
{
    ...
    else
    {
        ...
        uint8_t data0 = decrypt_byte(data[0], decrypt_key, 0);
        si->is_kf = 0;
        if (data_sz >= 10 && !(data0 & 0x01))  /* I-Frame */
        {
            uint8_t data3 = decrypt_byte(data[3], decrypt_key, 3);
            uint8_t data4 = decrypt_byte(data[4], decrypt_key, 4);
            uint8_t data5 = decrypt_byte(data[5], decrypt_key, 5);
            uint8_t data6 = decrypt_byte(data[6], decrypt_key, 6);
            uint8_t data7 = decrypt_byte(data[7], decrypt_key, 7);
            uint8_t data8 = decrypt_byte(data[8], decrypt_key, 8);
            uint8_t data9 = decrypt_byte(data[9], decrypt_key, 9);
