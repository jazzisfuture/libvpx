                                  ...
                                  long                    deadline)
{
    ...
    if (!res)
    {
        ...
        pbi->num_fragments = ctx->fragments.count;
        pbi->input_fragments = ctx->fragments.enabled;
        vpx_memcpy(pbi->fragments, ctx->fragments.ptrs,
                   sizeof(ctx->fragments.ptrs));
        vpx_memcpy(pbi->fragment_sizes, ctx->fragments.sizes,
