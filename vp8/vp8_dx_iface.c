...
#endif
    unsigned char           decrypt_key[VP8_KEY_SIZE];
    vpx_image_t             img;
    int                     img_setup;
...
static const unsigned char fake_decrypt_key[VP8_KEY_SIZE] = { 0 };
...
static void vp8_init_ctx(vpx_codec_ctx_t *ctx, const vpx_codec_mmap_t *mmap)
{
    ...
    memcpy(ctx->priv->alg_priv->decrypt_key, fake_decrypt_key, VP8_KEY_SIZE);
                                           ...
                                           va_list args)
{
    ...
    memcpy(ctx->decrypt_key, data, VP8_KEY_SIZE);
    return VPX_CODEC_OK;
}
