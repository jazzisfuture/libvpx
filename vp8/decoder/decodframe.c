...
static void yv12_extend_frame_top_c(YV12_BUFFER_CONFIG *ybf, int top)
{
    int i;
...
static void yv12_extend_frame_bottom_c(YV12_BUFFER_CONFIG *ybf, int top)
{
    int i;
...
static void decode_mb_rows(VP8D_COMP *pbi)
{
        ...
        if(pc->filter_level)
        {
            if(mb_row > 0)
            {
                ...
                if(mb_row > 1)
                {
                    ...
                    if(mb_row == 2)
                        yv12_extend_frame_top_c(&pc->yv12_fb[dst_fb_idx], 0);
    ...
    yv12_extend_frame_bottom_c(&pc->yv12_fb[dst_fb_idx], 0);
}
