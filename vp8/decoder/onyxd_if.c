...
vpx_codec_err_t vp9_get_reference_dec(VP8D_PTR ptr, VP9_REFFRAME ref_frame_flag,
...
vpx_codec_err_t vp9_set_reference_dec(VP8D_PTR ptr, VP9_REFFRAME ref_frame_flag,
                                      YV12_BUFFER_CONFIG *sd) {
  VP9D_COMP *pbi = (VP9D_COMP *) ptr;
  VP9_COMMON *cm = &pbi->common;
  int *ref_fb_ptr = NULL;
