...
VP8_COMMON_SRCS-$(HAVE_NEON)  += common/arm/neon/idct_dequant_full_2x_neon_intrinsics.c
VP8_COMMON_SRCS-$(HAVE_NEON)  += common/arm/neon/iwalsh_neon_intrinsics.c
VP8_COMMON_SRCS-$(HAVE_NEON)  += common/arm/neon/loopfilter_neon_intrinsics.c
VP8_COMMON_SRCS-$(HAVE_NEON)  += common/arm/neon/loopfiltersimplehorizontaledge_neon_intrinsics.c
VP8_COMMON_SRCS-$(HAVE_NEON)  += common/arm/neon/loopfiltersimpleverticaledge_neon_intrinsics.c
VP8_COMMON_SRCS-$(HAVE_NEON)  += common/arm/neon/mbloopfilter_neon_intrinsics.c
VP8_COMMON_SRCS-$(HAVE_NEON)  += common/arm/neon/sad_neon_intrinsics.c
VP8_COMMON_SRCS-$(HAVE_NEON)  += common/arm/neon/shortidct4x4llm_neon_intrinsics.c
VP8_COMMON_SRCS-$(HAVE_NEON)  += common/arm/neon/sixtappredict_neon_intrinsics.c
VP8_COMMON_SRCS-$(HAVE_NEON)  += common/arm/neon/idct_dequant_0_2x_neon_intrinsics.c
VP8_COMMON_SRCS-$(HAVE_NEON)  += common/arm/neon/variance_neon_intrinsics.c
VP8_COMMON_SRCS-$(HAVE_NEON)  += common/arm/neon/vp8_subpixelvariance_neon_intrinsics.c
VP8_COMMON_SRCS-$(HAVE_NEON)  += common/arm/neon/buildintrapredictorsmby_neon_intrinsics.c
VP8_COMMON_SRCS-$(HAVE_NEON)  += common/arm/neon/save_reg_neon_intrinsics.c
