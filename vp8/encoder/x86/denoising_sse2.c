                             ...
                             int y_offset, int uv_offset)
{
    ...
    for (r = 0; r < 16; ++r)
    {
        ...
        __m128i absdiff, clamped_absdiff;
        __m128i adj, adj0, adj1, adj2, padj, nadj, mask0, mask1, mask2;

        /* Calculate half absolute diff. */
        absdiff = _mm_or_si128(pdiff, ndiff);
        /* Clamp absdiff to 16 to be used to get mask. */
        clamped_absdiff = _mm_min_epu8(absdiff, k_16);

        /* Get masks for l2 l1 and l0 adjustments */
        mask2 = _mm_cmpgt_epi8(k_16, clamped_absdiff);
        mask1 = _mm_cmpgt_epi8(k_8, clamped_absdiff);
        mask0 = _mm_cmpgt_epi8(k_4, clamped_absdiff);

        /* Get adjustments for l2, l1, and l0 */
        adj2 = _mm_and_si128(mask2, l32);
        adj1 = _mm_and_si128(mask1, l21);
        adj0 = _mm_and_si128(mask0, absdiff);

        /* Combine the adjustments. */
        adj = _mm_sub_epi8(l3, adj2);
        adj = _mm_sub_epi8(adj, adj1);
