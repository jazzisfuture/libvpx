...
static inline unsigned int abs_sum_diff_16x1(__m128i acc_diff) {
  ...
  return (unsigned int)abs(sum_diff);
}
                             ...
                             int increase_denoising)
{
    ...
    for (r = 0; r < 4; ++r) {
        ...
        const __m128i v_sig_low = _mm_castpd_si128(
            _mm_loadl_pd(_mm_castsi128_pd(v_sig_low), (double *)(&sig[0])));
        ...
        const __m128i v_mc_running_avg_low = _mm_castpd_si128(
            _mm_loadl_pd(_mm_castsi128_pd(v_mc_running_avg_low),
                         (double *)(&mc_running_avg[0])));
          ...
          if (delta < 4) {
            ...
            for (r = 0; r < 4; ++r) {
              ...
              const __m128i v_running_avg_low = _mm_castpd_si128(
                  _mm_loadl_pd(_mm_castsi128_pd(v_running_avg_low),
