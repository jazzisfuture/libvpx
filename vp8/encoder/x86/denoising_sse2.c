                             ...
                             int y_offset, int uv_offset)
{
    ...
    l32 = _mm_sub_epi8 (l3, l2);
    l21 = _mm_sub_epi8 (l2, l1);
    ...
    for (r = 0; r < 16; ++r)
    {
        ...
        __m128i adj, adj0, padj, nadj, mask0;
        ...
        /* l2 adjustments */
        adj0 = _mm_cmpgt_epi8 (k_8, abshdiff);
        adj0 = _mm_and_si128 (adj0, l32);
        adj = _mm_sub_epi8 (l3, adj0);

        /* l1 adjustments */
        adj0 = _mm_cmpgt_epi8 (k_4, abshdiff);
        adj0 = _mm_and_si128 (adj0, l21);
        adj = _mm_sub_epi8 (adj, adj0);

        /* l0 adjustments */
        mask0 = _mm_cmpgt_epi8 (k_2, abshdiff);
        adj0 = _mm_and_si128 (mask0, l1);
        adj = _mm_sub_epi8 (adj, adj0);
