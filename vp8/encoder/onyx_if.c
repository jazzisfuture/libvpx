...
#ifdef ENTROPY_STATS
extern int intra_mode_stats[VP8_KF_BINTRAMODES][VP8_KF_BINTRAMODES][VP8_KF_BINTRAMODES];
#endif
...
//                        cpi->total_ssimg_v / cpi->count, cpi->total_ssimg_all / cpi->count, total_encode_time, cpi->tot_recode_hits);
...
#ifdef MODE_STATS
    {
      ...
      }
      {
        ...
        fprintf(f, "B: ");
        for (i = 0; i < VP8_NKF_BINTRAMODES; i++)
...
#ifdef ENTROPY_STATS
    {
      ...
      fprintf(fmode, "[VP8_KF_BINTRAMODES] [VP8_KF_BINTRAMODES] [VP8_KF_BINTRAMODES] =\n{\n");
      ...
      for (i = 0; i < VP8_KF_BINTRAMODES; i++) {
        ...
        for (j = 0; j < VP8_KF_BINTRAMODES; j++) {
          ...
          for (k = 0; k < VP8_KF_BINTRAMODES; k++) {
