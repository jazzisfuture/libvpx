...
int vp8_drop_encodedframe_overshoot(VP8_COMP *cpi, int Q) {
  if (cpi->pass == 0 &&
    ...
    if (Q < thresh_qp &&
      ...
      // frame because the QP/rate_correction_factor may have been to low
      ...
      // Rate correction factor based on target size/mb and max_QP.
      ...
      if (new_correction_factor > cpi->rate_correction_factor)
        cpi->rate_correction_factor = VPXMIN(2.0 * cpi->rate_correction_factor, new_correction_factor);
