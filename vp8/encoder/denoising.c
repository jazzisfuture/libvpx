                             ...
                             int recon_uvoffset)
{
    ...
    MV_REFERENCE_FRAME frame = x->e_mbd.best_reference_frame;
    MV_REFERENCE_FRAME zero_frame = x->e_mbd.best_zeromv_reference_frame;
    ...
    if(zero_frame)
    {
        ...
        mbmi->ref_frame = x->e_mbd.best_reference_frame;
        mbmi->mode = filter_xd.best_sse_inter_mode;
        mbmi->mv = filter_xd.best_sse_mv;
             ...
             sse_diff < SSE_DIFF_THRESHOLD))
        {
            ...
            mbmi->ref_frame =
                    x->e_mbd.best_zeromv_reference_frame;
