...
void reuse_coef_probs(VP8_COMP *cpi)
{
    ...
    {
        vpx_memcpy(&((REUSE_PROB *)cpi->oxcf.reuse_prob)->reuse_fc_coef_probs,&cpi->common.fc.coef_probs,sizeof(cpi->common.fc.coef_probs));
    }
    else
    {
        vpx_memcpy(&cpi->common.fc.coef_probs,&((REUSE_PROB *)cpi->oxcf.reuse_prob)->reuse_fc_coef_probs,sizeof(cpi->common.fc.coef_probs));
    }
