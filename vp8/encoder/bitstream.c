...
#if CONFIG_NEWMVENTROPY
                if (!cpi->dummy_packing)
                  fprintf (debug_fp, "NEWMV(%d,%d)(%d,%d)\n",
                           mi->mv[0].as_mv.row, mi->mv[0].as_mv.col,
                           best_mv.as_mv.row, best_mv.as_mv.col);
...
#if CONFIG_NEWMVENTROPY
//                  if (!cpi->dummy_packing)
//                    fprintf (debug_fp, "NEWMV2nd(%d,%d)(%d,%d)\n",
//                             mi->mv[1].as_mv.row, mi->mv[1].as_mv.col,
//                             best_second_mv.as_mv.row, best_second_mv.as_mv.col);
