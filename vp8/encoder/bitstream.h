...
void vp8cx_pack_tokens_into_partitions_armv5(VP8_COMP *, unsigned char *,
                                             int , unsigned char *,
                                             vp8_token *,
                                             vp8_extra_bit_struct *,
                                             const vp8_tree_index *);
...
# define pack_tokens_into_partitions(a,b,c,d)  \
    vp8cx_pack_tokens_into_partitions_armv5(a,b,d,c,vp8_coef_encodings,vp8_extra_bits,vp8_coef_tree)
