                         ...
                         int *returndistortion, int *returnintra)
{
    ...
    *returnintra = INT_MAX;
    ...
    if(cpi->oxcf.reuse_info!=NULL)
        cpi->oxcf.reuse_info[curr_index].frame_best_ref_mv[xd->mode_info_context->mbmi.ref_frame].as_mv = frame_best_ref_mv[xd->mode_info_context->mbmi.ref_frame].as_mv;
#endif
}
