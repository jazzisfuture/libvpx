                         ...
                         int *returndistortion, int *returnintra, int mb_row, int mb_col)
{
    ...
    // TODO: Now only consider down_sampling_factor = 2, add other case later.
    //if(cpi->oxcf.mr_down_sampling_factor == 2)
    {
        parent_mb_index = (mb_row>>1)*(cpi->common.mb_cols>>1) + (mb_col>>1);
    }
    /* else
    {
        // Find the index from a look-up table.
    }  */
    ...
    {
      //TODO: If down_sampling_factor!=2, need to change.
