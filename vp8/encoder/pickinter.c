    ...
    for (mode_index = 0; mode_index < MAX_MODES; mode_index++)
    {
        ...
        case NEWMV:
        {
            ...
            if (cpi->sf.search_method == HEX)
            {
                ...
                /* In higher-res pick_inter_mode, step_param is used to modify hex search range.
                         ...
                         int *returndistortion, int *returnintra, int mb_row, int mb_col)
{
    ...
    // Now only consider down_sampling_factor = 2, add other case later.
    ...
    {
      // If down_sampling_factor!=2, need to change.
