...
#if CONFIG_HYBRIDTRANSFORM
void vp8_fht4x4_c(short *input, short *output, int pitch, B_PREDICTION_MODE mode)
{
  int i, j, k ;
...
{
  vp8_fht4x4_c(input,     output,      pitch, mode) ;
  vp8_fht4x4_c(input + 4, output + 16, pitch, mode) ;
}
#endif
