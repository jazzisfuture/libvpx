...
#define VPX_CODEC_USE_XMA 0x00000001  /**< Use eXternal Memory Allocation */
 ...
 * returned by vpx_codec_version_str() following the three digit version number.
 *
 */
