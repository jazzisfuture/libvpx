...
typedef struct {
  ...
  char options[OPTION_BUF_SZ];        // set by vpx_svc_set_options
  char quantizers[OPTION_BUF_SZ];     // set by vpx_svc_set_quantizers
  char scale_factors[OPTION_BUF_SZ];  // set by vxp_svc_set_scale_factors
 ...
 *         quantizers=<q1>,<q2>,...
 */
void vpx_svc_set_options(SvcContext *svc_ctx, const char *options);
 ...
 * e.g., "60,53,39,33,27"
 */
void vpx_svc_set_quantizers(SvcContext *svc_ctx, const char *quantizer_values);
 ...
 */
void vpx_svc_set_scale_factors(SvcContext *svc_ctx, const char *scale_factors);
