...
#define VPX_CODEC_USE_OUTPUT_PARTITION                                      \
  0x20000                                  /**< Make the encoder output one \
partition at a time. */
...
#define VPX_FRAME_IS_DROPPABLE                    \
  0x2 /**< frame can be dropped without affecting \
the stream (no future frame depends on            \
this one) */
#define VPX_FRAME_IS_INVISIBLE                  \
  0x4 /**< frame should be decoded but will not \
be shown */
#define VPX_FRAME_IS_FRAGMENT                \
  0x8 /**< this is a fragment of the encoded \
frame */
...
#define VPX_ERROR_RESILIENT_DEFAULT   \
  0x1 /**< Improve resiliency against \
...
#define VPX_DL_REALTIME                    \
  (1) /**< deadline parameter analogous to \
*   VPx REALTIME mode. */
#define VPX_DL_GOOD_QUALITY                      \
  (1000000) /**< deadline parameter analogous to \
*   VPx GOOD QUALITY mode. */
#define VPX_DL_BEST_QUALITY                \
  (0) /**< deadline parameter analogous to \
