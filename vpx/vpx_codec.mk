...
API_DOC_SRCS-$(CONFIG_DECODERS) += vpx_decoder.h
API_DOC_SRCS-$(CONFIG_ENCODERS) += vpx_encoder.h
API_DOC_SRCS-$(CONFIG_ENCODERS) += vpx_ext_ratectrl.h
API_DOC_SRCS-$(CONFIG_DECODERS) += vpx_frame_buffer.h
...
API_SRCS-$(CONFIG_ENCODERS) += internal/vpx_ratectrl_rtc.h
API_SRCS-yes += src/vpx_codec.c
API_SRCS-yes += src/vpx_image.c
API_SRCS-yes += vpx_codec.h
API_SRCS-yes += vpx_codec.mk
API_SRCS-$(CONFIG_DECODERS) += vpx_frame_buffer.h
API_SRCS-yes += vpx_image.h
API_SRCS-yes += vpx_integer.h
API_SRCS-$(CONFIG_ENCODERS) += vpx_ext_ratectrl.h
API_SRCS-$(CONFIG_ENCODERS) += vpx_tpl.h
