 ...
 *
 * The encoder will the model handler using create_model() defined in
 * vpx_rc_funcs_t.
 */
...
/*!\brief Encode frame's information
 *
...
typedef struct vpx_rc_encodeframe_info {
  int frame_type;   /**< 0:key 1: inter 2: alternate reference 3: overlay 4:
                       golden*/
  ...
  int ref_frame_valid_list[3]; /**< three reference frames' validities 0:invalid
                                  1:valid*/
