...
typedef struct vpx_rc_gop_info {
  ...
  int allow_alt_ref;        /**< whether allow the use of alt ref */
  int is_key_frame;         /**< is the current frame key frame */
  int last_gop_use_alt_ref; /**< last gop uses alt ref or not */
  ...
  int lag_in_frames;        /**< num of lookahead source frames */
 ...
 */
typedef vpx_rc_status_t (*vpx_rc_get_gop_decision_fn_t)(
...
typedef struct vpx_rc_funcs {
   ...
   */
  vpx_rc_get_gop_decision_fn_t get_gop_decision;
  /*!
