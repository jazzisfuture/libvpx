...
static int DEFAULT_QUANTIZER_VALUES[] = {60, 53, 39, 33, 27};
static int DEFAULT_SCALE_FACTORS_NUM[] = {4, 5, 7, 11, 16};
static int DEFAULT_SCALE_FACTORS_DEN[] = {16, 16, 16, 16, 16};
...
int option_max_values[ALL_OPTION_TYPES] = {63, INT_MAX, INT_MAX, 1};
int option_min_values[ALL_OPTION_TYPES] = {0, 0, 1, 0};
