...
static vpx_codec_err_t parse_quantizer_values(SvcContext *svc_ctx,
  ...
  if (res == VPX_CODEC_OK && found != si->layers) {
    svc_log(svc_ctx, SVC_LOG_ERROR,
...
static void log_invalid_scale_factor(SvcContext *svc_ctx,
                                                char *value) {
...
vpx_codec_err_t vpx_svc_init(SvcContext *svc_ctx, vpx_codec_ctx_t *codec_ctx,
  ...
  res = parse_quantizer_values(svc_ctx, svc_ctx->quantizer_values);
