 ...
 *
 * Registers functions to be called when libvpx needs an external frame buffer
 * to decode the current frame and a function to be called when libvpx does
 * not internally reference the external frame buffer. This set function must
 ...
 * buffers.
 */
typedef vpx_codec_err_t (*vpx_codec_set_ext_fb_fn_t)(
...
struct vpx_codec_iface {
  ...
  struct vpx_codec_dec_iface {
    ...
    vpx_codec_set_ext_fb_fn_t set_ext_fb_fn; /**< \copydoc ::vpx_codec_set_ext_fb_fn_t */
  } dec;
