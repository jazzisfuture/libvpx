...
enum vp8e_enc_control_id {
   ...
   * spatial layer. Enabling it for layer k means spatial layer k has no temporal
   * prediction. Setting for base spatial layer has no effect.
   * Default is off (0) for all spatial layers.
   *
   * Supported in codecs: VP9
   */
...
VPX_CTRL_USE_TYPE(VP9E_SET_SVC_SPATIAL_LAYER_SYNC, vpx_svc_spatial_layer_sync_t *)
