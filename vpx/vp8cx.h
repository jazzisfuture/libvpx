...
typedef struct vpx_roi_map {
  ...
  int     delta_q[8];          /**< quantizer delta [-63, 63] off baseline for regions with id between 0 and 3*/
  int     delta_lf[8];         /**< loop filter strength delta [-63, 63] for regions with id between 0 and 3 */
  unsigned int   static_threshold[8];/**< threshold for region to be treated as static */
} vpx_roi_map_t;
