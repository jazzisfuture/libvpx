...
enum vp8e_enc_control_id {
  ...
  /*!\brief Codec control function set overshoot percentage for dropping frame.
    *
    * Supported in codecs: VP8
    */
  VP8E_SET_DROP_OVERSHOOT_PCT,
...
VPX_CTRL_USE_TYPE(VP8E_SET_DROP_OVERSHOOT_PCT, unsigned int)
