...
enum vp8e_enc_control_id {
   ...
   *
   * Allocation and free of memory of size MAX_ARF_GOP_SIZE *
   * sizeof(TplFrameStats *) should be provided by applications.
   * VPX_CODEC_MEM_ERROR will be returned if there's not enough memory.
   *
   * Supported in codecs: VP9
   *
   */
