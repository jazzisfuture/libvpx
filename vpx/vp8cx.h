...
typedef struct vpx_svc_ref_frame_config {
  ...
  int reference_last[VPX_SS_MAX_LAYERS];    /**< Last as reference. Use first
                                              referenced index if FALSE. */
  int reference_golden[VPX_SS_MAX_LAYERS];  /**< Golden as reference. Use first
                                              referenced index if FALSE. */
  int reference_alt_ref[VPX_SS_MAX_LAYERS]; /**< Altref as reference. Use first
                                              referenced index if FALSE. */
