 ...
 *
 * TODO(jianj): Add support for SEG_LVL_REF_FRAME for VP9.
 */
...
typedef struct vpx_roi_map {
  ...
  /*! TODO(jianj): SEG_LVL_REF_FRAME does not do anything in real-time
   * (nonrd-pickmode). Allow this to work for real-time. */
  int ref_frame[8]; /**< Referebce frame for this block. */
