...
enum vp8e_enc_control_id {
   ...
   *
   * This will turn off cyclic refresh. Only applicable to RTC 1-pass.
   *
   * Supported in codecs: VP9
   *
   */
  VP9E_SET_QUANTIZER_ONE_PASS_RTC,
};
...
VPX_CTRL_USE_TYPE(VP9E_SET_QUANTIZER_ONE_PASS_RTC, int)
#define VPX_CTRL_VP9E_SET_QUANTIZER_ONE_PASS_RTC
