...
enum vp8e_enc_control_id {
   ...
   * earlier ones, this allows encoder to output data packets for a tile row
   * prior to completely processing all tire rows in an frame, therefore
   * reduce the latency in pocessing between input and output. The parameter
