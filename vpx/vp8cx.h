...
enum vp8e_enc_control_id {
  ...
  /*!\brief Codec control function to set frame flags for the spatial layers.
   *
 ...
 *
 * This defines the frame flags and buffer indexes for each spatial layer for
 * svc encoding.
 * This is used with the #VP9E_SET_SVC_FRAME_FLAGS control to set the frame
 * flags and buffer indexes for each spatial layer for the current (super)frame.
 *
 */
