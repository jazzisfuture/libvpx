...
MAKE_D_4_INCDIR: 
	$(call job,../../../lib/common/rpcmem,make V=hexagonv5_Debug,making ../../../lib/common/rpcmem)

MAKE_D_4_INCDIR_clean: 
	$(call job,../../../lib/common/rpcmem,make V=hexagonv5_Debug clean,cleaning ../../../lib/common/rpcmem)

MAKE_D_3_LIBDIR: 
	$(call job,../../../lib/fastcv/dspCV,make V=hexagonv5_Debug,making ../../../lib/fastcv/dspCV)

MAKE_D_3_LIBDIR_clean: 
	$(call job,../../../lib/fastcv/dspCV,make V=hexagonv5_Debug clean,cleaning ../../../lib/fastcv/dspCV)

MAKE_D_4_LIBDIR: 
	$(call job,../../../test/common/test_util,make V=hexagonv5_Debug,making ../../../test/common/test_util)

MAKE_D_4_LIBDIR_clean: 
	$(call job,../../../test/common/test_util,make V=hexagonv5_Debug clean,cleaning ../../../test/common/test_util)
