...
struct RateControlMetrics {
  ...
  // Total (cumulative) number of encoded frames.
...
int main(int argc, char **argv) {
  ...
  // Threshold for frame dropper.
  frame_drop_threshold = strtol(argv[8], NULL, 0);
  ...
  cfg.rc_dropframe_thresh = frame_drop_threshold;
