...
static void printout_rate_control_summary(struct RateControlMetrics *rc,
  ...
  printf("Average, rms-variance, and percent-fluct of short-time encoding "
      "bitrate %d %f %f %f \n", rc->window_size, rc->avg_st_encoding_bitrate,
      sqrt(rc->variance_st_encoding_bitrate), perc_fluctuation);
