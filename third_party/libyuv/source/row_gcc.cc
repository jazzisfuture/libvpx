...
static const lvec8 kShufARGBToUV_AVX = { 0, 1, 8,  9,  2, 3, 10, 11,
                                         ...
                                         0, 1, 8,  9,  2, 3, 10, 11,
                                         4, 5, 12, 13, 6, 7, 14, 15 };
void ARGBToUVRow_AVX2(const uint8 *src_argb0, int src_stride_argb, uint8 *dst_u,
...
void OMITFP I422AlphaToARGBRow_SSSE3(const uint8 *y_buf, const uint8 *u_buf,
  ...
  asm volatile(
      YUVTORGB_SETUP(
          yuvconstants) "sub       %[u_buf],%[v_buf]               "
                        "\n" LABELALIGN
                        "1:                                          "
                        "\n" READYUVA422 YUVTORGB(yuvconstants) STOREARGB
      "subl      $0x8,%[width]                   \n"
      "jg        1b                              \n"
      : [y_buf] "+r"(y_buf),        // %[y_buf]
        [u_buf] "+r"(u_buf),        // %[u_buf]
...
#endif
      : [yuvconstants] "r"(yuvconstants)  // %[yuvconstants]
      : "memory", "cc", NACL_R14 YUVTORGB_REGS "xmm0", "xmm1", "xmm2", "xmm3",
        "xmm4", "xmm5");
}
  ...
  asm volatile(
      YUVTORGB_SETUP(
          yuvconstants) "pcmpeqb   %%xmm5,%%xmm5                   "
                        "\n" LABELALIGN
                        "1:                                          "
                        "\n" READNV12 YUVTORGB(yuvconstants) STOREARGB
      "sub       $0x8,%[width]                   \n"
      "jg        1b                              \n"
      : [y_buf] "+r"(y_buf),              // %[y_buf]
...
void OMITFP NV21ToARGBRow_SSSE3(const uint8 *y_buf, const uint8 *vu_buf,
                                uint8 *dst_argb,
                                const struct YuvConstants *yuvconstants,
                                int width) {
  asm volatile(
      YUVTORGB_SETUP(
          yuvconstants) "pcmpeqb   %%xmm5,%%xmm5                   "
                        "\n" LABELALIGN
                        "1:                                          "
                        "\n" READNV21 YUVTORGB(yuvconstants) STOREARGB
      "sub       $0x8,%[width]                   \n"
      "jg        1b                              \n"
      : [y_buf] "+r"(y_buf),               // %[y_buf]
...
void OMITFP YUY2ToARGBRow_SSSE3(const uint8 *yuy2_buf, uint8 *dst_argb,
                                const struct YuvConstants *yuvconstants,
                                int width) {
  asm volatile(
      YUVTORGB_SETUP(
...
void OMITFP UYVYToARGBRow_SSSE3(const uint8 *uyvy_buf, uint8 *dst_argb,
                                const struct YuvConstants *yuvconstants,
                                int width) {
  asm volatile(
      YUVTORGB_SETUP(
...
void OMITFP I444ToARGBRow_AVX2(const uint8 *y_buf, const uint8 *u_buf,
                               const uint8 *v_buf, uint8 *dst_argb,
                               const struct YuvConstants *yuvconstants,
                               int width) {
  asm volatile (
...
void OMITFP I411ToARGBRow_AVX2(const uint8 *y_buf, const uint8 *u_buf,
                               const uint8 *v_buf, uint8 *dst_argb,
                               const struct YuvConstants *yuvconstants,
                               int width) {
  asm volatile (
...
void OMITFP I422ToARGBRow_AVX2(const uint8 *y_buf, const uint8 *u_buf,
                               const uint8 *v_buf, uint8 *dst_argb,
                               const struct YuvConstants *yuvconstants,
                               int width) {
  asm volatile (
...
void OMITFP I422AlphaToARGBRow_AVX2(const uint8 *y_buf, const uint8 *u_buf,
                                    const uint8 *v_buf, const uint8 *a_buf,
                                    uint8 *dst_argb,
                                    const struct YuvConstants *yuvconstants,
                                    int width) {
  asm volatile(
      YUVTORGB_SETUP_AVX2(
          yuvconstants) "sub       %[u_buf],%[v_buf]               "
                        "\n" LABELALIGN
                        "1:                                          "
                        "\n" READYUVA422_AVX2 YUVTORGB_AVX2(yuvconstants)
                            STOREARGB_AVX2
      "subl      $0x10,%[width]                  \n"
      "jg        1b                              \n"
      "vzeroupper                                \n"
...
#endif
      : [yuvconstants] "r"(yuvconstants)  // %[yuvconstants]
      : "memory", "cc", NACL_R14 YUVTORGB_REGS_AVX2 "xmm0", "xmm1", "xmm2",
        "xmm3", "xmm4", "xmm5");
}
...
void OMITFP I422ToRGBARow_AVX2(const uint8 *y_buf, const uint8 *u_buf,
                               const uint8 *v_buf, uint8 *dst_argb,
                               const struct YuvConstants *yuvconstants,
                               int width) {
  asm volatile (
...
// 16 pixels.
// 8 UV values upsampled to 16 UV, mixed with 16 Y producing 16 ARGB (64 bytes).
void OMITFP NV12ToARGBRow_AVX2(const uint8 *y_buf, const uint8 *uv_buf,
                               uint8 *dst_argb,
                               const struct YuvConstants *yuvconstants,
                               int width) {
  asm volatile(
      YUVTORGB_SETUP_AVX2(
          yuvconstants) "vpcmpeqb   %%ymm5,%%ymm5,%%ymm5           "
                        "\n" LABELALIGN
                        "1:                                          "
                        "\n" READNV12_AVX2 YUVTORGB_AVX2(yuvconstants)
                            STOREARGB_AVX2
      "sub       $0x10,%[width]                  \n"
      "jg        1b                              \n"
      "vzeroupper                                \n"
...
void OMITFP NV21ToARGBRow_AVX2(const uint8 *y_buf, const uint8 *vu_buf,
                               uint8 *dst_argb,
                               const struct YuvConstants *yuvconstants,
                               int width) {
  asm volatile(
      YUVTORGB_SETUP_AVX2(
          yuvconstants) "vpcmpeqb   %%ymm5,%%ymm5,%%ymm5           "
                        "\n" LABELALIGN
                        "1:                                          "
                        "\n" READNV21_AVX2 YUVTORGB_AVX2(yuvconstants)
                            STOREARGB_AVX2
      "sub       $0x10,%[width]                  \n"
      "jg        1b                              \n"
      "vzeroupper                                \n"
...
void OMITFP YUY2ToARGBRow_AVX2(const uint8 *yuy2_buf, uint8 *dst_argb,
                               const struct YuvConstants *yuvconstants,
                               int width) {
  asm volatile(
      YUVTORGB_SETUP_AVX2(
...
void OMITFP UYVYToARGBRow_AVX2(const uint8 *uyvy_buf, uint8 *dst_argb,
                               const struct YuvConstants *yuvconstants,
                               int width) {
  asm volatile(
      YUVTORGB_SETUP_AVX2(
