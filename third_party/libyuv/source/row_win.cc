...
void I422ToARGBRow_SSSE3(const uint8 *y_buf, const uint8 *u_buf,
...
static const lvec8 kShufARGBToUV_AVX = { 0, 1, 8,  9,  2, 3, 10, 11,
                                         4, 5, 12, 13, 6, 7, 14, 15,
                                         0, 1, 8,  9,  2, 3, 10, 11,
                                         4, 5, 12, 13, 6, 7, 14, 15 };
...
static const uvec8 kShuffleMaskRAWToRGB24_0 = {
  2u, 1u, 0u, 5u, 4u, 3u, 8u, 7u, 128u, 128u, 128u, 128u, 128u, 128u, 128u, 128u
};

// Shuffle table for converting RAW to RGB24.  Middle 8.
static const uvec8 kShuffleMaskRAWToRGB24_1 = { 2u,   7u,   6u,   5u,
                                                10u,  9u,   8u,   13u,
                                                128u, 128u, 128u, 128u,
                                                128u, 128u, 128u, 128u };

// Shuffle table for converting RAW to RGB24.  Last 8.
static const uvec8 kShuffleMaskRAWToRGB24_2 = { 8u,   7u,   12u,  11u,
                                                10u,  15u,  14u,  13u,
                                                128u, 128u, 128u, 128u,
                                                128u, 128u, 128u, 128u };
...
__declspec(naked) void J400ToARGBRow_SSE2(const uint8 *src_y, uint8 *dst_argb,
                                          int width) {
  __asm {
    mov        eax, [esp + 4]  // src_y
...
// Duplicates gray value 3 times and fills in alpha opaque.
__declspec(naked) void J400ToARGBRow_AVX2(const uint8 *src_y, uint8 *dst_argb,
                                          int width) {
  __asm {
    mov         eax, [esp + 4]  // src_y
    mov         edx, [esp + 8]  // dst_argb
...
__declspec(naked) void RAWToARGBRow_SSSE3(const uint8 *src_raw, uint8 *dst_argb,
                                          int width) {
  __asm {
...
__declspec(naked) void ARGBToRAWRow_SSSE3(const uint8 *src_argb, uint8 *dst_rgb,
                                          int width) {
  __asm {
    mov       eax, [esp + 4]  // src_argb
    mov       edx, [esp + 8]  // dst_rgb
...
__declspec(naked) void ARGBToYRow_SSSE3(const uint8 *src_argb, uint8 *dst_y,
                                        int width) {
  __asm {
    mov        eax, [esp + 4] /* src_argb */
    mov        edx, [esp + 8] /* dst_y */
...
__declspec(naked) void ARGBToYJRow_SSSE3(const uint8 *src_argb, uint8 *dst_y,
                                         int width) {
  __asm {
    mov        eax, [esp + 4] /* src_argb */
    mov        edx, [esp + 8] /* dst_y */
...
__declspec(naked) void ARGBToYRow_AVX2(const uint8 *src_argb, uint8 *dst_y,
                                       int width) {
  __asm {
    mov        eax, [esp + 4] /* src_argb */
    mov        edx, [esp + 8] /* dst_y */
...
// Convert 32 ARGB pixels (128 bytes) to 32 Y values.
__declspec(naked) void ARGBToYJRow_AVX2(const uint8 *src_argb, uint8 *dst_y,
                                        int width) {
  __asm {
    mov        eax, [esp + 4] /* src_argb */
    mov        edx, [esp + 8] /* dst_y */
...
__declspec(naked) void BGRAToYRow_SSSE3(const uint8 *src_argb, uint8 *dst_y,
                                        int width) {
  __asm {
    mov        eax, [esp + 4] /* src_argb */
    mov        edx, [esp + 8] /* dst_y */
...
__declspec(naked) void ABGRToYRow_SSSE3(const uint8 *src_argb, uint8 *dst_y,
                                        int width) {
  __asm {
    mov        eax, [esp + 4] /* src_argb */
    mov        edx, [esp + 8] /* dst_y */
...
__declspec(naked) void RGBAToYRow_SSSE3(const uint8 *src_argb, uint8 *dst_y,
                                        int width) {
  __asm {
    mov        eax, [esp + 4] /* src_argb */
    mov        edx, [esp + 8] /* dst_y */
...
__declspec(naked) void ARGBToUVRow_SSSE3(const uint8 *src_argb0,
                                         int src_stride_argb, uint8 *dst_u,
...
__declspec(naked) void I422AlphaToARGBRow_AVX2(
    ...
    const uint8 *a_buf, uint8 *dst_argb,
    const struct YuvConstants *yuvconstants, int width) {
  __asm {
    push       esi
    push       edi
...
__declspec(naked) void I411ToARGBRow_AVX2(
    const uint8 *y_buf, const uint8 *u_buf, const uint8 *v_buf, uint8 *dst_argb,
    const struct YuvConstants *yuvconstants, int width) {
  __asm {
    push       esi
...
__declspec(naked) void NV12ToARGBRow_AVX2(
    const uint8 *y_buf, const uint8 *uv_buf, uint8 *dst_argb,
    const struct YuvConstants *yuvconstants, int width) {
  __asm {
    push       esi
    push       ebx
...
__declspec(naked) void NV21ToARGBRow_AVX2(
    const uint8 *y_buf, const uint8 *vu_buf, uint8 *dst_argb,
    const struct YuvConstants *yuvconstants, int width) {
  __asm {
    push       esi
    push       ebx
...
__declspec(naked) void YUY2ToARGBRow_AVX2(
    const uint8 *src_yuy2, uint8 *dst_argb,
    const struct YuvConstants *yuvconstants, int width) {
  __asm {
    push       ebx
...
__declspec(naked) void UYVYToARGBRow_AVX2(
    const uint8 *src_uyvy, uint8 *dst_argb,
    const struct YuvConstants *yuvconstants, int width) {
  __asm {
    push       ebx
...
__declspec(naked) void I422ToRGB24Row_SSSE3(
    const uint8 *y_buf, const uint8 *u_buf, const uint8 *v_buf,
    uint8 *dst_rgb24, const struct YuvConstants *yuvconstants, int width) {
  __asm {
    push       esi
    push       edi
    push       ebx
...
__declspec(naked) void I422ToRGB565Row_SSSE3(
    const uint8 *y_buf, const uint8 *u_buf, const uint8 *v_buf,
    uint8 *rgb565_buf, const struct YuvConstants *yuvconstants, int width) {
  __asm {
    push       esi
    push       edi
    push       ebx
...
__declspec(naked) void I411ToARGBRow_SSSE3(
    const uint8 *y_buf, const uint8 *u_buf, const uint8 *v_buf, uint8 *dst_argb,
    const struct YuvConstants *yuvconstants, int width) {
  __asm {
    push       esi
...
__declspec(naked) void I400ToARGBRow_SSE2(const uint8 *y_buf, uint8 *rgb_buf,
                                          int width) {
  __asm {
...
__declspec(naked) void I400ToARGBRow_AVX2(const uint8 *y_buf, uint8 *rgb_buf,
                                          int width) {
  __asm {
    mov        eax, 0x4a354a35  // 4a35 = 18997 = round(1.164 * 64 * 256)
    vmovd      xmm2, eax
...
__declspec(naked) void MirrorRow_SSSE3(const uint8 *src, uint8 *dst,
                                       int width) {
  __asm {
    mov       eax, [esp + 4]  // src
    mov       edx, [esp + 8]  // dst
...
__declspec(naked) void MirrorUVRow_SSSE3(const uint8 *src, uint8 *dst_u,
                                         uint8 *dst_v, int width) {
  __asm {
    push      edi
    mov       eax, [esp + 4 + 4]  // src
...
__declspec(naked) void ARGBMirrorRow_SSE2(const uint8 *src, uint8 *dst,
                                          int width) {
  __asm {
    mov       eax, [esp + 4]  // src
    mov       edx, [esp + 8]  // dst
...
__declspec(naked) void ARGBMirrorRow_AVX2(const uint8 *src, uint8 *dst,
                                          int width) {
  __asm {
    mov       eax, [esp + 4]  // src
    mov       edx, [esp + 8]  // dst
...
__declspec(naked) void SplitUVRow_SSE2(const uint8 *src_uv, uint8 *dst_u,
                                       uint8 *dst_v, int width) {
  __asm {
    push       edi
...
__declspec(naked) void SplitUVRow_AVX2(const uint8 *src_uv, uint8 *dst_u,
                                       uint8 *dst_v, int width) {
  __asm {
    push       edi
    mov        eax, [esp + 4 + 4]  // src_uv
...
__declspec(naked) void MergeUVRow_SSE2(const uint8 *src_u, const uint8 *src_v,
...
__declspec(naked) void MergeUVRow_AVX2(const uint8 *src_u, const uint8 *src_v,
                                       uint8 *dst_uv, int width) {
  __asm {
    push       edi
    mov        eax, [esp + 4 + 4]  // src_u
...
// width in pixels
__declspec(naked) void ARGBCopyAlphaRow_SSE2(const uint8 *src, uint8 *dst,
                                             int width) {
  __asm {
    mov        eax, [esp + 4]  // src
    mov        edx, [esp + 8]  // dst
...
// width in pixels
__declspec(naked) void ARGBCopyAlphaRow_AVX2(const uint8 *src, uint8 *dst,
                                             int width) {
  __asm {
    mov        eax, [esp + 4]  // src
    mov        edx, [esp + 8]  // dst
...
// width in pixels
__declspec(naked) void ARGBCopyYToAlphaRow_SSE2(const uint8 *src, uint8 *dst,
                                                int width) {
  __asm {
    mov        eax, [esp + 4]  // src
    mov        edx, [esp + 8]  // dst
...
// width in pixels
__declspec(naked) void ARGBCopyYToAlphaRow_AVX2(const uint8 *src, uint8 *dst,
                                                int width) {
  __asm {
    mov        eax, [esp + 4]  // src
    mov        edx, [esp + 8]  // dst
...
__declspec(naked) void YUY2ToYRow_AVX2(const uint8 *src_yuy2, uint8 *dst_y,
                                       int width) {
  __asm {
...
__declspec(naked) void YUY2ToUVRow_AVX2(const uint8 *src_yuy2, int stride_yuy2,
...
__declspec(naked) void YUY2ToUV422Row_AVX2(const uint8 *src_yuy2, uint8 *dst_u,
                                           uint8 *dst_v, int width) {
  __asm {
    push       edi
...
__declspec(naked) void UYVYToYRow_AVX2(const uint8 *src_uyvy, uint8 *dst_y,
                                       int width) {
  __asm {
...
__declspec(naked) void UYVYToUVRow_AVX2(const uint8 *src_uyvy, int stride_uyvy,
                                        uint8 *dst_u, uint8 *dst_v, int width) {
  __asm {
    push       esi
    push       edi
...
__declspec(naked) void UYVYToUV422Row_AVX2(const uint8 *src_uyvy, uint8 *dst_u,
                                           uint8 *dst_v, int width) {
  __asm {
    push       edi
    mov        eax, [esp + 4 + 4]  // src_yuy2
...
__declspec(naked) void YUY2ToYRow_SSE2(const uint8 *src_yuy2, uint8 *dst_y,
                                       int width) {
  __asm {
    mov        eax, [esp + 4]  // src_yuy2
    mov        edx, [esp + 8]  // dst_y
...
__declspec(naked) void YUY2ToUVRow_SSE2(const uint8 *src_yuy2, int stride_yuy2,
                                        uint8 *dst_u, uint8 *dst_v, int width) {
  __asm {
    push       esi
    push       edi
...
__declspec(naked) void YUY2ToUV422Row_SSE2(const uint8 *src_yuy2, uint8 *dst_u,
                                           uint8 *dst_v, int width) {
  __asm {
    push       edi
    mov        eax, [esp + 4 + 4]  // src_yuy2
...
__declspec(naked) void UYVYToYRow_SSE2(const uint8 *src_uyvy, uint8 *dst_y,
                                       int width) {
  __asm {
    mov        eax, [esp + 4]  // src_uyvy
    mov        edx, [esp + 8]  // dst_y
...
__declspec(naked) void UYVYToUVRow_SSE2(const uint8 *src_uyvy, int stride_uyvy,
                                        uint8 *dst_u, uint8 *dst_v, int width) {
  __asm {
    push       esi
    push       edi
...
__declspec(naked) void UYVYToUV422Row_SSE2(const uint8 *src_uyvy, uint8 *dst_u,
                                           uint8 *dst_v, int width) {
  __asm {
    push       edi
    mov        eax, [esp + 4 + 4]  // src_yuy2
...
__declspec(naked) void BlendPlaneRow_SSSE3(const uint8 *src0, const uint8 *src1,
                                           const uint8 *alpha, uint8 *dst,
                                           int width) {
  __asm {
    push       esi
    push       edi
...
// signed version of math
// =(((A2-128)*C2)+((B2-128)*(255-C2))+32768+127)/256
__declspec(naked) void BlendPlaneRow_AVX2(const uint8 *src0, const uint8 *src1,
                                          const uint8 *alpha, uint8 *dst,
                                          int width) {
  __asm {
    push        esi
...
__declspec(naked) void ARGBGrayRow_SSSE3(const uint8 *src_argb, uint8 *dst_argb,
                                         int width) {
  __asm {
    mov        eax, [esp + 4] /* src_argb */
    mov        edx, [esp + 8] /* dst_argb */
...
__declspec(naked) void ARGBQuantizeRow_SSE2(uint8 *dst_argb, int scale,
                                            int interval_size,
...
__declspec(naked) void ARGBShadeRow_SSE2(const uint8 *src_argb, uint8 *dst_argb,
...
__declspec(naked) void ARGBAddRow_SSE2(const uint8 *src_argb0,
                                       const uint8 *src_argb1, uint8 *dst_argb,
                                       int width) {
  __asm {
    push       esi
    mov        eax, [esp + 4 + 4]  // src_argb0
...
// -2  0  2
// -1  0  1
__declspec(naked) void SobelXRow_SSE2(const uint8 *src_y0, const uint8 *src_y1,
                                      const uint8 *src_y2, uint8 *dst_sobelx,
                                      int width) {
  __asm {
    push       esi
    push       edi
...
//  0  0  0
//  1  2  1
__declspec(naked) void SobelYRow_SSE2(const uint8 *src_y0, const uint8 *src_y1,
...
__declspec(naked) void SobelRow_SSE2(const uint8 *src_sobelx,
                                     const uint8 *src_sobely, uint8 *dst_argb,
                                     int width) {
  __asm {
    push       esi
...
__declspec(naked) void InterpolateRow_AVX2(uint8 *dst_ptr, const uint8 *src_ptr,
...
__declspec(naked) void I422ToYUY2Row_SSE2(const uint8 *src_y,
                                          const uint8 *src_u,
                                          const uint8 *src_v, uint8 *dst_frame,
                                          int width) {
  __asm {
    push       esi
    push       edi
