...
struct MasteringMetadata {
  ...
  MasteringMetadata()
      : r(NULL), g(NULL), b(NULL), white_point(NULL),
...
struct Projection {
  ...
  static const float kValueNotPresent;
  Projection()
      : type(kTypeNotPresent), private_data(NULL), private_data_length(0),
        pose_yaw(kValueNotPresent), pose_pitch(kValueNotPresent),
