...
ifeq ($(CONFIG_VP9_ENCODER)$(CONFIG_RATE_CTRL),yesyes)
  SIMPLE_ENCODE_SRCS := $(addprefix $(VP9_PREFIX),$(call enabled,VP9_CX_SRCS))
  SIMPLE_ENCODE_SRCS += $(VP9_PREFIX)vp9cx.mk vpx/vp8.h vpx/vp8cx.h
...
# However, if the target starts with "../", instead of adding prefix, it will remove "../".
# Using addprefix_clean, we can avoid two different targets building the same file, i.e.
...
TEST_INTRA_PRED_SPEED_SRCS=$(call addprefix_clean,test/,$(call enabled,TEST_INTRA_PRED_SPEED_SRCS))
TEST_INTRA_PRED_SPEED_OBJS := $(sort $(call objs,$(TEST_INTRA_PRED_SPEED_SRCS)))

RC_INTERFACE_TEST_BIN=./test_rc_interface$(EXE_SFX)
RC_INTERFACE_TEST_SRCS=$(call addprefix_clean,test/,$(call enabled,RC_INTERFACE_TEST_SRCS))
RC_INTERFACE_TEST_OBJS := $(sort $(call objs,$(RC_INTERFACE_TEST_SRCS)))

SIMPLE_ENCODE_TEST_BIN=./test_simple_encode$(EXE_SFX)
SIMPLE_ENCODE_TEST_SRCS=$(call addprefix_clean,test/,$(call enabled,SIMPLE_ENCODE_TEST_SRCS))
