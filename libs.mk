...
# universal Mac OS X build support from eons ago when universal meant PPC + X86,
# and we have build/make/iosbuild.sh that can build frameworks containing user
# selected targets.
BUILD_LIBVPX := yes
