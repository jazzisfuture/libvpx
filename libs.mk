...
LIBVPX_SO_VERSION_MAJOR := 2
LIBVPX_SO_VERSION_MINOR := 0
LIBVPX_SO_VERSION_PATCH := 0
ifeq ($(filter darwin%,$(TGT_OS)),$(TGT_OS))
LIBVPX_SO               := libvpx.$(LIBVPX_SO_VERSION_MAJOR).dylib
EXPORT_FILE             := libvpx.syms
LIBVPX_SO_SYMLINKS      := $(addprefix $(LIBSUBDIR)/, \
                             libvpx.dylib  )
else
LIBVPX_SO               := libvpx.so.$(LIBVPX_SO_VERSION_MAJOR).$(LIBVPX_SO_VERSION_MINOR).$(LIBVPX_SO_VERSION_PATCH)
EXPORT_FILE             := libvpx.ver
LIBVPX_SO_SYMLINKS      := $(addprefix $(LIBSUBDIR)/, \
                             libvpx.so libvpx.so.$(LIBVPX_SO_VERSION_MAJOR) \
                             libvpx.so.$(LIBVPX_SO_VERSION_MAJOR).$(LIBVPX_SO_VERSION_MINOR))
endif
...
$(BUILD_PFX)$(LIBVPX_SO): SONAME = libvpx.so.$(LIBVPX_SO_VERSION_MAJOR)
