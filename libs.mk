...
ifeq ($(CONFIG_VP9_ENCODER),yes)
  ...
  CODEC_SRCS-yes += $(VP9_PREFIX)vp9cx.mk vpx/vp9.h vpx/vp9cx.h vpx/vp9e.h
  CODEC_SRCS-$(ARCH_ARM) += $(VP9_PREFIX)vp98cx_arm.mk
  INSTALL-LIBS-yes += include/vpx/vp9.h include/vpx/vp9e.h include/vpx/vp9cx.h
  INSTALL_MAPS += include/vpx/% $(SRC_PATH_BARE)/$(VP9_PREFIX)/%
  CODEC_DOC_SRCS += vpx/vp9.h vpx/vp9cx.h
...
ifeq ($(CONFIG_VP9_DECODER),yes)
  ...
  CODEC_SRCS-yes += $(VP9_PREFIX)vp9dx.mk vpx/vp9.h vpx/vp9dx.h
  INSTALL-LIBS-yes += include/vpx/vp9.h include/vpx/vp9dx.h
  INSTALL_MAPS += include/vpx/% $(SRC_PATH_BARE)/$(VP9_PREFIX)/%
  CODEC_DOC_SRCS += vpx/vp9.h vpx/vp9dx.h
