...
# ./libvpx/configure --target=armv7-linux-gcc --disable-examples \
...
CODEC_SRCS_ASM_ADS2GAS = $(patsubst %.s, $(ASM_CNV_PATH_LOCAL)/libvpx/%.s, $(CODEC_SRCS_ASM))
LOCAL_SRC_FILES += $(CODEC_SRCS_ASM_ADS2GAS)
ADS2GAS_DIRECTORIES = $(dir $(CODEC_SRCS_ASM_ADS2GAS))
...
clean:
	...
	@rm -f $(CODEC_SRCS_ASM_ADS2GAS) $(CODEC_SRCS_ASM_NEON_ADS2GAS)
	@rm -f $(patsubst %.asm, %.*, $(ASM_CNV_OFFSETS_DEPEND))
	@rm -r $(ADS2GAS_DIRECTORIES_UNIQUE)
