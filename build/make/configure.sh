...
EOF
    ...
    mips*)
      ...
      if [ -n "${tune_cpu}" ]; then
        case ${tune_cpu} in
        p5600)
          add_cflags -mips32r5 -funroll-loops -mload-store-pairs -msched-weight -mhard-float
          add_asflags -mips32r5 -mhard-float
        ;;
        i6400)
          add_cflags -mips64r6 -mabi=64 -funroll-loops -mload-store-pairs -msched-weight -mhard-float
