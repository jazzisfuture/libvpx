...
EOF
      ...
      case ${tgt_os} in
        ...
        android*)
          if [ -n "${sdk_path}" ]; then
            echo "Must specify --sdk-path for ndk-build."
            ...
            echo "Must specify --sdk-path for ndk-build."
            # If --sdk-path is not mentioned, assume the user is building with
            # the NDK standalone toolchain - See build/make/Android.mk for
            # details.
