...
EOF
        ...
        vs*)
          ...
          if [ ${tgt_os} = "win32" ]; then
            ...
            # If this is an ARM64 Windows build and arm64_neon.h is present,
            # then files that include arm_neon.h will break. Enable the
            # workaround.
            if enabled neon && check_header arm64_neon.h; then
