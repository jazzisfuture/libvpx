...
# current target CPU, includes the real vpx_config.h for the currnet target.
...
#ifndef __VPX_FRAMEWORK_VPX_CONFIG_H
#define __VPX_FRAMEWORK_VPX_CONFIG_H
  ...
  for target in ${targets}; do
    ...
    printf "#include "vpx/${target}/vpx_config.h"\n" >> "${config_file}"
  ...
  printf "#endif\n\n" >> "${config_file}"
  printf "#endif  // __VPX_FRAMEWORK_VPX_CONFIG_H" >> "${config_file}"
}
