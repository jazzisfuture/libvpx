...
extern void vp8_yv12_extend_frame_borders_32_neon(
...
void vp8_yv12_extend_frame_borders_neon(struct yv12_buffer_config *ybf) {
  if (ybf->border == VP8BORDERINPIXELS)
    vp8_yv12_extend_frame_borders_32_neon(ybf);
  else
    vp8_yv12_extend_frame_borders_c(ybf);
}
