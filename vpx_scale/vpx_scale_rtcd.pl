...
if (vpx_config("CONFIG_VP9") eq "yes") {
    add_proto qw/void vp9_extend_frame_borders/, "struct yv12_buffer_config *ybf, int subsampling_x, int subsampling_y";
    specialize qw/vp9_extend_frame_borders dspr2/;

    add_proto qw/void vp9_extend_frame_inner_borders/, "struct yv12_buffer_config *ybf, int subsampling_x, int subsampling_y";
