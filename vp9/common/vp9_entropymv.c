...
vp9_token vp9_mv_joint_encodings[MV_JOINTS];
...
vp9_token vp9_mv_class_encodings[MV_CLASSES];

const vp9_tree_index vp9_mv_class0_tree [2 * CLASS0_SIZE - 2] = {
  -0, -1,
};
vp9_token vp9_mv_class0_encodings[CLASS0_SIZE];
...
vp9_token vp9_mv_fp_encodings[4];
