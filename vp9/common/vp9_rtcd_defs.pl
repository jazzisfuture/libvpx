...
# RECON
#
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_d207_predictor_4x4/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_d45_predictor_4x4/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_d63_predictor_4x4/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_h_predictor_4x4/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_d117_predictor_4x4/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_d135_predictor_4x4/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_d153_predictor_4x4/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_v_predictor_4x4/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_tm_predictor_4x4/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_dc_predictor_4x4/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_dc_top_predictor_4x4/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_dc_left_predictor_4x4/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_dc_128_predictor_4x4/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_d207_predictor_8x8/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_d45_predictor_8x8/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_d63_predictor_8x8/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_h_predictor_8x8/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_d117_predictor_8x8/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_d135_predictor_8x8/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_d153_predictor_8x8/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_v_predictor_8x8/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_tm_predictor_8x8/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_dc_predictor_8x8/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_dc_top_predictor_8x8/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_dc_left_predictor_8x8/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_dc_128_predictor_8x8/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_d207_predictor_16x16/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_d45_predictor_16x16/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_d63_predictor_16x16/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_h_predictor_16x16/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_d117_predictor_16x16/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_d135_predictor_16x16/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_d153_predictor_16x16/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_v_predictor_16x16/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_tm_predictor_16x16/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_dc_predictor_16x16/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_dc_top_predictor_16x16/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_dc_left_predictor_16x16/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_dc_128_predictor_16x16/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_d207_predictor_32x32/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_d45_predictor_32x32/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_d63_predictor_32x32/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_h_predictor_32x32/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_d117_predictor_32x32/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_d135_predictor_32x32/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_d153_predictor_32x32/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_v_predictor_32x32/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_tm_predictor_32x32/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_dc_predictor_32x32/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_dc_top_predictor_32x32/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_dc_left_predictor_32x32/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_dc_128_predictor_32x32/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left";
...
#
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_lpf_vertical_16/, "uint16_t *s, int pitch, const uint16_t *blimit, const uint16_t *limit, const uint16_t *thresh";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_lpf_vertical_16_dual/, "uint16_t *s, int pitch, const uint16_t *blimit, const uint16_t *limit, const uint16_t *thresh";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_lpf_vertical_8/, "uint16_t *s, int pitch, const uint16_t *blimit, const uint16_t *limit, const uint16_t *thresh, int count";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_lpf_vertical_8_dual/, "uint16_t *s, int pitch, const uint16_t *blimit0, const uint16_t *limit0, const uint16_t *thresh0, const uint16_t *blimit1, const uint16_t *limit1, const uint16_t *thresh1";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_lpf_vertical_4/, "uint16_t *s, int pitch, const uint16_t *blimit, const uint16_t *limit, const uint16_t *thresh, int count";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_lpf_vertical_4_dual/, "uint16_t *s, int pitch, const uint16_t *blimit0, const uint16_t *limit0, const uint16_t *thresh0, const uint16_t *blimit1, const uint16_t *limit1, const uint16_t *thresh1";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_lpf_horizontal_16/, "uint16_t *s, int pitch, const uint16_t *blimit, const uint16_t *limit, const uint16_t *thresh, int count";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_lpf_horizontal_8/, "uint16_t *s, int pitch, const uint16_t *blimit, const uint16_t *limit, const uint16_t *thresh, int count";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_lpf_horizontal_8_dual/, "uint16_t *s, int pitch, const uint16_t *blimit0, const uint16_t *limit0, const uint16_t *thresh0, const uint16_t *blimit1, const uint16_t *limit1, const uint16_t *thresh1";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_lpf_horizontal_4/, "uint16_t *s, int pitch, const uint16_t *blimit, const uint16_t *limit, const uint16_t *thresh, int count";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_lpf_horizontal_4_dual/, "uint16_t *s, int pitch, const uint16_t *blimit0, const uint16_t *limit0, const uint16_t *thresh0, const uint16_t *blimit1, const uint16_t *limit1, const uint16_t *thresh1";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_mbpost_proc_down/, "uint16_t *dst, int pitch, int rows, int cols, int flimit";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_mbpost_proc_across_ip/, "uint16_t *src, int pitch, int rows, int cols, int flimit";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_post_proc_down_and_across/, "const uint16_t *src_ptr, uint16_t *dst_ptr, int src_pixels_per_line, int dst_pixels_per_line, int rows, int cols, int flimit";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_plane_add_noise/, "uint16_t *Start, char *noise, char blackclamp[16], char whiteclamp[16], char bothclamp[16], unsigned int Width, unsigned int Height, int Pitch";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_blend_mb_inner/, "uint16_t *y, uint16_t *u, uint16_t *v, int y1, int u1, int v1, int alpha, int stride";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_blend_mb_outer/, "uint16_t *y, uint16_t *u, uint16_t *v, int y1, int u1, int v1, int alpha, int stride";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_blend_b/, "uint16_t *y, uint16_t *u, uint16_t *v, int y1, int u1, int v1, int alpha, int stride";
...
#
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_convolve_copy/, "const uint16_t *src, ptrdiff_t src_stride, uint16_t *dst, ptrdiff_t dst_stride, const int16_t *filter_x, int x_step_q4, const int16_t *filter_y, int y_step_q4, int w, int h";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_convolve_avg/, "const uint16_t *src, ptrdiff_t src_stride, uint16_t *dst, ptrdiff_t dst_stride, const int16_t *filter_x, int x_step_q4, const int16_t *filter_y, int y_step_q4, int w, int h";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_convolve8/, "const uint16_t *src, ptrdiff_t src_stride, uint16_t *dst, ptrdiff_t dst_stride, const int16_t *filter_x, int x_step_q4, const int16_t *filter_y, int y_step_q4, int w, int h";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_convolve8_horiz/, "const uint16_t *src, ptrdiff_t src_stride, uint16_t *dst, ptrdiff_t dst_stride, const int16_t *filter_x, int x_step_q4, const int16_t *filter_y, int y_step_q4, int w, int h";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_convolve8_vert/, "const uint16_t *src, ptrdiff_t src_stride, uint16_t *dst, ptrdiff_t dst_stride, const int16_t *filter_x, int x_step_q4, const int16_t *filter_y, int y_step_q4, int w, int h";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_convolve8_avg/, "const uint16_t *src, ptrdiff_t src_stride, uint16_t *dst, ptrdiff_t dst_stride, const int16_t *filter_x, int x_step_q4, const int16_t *filter_y, int y_step_q4, int w, int h";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_convolve8_avg_horiz/, "const uint16_t *src, ptrdiff_t src_stride, uint16_t *dst, ptrdiff_t dst_stride, const int16_t *filter_x, int x_step_q4, const int16_t *filter_y, int y_step_q4, int w, int h";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_convolve8_avg_vert/, "const uint16_t *src, ptrdiff_t src_stride, uint16_t *dst, ptrdiff_t dst_stride, const int16_t *filter_x, int x_step_q4, const int16_t *filter_y, int y_step_q4, int w, int h";
...
#
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_idct4x4_1_add/, "const int16_t *input, uint16_t *dest, int dest_stride";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_idct4x4_16_add/, "const int16_t *input, uint16_t *dest, int dest_stride";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_idct8x8_1_add/, "const int16_t *input, uint16_t *dest, int dest_stride";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_idct8x8_64_add/, "const int16_t *input, uint16_t *dest, int dest_stride";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_idct8x8_10_add/, "const int16_t *input, uint16_t *dest, int dest_stride";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_idct16x16_1_add/, "const int16_t *input, uint16_t *dest, int dest_stride";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_idct16x16_256_add/, "const int16_t *input, uint16_t *dest, int dest_stride";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_idct16x16_10_add/, "const int16_t *input, uint16_t *dest, int dest_stride";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_idct32x32_1024_add/, "const int16_t *input, uint16_t *dest, int dest_stride";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_idct32x32_34_add/, "const int16_t *input, uint16_t *dest, int dest_stride";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_idct32x32_1_add/, "const int16_t *input, uint16_t *dest, int dest_stride";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_iht4x4_16_add/, "const int16_t *input, uint16_t *dest, int dest_stride, int tx_type";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_iht8x8_64_add/, "const int16_t *input, uint16_t *dest, int dest_stride, int tx_type";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_iht16x16_256_add/, "const int16_t *input, uint16_t *output, int pitch, int tx_type";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_iwht4x4_1_add/, "const int16_t *input, uint16_t *dest, int dest_stride";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_iwht4x4_16_add/, "const int16_t *input, uint16_t *dest, int dest_stride";
...
# variance
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_variance32x16/, "const uint16_t *src_ptr, int source_stride, const uint16_t *ref_ptr, int ref_stride, unsigned int *sse";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_variance16x32/, "const uint16_t *src_ptr, int source_stride, const uint16_t *ref_ptr, int ref_stride, unsigned int *sse";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_variance64x32/, "const uint16_t *src_ptr, int source_stride, const uint16_t *ref_ptr, int ref_stride, unsigned int *sse";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_variance32x64/, "const uint16_t *src_ptr, int source_stride, const uint16_t *ref_ptr, int ref_stride, unsigned int *sse";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_variance32x32/, "const uint16_t *src_ptr, int source_stride, const uint16_t *ref_ptr, int ref_stride, unsigned int *sse";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_variance64x64/, "const uint16_t *src_ptr, int source_stride, const uint16_t *ref_ptr, int ref_stride, unsigned int *sse";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_variance16x16/, "const uint16_t *src_ptr, int source_stride, const uint16_t *ref_ptr, int ref_stride, unsigned int *sse";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_get_sse_sum_16x16/, "const uint16_t *src_ptr, int source_stride, const uint16_t *ref_ptr, int ref_stride, unsigned int *sse, int *sum";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_variance16x8/, "const uint16_t *src_ptr, int source_stride, const uint16_t *ref_ptr, int ref_stride, unsigned int *sse";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_variance8x16/, "const uint16_t *src_ptr, int source_stride, const uint16_t *ref_ptr, int ref_stride, unsigned int *sse";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_variance8x8/, "const uint16_t *src_ptr, int source_stride, const uint16_t *ref_ptr, int ref_stride, unsigned int *sse";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_get_sse_sum_8x8/, "const uint16_t *src_ptr, int source_stride, const uint16_t *ref_ptr, int ref_stride, unsigned int *sse, int *sum";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_variance8x4/, "const uint16_t *src_ptr, int source_stride, const uint16_t *ref_ptr, int ref_stride, unsigned int *sse";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_variance4x8/, "const uint16_t *src_ptr, int source_stride, const uint16_t *ref_ptr, int ref_stride, unsigned int *sse";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_variance4x4/, "const uint16_t *src_ptr, int source_stride, const uint16_t *ref_ptr, int ref_stride, unsigned int *sse";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_sub_pixel_variance64x64/, "const uint16_t *src_ptr, int source_stride, int xoffset, int  yoffset, const uint16_t *ref_ptr, int ref_stride, unsigned int *sse";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_sub_pixel_avg_variance64x64/, "const uint16_t *src_ptr, int source_stride, int xoffset, int  yoffset, const uint16_t *ref_ptr, int ref_stride, unsigned int *sse, const uint16_t *second_pred";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_sub_pixel_variance32x64/, "const uint16_t *src_ptr, int source_stride, int xoffset, int  yoffset, const uint16_t *ref_ptr, int ref_stride, unsigned int *sse";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_sub_pixel_avg_variance32x64/, "const uint16_t *src_ptr, int source_stride, int xoffset, int  yoffset, const uint16_t *ref_ptr, int ref_stride, unsigned int *sse, const uint16_t *second_pred";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_sub_pixel_variance64x32/, "const uint16_t *src_ptr, int source_stride, int xoffset, int  yoffset, const uint16_t *ref_ptr, int ref_stride, unsigned int *sse";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_sub_pixel_avg_variance64x32/, "const uint16_t *src_ptr, int source_stride, int xoffset, int  yoffset, const uint16_t *ref_ptr, int ref_stride, unsigned int *sse, const uint16_t *second_pred";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_sub_pixel_variance32x16/, "const uint16_t *src_ptr, int source_stride, int xoffset, int  yoffset, const uint16_t *ref_ptr, int ref_stride, unsigned int *sse";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_sub_pixel_avg_variance32x16/, "const uint16_t *src_ptr, int source_stride, int xoffset, int  yoffset, const uint16_t *ref_ptr, int ref_stride, unsigned int *sse, const uint16_t *second_pred";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_sub_pixel_variance16x32/, "const uint16_t *src_ptr, int source_stride, int xoffset, int  yoffset, const uint16_t *ref_ptr, int ref_stride, unsigned int *sse";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_sub_pixel_avg_variance16x32/, "const uint16_t *src_ptr, int source_stride, int xoffset, int  yoffset, const uint16_t *ref_ptr, int ref_stride, unsigned int *sse, const uint16_t *second_pred";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_sub_pixel_variance32x32/, "const uint16_t *src_ptr, int source_stride, int xoffset, int  yoffset, const uint16_t *ref_ptr, int ref_stride, unsigned int *sse";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_sub_pixel_avg_variance32x32/, "const uint16_t *src_ptr, int source_stride, int xoffset, int  yoffset, const uint16_t *ref_ptr, int ref_stride, unsigned int *sse, const uint16_t *second_pred";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_sub_pixel_variance16x16/, "const uint16_t *src_ptr, int source_stride, int xoffset, int  yoffset, const uint16_t *ref_ptr, int ref_stride, unsigned int *sse";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_sub_pixel_avg_variance16x16/, "const uint16_t *src_ptr, int source_stride, int xoffset, int  yoffset, const uint16_t *ref_ptr, int ref_stride, unsigned int *sse, const uint16_t *second_pred";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_sub_pixel_variance8x16/, "const uint16_t *src_ptr, int source_stride, int xoffset, int  yoffset, const uint16_t *ref_ptr, int ref_stride, unsigned int *sse";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_sub_pixel_avg_variance8x16/, "const uint16_t *src_ptr, int source_stride, int xoffset, int  yoffset, const uint16_t *ref_ptr, int ref_stride, unsigned int *sse, const uint16_t *second_pred";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_sub_pixel_variance16x8/, "const uint16_t *src_ptr, int source_stride, int xoffset, int  yoffset, const uint16_t *ref_ptr, int ref_stride, unsigned int *sse";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_sub_pixel_avg_variance16x8/, "const uint16_t *src_ptr, int source_stride, int xoffset, int  yoffset, const uint16_t *ref_ptr, int ref_stride, unsigned int *sse, const uint16_t *second_pred";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_sub_pixel_variance8x8/, "const uint16_t *src_ptr, int source_stride, int xoffset, int  yoffset, const uint16_t *ref_ptr, int ref_stride, unsigned int *sse";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_sub_pixel_avg_variance8x8/, "const uint16_t *src_ptr, int source_stride, int xoffset, int  yoffset, const uint16_t *ref_ptr, int ref_stride, unsigned int *sse, const uint16_t *second_pred";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_sub_pixel_variance8x4/, "const uint16_t *src_ptr, int source_stride, int xoffset, int yoffset, const uint16_t *ref_ptr, int ref_stride, unsigned int *sse";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_sub_pixel_avg_variance8x4/, "const uint16_t *src_ptr, int source_stride, int xoffset, int yoffset, const uint16_t *ref_ptr, int ref_stride, unsigned int *sse, const uint16_t *second_pred";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_sub_pixel_variance4x8/, "const uint16_t *src_ptr, int source_stride, int xoffset, int yoffset, const uint16_t *ref_ptr, int ref_stride, unsigned int *sse";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_sub_pixel_avg_variance4x8/, "const uint16_t *src_ptr, int source_stride, int xoffset, int yoffset, const uint16_t *ref_ptr, int ref_stride, unsigned int *sse, const uint16_t *second_pred";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_sub_pixel_variance4x4/, "const uint16_t *src_ptr, int source_stride, int xoffset, int  yoffset, const uint16_t *ref_ptr, int ref_stride, unsigned int *sse";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_sub_pixel_avg_variance4x4/, "const uint16_t *src_ptr, int source_stride, int xoffset, int  yoffset, const uint16_t *ref_ptr, int ref_stride, unsigned int *sse, const uint16_t *second_pred";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_sad64x64/, "const uint16_t *src_ptr, int source_stride, const uint16_t *ref_ptr, int  ref_stride, unsigned int max_sad";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_sad32x64/, "const uint16_t *src_ptr, int source_stride, const uint16_t *ref_ptr, int ref_stride, unsigned int max_sad";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_sad64x32/, "const uint16_t *src_ptr, int source_stride, const uint16_t *ref_ptr, int ref_stride, unsigned int max_sad";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_sad32x16/, "const uint16_t *src_ptr, int source_stride, const uint16_t *ref_ptr, int ref_stride, unsigned int max_sad";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_sad16x32/, "const uint16_t *src_ptr, int source_stride, const uint16_t *ref_ptr, int ref_stride, unsigned int max_sad";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_sad32x32/, "const uint16_t *src_ptr, int source_stride, const uint16_t *ref_ptr, int  ref_stride, unsigned int max_sad";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_sad16x16/, "const uint16_t *src_ptr, int source_stride, const uint16_t *ref_ptr, int  ref_stride, unsigned int max_sad";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_sad16x8/, "const uint16_t *src_ptr, int source_stride, const uint16_t *ref_ptr, int  ref_stride, unsigned int max_sad";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_sad8x16/, "const uint16_t *src_ptr, int source_stride, const uint16_t *ref_ptr, int  ref_stride, unsigned int max_sad";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_sad8x8/, "const uint16_t *src_ptr, int source_stride, const uint16_t *ref_ptr, int  ref_stride, unsigned int max_sad";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_sad8x4/, "const uint16_t *src_ptr, int source_stride, const uint16_t *ref_ptr, int ref_stride, unsigned int max_sad";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_sad4x8/, "const uint16_t *src_ptr, int source_stride, const uint16_t *ref_ptr, int ref_stride, unsigned int max_sad";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_sad4x4/, "const uint16_t *src_ptr, int source_stride, const uint16_t *ref_ptr, int  ref_stride, unsigned int max_sad";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_sad64x64_avg/, "const uint16_t *src_ptr, int source_stride, const uint16_t *ref_ptr, int  ref_stride, const uint16_t *second_pred, unsigned int max_sad";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_sad32x64_avg/, "const uint16_t *src_ptr, int source_stride, const uint16_t *ref_ptr, int ref_stride, const uint16_t *second_pred, unsigned int max_sad";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_sad64x32_avg/, "const uint16_t *src_ptr, int source_stride, const uint16_t *ref_ptr, int ref_stride, const uint16_t *second_pred, unsigned int max_sad";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_sad32x16_avg/, "const uint16_t *src_ptr, int source_stride, const uint16_t *ref_ptr, int ref_stride, const uint16_t *second_pred, unsigned int max_sad";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_sad16x32_avg/, "const uint16_t *src_ptr, int source_stride, const uint16_t *ref_ptr, int ref_stride, const uint16_t *second_pred, unsigned int max_sad";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_sad32x32_avg/, "const uint16_t *src_ptr, int source_stride, const uint16_t *ref_ptr, int  ref_stride, const uint16_t *second_pred, unsigned int max_sad";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_sad16x16_avg/, "const uint16_t *src_ptr, int source_stride, const uint16_t *ref_ptr, int  ref_stride, const uint16_t *second_pred, unsigned int max_sad";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_sad16x8_avg/, "const uint16_t *src_ptr, int source_stride, const uint16_t *ref_ptr, int  ref_stride, const uint16_t *second_pred, unsigned int max_sad";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_sad8x16_avg/, "const uint16_t *src_ptr, int source_stride, const uint16_t *ref_ptr, int  ref_stride, const uint16_t *second_pred, unsigned int max_sad";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_sad8x8_avg/, "const uint16_t *src_ptr, int source_stride, const uint16_t *ref_ptr, int  ref_stride, const uint16_t *second_pred, unsigned int max_sad";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_sad8x4_avg/, "const uint16_t *src_ptr, int source_stride, const uint16_t *ref_ptr, int ref_stride, const uint16_t *second_pred, unsigned int max_sad";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_sad4x8_avg/, "const uint16_t *src_ptr, int source_stride, const uint16_t *ref_ptr, int ref_stride, const uint16_t *second_pred, unsigned int max_sad";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_sad4x4_avg/, "const uint16_t *src_ptr, int source_stride, const uint16_t *ref_ptr, int  ref_stride, const uint16_t *second_pred, unsigned int max_sad";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_variance_halfpixvar16x16_h/, "const uint16_t *src_ptr, int source_stride, const uint16_t *ref_ptr, int ref_stride, unsigned int *sse";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_variance_halfpixvar16x16_v/, "const uint16_t *src_ptr, int source_stride, const uint16_t *ref_ptr, int ref_stride, unsigned int *sse";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_variance_halfpixvar16x16_hv/, "const uint16_t *src_ptr, int source_stride, const uint16_t *ref_ptr, int ref_stride, unsigned int *sse";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_variance_halfpixvar64x64_h/, "const uint16_t *src_ptr, int source_stride, const uint16_t *ref_ptr, int ref_stride, unsigned int *sse";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_variance_halfpixvar64x64_v/, "const uint16_t *src_ptr, int source_stride, const uint16_t *ref_ptr, int ref_stride, unsigned int *sse";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_variance_halfpixvar64x64_hv/, "const uint16_t *src_ptr, int source_stride, const uint16_t *ref_ptr, int ref_stride, unsigned int *sse";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_variance_halfpixvar32x32_h/, "const uint16_t *src_ptr, int source_stride, const uint16_t *ref_ptr, int ref_stride, unsigned int *sse";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_variance_halfpixvar32x32_v/, "const uint16_t *src_ptr, int source_stride, const uint16_t *ref_ptr, int ref_stride, unsigned int *sse";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_variance_halfpixvar32x32_hv/, "const uint16_t *src_ptr, int source_stride, const uint16_t *ref_ptr, int ref_stride, unsigned int *sse";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_sad64x64x3/, "const uint16_t *src_ptr, int source_stride, const uint16_t *ref_ptr, int  ref_stride, unsigned int *sad_array";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_sad32x32x3/, "const uint16_t *src_ptr, int source_stride, const uint16_t *ref_ptr, int  ref_stride, unsigned int *sad_array";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_sad16x16x3/, "const uint16_t *src_ptr, int source_stride, const uint16_t *ref_ptr, int  ref_stride, unsigned int *sad_array";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_sad16x8x3/, "const uint16_t *src_ptr, int source_stride, const uint16_t *ref_ptr, int  ref_stride, unsigned int *sad_array";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_sad8x16x3/, "const uint16_t *src_ptr, int source_stride, const uint16_t *ref_ptr, int  ref_stride, unsigned int *sad_array";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_sad8x8x3/, "const uint16_t *src_ptr, int source_stride, const uint16_t *ref_ptr, int  ref_stride, unsigned int *sad_array";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_sad4x4x3/, "const uint16_t *src_ptr, int source_stride, const uint16_t *ref_ptr, int  ref_stride, unsigned int *sad_array";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_sad64x64x8/, "const uint16_t *src_ptr, int  src_stride, const uint16_t *ref_ptr, int  ref_stride, uint32_t *sad_array";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_sad32x32x8/, "const uint16_t *src_ptr, int  src_stride, const uint16_t *ref_ptr, int  ref_stride, uint32_t *sad_array";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_sad16x16x8/, "const uint16_t *src_ptr, int  src_stride, const uint16_t *ref_ptr, int  ref_stride, uint32_t *sad_array";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_sad16x8x8/, "const uint16_t *src_ptr, int  src_stride, const uint16_t *ref_ptr, int  ref_stride, uint32_t *sad_array";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_sad8x16x8/, "const uint16_t *src_ptr, int  src_stride, const uint16_t *ref_ptr, int  ref_stride, uint32_t *sad_array";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_sad8x8x8/, "const uint16_t *src_ptr, int  src_stride, const uint16_t *ref_ptr, int  ref_stride, uint32_t *sad_array";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_sad8x4x8/, "const uint16_t *src_ptr, int src_stride, const uint16_t *ref_ptr, int ref_stride, uint32_t *sad_array";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_sad4x8x8/, "const uint16_t *src_ptr, int src_stride, const uint16_t *ref_ptr, int ref_stride, uint32_t *sad_array";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_sad4x4x8/, "const uint16_t *src_ptr, int  src_stride, const uint16_t *ref_ptr, int  ref_stride, uint32_t *sad_array";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_sad64x64x4d/, "const uint16_t *src_ptr, int  src_stride, const uint16_t* const ref_ptr[], int  ref_stride, unsigned int *sad_array";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_sad32x64x4d/, "const uint16_t *src_ptr, int  src_stride, const uint16_t* const ref_ptr[], int  ref_stride, unsigned int *sad_array";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_sad64x32x4d/, "const uint16_t *src_ptr, int  src_stride, const uint16_t* const ref_ptr[], int  ref_stride, unsigned int *sad_array";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_sad32x16x4d/, "const uint16_t *src_ptr, int  src_stride, const uint16_t* const ref_ptr[], int  ref_stride, unsigned int *sad_array";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_sad16x32x4d/, "const uint16_t *src_ptr, int  src_stride, const uint16_t* const ref_ptr[], int  ref_stride, unsigned int *sad_array";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_sad32x32x4d/, "const uint16_t *src_ptr, int  src_stride, const uint16_t* const ref_ptr[], int  ref_stride, unsigned int *sad_array";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_sad16x16x4d/, "const uint16_t *src_ptr, int  src_stride, const uint16_t* const ref_ptr[], int  ref_stride, unsigned int *sad_array";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_sad16x8x4d/, "const uint16_t *src_ptr, int  src_stride, const uint16_t* const ref_ptr[], int  ref_stride, unsigned int *sad_array";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_sad8x16x4d/, "const uint16_t *src_ptr, int  src_stride, const uint16_t* const ref_ptr[], int  ref_stride, unsigned int *sad_array";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_sad8x8x4d/, "const uint16_t *src_ptr, int  src_stride, const uint16_t* const ref_ptr[], int  ref_stride, unsigned int *sad_array";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_sad8x4x4d/, "const uint16_t *src_ptr, int src_stride, const uint16_t* const ref_ptr[], int ref_stride, unsigned int *sad_array";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_sad4x8x4d/, "const uint16_t *src_ptr, int src_stride, const uint16_t* const ref_ptr[], int ref_stride, unsigned int *sad_array";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_sad4x4x4d/, "const uint16_t *src_ptr, int  src_stride, const uint16_t* const ref_ptr[], int  ref_stride, unsigned int *sad_array";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
#add_proto qw/unsigned int vp9_sub_pixel_mse16x16/, "const uint16_t *src_ptr, int  src_pixels_per_line, int  xoffset, int  yoffset, const uint16_t *dst_ptr, int dst_pixels_per_line, unsigned int *sse";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_mse16x16/, "const uint16_t *src_ptr, int  source_stride, const uint16_t *ref_ptr, int  recon_stride, unsigned int *sse";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_mse8x16/, "const uint16_t *src_ptr, int  source_stride, const uint16_t *ref_ptr, int  recon_stride, unsigned int *sse";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_mse16x8/, "const uint16_t *src_ptr, int  source_stride, const uint16_t *ref_ptr, int  recon_stride, unsigned int *sse";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_mse8x8/, "const uint16_t *src_ptr, int  source_stride, const uint16_t *ref_ptr, int  recon_stride, unsigned int *sse";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_sub_pixel_mse64x64/, "const uint16_t *src_ptr, int  source_stride, int  xoffset, int  yoffset, const uint16_t *ref_ptr, int ref_stride, unsigned int *sse";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/unsigned int vp9_sub_pixel_mse32x32/, "const uint16_t *src_ptr, int  source_stride, int  xoffset, int  yoffset, const uint16_t *ref_ptr, int ref_stride, unsigned int *sse";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_subtract_block/, "int rows, int cols, int16_t *diff_ptr, ptrdiff_t diff_stride, const uint16_t *src_ptr, ptrdiff_t src_stride, const uint16_t *pred_ptr, ptrdiff_t pred_stride";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
    add_proto qw/void vp9_ssim_parms_8x8/, "uint16_t *s, int sp, uint16_t *r, int rp, unsigned long *sum_s, unsigned long *sum_r, unsigned long *sum_sq_s, unsigned long *sum_sq_r, unsigned long *sum_sxr";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
    add_proto qw/void vp9_ssim_parms_16x16/, "uint16_t *s, int sp, uint16_t *r, int rp, unsigned long *sum_s, unsigned long *sum_r, unsigned long *sum_sq_s, unsigned long *sum_sq_r, unsigned long *sum_sxr";
...
if (vpx_config("CONFIG_HIGHBITDEPTH") eq "yes"){
add_proto qw/void vp9_temporal_filter_apply/, "uint16_t *frame1, unsigned int stride, uint16_t *frame2, unsigned int block_size, int strength, int filter_weight, unsigned int *accumulator, uint16_t *count";
