...
typedef struct VP9LfSyncData {
  ...
  pthread_mutex_t *recon_done_mutex_;
  pthread_cond_t *recon_done_cond_;
#endif
  int *num_tiles_in_frame_row_done;
} VP9LfSync;
...
void vp9_lpf_mt_init(struct VP9Common *cm, VP9LfSync *lf_sync,
