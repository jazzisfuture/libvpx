...
//  const MODE_INFO *const mi = mi_8x8t;
  ...
  const int left_intra = left_mbmi ? left_mbmi->ref_frame[0] == INTRA_FRAME : 0;
  const int above_intra = above_mbmi ? above_mbmi->ref_frame[0] == INTRA_FRAME : 0;
