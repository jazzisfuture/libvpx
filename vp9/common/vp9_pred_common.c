...
unsigned char vp9_get_pred_context_switchable_interp(const VP9_COMMON *cm,
  ...
  int above_mv_pred = 0;
  int above_interp = 0;
  INTERPOLATIONFILTERTYPE left_interp_filter = left_mi ? left_mi->mbmi.interp_filter : 0;
  INTERPOLATIONFILTERTYPE above_interp_filter = above_mi ? above_mi->mbmi.interp_filter : 0;
