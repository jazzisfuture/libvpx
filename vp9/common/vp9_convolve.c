...
static const subpel_kernel * get_kernel(const int16_t *filter) {
...
void vp9_convolve8_horiz_c(const uint8_t *src, ptrdiff_t src_stride,
                           ...
                           int w, int h) {
  const subpel_kernel *const x_filters = get_kernel(filter_x);
  const int x0_q4 = (const subpel_kernel *)filter_x - x_filters;

  convolve_horiz(src, src_stride, dst, dst_stride, x_filters,
                 x0_q4, x_step_q4, w, h);
}
...
void vp9_convolve8_avg_horiz_c(const uint8_t *src, ptrdiff_t src_stride,
  ...
  convolve_avg_horiz(src, src_stride, dst, dst_stride, x_filters,
                     x0_q4, x_step_q4, w, h);
}
...
void vp9_convolve8_vert_c(const uint8_t *src, ptrdiff_t src_stride,
                          ...
                          const int16_t *filter_y, int y_step_q4,
                          int w, int h) {
  const subpel_kernel *const y_filters = get_kernel(filter_y);
  const int y0_q4 = (const subpel_kernel *)filter_y - y_filters;
  convolve_vert(src, src_stride, dst, dst_stride, y_filters,
                y0_q4, y_step_q4, w, h);
}
...
void vp9_convolve8_avg_vert_c(const uint8_t *src, ptrdiff_t src_stride,
  ...
  const subpel_kernel *const y_filters = get_kernel(filter_y);
  const int y0_q4 = (const subpel_kernel *)filter_y - y_filters;
  convolve_avg_vert(src, src_stride, dst, dst_stride, y_filters,
                    y0_q4, y_step_q4, w, h);
}
