...
[ $arch = "x86_64" -o ! "$CONFIG_PIC" = "yes" ] && mmx_x86inc=mmx && sse2_x86inc=sse2  && ssse3_x86inc=ssse3
...
if [ $arch = "x86_64" ]; then
    specialize vp9_quantize_b ssse3
fi
...
if [ $arch = "x86_64" ]; then
    specialize vp9_quantize_b_32x32 ssse3
fi
...
if [ "$CONFIG_INTERNAL_STATS" = "yes" ]; then
    ...
    specialize vp9_ssim_parms_8x8 $sse2_x86inc
    ...
    specialize vp9_ssim_parms_16x16 $sse2_x86inc
fi
