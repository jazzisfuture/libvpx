...
prototype void vp9_intra4x4_predict "struct macroblockd *xd, struct blockd *x, int b_mode, int pf_state, uint8_t *predictor"
specialize vp9_intra4x4_predict;

prototype void vp9_intra8x8_predict "struct macroblockd *xd, struct blockd *x, int b_mode, int pf_state, uint8_t *predictor"
specialize vp9_intra8x8_predict;

prototype void vp9_intra_uv4x4_predict "struct macroblockd *xd, struct blockd *x, int b_mode, int pf_state, uint8_t *predictor"
