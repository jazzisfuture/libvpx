...
prototype void vp9_mb_lpf_horizontal_edge_w_8 "uint8_t *s, int pitch, const uint8_t *blimit, const uint8_t *limit, const uint8_t *thresh"
specialize vp9_mb_lpf_horizontal_edge_w_8 sse2 avx2 neon dspr2

prototype void vp9_mb_lpf_horizontal_edge_w_16 "uint8_t *s, int pitch, const uint8_t *blimit, const uint8_t *limit, const uint8_t *thresh"
specialize vp9_mb_lpf_horizontal_edge_w_16 sse2 avx2 neon dspr2
