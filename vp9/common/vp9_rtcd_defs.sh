...
prototype void vp9_get_sse_sum "const uint8_t *src_ptr, int source_stride, const uint8_t *ref_ptr, int ref_stride, unsigned int *sse, int *sum"
specialize vp9_get_sse_sum sse2
vp9_get_sse_sum_sse2=vp9_get8x8var_sse2
