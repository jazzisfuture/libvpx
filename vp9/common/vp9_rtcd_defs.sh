...
if [ "CONFIG_FILTERBIT" = "yes" ]; then
prototype void vp9_intra4x4_predict "struct macroblockd *xd, int block, enum BLOCK_SIZE_TYPE bsize, int b_mode, int filterbit, uint8_t *predictor, int pre_stride"
