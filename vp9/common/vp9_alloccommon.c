...
void vp9_free_frame_buffers(VP9_COMMON *oci) {
  ...
  oci->above_context[0] = oci->above_context[1] = oci->above_context[2] = 0;
  oci->mip = 0;
  oci->prev_mip = 0;
...
int vp9_alloc_frame_buffers(VP9_COMMON *oci, int width, int height) {
  ...
  oci->above_context[0] = vpx_calloc(sizeof(ENTROPY_CONTEXT) * 8 * mb_cols, 1);
  ...
  oci->above_context[2] =
    oci->above_context[1] + sizeof(ENTROPY_CONTEXT) * 2 * mb_cols;
