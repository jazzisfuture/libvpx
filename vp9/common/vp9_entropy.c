...
#if CONFIG_TX_SKIP
uint8_t vp9_coefband_tx_skip[MAX_NUM_COEFS] = {
    TX_SKIP_COEFF_BAND
};
...
#if CONFIG_TX_SKIP
      , {  // Band 6
          {   37, 196,  97 }, {   64, 124, 117 }, {   25,  87,  71 },
          {   13,  67,  51 }, {   10,  57,  33 }, {    7,  44,  16 }
      }
#endif  // CONFIG_TX_SKIP
    }, {  // Inter
      {  // Band 0
...
#if CONFIG_TX_SKIP
      , {  // Band 6
          {   36, 193, 193 }, {   54, 140, 198 }, {   37,  99, 115 },
          {   15,  65,  47 }, {    5,  51,  34 }, {    5,  34,  12 }
      }
#endif  // CONFIG_TX_SKIP
    }
  }, {  // UV plane
...
#if CONFIG_TX_SKIP
      , {  // Band 6
          {   22, 204, 187 }, {   30, 125, 172 }, {   15,  88, 126 },
          {    6,  59,  93 }, {    3,  40,  63 }, {    1,  19,  36 }
      }
#endif  // CONFIG_TX_SKIP
    }, {  // Inter
      {  // Band 0
...
#if CONFIG_TX_SKIP
      , {  // Band 6
          {   29, 202, 233 }, {   40, 146, 220 }, {   21, 106, 161 },
          {    9,  53,  95 }, {    6,  34,  48 }, {    1,   5,  47 }
      }
#endif  // CONFIG_TX_SKIP
    }
  }
...
#if CONFIG_TX_SKIP
      , {  // Band 6
          {    5, 224, 109 }, {   10, 137, 129 }, {    4, 107,  69 },
          {    3,  78,  44 }, {    1,  56,  26 }, {    1,  39,  12 }
      }
#endif  // CONFIG_TX_SKIP
    }, {  // Inter
      {  // Band 0
...
#if CONFIG_TX_SKIP
      , {  // Band 6
          {    6, 219, 217 }, {    7, 169, 207 }, {    6, 115,  99 },
          {    3,  82,  39 }, {    2,  43,  27 }, {    2,  30,  11 }
      }
#endif  // CONFIG_TX_SKIP
    }
  }, {  // UV plane
...
#if CONFIG_TX_SKIP
      , {  // Band 6
          {    8, 219, 186 }, {    8, 131, 164 }, {    4,  81, 110 },
          {    1,  45,  74 }, {    1,  27,  39 }, {    5,  10,  23 }
      }
#endif  // CONFIG_TX_SKIP
    }, {  // Inter
      {  // Band 0
...
#if CONFIG_TX_SKIP
      , {  // Band 6
          {   11, 220, 238 }, {   10, 157, 213 }, {    6,  85, 134 },
          {    4,  42,  72 }, {    3,  36,  36 }, {    1,   1,   1 }
      }
#endif  // CONFIG_TX_SKIP
    }
  }
...
#if CONFIG_TX_SKIP
      , {  // Band 6
          {    1, 234, 102 }, {    2, 137, 117 }, {    1, 118,  58 },
          {    1,  74,  33 }, {    1,  42,  20 }, {    1,  27,  10 }
      }
#endif  // CONFIG_TX_SKIP
    }, {  // Inter
      {  // Band 0
...
#if CONFIG_TX_SKIP
      , {  // Band 6
          {    2, 222, 223 }, {    1, 179, 219 }, {    2, 129,  80 },
          {    1,  92,  22 }, {    1,  40,  17 }, {    1,  28,  11 }
      }
#endif  // CONFIG_TX_SKIP
    }
  }, {  // UV plane
...
#if CONFIG_TX_SKIP
      , {  // Band 6
          {    9, 239, 182 }, {   12, 136, 163 }, {    8,  81, 101 },
          {    1,  33,  70 }, {    1,  16,  39 }, {    1,   1,   2 }
      }
#endif  // CONFIG_TX_SKIP
    }, {  // Inter
      {  // Band 0
...
#if CONFIG_TX_SKIP
      , {  // Band 6
          {   31, 238, 246 }, {   33, 178, 213 }, {   47,  82, 129 },
          {    1,   1,  98 }, {  128, 128, 128 }, {  128, 128, 128 }
      }
#endif  // CONFIG_TX_SKIP
    }
  }
...
#if CONFIG_TX_SKIP
      , {  // Band 6
          {    1, 246, 117 }, {    2, 158, 120 }, {    1, 119,  67 },
          {    1,  74,  40 }, {    1,  27,  20 }, {    1,  19,   8 }
      }
#endif  // CONFIG_TX_SKIP
    }, {  // Inter
      {  // Band 0
...
#if CONFIG_TX_SKIP
      , {  // Band 6
          {   20, 251,  43 }, {   67, 157, 136 }, {   26, 156,  74 },
          {   14, 105,  51 }, {   31,  35,   8 }, {    1,  33,   1 }
      }
#endif  // CONFIG_TX_SKIP
    }
  }, {  // UV plane
...
#if CONFIG_TX_SKIP
      , {  // Band 6
          {    2, 250, 241 }, {    8, 153, 221 }, {   21,  76, 114 },
          {    1,  48,  85 }, {    1,   1,  54 }, {    1,   1,   1 }
      }
#endif  // CONFIG_TX_SKIP
    }, {  // Inter
      {  // Band 0
...
vp9_coeff_probs_pxd default_coef_probs_pxd[TX_SIZES][PLANE_TYPES] = {
    {  // TX_4X4
        {  // Y plane
            {  // Intra
                {  // ctx 0
                    123, 197,  82, 133, 130, 159, 165, 138, 202, 162, 153,
                },
                {  // ctx 1
                    85, 138, 114, 172, 150, 165, 185, 151, 200, 163, 151,
                },
                {  // ctx 2
                    46, 112,  65, 145, 127, 162, 198, 143, 203, 173, 153,
                },
                {  // ctx 3
                    30,  82,  47, 141,  94, 156, 152, 143, 201, 163, 153,
                },
                {  // ctx 4
                    34,  81,  42,  81, 101, 128, 204, 136, 203, 174, 151,
                },
                {  // ctx 5
                    60,  92,  62,  69, 113, 132,  87, 105, 201, 160, 154,
                },
            },
            {  // Inter
                {  // ctx 0
                    128, 139, 126, 139, 129, 135, 141, 134, 145, 133, 136,
                },
                {  // ctx 1
                    118, 127, 128, 140, 130, 134, 140, 133, 147, 140, 135,
                },
                {  // ctx 2
                    112, 120, 118, 136, 125, 135, 140, 131, 149, 136, 134,
                },
                {  // ctx 3
                    106, 113, 114, 132, 120, 131, 138, 130, 149, 138, 136,
                },
                {  // ctx 4
                    104, 110, 110, 123, 121, 126, 139, 130, 149, 137, 138,
                },
                {  // ctx 5
                    104, 108, 107, 114, 119, 128, 121, 122, 149, 131, 138,
                },
            },
        },
        {  // UV plane
            {  // Intra
                {  // ctx 0
                    88, 200, 202, 223, 185, 180, 203, 181, 155, 154, 126,
                },
                {  // ctx 1
                    77, 124, 189, 218, 180, 178, 200, 174, 165, 164, 126,
                },
                {  // ctx 2
                    46, 108, 137, 207, 159, 164, 201, 173, 168, 166, 126,
                },
                {  // ctx 3
                    45,  75, 103, 182, 124, 156, 201, 172, 166, 166, 126,
                },
                {  // ctx 4
                    53,  70,  82, 145, 108, 134, 193, 152, 168, 166, 126,
                },
                {  // ctx 5
                    80,  87,  90, 105, 115, 122, 144, 122, 163, 160, 131,
                },
            },
            {  // Inter
                {  // ctx 0
                    124, 140, 139, 144, 136, 137, 143, 134, 145, 143, 128,
                },
                {  // ctx 1
                    115, 127, 136, 144, 136, 138, 141, 132, 146, 144, 128,
                },
                {  // ctx 2
                    108, 119, 127, 139, 131, 135, 142, 130, 146, 143, 130,
                },
                {  // ctx 3
                    106, 110, 118, 134, 125, 133, 140, 126, 146, 142, 131,
                },
                {  // ctx 4
                    106, 110, 116, 122, 122, 127, 138, 125, 146, 142, 130,
                },
                {  // ctx 5
                    107, 108, 111, 115, 122, 127, 127, 120, 146, 141, 131,
                },
            },
        },
    },
    {  // TX_8X8
        {  // Y plane
            {  // Intra
                {  // ctx 0
                    41, 230,  93, 168, 124, 159, 192, 157, 204, 180, 154,
                },
                {  // ctx 1
                    25, 137, 109, 176, 147, 168, 190, 154, 202, 175, 153,
                },
                {  // ctx 2
                    16, 107,  65, 160, 108, 158, 201, 151, 204, 178, 155,
                },
                {  // ctx 3
                    10,  70,  50, 146,  91, 152, 171, 144, 202, 174, 159,
                },
                {  // ctx 4
                    15,  54,  43,  96,  95, 129, 191, 142, 204, 174, 158,
                },
                {  // ctx 5
                    49,  67,  60,  78, 110, 128, 109, 104, 201, 167, 159,
                },
            },
            {  // Inter
                {  // ctx 0
                    114, 147, 112, 117, 123, 131, 122, 125, 138, 124, 142,
                },
                {  // ctx 1
                    112, 132, 120, 122, 127, 131, 129, 126, 141, 130, 141,
                },
                {  // ctx 2
                    107, 123, 109, 122, 121, 131, 132, 122, 144, 128, 146,
                },
                {  // ctx 3
                    107, 120, 106, 112, 121, 129, 116, 121, 140, 125, 146,
                },
                {  // ctx 4
                    104, 110, 106, 112, 118, 127, 130, 122, 145, 128, 146,
                },
                {  // ctx 5
                    105, 111, 104, 107, 119, 128, 112, 119, 141, 122, 146,
                },
            },
        },
        {  // UV plane
            {  // Intra
                {  // ctx 0
                    93, 219, 199, 220, 186, 178, 187, 170, 145, 144, 126,
                },
                {  // ctx 1
                    57, 138, 182, 214, 181, 179, 190, 160, 155, 154, 126,
                },
                {  // ctx 2
                    33, 110, 132, 206, 152, 173, 191, 168, 156, 156, 126,
                },
                {  // ctx 3
                    43,  73,  94, 180, 115, 151, 192, 154, 163, 162, 126,
                },
                {  // ctx 4
                    59,  78,  89, 133, 108, 128, 184, 150, 160, 155, 128,
                },
                {  // ctx 5
                    89,  93,  94, 109, 113, 131, 144, 119, 151, 148, 128,
                },
            },
            {  // Inter
                {  // ctx 0
                    116, 144, 137, 142, 137, 131, 140, 129, 138, 137, 126,
                },
                {  // ctx 1
                    110, 129, 134, 143, 137, 137, 142, 129, 138, 138, 126,
                },
                {  // ctx 2
                    107, 119, 124, 137, 132, 134, 140, 127, 143, 142, 126,
                },
                {  // ctx 3
                    106, 111, 115, 131, 125, 132, 142, 127, 141, 141, 126,
                },
                {  // ctx 4
                    107, 110, 115, 123, 120, 125, 141, 124, 141, 141, 128,
                },
                {  // ctx 5
                    108, 111, 110, 114, 120, 128, 129, 123, 143, 140, 128,
                },
            },
        },
    },
    {  // TX_16X16
        {  // Y plane
            {  // Intra
                {  // ctx 0
                    32, 242,  82, 160, 117, 157, 188, 156, 202, 172, 154,
                },
                {  // ctx 1
                    13, 139,  97, 177, 154, 168, 189, 152, 201, 173, 148,
                },
                {  // ctx 2
                    8, 108,  53, 153,  94, 155, 202, 151, 203, 174, 154,
                },
                {  // ctx 3
                    5,  69,  41, 137,  87, 151, 155, 131, 200, 165, 157,
                },
                {  // ctx 4
                    13,  57,  36,  85,  89, 128, 181, 139, 202, 166, 154,
                },
                {  // ctx 5
                    47,  65,  57,  74, 107, 121, 100, 104, 199, 158, 158,
                },
            },
            {  // Inter
                {  // ctx 0
                    125, 148, 116, 127, 125, 137, 127, 129, 142, 127, 138,
                },
                {  // ctx 1
                    111, 134, 123, 130, 129, 134, 125, 126, 143, 127, 136,
                },
                {  // ctx 2
                    107, 125, 112, 125, 122, 133, 129, 129, 141, 125, 143,
                },
                {  // ctx 3
                    106, 117, 109, 116, 119, 132, 121, 123, 140, 122, 140,
                },
                {  // ctx 4
                    106, 111, 107, 113, 117, 130, 122, 124, 143, 120, 138,
                },
                {  // ctx 5
                    106, 110, 106, 107, 123, 124, 112, 118, 138, 118, 143,
                },
            },
        },
        {  // UV plane
            {  // Intra
                {  // ctx 0
                    142, 233, 201, 197, 165, 153, 173, 158, 136, 136, 126,
                },
                {  // ctx 1
                    72, 159, 167, 201, 168, 161, 171, 149, 141, 141, 126,
                },
                {  // ctx 2
                    60, 116, 115, 183, 138, 152, 183, 160, 143, 142, 126,
                },
                {  // ctx 3
                    59,  87,  97, 154, 108, 137, 176, 148, 141, 139, 126,
                },
                {  // ctx 4
                    71,  80,  93, 123, 106, 135, 173, 143, 143, 140, 126,
                },
                {  // ctx 5
                    106, 106, 108, 110, 122, 124, 128, 120, 143, 141, 126,
                },
            },
            {  // Inter
                {  // ctx 0
                    124, 146, 137, 145, 138, 136, 135, 127, 131, 131, 126,
                },
                {  // ctx 1
                    111, 130, 135, 143, 135, 131, 135, 130, 133, 133, 126,
                },
                {  // ctx 2
                    111, 119, 123, 136, 133, 133, 135, 131, 134, 133, 128,
                },
                {  // ctx 3
                    110, 114, 117, 130, 126, 132, 135, 127, 133, 132, 126,
                },
                {  // ctx 4
                    115, 117, 121, 126, 125, 128, 131, 126, 133, 133, 126,
                },
                {  // ctx 5
                    118, 119, 120, 122, 124, 128, 130, 122, 133, 131, 128,
                },
            },
        },
    },
    {  // TX_32X32
        {  // Y plane
            {  // Intra
                {  // ctx 0
                    73, 250,  97,  89,  96, 148, 139, 115, 189, 159, 166,
                },
                {  // ctx 1
                    50, 175, 132, 143, 143, 148, 164, 127, 196, 171, 164,
                },
                {  // ctx 2
                    23, 139,  44, 107,  89, 151, 190, 115, 198, 168, 166,
                },
                {  // ctx 3
                    14, 111,  40,  94,  91, 147, 115, 132, 200, 163, 174,
                },
                {  // ctx 4
                    5,  51,  26,  71,  87, 130, 179, 123, 202, 155, 164,
                },
                {  // ctx 5
                    28,  64,  42,  51, 102, 131,  75, 103, 197, 147, 173,
                },
            },
            {  // Inter
                {  // ctx 0
                    143, 142, 111, 112, 119, 130, 129, 123, 136, 128, 133,
                },
                {  // ctx 1
                    134, 134, 120, 118, 126, 128, 127, 119, 127, 128, 131,
                },
                {  // ctx 2
                    123, 128, 113, 114, 126, 129, 126, 120, 130, 132, 136,
                },
                {  // ctx 3
                    113, 120, 112, 115, 123, 131, 123, 122, 133, 127, 138,
                },
                {  // ctx 4
                    122, 123, 116, 116, 124, 127, 124, 126, 135, 131, 133,
                },
                {  // ctx 5
                    114, 115, 113, 114, 120, 125, 120, 123, 133, 124, 137,
                },
            },
        },
        {  // UV plane
            {  // Intra
                {  // ctx 0
                    98, 231, 210, 168, 140, 140, 157, 143, 140, 140, 126,
                },
                {  // ctx 1
                    107, 174, 164, 162, 137, 136, 158, 140, 143, 142, 126,
                },
                {  // ctx 2
                    79, 129, 133, 151, 126, 141, 158, 142, 140, 136, 126,
                },
                {  // ctx 3
                    84, 102, 111, 136, 122, 128, 144, 128, 145, 139, 128,
                },
                {  // ctx 4
                    96, 106, 119, 118, 124, 133, 144, 127, 139, 132, 128,
                },
                {  // ctx 5
                    111, 110, 117, 114, 129, 132, 121, 126, 143, 140, 126,
                },
            },
            {  // Inter
                {  // ctx 0
                    138, 126, 126, 126, 126, 126, 126, 126, 126, 126, 126,
                },
                {  // ctx 1
                    133, 126, 126, 126, 126, 126, 126, 126, 126, 126, 126,
                },
                {  // ctx 2
                    130, 125, 125, 125, 126, 126, 128, 125, 126, 126, 126,
                },
                {  // ctx 3
                    125, 125, 128, 126, 126, 126, 126, 126, 126, 126, 126,
                },
                {  // ctx 4
                    125, 125, 125, 128, 125, 128, 126, 126, 126, 126, 126,
                },
                {  // ctx 5
...
void vp9_default_coef_probs(VP9_COMMON *cm) {
  ...
  //memset(cm->fc.coef_probs_pxd, 128, sizeof(cm->fc.coef_probs_pxd));
#endif  // CONFIG_TX_SKIP
}
...
static void adapt_coef_probs(VP9_COMMON *cm, TX_SIZE tx_size,
  ...
  const vp9_tree_index vp9_coef_tree_2[TREE_SIZE(ENTROPY_TOKENS)] = {
      -EOB_TOKEN, 2,                       // 0  = EOB
      -ZERO_TOKEN, 4,                      // 1  = ZERO
      -ONE_TOKEN, 6,                       // 2  = ONE
      8, 12,                               // 3  = LOW_VAL
    ...
    for (i = 0; i < PLANE_TYPES; ++i)
      for (j = 0; j < REF_TYPES; ++j)
        for (l = 0; l < COEFF_CONTEXTS; ++l) {
          ...
          vp9_tree_merge_probs(vp9_coef_tree_2, pre_probs_pxd[i][j][l],
                               counts_pxd[i][j][l],
                               count_sat, update_factor, probs_pxd[i][j][l]);

          probs_pxd[i][j][l][0] =  merge_probs(pre_probs[i][j][k][l][0],
                                               eob_ct,
                                               count_sat, update_factor);
        }
  }
        ...
        for (l = 0; l < 6; ++l) {
          for (idx = 0; idx < 12; idx++) {
            ...
            for (t = TX_4X4; t < TX_SIZES; t++) {
              temp += cm->counts.coef_pxd[t][i][j][l][idx];
            }

            for (t = TX_4X4; t < TX_SIZES; t++) {
              cm->counts.coef_pxd[t][i][j][l][idx] = temp;
            }
          }
        }
      }
