...
vp9_coeff_probs_pxd default_coef_probs_pxd[TX_SIZES][PLANE_TYPES] = {
    {  // TX_SIZE 0
        {  // plane 0
            ...
            {  // ref 1
                {  // ctx 0
                    119, 199, 129, 217, 153, 175, 230, 170, 253, 215, 255,
                },
                {  // ctx 1
                    72, 127, 132, 216, 149, 175, 229, 166, 254, 225, 255,
                },
                {  // ctx 2
                    38,  90,  88, 195, 127, 165, 228, 156, 254, 222, 250,
                },
                {  // ctx 3
                    17,  59,  61, 173,  99, 156, 214, 140, 255, 220, 255,
                },
                {  // ctx 4
                    11,  40,  37, 101,  89, 132, 216, 115, 254, 225, 255,
                },
                {  // ctx 5
        ...
        {  // plane 1
            {  // ref 0
                {  // ctx 0
                    77, 209, 164, 218, 157, 175, 244, 175, 255, 248, 128,
                },
                {  // ctx 1
                    52, 122, 142, 210, 159, 175, 227, 155, 255, 246, 128,
                },
                {  // ctx 2
                    27,  88,  99, 190, 127, 162, 235, 164, 255, 233, 128,
                },
                {  // ctx 3
                    15,  46,  71, 158, 106, 150, 219, 141, 255, 244, 128,
                },
                {  // ctx 4
                    8,  37,  54, 117, 100, 142, 215, 133, 255, 234, 128,
                },
                {  // ctx 5
                    3,  17,  46,  72, 118, 143, 146, 104, 255, 220, 255,
                },
            },
            {  // ref 1
                {  // ctx 0
                    116, 205, 194, 220, 168, 176, 240, 169, 255, 242, 255,
                },
                {  // ctx 1
                    73, 133, 184, 214, 168, 172, 232, 158, 255, 240, 255,
                },
                {  // ctx 2
                    41, 100, 122, 184, 142, 160, 224, 143, 254, 229, 255,
                },
                {  // ctx 3
                    21,  55,  79, 153, 111, 150, 218, 128, 255, 245, 255,
                },
                {  // ctx 4
                    12,  39,  51, 105,  98, 138, 209, 113, 254, 241, 255,
                },
                {  // ctx 5
                    4,  17,  37,  61, 102, 130, 137,  97, 254, 218, 255,
                },
            },
        },
    },
    {  // TX_SIZE 1
        ...
        {  // plane 1
            {  // ref 0
                {  // ctx 0
                    76, 234, 176, 221, 163, 178, 245, 179, 255, 250, 128,
                },
                {  // ctx 1
                    27, 135, 152, 221, 165, 179, 232, 159, 255, 245, 128,
                },
                {  // ctx 2
                    12,  85,  96, 194, 127, 160, 243, 169, 255, 237, 128,
                },
                {  // ctx 3
                    7,  47,  66, 161, 108, 150, 222, 147, 255, 242, 128,
                },
                {  // ctx 4
                    4,  36,  46, 122,  91, 137, 223, 138, 255, 233, 255,
                },
                {  // ctx 5
                    1,  17,  35,  61, 110, 136, 143, 101, 255, 220, 255,
                },
            },
            {  // ref 1
                {  // ctx 0
                    130, 234, 165, 188, 150, 160, 215, 129, 255, 251, 128,
                },
                {  // ctx 1
                    41, 139, 156, 195, 170, 165, 209, 111, 255, 253, 128,
                },
                {  // ctx 2
                    18,  84,  89, 141, 131, 157, 212,  90, 255, 249, 128,
                },
                {  // ctx 3
                    8,  40,  47,  83,  95, 147, 170,  80, 255, 252, 128,
                },
                {  // ctx 4
                    8,  36,  42,  74,  93, 136, 168,  93, 255, 245, 255,
                },
                {  // ctx 5
                    3,  28,  34,  70,  92, 129, 150,  97, 255, 236, 255,
                },
            },
        },
    },
    {  // TX_SIZE 2
        {  // plane 0
            ...
            {  // ref 1
                {  // ctx 0
                    118, 247, 104, 164, 139, 178, 146, 140, 232, 148, 255,
                },
                {  // ctx 1
                    24, 142, 121, 218, 152, 192, 165, 165, 244, 164, 255,
                },
                {  // ctx 2
                    10, 108,  64, 183, 110, 178, 179, 168, 239, 140, 255,
                },
                {  // ctx 3
                    5,  63,  28,  98,  88, 166, 109, 109, 229, 128, 255,
                },
                {  // ctx 4
                    5,  41,  17,  52,  85, 139,  88, 122, 223, 105, 255,
                },
                {  // ctx 5
                    2,  18,   6,  17,  91, 135,  32,  85, 164,  72, 255,
                },
            },
        },
        {  // plane 1
            {  // ref 0
                {  // ctx 0
                    126, 249, 176, 212, 148, 172, 249, 178, 255, 249, 128,
                },
                {  // ctx 1
                    34, 155, 150, 204, 164, 177, 208, 134, 255, 240, 128,
                },
                {  // ctx 2
                    16, 100, 102, 181, 114, 157, 235, 156, 255, 208, 128,
                },
                {  // ctx 3
                    6,  45,  76, 133, 101, 144, 188, 123, 255, 231, 128,
                },
                {  // ctx 4
                    3,  31,  38,  93,  91, 133, 216, 129, 255, 183, 128,
                },
                {  // ctx 5
                    0,  13,  28,  32, 134, 126,  93,  92, 255, 233, 128,
                },
            },
            {  // ref 1
                {  // ctx 0
                    155, 246, 176, 203, 154, 153, 220, 134, 255, 253, 128,
                },
                {  // ctx 1
                    29, 140, 167, 217, 189, 159, 219, 117, 255, 255, 128,
                },
                {  // ctx 2
                    10,  87,  87, 149, 138, 157, 222,  87, 255, 253, 255,
                },
                {  // ctx 3
                    3,  40,  45,  85,  96, 150, 176,  76, 255, 254, 128,
                },
                {  // ctx 4
                    4,  37,  40,  73,  94, 142, 170,  95, 255, 250, 128,
                },
                {  // ctx 5
                    1,  31,  34,  67, 100, 137, 153,  95, 255, 241, 255,
                },
            },
        },
    },
    {  // TX_SIZE 3
        {  // plane 0
            ...
            {  // ref 1
                {  // ctx 0
                    250, 254,  10,  33,  59, 156, 181, 106, 225, 153, 255,
                },
                {  // ctx 1
                    227, 215,  40,  41,  78, 170,  99,  59, 187, 196, 255,
                },
                {  // ctx 2
                ...
                {  // ctx 4
                    66,  72,  13,  30,  99, 147,  96, 127, 227, 128, 255,
                },
                {  // ctx 5
        ...
        {  // plane 1
            {  // ref 0
                {  // ctx 0
                    51, 252, 195, 198, 151, 184, 251, 191, 255, 255, 128,
                },
                {  // ctx 1
                    14, 184, 112, 122, 145, 156, 233, 137, 255, 242, 128,
                },
                {  // ctx 2
                    6, 109, 154, 156, 127, 192, 206, 107, 255, 230, 128,
                },
                {  // ctx 3
                    3,  37,  88, 100, 165, 139, 212, 164, 254, 225, 255,
                },
                {  // ctx 4
                    0,  37,  82, 108, 118, 151, 197,  88, 231, 128, 255,
                },
                {  // ctx 5
                    1,   9,  52,  35, 183, 137,  77, 108, 255, 220, 128,
                },
            },
            {  // ref 1
                {  // ctx 0
                ...
                {  // ctx 3
                    0,   0, 255, 128, 128, 128, 128, 128, 128, 128, 128,
                },
                {  // ctx 4
                    0,   0,   0, 255,   0, 255, 128, 128, 128, 128, 128,
                },
                {  // ctx 5
