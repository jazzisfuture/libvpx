...
#if CONFIG_BALANCED_COEFTREE && 0 >= TX_SIZE_BALANCED_START
...
#if CONFIG_BALANCED_COEFTREE && 1 >= TX_SIZE_BALANCED_START
...
#if CONFIG_BALANCED_COEFTREE && 2 >= TX_SIZE_BALANCED_START
...
#if CONFIG_BALANCED_COEFTREE && 3 >= TX_SIZE_BALANCED_START
