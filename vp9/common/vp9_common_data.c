...
const int block_type_to_ablocks_wide[BLOCK_SIZE_TYPES] =
  {1, 1, 2, 2, 2, 4, 4, 4, 8, 8, 8, 16, 16};
const int block_type_to_ablocks_high[BLOCK_SIZE_TYPES] =
...
const PARTITION_TYPE
  ...
  {  // 4X4
    // 4X4, 4X8,8X4,8X8,8X16,16X8,MB16X16,16X32,32X16,32X32,32X64,64X32,64X64
