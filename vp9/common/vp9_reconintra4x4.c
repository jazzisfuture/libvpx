...
void vp9_filter_intra4x4_predict(BLOCKD *x,
  ...
  double cv[10] = {
    0.427564, 0, 0.990567, 0.304926, 0, 0.297085, 0.710759, 0, 0.334470, 0
  };
  double ch[10] = {
    0.644141, 0, 0.552083, 0.993424, 0, 0.347753, 0.495451, 0, 0.742129, 0
  };
  double cd[10] = {
    -0.343843, 0, -0.541060, -0.304502, 0, 0.434364, -0.169892, 0, -0.054123, 0
  };
  ...
  switch (b_mode) {
    case B_VE_PRED :
      mean = (double)Above[0] + (double)Above[1] +
             (double)Above[2] + (double)Above[3];
      mean = mean/4;
      break;
    case B_HE_PRED :
      mean = (double)Left[0] + (double)Left[1] +
             (double)Left[2] + (double)Left[3];
      mean = mean/4;
      break;
    default :
      mean = (double)Above[0] + (double)Above[1] +
