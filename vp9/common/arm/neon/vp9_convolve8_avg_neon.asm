...
;
    ...
    EXPORT  |vp9_convolve8_avg_horiz_neon_asm|
    EXPORT  |vp9_convolve8_avg_vert_neon_asm|
...
|vp9_convolve8_avg_horiz_neon_asm| PROC
...
|vp9_convolve8_avg_vert_neon_asm| PROC
    ldr             r12, [sp, #12]
    cmp             r12, #16
