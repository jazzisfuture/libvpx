...
|vp9_short_idct16x16_add_neon_pass1| PROC
    ...
    ; dct_const_round_shift(step2[4] * cospi_28_64 - step2[7] * cospi_4_64)
    ...
    ; dct_const_round_shift(step2[4] * cospi_4_64 + step2[7] * cospi_28_64)
    ...
    ; dct_const_round_shift(input[5] * cospi_12_64 - input[3] * cospi_20_64)
    ...
    ; dct_const_round_shift((step1[0] + step1[1]) * cospi_16_64)
    ...
    ; dct_const_round_shift(input[1] * cospi_8_64 + input[3] * cospi_24_64)
    ...
    ; dct_const_round_shift(input[1] * cospi_24_64 - input[3] * cospi_8_64)
    ...
    ; dct_const_round_shift((step2[6] - step2[5]) * cospi_16_64)
    ...
    ; dct_const_round_shift((step2[5] + step2[6]) * cospi_16_64)
...
|vp9_short_idct16x16_add_neon_pass2| PROC
    ...
    ; dct_const_round_shift(step1[8] * cospi_30_64 - step1[15] * cospi_2_64);
    ...
    ; dct_const_round_shift(step1[8] * cospi_2_64 + step1[15] * cospi_30_64)
    vqrshrn.s32     d14, q2, #14              ; >> 14
    vqrshrn.s32     d15, q3, #14              ; >> 14
    ...
    ; dct_const_round_shift(step1[9] * cospi_14_64 - step1[14] * cospi_18_64)
    ...
    ; dct_const_round_shift(step1[9] * cospi_18_64 + step1[14] * cospi_14_64)
    vqrshrn.s32     d12, q2, #14              ; >> 14
    vqrshrn.s32     d13, q3, #14              ; >> 14
    ...
    ; dct_const_round_shift(step1[10] * cospi_22_64 - step1[13] * cospi_10_64)
    ...
    ; dct_const_round_shift(step1[10] * cospi_10_64 + step1[13] * cospi_22_64)
    ...
    ; dct_const_round_shift(step1[11] * cospi_6_64 - step1[12] * cospi_26_64)
    ...
    ; dct_const_round_shift(step1[11] * cospi_26_64 + step1[12] * cospi_6_64)
    ...
    ; dct_const_round_shift(-step1[9] * cospi_8_64 + step1[14] * cospi_24_64)
    ...
    ; dct_const_round_shift(step1[9] * cospi_24_64 + step1[14] * cospi_8_64)
    vqrshrn.s32     d12, q2, #14              ; >> 14
    vqrshrn.s32     d13, q3, #14              ; >> 14
    ...
    ; dct_const_round_shift(-step1[10] * cospi_8_64 + step1[13] * cospi_24_64)
    vqrshrn.s32     d4, q11, #14              ; >> 14
    vqrshrn.s32     d5, q12, #14              ; >> 14
    ...
    ; dct_const_round_shift((-step1[10] + step1[13]) * cospi_16_64)
