...
|vp9_short_idct10_16x16_add_neon_pass1| PROC
    ...
    ; stage 4
    vdup.16         q15, r3                   ; cospi_16_64*2

    ; generate cospi_16_64 = 11585
    mov             r3, #0x2d00
    add             r3, #0x41

    vdup.16         d22, r3;                  ; duplicate cospi_16_64

    ; step2[0] = dct_const_round_shift(step1[0] * cospi_16_64)
    vqrdmulh.s16    q8, q8, q15

    ; step2[6] * cospi_16_64
    vmull.s16       q9, d14, d22
    vmull.s16       q10, d15, d22

    ; step2[5] * cospi_16_64
    vmull.s16       q12, d9, d22
    vmull.s16       q11, d8, d22
    ...
    vadd.s16        q8, q8, q7                ; step2[0] = step1[0] + step1[7];
...
|vp9_short_idct10_16x16_add_neon_pass2| PROC
    ...
    vdup.16         q6, r12                   ; duplicate 28cospi_2_64
    ...
    vdup.16         q15, r3                   ; duplicate 2*cospi_6_64

    ; dct_const_round_shift(input_dc * cospi_16_64)
    vqrdmulh.s16    q4, q9, q15
