...
|vp9_short_idct16x16_add_neon_pass2| PROC
    ...
    vaddw.u8        q12, q12, d28             ; ROUND_POWER_OF_TWO(temp_out[j], 6) + dest[j * dest_stride + i]
    vaddw.u8        q13, q13, d29             ; ROUND_POWER_OF_TWO(temp_out[j], 6) + dest[j * dest_stride + i]
    ...
    vaddw.u8        q0, q0, d28               ; ROUND_POWER_OF_TWO(temp_out[j], 6) + dest[j * dest_stride + i]
    vqmovun.s16     d28, q0                   ; clip pixel
    vst1.64         {d28}, [r9], r8           ; store the stata
    vld1.64         {d28}, [r7], r8           ; load destinatoin data
    vrshr.s16       q1, q1, #6
    vaddw.u8        q1, q1, d29               ; ROUND_POWER_OF_TWO(temp_out[j], 6) + dest[j * dest_stride + i]
    vqmovun.s16     d29, q1                   ; clip pixel
    vst1.64         {d29}, [r9], r8           ; store the stata
    vld1.64         {d29}, [r7], r8           ; load destinatoin data
    vrshr.s16       q2, q2, #6
    vaddw.u8        q2, q2, d28               ; ROUND_POWER_OF_TWO(temp_out[j], 6) + dest[j * dest_stride + i]
    vqmovun.s16     d28, q2                   ; clip pixel
    vst1.64         {d28}, [r9], r8           ; store the stata
    vld1.64         {d28}, [r7], r8           ; load destinatoin data
    vrshr.s16       q3, q3, #6
    vaddw.u8        q3, q3, d29               ; ROUND_POWER_OF_TWO(temp_out[j], 6) + dest[j * dest_stride + i]
    vqmovun.s16     d29, q3                   ; clip pixel
    vst1.64         {d29}, [r9], r8           ; store the stata
    vld1.64         {d29}, [r7], r8           ; load destinatoin data
    vrshr.s16       q4, q4, #6
    vaddw.u8        q4, q4, d28               ; ROUND_POWER_OF_TWO(temp_out[j], 6) + dest[j * dest_stride + i]
    vqmovun.s16     d28, q4                   ; clip pixel
    vst1.64         {d28}, [r9], r8           ; store the stata
    vld1.64         {d28}, [r7], r8           ; load destinatoin data
    vrshr.s16       q5, q5, #6
    vaddw.u8        q5, q5, d29               ; ROUND_POWER_OF_TWO(temp_out[j], 6) + dest[j * dest_stride + i]
    vqmovun.s16     d29, q5                   ; clip pixel
    vst1.64         {d29}, [r9], r8           ; store the stata
    vld1.64         {d29}, [r7], r8           ; load destinatoin data
    vrshr.s16       q6, q6, #6
    vaddw.u8        q6, q6, d28               ; ROUND_POWER_OF_TWO(temp_out[j], 6) + dest[j * dest_stride + i]
    vqmovun.s16     d28, q6                   ; clip pixel
    vst1.64         {d28}, [r9], r8           ; store the stata
    vld1.64         {d28}, [r7], r8           ; load destinatoin data
    vrshr.s16       q7, q7, #6
    vaddw.u8        q7, q7, d29               ; ROUND_POWER_OF_TWO(temp_out[j], 6) + dest[j * dest_stride + i]
