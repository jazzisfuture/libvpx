...
static inline void LD_16x8(uint8_t *d,
                           int d_stride,
                           uint8x16_t *q8u8,
                           uint8x16_t *q9u8,
                           uint8x16_t *q10u8,
...
static inline void ADD_DIFF_16x8(uint8x16_t qdiffu8,
                                 uint8x16_t *q8u8,
                                 uint8x16_t *q9u8,
                                 uint8x16_t *q10u8,
                                 uint8x16_t *q11u8,
...
static inline void SUB_DIFF_16x8(uint8x16_t qdiffu8,
                                 uint8x16_t *q8u8,
                                 uint8x16_t *q9u8,
                                 uint8x16_t *q10u8,
                                 uint8x16_t *q11u8,
...
static inline void ST_16x8(uint8_t *d,
                           int d_stride,
                           uint8x16_t *q8u8,
                           uint8x16_t *q9u8,
                           uint8x16_t *q10u8,
...
void vp9_idct32x32_1_add_neon(tran_low_t *input,
                              uint8_t *dest,
                              int dest_stride) {
