...
static void LD_16x8(
        ...
        uint8x16_t *q14u8,
        uint8x16_t *q15u8) {
    *q8u8  = vld1q_u8(d); d += d_stride;
    *q9u8  = vld1q_u8(d); d += d_stride;
    *q10u8 = vld1q_u8(d); d += d_stride;
    *q11u8 = vld1q_u8(d); d += d_stride;
    *q12u8 = vld1q_u8(d); d += d_stride;
    *q13u8 = vld1q_u8(d); d += d_stride;
    *q14u8 = vld1q_u8(d); d += d_stride;
    *q15u8 = vld1q_u8(d);
    return;
}

static void ADD_DIFF_16x8(
        uint8x16_t qdiffu8,
        uint8x16_t *q8u8,
        uint8x16_t *q9u8,
        uint8x16_t *q10u8,
...
static void ST_16x8(
        ...
        uint8x16_t *q14u8,
        uint8x16_t *q15u8) {
    vst1q_u8(d, *q8u8);  d += d_stride;
    vst1q_u8(d, *q9u8);  d += d_stride;
    vst1q_u8(d, *q10u8); d += d_stride;
    vst1q_u8(d, *q11u8); d += d_stride;
    vst1q_u8(d, *q12u8); d += d_stride;
    vst1q_u8(d, *q13u8); d += d_stride;
    vst1q_u8(d, *q14u8); d += d_stride;
    vst1q_u8(d, *q15u8);
    return;
}
