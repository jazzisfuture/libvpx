...
void vp9_h_predictor_16x16_neon(
    ...
    for (j = 0; j < 2; j++, d2u8 = vget_high_u8(q1u8)) {
        ...
        vst1q_u8(dst, q0u8); dst += y_stride;
...
void vp9_h_predictor_32x32_neon(
    ...
    for (k = 0; k < 2; k++, left += 16) {
        ...
        for (j = 0; j < 2; j++, d2u8 = vget_high_u8(q1u8)) {
            q0u8 = vdupq_lane_u8(d2u8, 0);
            vst1q_u8(dst, q0u8);
            vst1q_u8(dst + 16, q0u8); dst += y_stride;
            q0u8 = vdupq_lane_u8(d2u8, 1);
            vst1q_u8(dst, q0u8);
            vst1q_u8(dst + 16, q0u8); dst += y_stride;
            q0u8 = vdupq_lane_u8(d2u8, 2);
...
void vp9_tm_predictor_8x8_neon(
    ...
    for (j = 0; j < 2; j++, d20u16 = vget_high_u16(q10u16)) {
        ...
        vst1_u64((uint64_t *)dst, vreinterpret_u64_u8(d0u8)); dst += y_stride;
