...
void vp9_dc_predictor_8x8_neon(uint8_t *dst, ptrdiff_t y_stride,
                               const uint8_t *above, const uint8_t *left) {
  dc_8x8(dst, y_stride, above, left);
}

void vp9_dc_left_predictor_8x8_neon(uint8_t *dst, ptrdiff_t y_stride,
                                    const uint8_t *above, const uint8_t *left) {
  (void)above;
  dc_8x8(dst, y_stride, NULL, left);
}

void vp9_dc_top_predictor_8x8_neon(uint8_t *dst, ptrdiff_t y_stride,
                                   const uint8_t *above, const uint8_t *left) {
  (void)left;
  dc_8x8(dst, y_stride, above, NULL);
}

void vp9_dc_128_predictor_8x8_neon(uint8_t *dst, ptrdiff_t y_stride,
                                   const uint8_t *above, const uint8_t *left) {
  (void)above;
  (void)left;
