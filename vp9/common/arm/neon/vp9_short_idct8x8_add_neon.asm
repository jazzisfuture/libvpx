...
;
    ...
    vqrshrn.s32     d8, q0, #14               ; >> 14
    vqrshrn.s32     d9, q1, #14               ; >> 14
    ...
    ; dct_const_round_shift(input_dc * cospi_16_64)
    vqrshrn.s32     d26, q0, #14              ; >> 14
    vqrshrn.s32     d27, q1, #14              ; >> 14
    ...
    vadd.s16        q15, q7, q6               ; step2[7] = step1[6] + step1[7]

    ; stage 3 -odd half
    vmov            q4, q12                   ; step1[4] = step2[4];

    ; temp1 = (step2[6] - step2[5]) * cospi_16_64;
    vdup.16         d16, r7;                   ; duplicate cospi_16_64

    ; step2[6] - step2[5]
    vsub.s16        q11, q14, q13

    ; (step2[6] - step2[5]) * cospi_16_64
    vmull.s16       q9, d22, d16
    vmull.s16       q10, d23, d16
