...
|vp9_short_idct10_8x8_add_neon| PROC
    ...
    mul             r11, r3, r10
    vdup.16         q0, r11                   ; duplicate cospi_28_64
    vqrdmulh.s16    q4, q9, q0

    ; dct_const_round_shift(input[1] * cospi_4_64)
    mul             r11, r4, r10
    vdup.16         q0, r11                   ; duplicate cospi_4_64
    vqrdmulh.s16    q7, q9, q0

    ; dct_const_round_shift(- input[3] * cospi_20_64)
    mul             r11, r6, r10
    rsb             r11, #0
    vdup.16         q0, r11                   ; duplicate -cospi_20_64
    vqrdmulh.s16    q5, q11, q0

    ; dct_const_round_shift(input[3] * cospi_12_64)
    mul             r11, r5, r10
    vdup.16         q0, r11                   ; duplicate cospi_12_64
    vqrdmulh.s16    q6, q11, q0

    ; stage 2 & stage 3 - even half
    ; dct_const_round_shift(input_dc * cospi_16_64)
    mul             r11, r7, r10
    vdup.16         q0, r11                   ; duplicate cospi_16_64
    vqrdmulh.s16    q9, q8, q0

    ; dct_const_round_shift(input[1] * cospi_24_64)
    mul             r11, r8, r10
    vdup.16         q0, r11                   ; duplicate cospi_24_64
    vqrdmulh.s16    q13, q10, q0
