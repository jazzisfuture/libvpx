...
|vp9_short_idct10_8x8_add_neon| PROC
    ...
    mov             r10, r3, lsl #1
    vdup.16         q0, r10                   ; duplicate cospi_28_64*2
    mov             r10, r4, lsl #1
    vdup.16         q1, r10                   ; duplicate cospi_4_64*2
    ...
    ; stage 2 & stage 3 - even half
    mov             r10, r8, lsl #1
    vdup.16         q1, r10                   ; duplicate cospi_24_64*2

    ; dct_const_round_shift(input_dc * cospi_16_64)
    vqrdmulh.s16    q9, q8, q0

    mov             r10, r9, lsl #1
    vdup.16         q0, r10                   ; duplicate cospi_8_64*2
