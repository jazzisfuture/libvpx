...
static void GENERATE_COSINE_CONSTANTS(
        int16x4_t *d0s16,
        int16x4_t *d1s16,
        int16x4_t *d2s16) {
    int16_t cospi_8_64, cospi_16_64, cospi_24_64;
...
static void GENERATE_SINE_CONSTANTS(
        int16x4_t *d3s16,
        int16x4_t *d4s16,
        int16x4_t *d5s16,
        int16x8_t *q3s16) {
    int16_t sinpi_1_9, sinpi_2_9, sinpi_3_9, sinpi_4_9;
