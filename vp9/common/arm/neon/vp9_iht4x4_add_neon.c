...
static inline void TRANSPOSE4X4(int16x8_t *q8s16,
                                int16x8_t *q9s16) {
...
static inline void GENERATE_COSINE_CONSTANTS(int16x4_t *d0s16,
                                             int16x4_t *d1s16,
                                             int16x4_t *d2s16) {
...
static inline void GENERATE_SINE_CONSTANTS(int16x4_t *d3s16,
                                           int16x4_t *d4s16,
                                           int16x4_t *d5s16,
                                           int16x8_t *q3s16) {
...
static inline void IDCT4x4_1D(int16x4_t *d0s16,
                              int16x4_t *d1s16,
                              int16x4_t *d2s16,
                              int16x8_t *q8s16,
                              int16x8_t *q9s16) {
