...
void vp9_lpf_vertical_4_dual_neon(uint8_t *s, int p,
                                  ...
                                  const uint8_t *limit1,
                                  const uint8_t *thresh1) {
  vp9_lpf_vertical_4(s, p, blimit0, limit0, thresh0, 1);
  vp9_lpf_vertical_4(s + 8 * p, p, blimit1, limit1, thresh1, 1);
}
...
void vp9_lpf_vertical_8_dual_neon(uint8_t *s, int p,
                                  ...
                                  const uint8_t *limit1,
                                  const uint8_t *thresh1) {
  vp9_lpf_vertical_8(s, p, blimit0, limit0, thresh0, 1);
  vp9_lpf_vertical_8(s + 8 * p, p, blimit1, limit1, thresh1, 1);
}
...
void vp9_lpf_vertical_16_dual_neon(uint8_t *s, int p,
  ...
  vp9_lpf_vertical_16(s, p, blimit, limit, thresh);
  vp9_lpf_vertical_16(s + 8 * p, p, blimit, limit, thresh);
}
