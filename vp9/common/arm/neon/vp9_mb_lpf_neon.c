...
void vp9_lpf_vertical_16_neon(
    ...
    case 2: {  // v_mbfilter
        ...
        vst3_lane_u8(st + 3, d1x3u8, 0);
        st += p;
        vst3_lane_u8(st, d0x3u8, 1);
        vst3_lane_u8(st + 3, d1x3u8, 1);
        st += p;
        vst3_lane_u8(st, d0x3u8, 2);
        vst3_lane_u8(st + 3, d1x3u8, 2);
        st += p;
        vst3_lane_u8(st, d0x3u8, 3);
        vst3_lane_u8(st + 3, d1x3u8, 3);
        st += p;
        vst3_lane_u8(st, d0x3u8, 4);
        vst3_lane_u8(st + 3, d1x3u8, 4);
        st += p;
        vst3_lane_u8(st, d0x3u8, 5);
        vst3_lane_u8(st + 3, d1x3u8, 5);
        st += p;
        vst3_lane_u8(st, d0x3u8, 6);
        vst3_lane_u8(st + 3, d1x3u8, 6);
        st += p;
