...
|vp9_mbloop_filter_neon| PROC
    ...
    vmov.u8     d23, #1
    vcge.u8     d24, d0, d24               ; (a > blimit * 2 + limit) * -1
    ...
    vmlal.u8    q14, d3, d27               ; op2 = p0 + q0 + p3 * 3
    vmlal.u8    q14, d4, d21               ; op2 = p0 + q0 + p3 * 3 + p2 * 2
    vaddw.u8    q14, d5                    ; op2=p1 + p0 + q0 + p3 * 3 + p2 *2
    ...
    vmvn        d19, d20                   ; flip flat & mask

    ; Filter does not set op2 or oq2, so use p2 and q2.
    vbit        d2, d30, d20               ; op2 |= r_op2 & (flat & mask)
    vbit        d2, d4, d19                ; op2 |= op2 & ~(flat & mask)

    vbit        d3, d31, d20               ; op1 |= r_op1 & (flat & mask)
    vbit        d3, d25, d19               ; op1 |= f_op1 & ~(flat & mask)

    vbit        d4, d21, d20               ; op0 |= r_op0 & (flat & mask)
    vbit        d4, d24, d19               ; op0 |= f_op0 & ~(flat & mask)

    vbit        d5, d22, d20               ; oq0 |= r_oq0 & (flat & mask)
    vbit        d5, d23, d19               ; oq0 |= f_oq0 & ~(flat & mask)

    vbit        d6, d0, d20                ; oq1 |= r_oq1 & (flat & mask)
    vbit        d6, d26, d19               ; oq1 |= f_oq1 & ~(flat & mask)

    vbit        d7, d1, d20                ; oq2 |= r_oq2 & (flat & mask)
    vbit        d7, d17, d19               ; oq2 |= oq2 & ~(flat & mask)
