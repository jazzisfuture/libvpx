...
|vp9_mbloop_filter_neon| PROC
    ...
    ; This instrcution will truncate the "flat & mask" masks down to 4 bits
    ; each to fit into one 32 bit arm register. The values are stroed in
    ; q10.64[0]. We do not care what is in q10.64[1].
    vshrn.u16   d30, q10, #4
