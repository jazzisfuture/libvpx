...
|vp9_loop_filter_horizontal_edge_neon| PROC
    ...
    vdup.u8     d28, r3                    ; duplicate thresh
...
|vp9_loop_filter_neon| PROC
    ...
    ; hevmask
    vcgt.u8     d21, d21, d28               ; (abs(p1 - p0) > thresh)*-1
    vcgt.u8     d22, d22, d28               ; (abs(q1 - q0) > thresh)*-1
    vmax.u8     d23, d23, d3
    ...
    vaddw.s8    q12, q12, d1                ; filter + 3 * (qs0 - ps0)
