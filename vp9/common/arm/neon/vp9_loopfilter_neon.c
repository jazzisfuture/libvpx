...
static inline void vp9_loop_filter_neon(uint8x8_t dblimit,    // flimit
...
void vp9_lpf_horizontal_4_neon(unsigned char *src,
                               int pitch,
...
void vp9_lpf_vertical_4_neon(unsigned char *src,
                             int pitch,
                             unsigned char *blimit,
                             unsigned char *limit,
                             unsigned char *thresh,
...
static inline void vp9_mbloop_filter_neon(uint8x8_t dblimit,   // mblimit
                                          uint8x8_t dlimit,    // limit
                                          uint8x8_t dthresh,   // thresh
                                          uint8x8_t d3u8,      // p2
                                          uint8x8_t d4u8,      // p2
...
void vp9_lpf_horizontal_8_neon(unsigned char *src,
                               int pitch,
                               unsigned char *blimit,
                               unsigned char *limit,
                               unsigned char *thresh,
...
void vp9_lpf_vertical_8_neon(unsigned char *src,
                             int pitch,
                             unsigned char *blimit,
                             unsigned char *limit,
                             unsigned char *thresh,
