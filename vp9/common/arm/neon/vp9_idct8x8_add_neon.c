...
void vp9_idct8x8_64_add_neon(
    ...
    input += 8;
    q10s16 = vld1q_s16(input);
    input += 8;
    q11s16 = vld1q_s16(input);
    input += 8;
    q12s16 = vld1q_s16(input);
    input += 8;
    q13s16 = vld1q_s16(input);
    input += 8;
    q14s16 = vld1q_s16(input);
    input += 8;
    ...
    d = dest;
    d0u64 = vld1_u64((uint64_t *)d);
    d += dest_stride;
    d1u64 = vld1_u64((uint64_t *)d);
    d += dest_stride;
    d2u64 = vld1_u64((uint64_t *)d);
    d += dest_stride;
    d3u64 = vld1_u64((uint64_t *)d);
    d += dest_stride;
    d4u64 = vld1_u64((uint64_t *)d);
    d += dest_stride;
    d5u64 = vld1_u64((uint64_t *)d);
    d += dest_stride;
    d6u64 = vld1_u64((uint64_t *)d);
    d += dest_stride;
    ...
    d = dest;
    vst1_u64((uint64_t *)d, vreinterpret_u64_u8(d0u8));
    d += dest_stride;
    vst1_u64((uint64_t *)d, vreinterpret_u64_u8(d1u8));
    d += dest_stride;
    vst1_u64((uint64_t *)d, vreinterpret_u64_u8(d2u8));
    d += dest_stride;
    vst1_u64((uint64_t *)d, vreinterpret_u64_u8(d3u8));
    d += dest_stride;
    vst1_u64((uint64_t *)d, vreinterpret_u64_u8(d4u8));
    d += dest_stride;
    vst1_u64((uint64_t *)d, vreinterpret_u64_u8(d5u8));
    d += dest_stride;
    vst1_u64((uint64_t *)d, vreinterpret_u64_u8(d6u8));
    d += dest_stride;
