...
void vp9_idct8x8_64_add_neon(
    ...
    uint64x1_t d0u64, d1u64, d2u64, d3u64, d4u64, d5u64, d6u64, d7u64;
    int16x8_t q8s16, q9s16, q10s16, q11s16, q12s16, q13s16, q14s16, q15s16;
    uint16x8_t q8u16, q9u16, q10u16, q11u16, q12u16, q13u16, q14u16, q15u16;

    q8s16  = vld1q_s16(input); input += 8;
    q9s16  = vld1q_s16(input); input += 8;
    q10s16 = vld1q_s16(input); input += 8;
    q11s16 = vld1q_s16(input); input += 8;
    q12s16 = vld1q_s16(input); input += 8;
    q13s16 = vld1q_s16(input); input += 8;
    q14s16 = vld1q_s16(input); input += 8;
    q15s16 = vld1q_s16(input);
    ...
    d = dest;
    d0u64 = vld1_u64((uint64_t *)d); d += dest_stride;
    d1u64 = vld1_u64((uint64_t *)d); d += dest_stride;
    d2u64 = vld1_u64((uint64_t *)d); d += dest_stride;
    d3u64 = vld1_u64((uint64_t *)d); d += dest_stride;
    d4u64 = vld1_u64((uint64_t *)d); d += dest_stride;
    d5u64 = vld1_u64((uint64_t *)d); d += dest_stride;
    d6u64 = vld1_u64((uint64_t *)d); d += dest_stride;
    d7u64 = vld1_u64((uint64_t *)d);
    ...
    q12u16 = vaddw_u8(vreinterpretq_u16_s16(q12s16),
                      vreinterpret_u8_u64(d4u64));
    q13u16 = vaddw_u8(vreinterpretq_u16_s16(q13s16),
                      vreinterpret_u8_u64(d5u64));
    q14u16 = vaddw_u8(vreinterpretq_u16_s16(q14s16),
                      vreinterpret_u8_u64(d6u64));
    q15u16 = vaddw_u8(vreinterpretq_u16_s16(q15s16),
                      vreinterpret_u8_u64(d7u64));

    d0u8 = vqmovun_s16(vreinterpretq_s16_u16(q8u16));
    d1u8 = vqmovun_s16(vreinterpretq_s16_u16(q9u16));
    d2u8 = vqmovun_s16(vreinterpretq_s16_u16(q10u16));
    d3u8 = vqmovun_s16(vreinterpretq_s16_u16(q11u16));
    d4u8 = vqmovun_s16(vreinterpretq_s16_u16(q12u16));
    d5u8 = vqmovun_s16(vreinterpretq_s16_u16(q13u16));
    d6u8 = vqmovun_s16(vreinterpretq_s16_u16(q14u16));
    d7u8 = vqmovun_s16(vreinterpretq_s16_u16(q15u16));

    d = dest;
    vst1_u64((uint64_t *)d, vreinterpret_u64_u8(d0u8)); d += dest_stride;
    vst1_u64((uint64_t *)d, vreinterpret_u64_u8(d1u8)); d += dest_stride;
    vst1_u64((uint64_t *)d, vreinterpret_u64_u8(d2u8)); d += dest_stride;
    vst1_u64((uint64_t *)d, vreinterpret_u64_u8(d3u8)); d += dest_stride;
    vst1_u64((uint64_t *)d, vreinterpret_u64_u8(d4u8)); d += dest_stride;
    vst1_u64((uint64_t *)d, vreinterpret_u64_u8(d5u8)); d += dest_stride;
    vst1_u64((uint64_t *)d, vreinterpret_u64_u8(d6u8)); d += dest_stride;
    vst1_u64((uint64_t *)d, vreinterpret_u64_u8(d7u8));
    return;
}

void vp9_idct8x8_10_add_neon(
        int16_t *input,
        uint8_t *dest,
        int dest_stride) {
    uint8_t *d;
