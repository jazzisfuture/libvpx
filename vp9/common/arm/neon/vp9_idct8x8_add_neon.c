...
static inline void TRANSPOSE8X8(int16x8_t *q8s16,
                                int16x8_t *q9s16,
                                int16x8_t *q10s16,
                                int16x8_t *q11s16,
                                int16x8_t *q12s16,
...
static inline void IDCT8x8_1D(int16x8_t *q8s16,
                              int16x8_t *q9s16,
                              int16x8_t *q10s16,
                              int16x8_t *q11s16,
                              int16x8_t *q12s16,
...
void vp9_idct8x8_64_add_neon(tran_low_t *input,
                             uint8_t *dest,
                             int dest_stride) {
  uint8_t *d1, *d2;
...
void vp9_idct8x8_12_add_neon(tran_low_t *input,
                             uint8_t *dest,
                             int dest_stride) {
  uint8_t *d1, *d2;
  uint8x8_t d0u8, d1u8, d2u8, d3u8;
