...
void vp9_convolve8_avg_horiz_neon(const uint8_t *src, ptrdiff_t src_stride,
  ...
  uint32x2_t v_u32x2_0, v_u32x2_1, v_u32x2_2,
    v_u32x2_3, v_u32x2_4, v_u32x2_5;
  uint8x16_t v_u8x16_0, v_u8x16_1, v_u8x16_2, v_u8x16_3;
  ...
  for (i = h; i > 0; i -= 4) {
    ...
    for (j = w; j > 0; j -= 4) {
      ...
      v_u32x2_4 =
        vld1_lane_u32((const uint32_t *)pdst, v_u32x2_4, 0);
      v_u32x2_5 =
        vld1_lane_u32((const uint32_t *)((uint8_t *)pdst + dst_stride),
                      v_u32x2_5, 0);
      v_u32x2_4 =
        vld1_lane_u32((const uint32_t *)((uint8_t *)pdst + dst_stride * 2),
                      v_u32x2_4, 1);
      v_u32x2_5 =
        vld1_lane_u32((const uint32_t *)((uint8_t *)pdst + dst_stride * 3),
                      v_u32x2_5, 1);
      ...
      v_u8x16_2 = vcombine_u8(co_u8x8x2.val[0], co_u8x8x2.val[1]);
      v_u8x16_3 = vreinterpretq_u8_u32(vcombine_u32(v_u32x2_4, v_u32x2_5));
      v_u8x16_2 = vrhaddq_u8(v_u8x16_2, v_u8x16_3);
      co_u32x2_0 = vreinterpret_u32_u8(vget_low_u8(v_u8x16_2));
      co_u32x2_1 = vreinterpret_u32_u8(vget_high_u8(v_u8x16_2));
...
void vp9_convolve8_avg_vert_neon(const uint8_t *src, ptrdiff_t src_stride,
    ...
    for (; w > 0; w -= 4) {
      ...
      for (j = h; j > 0; j -= 4) {
        ...
        v_u32x2_8 =
          vld1_lane_u32((const uint32_t *)dst, v_u32x2_8, 0);
        v_u32x2_8 =
          vld1_lane_u32((const uint32_t *)((uint8_t *)dst + dst_stride),
                        v_u32x2_8, 1);
        v_u32x2_9 =
          vld1_lane_u32((const uint32_t *)((uint8_t *)dst + dst_stride * 2),
                        v_u32x2_9, 0);
        v_u32x2_9 =
          vld1_lane_u32((const uint32_t *)((uint8_t *)dst + dst_stride * 3),
                        v_u32x2_9, 1);
        ...
        v_u8x8_0 = vqmovn_u16(v_u16x8_0);
        v_u8x8_1 = vqmovn_u16(v_u16x8_1);

        v_u8x16_0 = vcombine_u8(v_u8x8_0, v_u8x8_1);
        v_u8x16_1 = vreinterpretq_u8_u32(vcombine_u32(v_u32x2_8, v_u32x2_9));

        v_u8x16_0 = vrhaddq_u8(v_u8x16_0, v_u8x16_1);

        v_u32x2_6 = vreinterpret_u32_u8(vget_low_u8(v_u8x16_0));
        v_u32x2_7 = vreinterpret_u32_u8(vget_high_u8(v_u8x16_0));
