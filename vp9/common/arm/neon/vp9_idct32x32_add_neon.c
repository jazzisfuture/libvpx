...
static inline void __STORE_COMBINE_CENTER_RESULTS(uint8_t *p1,
                                                  uint8_t *p2,
                                                  int stride,
                                                  int16x8_t q6s16,
                                                  int16x8_t q7s16,
...
static inline void __STORE_COMBINE_EXTREME_RESULTS(uint8_t *p1,
                                                   uint8_t *p2,
                                                   int stride,
                                                   int16x8_t q4s16,
                                                   int16x8_t q5s16,
...
static inline void DO_BUTTERFLY(int16x8_t q14s16,
                                int16x8_t q13s16,
                                int16_t first_const,
...
static inline void idct32_transpose_pair(int16_t *input,
                                         int16_t *t_buf) {
  int16_t *in;
  int i;
  const int stride = 32;
...
static inline void idct32_bands_end_1st_pass(int16_t *out,
                                             int16x8_t q2s16,
                                             int16x8_t q3s16,
                                             int16x8_t q6s16,
                                             int16x8_t q7s16,
...
static inline void idct32_bands_end_2nd_pass(int16_t *out,
                                             uint8_t *dest,
                                             int stride,
                                             int16x8_t q2s16,
                                             int16x8_t q3s16,
...
void vp9_idct32x32_1024_add_neon(tran_low_t *input,
                                 uint8_t *dest,
                                 int stride) {
    ...
    for (i = 0;
      ...
      if (idct32_pass_loop == 0) {
        idct32_bands_end_1st_pass(out,
                                  q2s16, q3s16, q6s16,
                                  q7s16, q8s16, q9s16,
                                  q10s16, q11s16, q12s16,
                                  q13s16, q14s16, q15s16);
      } else {
