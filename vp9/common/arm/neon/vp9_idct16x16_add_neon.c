...
void vp9_idct16x16_256_add_neon_pass1(
    ...
    q0x2s16 = vld2q_s16(input); q8s16  = q0x2s16.val[0]; input += 16;
    q0x2s16 = vld2q_s16(input); q9s16  = q0x2s16.val[0]; input += 16;
    q0x2s16 = vld2q_s16(input); q10s16 = q0x2s16.val[0]; input += 16;
    q0x2s16 = vld2q_s16(input); q11s16 = q0x2s16.val[0]; input += 16;
    q0x2s16 = vld2q_s16(input); q12s16 = q0x2s16.val[0]; input += 16;
    q0x2s16 = vld2q_s16(input); q13s16 = q0x2s16.val[0]; input += 16;
    q0x2s16 = vld2q_s16(input); q14s16 = q0x2s16.val[0]; input += 16;
    q0x2s16 = vld2q_s16(input); q15s16 = q0x2s16.val[0];
    ...
    // store the data
    output_stride >>= 1;  // output_stride / 2, output is int16_t
    vst1_u64((uint64_t *)output, d16u64); output += output_stride;
    vst1_u64((uint64_t *)output, d17u64); output += output_stride;
    vst1_u64((uint64_t *)output, d18u64); output += output_stride;
    vst1_u64((uint64_t *)output, d19u64); output += output_stride;
    vst1_u64((uint64_t *)output, d20u64); output += output_stride;
    vst1_u64((uint64_t *)output, d21u64); output += output_stride;
    vst1_u64((uint64_t *)output, d22u64); output += output_stride;
    vst1_u64((uint64_t *)output, d23u64); output += output_stride;
    vst1_u64((uint64_t *)output, d24u64); output += output_stride;
    vst1_u64((uint64_t *)output, d25u64); output += output_stride;
    vst1_u64((uint64_t *)output, d26u64); output += output_stride;
    vst1_u64((uint64_t *)output, d27u64); output += output_stride;
    vst1_u64((uint64_t *)output, d28u64); output += output_stride;
    vst1_u64((uint64_t *)output, d29u64); output += output_stride;
    vst1_u64((uint64_t *)output, d30u64); output += output_stride;
    vst1_u64((uint64_t *)output, d31u64);
    return;
}
...
void vp9_idct16x16_256_add_neon_pass2(
    ...
    q0x2s16 = vld2q_s16(src); q15s16 = q0x2s16.val[0];
    ...
    if (skip_adding != 0) {
        ...
        q0s16 = vld1q_s16(pass1Output); pass1Output += 8;
        q1s16 = vld1q_s16(pass1Output); pass1Output += 8;
        d12s64 = vld1_s64((int64_t *)dest); dest += dest_stride;
        d13s64 = vld1_s64((int64_t *)dest); dest += dest_stride;
        ...
        vst1_u64((uint64_t *)d, vreinterpret_u64_u8(d12u8)); d += dest_stride;
        vst1_u64((uint64_t *)d, vreinterpret_u64_u8(d13u8)); d += dest_stride;
        q14s16 = vsubq_s16(q1s16, q14s16);
        q15s16 = vsubq_s16(q0s16, q15s16);

        q10s16 = vld1q_s16(pass1Output); pass1Output += 8;
        q11s16 = vld1q_s16(pass1Output); pass1Output += 8;
        d12s64 = vld1_s64((int64_t *)dest); dest += dest_stride;
        d13s64 = vld1_s64((int64_t *)dest); dest += dest_stride;
        ...
        d26u64 = vreinterpret_u64_s16(vget_low_s16(q13s16));
        d27u64 = vreinterpret_u64_s16(vget_high_s16(q13s16));
        vst1_u64((uint64_t *)output, d24u64); output += 4;
        vst1_u64((uint64_t *)output, d25u64); output += 12;
        vst1_u64((uint64_t *)output, d26u64); output += 4;
        vst1_u64((uint64_t *)output, d27u64); output += 12;
        q14s16 = vsubq_s16(q1s16, q14s16);
        q15s16 = vsubq_s16(q0s16, q15s16);
        ...
        vst1_u64((uint64_t *)output, d16u64); output += 4;
        vst1_u64((uint64_t *)output, d17u64); output += 12;
        vst1_u64((uint64_t *)output, d18u64); output += 4;
        vst1_u64((uint64_t *)output, d19u64); output += 12;
        vst1_u64((uint64_t *)output, d4u64);  output += 4;
        vst1_u64((uint64_t *)output, d5u64);  output += 12;
        vst1_u64((uint64_t *)output, d6u64);  output += 4;
        vst1_u64((uint64_t *)output, d7u64);  output += 12;
        vst1_u64((uint64_t *)output, d8u64);  output += 4;
        vst1_u64((uint64_t *)output, d9u64);  output += 12;
        vst1_u64((uint64_t *)output, d10u64); output += 4;
        vst1_u64((uint64_t *)output, d11u64); output += 12;
        vst1_u64((uint64_t *)output, d28u64); output += 4;
        vst1_u64((uint64_t *)output, d29u64); output += 12;
        vst1_u64((uint64_t *)output, d30u64); output += 4;
        vst1_u64((uint64_t *)output, d31u64);
    }
    return;
}
...
void vp9_idct16x16_10_add_neon_pass1(
    ...
    // store the data
    output_stride >>= 1;  // output_stride / 2, output is int16_t
    vst1_u64((uint64_t *)output, d4u64);  output += output_stride;
    vst1_u64((uint64_t *)output, d5u64);  output += output_stride;
    vst1_u64((uint64_t *)output, d18u64); output += output_stride;
    vst1_u64((uint64_t *)output, d19u64); output += output_stride;
    vst1_u64((uint64_t *)output, d20u64); output += output_stride;
    vst1_u64((uint64_t *)output, d21u64); output += output_stride;
