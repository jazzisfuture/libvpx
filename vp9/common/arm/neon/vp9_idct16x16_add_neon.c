...
void vp9_idct16x16_256_add_neon_pass1(
    ...
    vst1_u64((uint64_t *)output, d16u64);
    output += output_stride;
    vst1_u64((uint64_t *)output, d17u64);
    output += output_stride;
    vst1_u64((uint64_t *)output, d18u64);
    output += output_stride;
    vst1_u64((uint64_t *)output, d19u64);
    output += output_stride;
    vst1_u64((uint64_t *)output, d20u64);
    output += output_stride;
    vst1_u64((uint64_t *)output, d21u64);
    output += output_stride;
    vst1_u64((uint64_t *)output, d22u64);
    output += output_stride;
    vst1_u64((uint64_t *)output, d23u64);
    output += output_stride;
    vst1_u64((uint64_t *)output, d24u64);
    output += output_stride;
    vst1_u64((uint64_t *)output, d25u64);
    output += output_stride;
    vst1_u64((uint64_t *)output, d26u64);
    output += output_stride;
    vst1_u64((uint64_t *)output, d27u64);
    output += output_stride;
    vst1_u64((uint64_t *)output, d28u64);
    output += output_stride;
    vst1_u64((uint64_t *)output, d29u64);
    output += output_stride;
    vst1_u64((uint64_t *)output, d30u64);
    output += output_stride;
...
void vp9_idct16x16_256_add_neon_pass2(
    ...
    if (skip_adding != 0) {
        ...
        vst1_u64((uint64_t *)output, d19u64);
        output += 12;
        vst1_u64((uint64_t *)output, d4u64);
        output += 4;
        vst1_u64((uint64_t *)output, d5u64);
        output += 12;
        vst1_u64((uint64_t *)output, d6u64);
        output += 4;
        vst1_u64((uint64_t *)output, d7u64);
        output += 12;
        vst1_u64((uint64_t *)output, d8u64);
        output += 4;
        vst1_u64((uint64_t *)output, d9u64);
        output += 12;
        vst1_u64((uint64_t *)output, d10u64);
        output += 4;
        vst1_u64((uint64_t *)output, d11u64);
        output += 12;
        vst1_u64((uint64_t *)output, d28u64);
        output += 4;
        vst1_u64((uint64_t *)output, d29u64);
