...
static inline int32x4_t MULTIPLY_BY_Q0(int16x4_t dsrc0,
                                       int16x4_t dsrc1,
                                       int16x4_t dsrc2,
                                       int16x4_t dsrc3,
                                       int16x4_t dsrc4,
...
void vp9_convolve8_horiz_neon(uint8_t *src,
                              ...
                              int h) {
    int width;
    uint8_t *s = NULL, *d = NULL, *psrc = NULL, *pdst = NULL;
...
void vp9_convolve8_vert_neon(uint8_t *src,
                             ptrdiff_t src_stride,
                             uint8_t *dst,
                             ptrdiff_t dst_stride,
