...
/*
 * This functions are only valid when:
 * x_step_q4 == 16
 * w%4 == 0
 * h%4 == 0
 * taps == 8
...
void vp9_convolve8_horiz_neon(const uint8_t *src, ptrdiff_t src_stride,
                              ...
                              const int16_t *filter_y, int y_step_q4,
                              int w, int h) {
  const uint8_t *psrc = NULL, *ps = NULL;
  uint8_t *pdst = NULL, *pd = NULL;
  int i, j;
  ...
  uint16x8_t ci_u16x8_0, ci_u16x8_1, ci_u16x8_2, ci_u16x8_3, ci_u16x8_4, ci_u16x8_5;
  int16x4_t ci_s16x4_0, ci_s16x4_1, ci_s16x4_2, ci_s16x4_3, ci_s16x4_4; //ci_s16x4_5 disused
  int16x4_t ci_s16x4_6, ci_s16x4_7, ci_s16x4_8, ci_s16x4_9, ci_s16x4_10, ci_s16x4_11;
  ...
  */
  for (i = h;
       i > 0;
       i -= 4, src += src_stride << 2, dst += dst_stride << 2) {
    /*
      vld1.8          {d24}, [r0], r1
      vld1.8          {d25}, [r0], r1
      vld1.8          {d26}, [r0], r1
    ...
    */
     ...
     */
    psrc = src;
    v_u8x8_0 = vld1_u8(psrc);
    psrc += src_stride;
    v_u8x8_1 = vld1_u8(psrc);
    psrc += src_stride;
    v_u8x8_2 = vld1_u8(psrc);
    psrc += src_stride;
    v_u8x8_3 = vld1_u8(psrc);
    ...
    */
     ...
     */
    m_u16x8x2 = vtrnq_u16(vreinterpretq_u16_u8(vcombine_u8(v_u8x8_0, v_u8x8_1)),
                          vreinterpretq_u16_u8(vcombine_u8(v_u8x8_2, v_u8x8_3)));
    ...
    */
    /*
     * extend each element in a doubleword vector, i.e., u8x8,
     * to twice its original length, i.e., u16x8.
     *
     * ci_u16x8_0: 33 23 13 03 37 27 17 07
     * ci_u16x8_1: 32 22 12 02 36 26 16 06
     * ci_u16x8_2: 31 21 11 01 35 25 15 05
     * ci_u16x8_3: 30 20 10 00 34 24 14 04
     */
    ci_u16x8_0 = vmovl_u8(v_u8x8_0);
    ci_u16x8_1 = vmovl_u8(v_u8x8_1);
    ci_u16x8_2 = vmovl_u8(v_u8x8_2);
    ci_u16x8_3 = vmovl_u8(v_u8x8_3);
    ...
    */
     ...
     * ci_u16x8_0's high u16x4 and ci_u16x8_1's low u16x4.
     *
     * copy the contents of vector of ci_u16x8_2's high u16x4 to
     * vector of ci_u16x8_3's high u16x4.
     *
     * before:
     * ci_u16x8_0: 33 23 13 03 37 27 17 07
     * ci_u16x8_1: 32 22 12 02 36 26 16 06
     ...
     *
     * after:
     * ci_u16x8_0: 33 23 13 03 32 22 12 02
     * ci_u16x8_1: 37 27 17 07 36 26 16 06
     * ci_u16x8_2: 31 21 11 01 35 25 15 05
     * ci_u16x8_3: 30 20 10 00 35 25 15 05
     */
    ci_u16x8_0 = vcombine_u16(vget_low_u16(ci_u16x8_0),
                              vget_low_u16(ci_u16x8_1));
    ci_u16x8_1 = vcombine_u16(vget_high_u16(ci_u16x8_0),
                              vget_high_u16(ci_u16x8_1));
    ci_u16x8_3 = vcombine_u16(vget_low_u16(ci_u16x8_3),
                              vget_high_u16(ci_u16x8_2));
    ...
    */
    for (j = w, psrc = src + 7, pdst = dst;
      ...
      */
       ...
       */
      ps = psrc;
      v_u32x2_0 = vld1_dup_u32((const uint32_t *)ps);
      ps += src_stride;
      v_u32x2_1 = vld1_dup_u32((const uint32_t *)ps);
      ps += src_stride;
      v_u32x2_2 = vld1_dup_u32((const uint32_t *)ps);
      ps += src_stride;
      v_u32x2_3 = vld1_dup_u32((const uint32_t *)ps);
      ...
      */
       ...
       * to twice its original length, i.e., u16x8.
       *
       * ci_u16x8_4: 314 214 114 014 317 217 117 017
       * ci_u16x8_5: 315 215 115 015 316 216 116 016
       */
      ci_u16x8_4 = vmovl_u8(vreinterpret_u8_u32(vget_low_u32(m_u32x4x2.val[0])));
      ci_u16x8_5 = vmovl_u8(vreinterpret_u8_u32(vget_high_u32(m_u32x4x2.val[0])));
      ...
      */
      ...
      /*
        multiply_by_filter  q1,  d16, d17, d20, d22, d18, d19, d23, d24
        multiply_by_filter  q2,  d17, d20, d22, d18, d19, d23, d24, d26
        multiply_by_filter  q14, d20, d22, d18, d19, d23, d24, d26, d27
        multiply_by_filter  q15, d22, d18, d19, d23, d24, d26, d27, d25
      */
      // src[] * filter_x
      ci_s16x4_0 = vreinterpret_s16_u16(vget_low_u16(ci_u16x8_0));
      ci_s16x4_1 = vreinterpret_s16_u16(vget_high_u16(ci_u16x8_0));
      ci_s16x4_2 = vreinterpret_s16_u16(vget_low_u16(ci_u16x8_1));
      ci_s16x4_3 = vreinterpret_s16_u16(vget_high_u16(ci_u16x8_1));
      ci_s16x4_4 = vreinterpret_s16_u16(vget_low_u16(ci_u16x8_2));
      //ci_s16x4_5 = vreinterpret_s16_u16(vget_high_u16(ci_u16x8_2)); disused
      ci_s16x4_6 = vreinterpret_s16_u16(vget_low_u16(ci_u16x8_3));
      ci_s16x4_7 = vreinterpret_s16_u16(vget_high_u16(ci_u16x8_3));
      ci_s16x4_8 = vreinterpret_s16_u16(vget_low_u16(ci_u16x8_4));
      ci_s16x4_9 = vreinterpret_s16_u16(vget_high_u16(ci_u16x8_4));
      ci_s16x4_10 = vreinterpret_s16_u16(vget_low_u16(ci_u16x8_5));
      ci_s16x4_11 = vreinterpret_s16_u16(vget_high_u16(ci_u16x8_5));

      co_s32x4_0 = multiply_by_filter(ci_s16x4_0, ci_s16x4_1, ci_s16x4_4, ci_s16x4_6,
                                     ci_s16x4_2, ci_s16x4_3, ci_s16x4_7, ci_s16x4_8,
                                     f_s16x8);
      co_s32x4_1 = multiply_by_filter(ci_s16x4_1, ci_s16x4_4, ci_s16x4_6, ci_s16x4_2,
                                     ci_s16x4_3, ci_s16x4_7, ci_s16x4_8, ci_s16x4_10,
                                     f_s16x8);
      co_s32x4_2 = multiply_by_filter(ci_s16x4_4, ci_s16x4_6, ci_s16x4_2, ci_s16x4_3,
                                     ci_s16x4_7, ci_s16x4_8, ci_s16x4_10, ci_s16x4_11,
                                     f_s16x8);
      co_s32x4_3 = multiply_by_filter(ci_s16x4_6, ci_s16x4_2, ci_s16x4_3, ci_s16x4_7,
                                     ci_s16x4_8, ci_s16x4_10, ci_s16x4_11, ci_s16x4_9,
                                     f_s16x8);
      ...
      */
      ...
      pd = pdst;
      vst1_lane_u32((uint32_t *)pd, co_u32x2_0, 0);
      pd += dst_stride;
      vst1_lane_u32((uint32_t *)pd, co_u32x2_1, 0);
      pd += dst_stride;
      vst1_lane_u32((uint32_t *)pd, co_u32x2_0, 1);
      pd += dst_stride;
      vst1_lane_u32((uint32_t *)pd, co_u32x2_1, 1);
      ...
      /*
        ...
        vmov            q9,  q13
      */
      ci_u16x8_0 = ci_u16x8_1;
      ci_u16x8_2 = vcombine_u16(vget_high_u16(ci_u16x8_3),
                                vget_high_u16(ci_u16x8_2));
      ci_u16x8_3 = ci_u16x8_4;
      ci_u16x8_1 = ci_u16x8_5;
    }
  }
}
