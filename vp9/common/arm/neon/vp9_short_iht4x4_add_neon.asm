...
;
    ...
    ; loaded in d16-q19. The output will be stored back into d16-q19 registers.
    ; This macro will touch q10- q15 registers and use them
    ; as buffer during calculation.
    MACRO
    IDCT4x4_1D
    ; stage 1
    ...
    ; Parallel 1D IADST on all the columns of a 4x4 16bits data matrix which are
    ; loaded in d16-q19. The output will be stored back into d16-q19 registers.
    ; This macro will touch q1,q11,q12,q13,q14,q15 registers and use them as buffer during
    ; calculation.
    MACRO
    IADST4x4_1D
    ...
    vadd.s32    q10, q10, q11   ; s3 = x0 + x1 - x3
    ...
    ; Transpose a 4x4 16bit data matrix. Datas are loaded in d16-d19.
    MACRO
    TRANSPOSE4X4
    vtrn.16     d16, d17
    vtrn.16     d18, d19
