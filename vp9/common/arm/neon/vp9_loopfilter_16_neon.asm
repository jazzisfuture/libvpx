...
|vp9_loop_filter_horizontal_edge_16_neon| PROC
    ...
    vld1.8      {d0[]}, [r2]               ; duplicate *blimit0 to first half q
    vld1.8      {d2[]}, [r3]               ; duplicate *limit0 to first half q

    add         r1, r1, r1                 ; double pitch
    ldr         r2, [sp, #8]               ; load *blimit1

    vld1.8      {d4[]}, [r12]              ; duplicate *thresh0 to first half q

    ldr         r3, [sp, #12]              ; load *limit1
    ldr         r12, [sp, #16]             ; load *thresh1
    vld1.8      {d1[]}, [r2]               ; duplicate *blimit1 to 2nd half q

    sub         r2, r0, r1, lsl #1         ; move src pointer down by 4 lines

    vld1.8      {d3[]}, [r3]               ; duplicate *limit1 to 2nd half q
    vld1.8      {d5[]}, [r12]              ; duplicate *thresh1 to 2nd half q
