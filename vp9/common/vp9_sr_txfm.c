...
int post_filter[UPSCALE_FILTER_TAPS - 1] = {3, -8, -12, 39, 82, 39, -12, -8, 3};
int interpl_filter[UPSCALE_FILTER_TAPS] = {1, -4, 10, -23, 80, 80, -23, 10, -4, 1};
...
void sr_lowpass(int16_t *src, int src_stride, int16_t *dst, int dst_stride, int w, int h) {
...
void sr_upsample(int16_t *src, int src_stride, int16_t *dst, int dst_stride, int w, int h) {
  /*** pay attention here when changing the filters  ***/
