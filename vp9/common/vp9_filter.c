...
void vp9_eighttap_predict8x8_smooth(uint8_t *src_ptr,
                                    int src_pixels_per_line,
                                    int xoffset,
                                    int yoffset,
                                    uint8_t *dst_ptr,
...
void vp9_eighttap_predict_avg8x8_smooth(uint8_t *src_ptr,
                                        int src_pixels_per_line,
                                        int xoffset,
                                        int yoffset,
                                        uint8_t *dst_ptr,
...
void vp9_eighttap_predict8x4_smooth(uint8_t *src_ptr,
                                    int src_pixels_per_line,
                                    int xoffset,
                                    int yoffset,
                                    uint8_t *dst_ptr,
...
void vp9_eighttap_predict16x16_smooth(uint8_t *src_ptr,
                                      int src_pixels_per_line,
                                      int xoffset,
                                      int yoffset,
                                      uint8_t *dst_ptr,
...
void vp9_eighttap_predict_avg16x16_smooth(uint8_t *src_ptr,
                                          int src_pixels_per_line,
                                          int xoffset,
                                          int yoffset,
                                          uint8_t *dst_ptr,
