...
extern const int block_type_to_height[BLOCK_SIZE_TYPES];
extern const int block_type_to_width[BLOCK_SIZE_TYPES];
extern const PARTITION_TYPE block_type_to_partition[BLOCK_SIZE_TYPES][BLOCK_SIZE_TYPES];
