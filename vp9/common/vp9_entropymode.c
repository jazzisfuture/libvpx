...
static const vp9_prob default_inter_compound_mode_probs
  ...
  {2,       193,   34},  // 0 = both zero mv
  {7,       165,   85},  // 1 = one zero mv + one a predicted mv
  {7,       186,   63},  // 2 = two predicted mvs
  {7,       114,   66},  // 3 = one predicted/zero and one new mv
  {8,       84,    46},  // 4 = two new mvs
  {17,      99,    31},  // 5 = one intra neighbour + x
  {25,      49,    30},  // 6 = two intra neighbours
};
#endif
