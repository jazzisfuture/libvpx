...
static const vp9_prob default_if_y_probs[BLOCK_SIZE_TYPES][VP9_INTRA_MODES - 1] = {
  {  47,  35,  23, 143, 143, 190,  35,  56, 105 } /* block_size = 4x4 */,
  {  32,  27,  24, 160, 183, 197,  27,  48,  98 } /* block_size = 4x8 */,
  {  44,  28,  23, 149, 163, 195,  31,  51,  95 } /* block_size = 8x4 */,
  { 130,  56,  28, 157, 206, 197,  52,  47,  77 } /* block_size = 8x8 */,
  { 132,  54,  14, 186, 241, 200,  43,  25,  76 } /* block_size = 8x16 */,
  { 153, 100, 106, 129, 166, 151,  69, 100,  59 } /* block_size = 16x8 */,
  { 178,  79,  24, 164, 235, 202,  86,  45,  46 } /* block_size = 16x16 */,
  { 163, 104,  11, 214, 252, 158, 112,  22,  50 } /* block_size = 16x32 */,
  { 208, 190,  91, 133, 189, 113, 106, 134,  58 } /* block_size = 32x16 */,
  { 224, 156,  64, 133, 237, 122, 128, 104,  31 } /* block_size = 32x32 */,
  { 198, 226,  67, 126, 202, 132, 109, 156, 100 } /* block_size = 32x64 */,
  { 216, 227,  47, 110, 177, 110,  49,  67,  24 } /* block_size = 64x32 */,
  { 219, 230,  59, 162, 207, 120, 125, 115, 102 } /* block_size = 64x64 */,
};
...
const vp9_prob vp9_partition_probs[2][NUM_PARTITION_CONTEXTS]
                                  [PARTITION_TYPES - 1] = {
  { /* frame_type = keyframe */
    /* 8x8 -> 4x4 */
