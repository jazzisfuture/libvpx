...
static const vp9_prob default_inter_mode_probs[INTER_MODE_CONTEXTS]
                                              [INTER_MODES - 1] = {
  {2,  2,     173,   34},  // 0 = both zero mv
  {7,  2,   145,   85},  // 1 = one zero mv + one a predicted mv
  {7,  2,    166,   63},  // 2 = two predicted mvs
  {7,  2,    94,    66},  // 3 = one predicted/zero and one new mv
  {8,  2,    64,    46},  // 4 = two new mvs
  {17, 2,    81,    31},  // 5 = one intra neighbour + x
  {25, 2,    29,    30},  // 6 = two intra neighbours
};
#else
static const vp9_prob default_inter_mode_probs[INTER_MODE_CONTEXTS]
                                              [INTER_MODES - 1] = {
...
const vp9_tree_index vp9_inter_mode_tree[TREE_SIZE(INTER_MODES)] = {
  ...
  -INTER_OFFSET(FADEMV), 4
  -INTER_OFFSET(NEARESTMV), 6,
