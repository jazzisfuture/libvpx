...
static const vp9_prob default_inter_compound_mode_probs[INTER_MODE_CONTEXTS]
  ...
  { 7, 145, 150, 192, 192, 128, 180, 180},   // 1 = 1 zero + 1 predicted
  { 7, 166, 126, 192, 192, 128, 180, 180},   // 2 = two predicted mvs
  { 7,  94, 128, 192, 192, 128, 180, 180},   // 3 = 1 pred/zero, 1 new
  { 8,  64,  92, 192, 192, 128, 180, 180},   // 4 = two new mvs
  {17,  81,  62, 192, 192, 128, 180, 180},   // 5 = one intra neighbour
  {25,  29,  60, 192, 192, 128, 180, 180},   // 6 = two intra neighbours
};
