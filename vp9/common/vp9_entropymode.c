...
static const vp9_prob default_inter_compound_mode_probs[INTER_MODE_CONTEXTS]
  ...
  {2,   173,   120,  120, 120, 120, 120, 34},  // 0 = both zero mv
  {7,   145,   120,  120, 120, 120, 120, 85},  // 1 = one zero mv + one a predicted mv
  {7,   166,   120,  120, 120, 120, 120, 63},  // 2 = two predicted mvs
  {7,   94,    120,  120, 120, 120, 120, 66},  // 3 = one predicted/zero and one new mv
  {8,   64,    120,  120, 120, 120, 120, 46},  // 4 = two new mvs
  {17,  81,    120,  120, 120, 120, 120, 31},  // 5 = one intra neighbour + x
