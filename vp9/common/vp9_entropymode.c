...
static const unsigned int uv_mode_cts[VP9_INTRA_MODES][VP9_INTRA_MODES] = {
  /* DC   V   H  D45 135 117 153 D27 D63 BM TM*/
  { 200, 15, 15, 10, 10, 10, 10, 10, 10,  0,  6}, /* DC */
  { 130, 75, 10, 10, 10, 10, 10, 10, 10,  0,  6}, /* V */
  { 130, 10, 75, 10, 10, 10, 10, 10, 10,  0,  6}, /* H */
  { 130, 15, 10, 75, 10, 10, 10, 10, 10,  0,  6}, /* D45 */
  { 150, 15, 10, 10, 75, 10, 10, 10, 10,  0,  6}, /* D135 */
  { 150, 15, 10, 10, 10, 75, 10, 10, 10,  0,  6}, /* D117 */
  { 150, 15, 10, 10, 10, 10, 75, 10, 10,  0,  6}, /* D153 */
  { 150, 15, 10, 10, 10, 10, 10, 75, 10,  0,  6}, /* D27 */
  { 150, 15, 10, 10, 10, 10, 10, 10, 75,  0,  6}, /* D63 */
  { 200, 15, 15, 10, 10, 10, 10, 10, 10,  0,  6}, /* BM */
  { 160, 30, 30, 10, 10, 10, 10, 10, 10,  0, 16}, /* TM */
};

static const unsigned int kf_uv_mode_cts[VP9_INTRA_MODES][VP9_INTRA_MODES] = {
  // DC   V   H  D45 135 117 153 D27 D63 BM TM
  { 160, 24, 24, 20, 20, 20, 20, 20, 20,  0,  8}, /* DC */
  { 102, 64, 30, 20, 20, 20, 20, 20, 20,  0, 10}, /* V */
  { 102, 30, 64, 20, 20, 20, 20, 20, 20,  0, 10}, /* H */
  { 102, 33, 20, 64, 20, 20, 20, 20, 20,  0, 14}, /* D45 */
  { 102, 33, 20, 20, 64, 20, 20, 20, 20,  0, 14}, /* D135 */
  { 122, 33, 20, 20, 20, 64, 20, 20, 20,  0, 14}, /* D117 */
  { 102, 33, 20, 20, 20, 20, 64, 20, 20,  0, 14}, /* D153 */
  { 102, 33, 20, 20, 20, 20, 20, 64, 20,  0, 14}, /* D27 */
  { 102, 33, 20, 20, 20, 20, 20, 20, 64,  0, 14}, /* D63 */
  { 160, 24, 24, 20, 20, 20, 20, 20, 20,  0,  8}, /* BM */
  { 132, 36, 30, 20, 20, 20, 20, 20, 20,  0, 18}, /* TM */
};
#else
static const unsigned int uv_mode_cts[VP9_INTRA_MODES][VP9_INTRA_MODES] = {
...
#if CONFIG_BM_INTRA
const vp9_tree_index vp9_intra_mode_tree_uv[(VP9_INTRA_MODES -1) * 2 - 2] = {
  -DC_PRED, 2,                      /* 0 = DC_NODE */
  -TM_PRED, 4,                      /* 1 = TM_NODE */
  -V_PRED, 6,                       /* 2 = V_NODE */
  8, 12,                            /* 3 = COM_NODE */
