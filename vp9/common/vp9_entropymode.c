...
static const vp9_prob default_inter_compound_mode_probs[INTER_MODE_CONTEXTS]
  ...
  {14,  107,  76,   63,   18,   16,   11,   129}, // 1 = one zero mv + one a predicted mv
  {8,   126,  64,   35,   15,   8,    12,   129}, // 2 = two predicted mvs
  {17,  91,   72,   25,   16,   4,    17,   129}, // 3 = one predicted/zero and one new mv
  {19,  54,   61,   31,   14,   14,   3,    65},  // 4 = two new mvs
  {20,  81,   79,   52,   46,   45,   44,   57},  // 5 = one intra neighbour + x
