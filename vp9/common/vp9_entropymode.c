...
void tx_counts_to_branch_counts(unsigned int *tx_count_32x32p,
  ...
  ct[1][1] = tx_count_16x16p[TX_16X16] +
  ...
  ct[4][0] = tx_count_32x32p[TX_8X8] +
             tx_count_16x16p[TX_8X8];
  ct[4][1] = tx_count_32x32p[TX_16X16] +
             tx_count_32x32p[TX_32X32] +
             tx_count_16x16p[TX_16X16];
  ...
  ct[0][1] = tx_count_32x32p[TX_8X8] +
             ...
             tx_count_16x16p[TX_16X16] +
             tx_count_8x8p[TX_8X8];
  ct[0][0] = tx_count_32x32p[TX_8X8] +
             tx_count_16x16p[TX_8X8];
  ct[0][1] = tx_count_32x32p[TX_16X16] +
             tx_count_32x32p[TX_32X32] +
             tx_count_16x16p[TX_16X16];
  ct[0][0] = tx_count_32x32p[TX_16X16];
  ct[0][1] = tx_count_32x32p[TX_32X32];
#endif
}
