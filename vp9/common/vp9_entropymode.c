...
const vp9_prob vp9_kf_filterintra_prob[TX_SIZES][VP9_INTRA_MODES] = {
...
#endif
#if CONFIG_FILTERINTRA
  vp9_copy(cm->fc.filterintra_prob, vp9_kf_filterintra_prob);
#endif
}
...
#if CONFIG_FILTERINTRA
/*  fc->filterintra_prob =
      update_ct2(pre_fc->filterintra_prob, counts->filterintra);*/
