...
static void high_mb_lpf_horizontal_edge_w_sse2_16(uint16_t *s,
                                                  ...
                                                  const uint8_t *_thresh,
                                                  int bd) {
  high_mb_lpf_horizontal_edge_w_sse2_8(s, p, _blimit, _limit, _thresh, bd);
  high_mb_lpf_horizontal_edge_w_sse2_8(s + 8, p, _blimit, _limit, _thresh, bd);
}
...
void vp9_high_lpf_horizontal_16_sse2(uint16_t *s, int p,
  ...
  if (count == 1)
    ...
    high_mb_lpf_horizontal_edge_w_sse2_16(s, p, _blimit, _limit, _thresh,  bd);
}
...
void vp9_high_lpf_horizontal_8_dual_sse2(uint16_t *s, int p,
                                         ...
                                         int bd) {
  vp9_high_lpf_horizontal_8_sse2(s, p, _blimit0, _limit0, _thresh0, 1, bd);
  vp9_high_lpf_horizontal_8_sse2(s + 8, p, _blimit1, _limit1, _thresh1, 1, bd);
}
...
void vp9_high_lpf_horizontal_4_dual_sse2(uint16_t *s, int p,
                                         ...
                                         const uint8_t *_thresh1,
                                         int bd) {
  vp9_high_lpf_horizontal_4_sse2(s, p, _blimit0, _limit0, _thresh0, 1, bd);
  vp9_high_lpf_horizontal_4_sse2(s + 8, p, _blimit1, _limit1, _thresh1, 1, bd);
}
