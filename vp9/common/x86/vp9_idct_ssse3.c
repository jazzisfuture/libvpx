...
static void idct16_8x4_8col(__m128i *in) {
  const __m128i k__cospi_p30_m02 = pair_set_epi16(cospi_30_64, -cospi_2_64);
  const __m128i k__cospi_p02_p30 = pair_set_epi16(cospi_2_64, cospi_30_64);
  const __m128i k__cospi_p14_m18 = pair_set_epi16(cospi_14_64, -cospi_18_64);
  const __m128i k__cospi_p18_p14 = pair_set_epi16(cospi_18_64, cospi_14_64);
...
//  s[15] = in[15];
  ...
  // ================================
  s[9]  = _mm_setzero_si128();
  s[10] = _mm_setzero_si128();
  s[13] = _mm_setzero_si128();
  s[14] = _mm_setzero_si128();
  // ================================

  // stage 3
  t[0] = s[0];
  t[1] = _mm_setzero_si128();
  t[2] = _mm_setzero_si128();
  t[3] = _mm_setzero_si128();

  t[4] = _mm_mulhrs_epi16(s[4], k__cospi_p28_p28_x2);
  t[7] = _mm_mulhrs_epi16(s[4], k__cospi_p04_p04_x2);

  // ====================================================
  t[5] = _mm_setzero_si128();
  t[6] = _mm_setzero_si128();
  // ====================================================
...
//  s[1] = _mm_mulhrs_epi16(s[0], k__cospi_p16_p16_x2);
  v[4] = _mm_madd_epi16(u[2], k__cospi_p24_m08);
  v[5] = _mm_madd_epi16(u[3], k__cospi_p24_m08);
  v[6] = _mm_madd_epi16(u[2], k__cospi_p08_p24);
  v[7] = _mm_madd_epi16(u[3], k__cospi_p08_p24);
  ...
  // stage 5
  t[0] = _mm_add_epi16(s[0], s[3]);
  t[1] = _mm_add_epi16(s[0], s[2]);
  t[2] = _mm_sub_epi16(s[0], s[2]);
  t[3] = _mm_sub_epi16(s[0], s[3]);
  t[4] = s[4];
  t[7] = s[7];
...
static void idct16_10_sse2(__m128i *in0, __m128i *in1) {
  array_transpose_16x16(in0, in1);
  idct16_8x4_8col(in1);
  idct16_8x4_8col(in0);
}
