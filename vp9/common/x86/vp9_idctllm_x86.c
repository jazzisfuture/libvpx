...
void vp9_short_idct8x8_sse2(int16_t *input, int16_t *output, int pitch) {
  ...
  const __m128i stg3_1 = pair_set_epi16(cospi_16_64, cospi_16_64);
  ...
  for(i = 0; i < 2; i++) {
    ...
    //Stage3
    {
      ...
      const __m128i hi_56 = _mm_unpackhi_epi16(stp2_5, stp2_6);
      ...
      tmp1 = _mm_madd_epi16(hi_56, stg3_0);
      tmp2 = _mm_madd_epi16(lo_56, stg3_1);
      tmp3 = _mm_madd_epi16(hi_56, stg3_1);
