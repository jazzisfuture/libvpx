...
static INLINE void transpose16x16(unsigned char *in0, unsigned char *in1,
  ...
  __m128i x0, x1, x2, x3, x4, x5, x6, x7;
  __m128i x8, x9, x10, x11, x12, x13, x14, x15;
  DECLARE_ALIGNED(16, unsigned char, tmp[16]);

  // interleave 4 loads and 4 unpack
  ...
  // interleave next 4 loads and 4 unpack
  ...
  _mm_store_si128((__m128i *)out, _mm_unpacklo_epi64(x7, x14));

  x7 = _mm_unpackhi_epi64(x7, x14);
  _mm_store_si128((__m128i *)(out + out_p), x7);
  ...
  _mm_store_si128((__m128i *)(out + out_p*4), x7);
  _mm_store_si128((__m128i *)(out + out_p*5), x12);

  x15 = _mm_unpacklo_epi64(x8, x9);
  x8 = _mm_unpackhi_epi64(x8, x9);

  _mm_store_si128((__m128i *)(out + out_p*6), x15);
  _mm_store_si128((__m128i *)(out + out_p*7), x8);

  x10 = _mm_unpacklo_epi64(x11, x4);
  x11 = _mm_unpackhi_epi64(x11, x4);

  _mm_store_si128((__m128i *)(out + out_p*8), x10);
  _mm_store_si128((__m128i *)(out + out_p*9), x11);

  x9 = _mm_unpacklo_epi64(x5, x3);
  x5 = _mm_unpackhi_epi64(x5, x3);

  _mm_store_si128((__m128i *)(out + out_p*10), x9);
  _mm_store_si128((__m128i *)(out + out_p*11), x5);

  x4 = _mm_unpacklo_epi64(x13, x6);
  x13 = _mm_unpackhi_epi64(x13, x6);

  _mm_store_si128((__m128i *)(out + out_p*12), x4);
  _mm_store_si128((__m128i *)(out + out_p*13), x13);

  x11 = _mm_unpacklo_epi64(x0, x2);
  x0 = _mm_unpackhi_epi64(x0, x2);

  _mm_store_si128((__m128i *)(out + out_p*14), x11);
  _mm_store_si128((__m128i *)(out + out_p*15), x0);
}
