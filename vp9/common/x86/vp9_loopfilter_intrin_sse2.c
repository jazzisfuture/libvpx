...
static void mb_lpf_horizontal_edge_w_sse2_8(unsigned char *s,
  ...
  const __m128i blimit = _mm_loadl_epi64((const __m128i *)_blimit);
  const __m128i limit = _mm_loadl_epi64((const __m128i *)_limit);
  const __m128i thresh = _mm_loadl_epi64((const __m128i *)_thresh);
