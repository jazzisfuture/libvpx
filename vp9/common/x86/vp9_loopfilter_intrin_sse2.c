...
void vp9_lpf_vertical_16_sse2(unsigned char *s, int p,
  ...
  if (count > 4)
    ...
    unsigned char *ss        = s - 8;
    *((long long *) ss)      = 0x0706050403020100;
    *((long long *) (ss+p))  = 0x1716151413121110;
    *((long long *) (ss+2*p))= 0x2726252423222120;
    *((long long *) (ss+3*p))= 0x3736353433323130;
