...
void vp9_mbloop_filter_horizontal_edge_uv_sse2(unsigned char *u,
  ...
  /* Loop filtering */
  vp9_mbloop_filter_horizontal_edge_sse2(src + 80, 16, _blimit, _limit,_thresh);
...
static __inline void transpose8x16(unsigned char *in0, unsigned char *in1,
  ...
  _mm_store_si128((__m128i *)out, _mm_unpacklo_epi64(x6, x14));
  _mm_store_si128((__m128i *)(out + out_p), _mm_unpackhi_epi64(x6, x14));
  _mm_store_si128((__m128i *)(out + 2 * out_p), _mm_unpacklo_epi64(x7, x15));
  _mm_store_si128((__m128i *)(out + 3 * out_p), _mm_unpackhi_epi64(x7, x15));
  ...
  _mm_store_si128((__m128i *)(out + 4 * out_p), _mm_unpacklo_epi64(x6, x14));
  _mm_store_si128((__m128i *)(out + 5 * out_p), _mm_unpackhi_epi64(x6, x14));
  _mm_store_si128((__m128i *)(out + 6 * out_p), _mm_unpacklo_epi64(x7, x15));
  _mm_store_si128((__m128i *)(out + 7 * out_p), _mm_unpackhi_epi64(x7, x15));
}
