...
#include <assert.h>
  ...
  typedef struct {
    ...
    long int target_bandwidth;    // bandwidth to be used in kilobits per second
    ...
    long int starting_buffer_level;  // in seconds
    long int optimal_buffer_level;
    long int maximum_buffer_size;
