...
static const uint8_t vp9_nuq_doff_tiny[COEF_BANDS] = { 12, 18, 18, 22, 22, 22 };
static const uint8_t vp9_nuq_doff_low[COEF_BANDS] =  { 12, 18, 18, 22, 22, 22 };
static const uint8_t vp9_nuq_doff_mid[COEF_BANDS] =  { 12, 18, 18, 22, 22, 22 };
static const uint8_t vp9_nuq_doff_high[COEF_BANDS] = { 12, 18, 18, 22, 22, 22 };
static const uint8_t vp9_nuq_doff_huge[COEF_BANDS] = { 12, 18, 18, 22, 22, 22 };
...
static INLINE void get_cumbins_nuq(int q, int band, int bd, tran_low_t *cumbins) {
