...
//
// TODO(debargha): Optimize based on q range. Currently all parameters are same.
...
static const uint8_t vp9_nuq_doff_tiny[COEF_BANDS] = { 10, 16, 17, 22, 22, 24 };
static const uint8_t vp9_nuq_doff_low[COEF_BANDS] =  { 10, 16, 17, 22, 22, 24 };
static const uint8_t vp9_nuq_doff_mid[COEF_BANDS] =  { 10, 16, 17, 22, 22, 24 };
static const uint8_t vp9_nuq_doff_high[COEF_BANDS] = { 10, 16, 17, 22, 22, 24 };
static const uint8_t vp9_nuq_doff_huge[COEF_BANDS] = { 10, 16, 17, 22, 22, 24 };
