...
static const uint8_t vp9_nuq_knotes_tiny[2][NUQ_KNOTES] = {
  {80, 128, 128, 128, 128},  // dc
  {84, 128, 128, 128, 128},  // ac
};
static const uint8_t vp9_nuq_knotes_low[2][NUQ_KNOTES] = {
  {80, 128, 128, 128, 128},  // dc
  {86, 128, 128, 128, 128},  // ac
};
static const uint8_t vp9_nuq_knotes_mid[2][NUQ_KNOTES] = {
  {80, 128, 128, 128, 128},  // dc
  {86, 128, 128, 128, 128},  // ac
};
static const uint8_t vp9_nuq_knotes_high[2][NUQ_KNOTES] = {
  {80, 128, 128, 128, 128},  // dc
  {86, 128, 128, 128, 128},  // ac
};
static const uint8_t vp9_nuq_knotes_huge[2][NUQ_KNOTES] = {
  {80, 128, 128, 128, 128},  // dc
  {86, 128, 128, 128, 128},  // ac
};

static const uint8_t vp9_nuq_doff_tiny[2] = { 16, 22 };
static const uint8_t vp9_nuq_doff_low[2] = { 16, 22 };
static const uint8_t vp9_nuq_doff_mid[2] = { 16, 22 };
static const uint8_t vp9_nuq_doff_high[2] = { 16, 22 };
static const uint8_t vp9_nuq_doff_huge[2] = { 16, 22 };

// Allow different quantization profiles in different q ranges,
// to enable entropy-constraints in scalar quantization.
static const uint8_t *get_nuq_knotes(int16_t quant, int isac) {
  if (quant > 1024)
    return vp9_nuq_knotes_huge[isac];
  else if (quant > 512)
    return vp9_nuq_knotes_high[isac];
  else if (quant > 256)
    return vp9_nuq_knotes_mid[isac];
  else if (quant > 128)
    return vp9_nuq_knotes_low[isac];
  else
    return vp9_nuq_knotes_tiny[isac];
}

static INLINE int16_t quant_to_doff_fixed(int16_t quant, int isac) {
  if (quant > 1024)
    return vp9_nuq_doff_huge[isac];
  else if (quant > 512)
    return vp9_nuq_doff_high[isac];
  else if (quant > 256)
    return vp9_nuq_doff_mid[isac];
  else if (quant > 128)
    return vp9_nuq_doff_low[isac];
  else
    return vp9_nuq_doff_tiny[isac];
}
...
static INLINE void get_cumbins_nuq(int q, int isac, tran_low_t *cumbins) {
  const uint8_t *knotes = get_nuq_knotes(q, isac);
