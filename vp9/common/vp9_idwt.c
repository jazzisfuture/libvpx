...
#if DWT_TYPE == 26
  dyadic_synthesize_26(5, 32, 32, input, 32, output, stride, 1);
#elif DWT_TYPE == 97
  dyadic_synthesize_97(5, 32, 32, input, 32, output, stride, 1);
#elif DWT_TYPE == 53
  dyadic_synthesize_53(5, 32, 32, input, 32, output, stride, 1);
#endif
}
...
#if DWT_TYPE == 26
  dyadic_synthesize_26(6, 64, 64, input, 64, output, stride, 1);
#elif DWT_TYPE == 97
  dyadic_synthesize_97(6, 64, 64, input, 64, output, stride, 1);
#elif DWT_TYPE == 53
  dyadic_synthesize_53(6, 64, 64, input, 64, output, stride, 1);
#endif
}
