...
void vp9_idwtdct32x32_c(const tran_low_t *input, tran_low_t *output, int stride) {
...
void vp9_idwtdct32x32_add_c(const tran_low_t *input, uint8_t *dest, int stride) {
  int i, j;
  tran_low_t output[32 * 32];
...
void vp9_idwtdct64x64_c(const tran_low_t *input, tran_low_t *output, int stride) {
  const int dwt_levels = 1;
...
void vp9_idwtdct64x64_add_c(const tran_low_t *input, uint8_t *dest, int stride) {
  int i, j;
  tran_low_t output[64 * 64];
