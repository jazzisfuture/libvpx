...
void vp9_intra4x4_predict(MACROBLOCKD *xd,
                          ...
                          int mode,
                          uint8_t *predictor, int pre_stride) {
  const int have_top = (block_idx >> (2 >> CONFIG_SB8X8)) || xd->up_available;
  const int have_left = (block_idx & (3 >> CONFIG_SB8X8)) || xd->left_available;
  const int have_right = ((block_idx & (3 >> CONFIG_SB8X8)) != (3 >> CONFIG_SB8X8));
