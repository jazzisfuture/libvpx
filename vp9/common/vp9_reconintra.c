...
// TODO(jingning): This function subsumes vp9_build_intra_predictors_internal()
// BLOCK_SIZE_TYPE is enabled down to 4x4.
...
void vp9_build_intra_predictors_internal(uint8_t *src, int src_stride,
  ...
  switch (mode) {
    ...
    case TM_PRED:
      ...
      break;
    case D45_PRED:
      d45_predictor(ypred_ptr, y_stride, bsize, bsize, yabove_row, yleft_col);
      break;
    case D135_PRED:
      d135_predictor(ypred_ptr, y_stride, bsize, bsize, yabove_row, yleft_col);
      break;
    case D117_PRED:
      d117_predictor(ypred_ptr, y_stride, bsize, bsize, yabove_row, yleft_col);
      break;
    case D153_PRED:
      d153_predictor(ypred_ptr, y_stride, bsize, bsize, yabove_row, yleft_col);
      break;
    case D27_PRED:
      d27_predictor(ypred_ptr, y_stride, bsize, bsize, yabove_row, yleft_col);
      break;
    case D63_PRED:
      d63_predictor(ypred_ptr, y_stride, bsize, bsize, yabove_row, yleft_col);
      break;
    case I8X8_PRED:
    case B_PRED:
    case NEARESTMV:
...
// TODO(jingning): all the following functions should be replaced with the
// above two, when BLOCK_SIZE_TYPE is enabled down to 4x4.
