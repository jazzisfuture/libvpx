...
void vp9_intra8x8_predict(MACROBLOCKD *xd,
  ...
  const int have_left = ODD(block_idx)  || xd->left_available;
  const int have_right = !ODD(block_idx) || xd->right_available;
