...
static int buffer_offset_with_scaling(int x_offset,
                                      int y_offset,
                                      int stride,
                                      const struct scale_factors *scale) {
...
static int buffer_offset_without_scaling(int x_offset,
                                         int y_offset,
                                         int stride,
                                         const struct scale_factors *scale) {
  (void) scale;
...
static void setup_pred_block(YV12_BUFFER_CONFIG *dst,
  ...
  if (scale) {
    recon_yoffset = scale->scaled_buffer_offset(16 * mb_col, 16 * mb_row,
                                                recon_y_stride, scale);
    recon_uvoffset = scale->scaled_buffer_offset(8 * mb_col, 8 * mb_row,
