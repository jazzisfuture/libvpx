...
${ndk_path}/toolchains/renderscript/prebuilt/${arch}/bin/llvm-rs-cc -o ./obj/ -d ./obj/ -MD -reflect-c++ -I ${ndk_path}/toolchains/renderscript/prebuilt/${arch}/lib/clang/3.3/include -I ${ndk_path}/platforms/android-${api}/arch-${platform}/usr/include/rs/scriptc ${input3}.rs

${ndk_path}/toolchains/renderscript/prebuilt/${arch}/bin/llvm-rs-cc -o ./obj/ -d ./obj/ -MD -reflect-c++ -I ${ndk_path}/toolchains/renderscript/prebuilt/${arch}/lib/clang/3.3/include -I ${ndk_path}/platforms/android-${api}/arch-${platform}/usr/include/rs/scriptc ${input4}.rs
...
${ndk_path}/toolchains/renderscript/prebuilt/${arch}/bin/bcc_compat -O3 -o ./obj/${input3}.bc.o -fPIC -shared -rt-path ${ndk_path}/toolchains/renderscript/prebuilt/${arch}/lib/libclcore.bc -mtriple ${target}-none-linux-gnueabi ./obj/${input3}.bc

${ndk_path}/toolchains/renderscript/prebuilt/${arch}/bin/bcc_compat -O3 -o ./obj/${input4}.bc.o -fPIC -shared -rt-path ${ndk_path}/toolchains/renderscript/prebuilt/${arch}/lib/libclcore.bc -mtriple ${target}-none-linux-gnueabi ./obj/${input4}.bc
...
${ndk_path}/toolchains/${platform}-linux-androideabi-4.6/prebuilt/${arch}/bin/${platform}-linux-androideabi-g++ -shared -Wl,-soname,librs.${input3}.so -nostdlib ./obj/${input3}.bc.o ${ndk_path}/platforms/android-${api}/arch-${platform}/usr/lib/rs/libcompiler_rt.a -o ./obj/librs.${input3}.so -L ${ndk_path}/platforms/android-${api}/arch-${platform}/usr/lib -L ${ndk_path}/platforms/android-${api}/arch-${platform}/usr/lib/rs -lRSSupport -lm -lc

${ndk_path}/toolchains/${platform}-linux-androideabi-4.6/prebuilt/${arch}/bin/${platform}-linux-androideabi-g++ -shared -Wl,-soname,librs.${input4}.so -nostdlib ./obj/${input4}.bc.o ${ndk_path}/platforms/android-${api}/arch-${platform}/usr/lib/rs/libcompiler_rt.a -o ./obj/librs.${input4}.so -L ${ndk_path}/platforms/android-${api}/arch-${platform}/usr/lib -L ${ndk_path}/platforms/android-${api}/arch-${platform}/usr/lib/rs -lRSSupport -lm -lc
...
${ndk_path}/toolchains/${platform}-linux-androideabi-4.6/prebuilt/${arch}/bin/${platform}-linux-androideabi-g++ -MMD -MP -MF ./obj/${input3}.o.d -fpic -ffunction-sections -funwind-tables -fstack-protector -no-canonical-prefixes -march=armv7-a -mfloat-abi=softfp -mfpu=vfpv3-d16 -fno-exceptions -fno-rtti -mthumb -Os -g -DNDEBUG -fomit-frame-pointer -fno-strict-aliasing -finline-limit=64 -I${ndk_path}/platforms/android-${api}/arch-${platform}/usr/include/rs/cpp -I${ndk_path}/platforms/android-${api}/arch-${platform}/usr/include/rs -I${ndk_path}/sources/cxx-stl/stlport/stlport -I${ndk_path}/sources/cxx-stl//gabi++/include -DANDROID  -Wa,--noexecstack -Wformat -Werror=format-security  -frtti -I${ndk_path}/platforms/android-${api}/arch-${platform}/usr/include -fno-rtti -c ./obj/ScriptC_${input3}.cpp -o ./obj/${input3}.o

${ndk_path}/toolchains/${platform}-linux-androideabi-4.6/prebuilt/${arch}/bin/${platform}-linux-androideabi-g++ -MMD -MP -MF ./obj/${input4}.o.d -fpic -ffunction-sections -funwind-tables -fstack-protector -no-canonical-prefixes -march=armv7-a -mfloat-abi=softfp -mfpu=vfpv3-d16 -fno-exceptions -fno-rtti -mthumb -Os -g -DNDEBUG -fomit-frame-pointer -fno-strict-aliasing -finline-limit=64 -I${ndk_path}/platforms/android-${api}/arch-${platform}/usr/include/rs/cpp -I${ndk_path}/platforms/android-${api}/arch-${platform}/usr/include/rs -I${ndk_path}/sources/cxx-stl/stlport/stlport -I${ndk_path}/sources/cxx-stl//gabi++/include -DANDROID  -Wa,--noexecstack -Wformat -Werror=format-security  -frtti -I${ndk_path}/platforms/android-${api}/arch-${platform}/usr/include -fno-rtti -c ./obj/ScriptC_${input4}.cpp -o ./obj/${input4}.o
