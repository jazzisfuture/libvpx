...
#if HAVE_DSPR2
void idct16_1d_rows_dspr2(int16_t *input, int16_t *output) {
  int i;
  ...
  for (i = 0; i < 16; ++i) {
    ...
    __asm__ __volatile__ (
        ...
        /* temp1 = (input[0] + input[8]) * cospi_16_64;
           step2_0 = dct_const_round_shift(temp1);
           temp2 = (input[0] - input[8]) * cospi_16_64;
        ...
        */
        ...
        /* temp1 = input[4] * cospi_24_64 - input[12] * cospi_8_64;
        ...
        */
        ...
        /* temp2 = input[4] * cospi_8_64  + input[12] * cospi_24_64;
    ...
    __asm__ __volatile__ (
        ...
        /* temp1 = input[1] * cospi_30_64 - input[15] * cospi_2_64;
          step2_8 = dct_const_round_shift(temp1);
        */
        "mtlo     %[const_2_power_13],  $ac1                            \n\t"
        "mthi     $zero,                $ac1                            \n\t"
        "mtlo     %[const_2_power_13],  $ac3                            \n\t"
        ...
        /* temp1 = input[9] * cospi_14_64 - input[7] * cospi_18_64;
          step2_9 = dct_const_round_shift(temp1);
        */
        ...
        /* temp2 = input[9] * cospi_18_64 + input[7] * cospi_14_64;
           step2_14 = dct_const_round_shift(temp2);
        */
        "madd     $ac1,                 %[load7],       %[cospi_18_64]  \n\t"
        "madd     $ac1,                 %[load8],       %[cospi_14_64]  \n\t"
        "extp     %[result3],           $ac1,           31              \n\t"

        /* temp2 = input[1] * cospi_2_64  + input[15] * cospi_30_64;  const_2_power_13 = 8192
           step2_15 = dct_const_round_shift(temp2);
        */
        ...
        /* step1_8 = step2_8 + step2_9;
           ...
           step1_15 = step2_15 + step2_14;
           step2_8  = step1_8;
           step2_15 = step1_15;
           temp1 = step1_14 * cospi_24_64 - step1_9 * cospi_8_64;
           step2_9 = dct_const_round_shift(temp1);
           temp2 = step1_9 * cospi_24_64 + step1_14 * cospi_8_64;
           step2_14 = dct_const_round_shift(temp2);
        */
    ...
    __asm__ __volatile__ (
        ...
        /* temp1 = input[5] * cospi_22_64 - input[11] * cospi_10_64;
           step2_10 = dct_const_round_shift(temp1);
        */
        "mtlo     %[const_2_power_13],  $ac1                            \n\t"
        "mthi     $zero,                $ac1                            \n\t"
        "mtlo     %[const_2_power_13],  $ac3                            \n\t"
        ...
        /* temp1 = input[13] * cospi_6_64  - input[3] * cospi_26_64;
           step2_11 = dct_const_round_shift(temp1);
        */
        ...
        /* temp2 = input[5] * cospi_10_64 + input[11] * cospi_22_64;
           step2_13 = dct_const_round_shift(temp2);
        */
        "madd     $ac1,                 %[load1],       %[cospi_10_64]  \n\t"
        "madd     $ac1,                 %[load2],       %[cospi_22_64]  \n\t"
        "extp     %[result3],           $ac1,           31              \n\t"

        /* temp2 = input[13] * cospi_26_64 + input[3] * cospi_6_64;
           step2_12 = dct_const_round_shift(temp2);
        */
        ...
        /* step1_10 = step2_11 - step2_10;
           ...
           step2_11 = step1_11;
           step2_12 = step1_12;
           temp1 = -step1_10 * cospi_24_64 - step1_13 * cospi_8_64;
           step2_10 = dct_const_round_shift(temp1);
           temp2 = step1_13 * cospi_24_64 - step1_10 * cospi_8_64;
           step2_13 = dct_const_round_shift(temp2);
        */
        "mtlo     %[const_2_power_13],  $ac1                            \n\t"
        "mthi     $zero,                $ac1                            \n\t"
    ...
    __asm__ __volatile__ (
        ...
        /* temp1 = input[2] * cospi_28_64 - input[14] * cospi_4_64;
           step1_4 = dct_const_round_shift(temp1);
        */
        "mtlo     %[const_2_power_13],  $ac1                            \n\t"
        "mthi     $zero,                $ac1                            \n\t"
        "mtlo     %[const_2_power_13],  $ac3                            \n\t"
        ...
        /* temp1 = input[10] * cospi_12_64 - input[6] * cospi_20_64;
        ...
        */
        ...
        /* temp2 = input[10] * cospi_20_64 + input[6] * cospi_12_64;
        ...
        */
        ...
        /* temp2 = input[2] * cospi_4_64  + input[14] * cospi_28_64;
           step1_7 = dct_const_round_shift(temp2);
        */
    ...
    __asm__ __volatile__ (
        ...
        /* temp1 = (step2_14 - step2_13 - step2_9 + step2_10) * cospi_16_64;
           step1_10 = dct_const_round_shift(temp1);
        */
        ...
        /* temp2 = (step2_14 - step2_13 + step2_9 - step2_10) * cospi_16_64;
           step1_13 = dct_const_round_shift(temp2);
        */
        ...
        /* temp1 = (step2_15 - step2_12 - step2_8 + step2_11) * cospi_16_64;
           step1_11 = dct_const_round_shift(temp1);
        */
        ...
        /* temp2 = (step2_15 - step2_12 + step2_8 - step2_11) * cospi_16_64;
           step1_12 = dct_const_round_shift(temp2);
        */
...
void vp9_short_idct16x16_add_dspr2(int16_t *input, uint8_t *dest, int dest_stride) {
  ...
  idct16_1d_rows_dspr2(input, out);

  // Then transform columns and add to dest
  idct16_1d_cols_add_blk_dspr2(out, dest, dest_stride);
}

void iadst16_1d_dspr2(int16_t *input, int16_t *output) {
...
void vp9_short_iht16x16_add_dspr2(int16_t *input, uint8_t *dest, int dest_stride,
                              int tx_type) {
  int i, j;
  DECLARE_ALIGNED(32, int16_t,  out[16 * 16]);
  int16_t *outptr = out;
  ...
  switch(tx_type) {
    case DCT_DCT:     // DCT in both horizontal and vertical
      idct16_1d_rows_dspr2(input, outptr);
      idct16_1d_cols_add_blk_dspr2(out, dest, dest_stride);
      break;
    case ADST_DCT:    // ADST in vertical, DCT in horizontal
      ...
      for (i = 0; i < 16; ++i) {
        iadst16_1d_dspr2(outptr, temp_out);

        for (j = 0; j < 16; ++j)
          dest[j * dest_stride + i] = clip_pixel(ROUND_POWER_OF_TWO(temp_out[j], 6) + dest[j * dest_stride + i]);
    ...
    case ADST_ADST:   // ADST in both directions
    {
      ...
      for (i = 0; i < 16; ++i) {
        ...
        iadst16_1d_dspr2(temp_in, temp_out);
        for (j = 0; j < 16; ++j)
          dest[j * dest_stride + i] = clip_pixel(ROUND_POWER_OF_TWO(temp_out[j], 6) + dest[j * dest_stride + i]);
      }
    }
...
void idct16_1d_4rows_dspr2(int16_t *input, int16_t *output) {
  int i;
  int step1_0, step1_1, step1_2, step1_3, step1_4, step1_5, step1_6, step1_7;
  int step1_10, step1_11, step1_12, step1_13;
  int step2_0, step2_1, step2_2, step2_3;
...
void vp9_short_idct10_16x16_add_dspr2(int16_t *input, uint8_t *dest,
  ...
  idct16_1d_4rows_dspr2(input, outptr);

  // Then transform columns
  idct16_1d_cols_add_blk_dspr2(out, dest, dest_stride);
}

void vp9_short_idct1_16x16_dspr2(int16_t *input, int16_t *output) {
  int a1, out;
  uint32_t pos = 45;
