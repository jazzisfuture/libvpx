...
#if HAVE_DSPR2
static void idct16_1d_rows_dspr2(int16_t *input, int16_t *output,
                                 uint32_t no_rows) {
  int i;
...
void vp9_idct16x16_256_add_dspr2(int16_t *input, uint8_t *dest,
                                 int dest_stride) {
...
static void iadst16_1d(int16_t *input, int16_t *output) {
...
void vp9_idct16x16_10_add_dspr2(int16_t *input, uint8_t *dest,
                                int dest_stride) {
  DECLARE_ALIGNED(32, int16_t,  out[16 * 16]);
  int16_t *outptr = out;
  uint32_t i;
...
void vp9_idct16x16_1_add_dspr2(int16_t *input, uint8_t *dest, int dest_stride) {
  uint32_t pos = 45;
  int32_t out;
  int32_t r;
  int32_t a1, absa1;
