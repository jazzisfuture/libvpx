...
#if HAVE_DSPR2
static void idct32_1d_rows_dspr2(int16_t *input, int16_t *output) {
...
void vp9_idct32x32_1024_add_dspr2(int16_t *input, uint8_t *dest,
                                  int dest_stride) {
...
void vp9_idct32x32_1_add_dspr2(int16_t *input, uint8_t *dest, int stride) {
  int       r, out;
  int32_t   a1, absa1;
  int32_t   vector_a1;
  int32_t   t1, t2, t3, t4;
