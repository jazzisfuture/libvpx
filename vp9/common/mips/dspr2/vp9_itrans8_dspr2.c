...
void idct8_1d_columns_add_blk_dspr2(int16_t *input, uint8_t *dest,
                                    int dest_stride) {
  int step1_0, step1_1, step1_2, step1_3, step1_4, step1_5, step1_6, step1_7;
...
void vp9_idct8x8_64_add_dspr2(int16_t *input, uint8_t *dest, int dest_stride) {
...
void vp9_short_iht8x8_add_dspr2(int16_t *input, uint8_t *dest,
...
void vp9_idct8x8_10_add_dspr2(int16_t *input, uint8_t *dest, int dest_stride) {
  DECLARE_ALIGNED(32, int16_t, out[8 * 8]);
  int16_t *outptr = out;
  uint32_t pos = 45;
...
void vp9_idct8x8_1_add_dspr2(int16_t *input, uint8_t *dest, int dest_stride) {
  uint32_t pos = 45;
  int32_t out;
  int32_t r;
  int32_t a1, absa1;
