...
#if HAVE_DSPR2
static void idct8_1d_rows_dspr2(int16_t *input, int16_t *output, uint32_t no_rows) {
...
void vp9_short_idct8x8_1_add_dspr2(int16_t *input, uint8_t *dest, int dest_stride) {
  uint32_t pos = 45;
  int32_t out;
  int32_t r;
  int32_t a1, absa1;
