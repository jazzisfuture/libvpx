...
void vp9_dc_predictor_4x4_dspr2(uint8_t *dst, ptrdiff_t stride,
  ...
  int expected_dc;
  int average;
  int tmp, above_c, above_l, above_r, left_c, left_r, left_l;
  ...
  __asm__ __volatile__ (
      ...
      : [above_c] "=&r" (above_c), [above_l] "=&r" (above_l), [above_r] "=&r" (above_r),
        [left_c] "=&r" (left_c), [left_l] "=&r" (left_l), [left_r] "=&r" (left_r),
