...
void vp9_idct4_1d_columns_add_blk_dspr2(int16_t *input, uint8_t *dest,
                                        int dest_stride) {
  int16_t   step_0, step_1, step_2, step_3;
  int       Temp0, Temp1, Temp2, Temp3;
  const int const_2_power_13 = 8192;
...
void vp9_idct4x4_16_add_dspr2(int16_t *input, uint8_t *dest, int dest_stride) {
...
void vp9_idct4x4_1_add_dspr2(int16_t *input, uint8_t *dest, int dest_stride) {
  int       a1, absa1;
  int       r;
  int32_t   out;
...
void vp9_short_iht4x4_add_dspr2(int16_t *input, uint8_t *dest,
