  ...
  for (i = 0; i < 32; ++i) {
    ...
    __asm__ __volatile__ (
        ...
        : [load1] "=&r" (load1), [load2] "=&r" (load2), [load3] "=&r" (load3),
          ...
          [step1_17] "=r" (step1_17), [step1_30] "=r" (step1_30), [step1_31] "=r" (step1_31)
    ...
    __asm__ __volatile__ (
        ...
        : [load1] "=&r" (load1), [load2] "=&r" (load2), [load3] "=&r" (load3),
          ...
          [step1_19] "=r" (step1_19), [step1_28] "=r" (step1_28), [step1_29] "=r" (step1_29)
        : [const_2_power_13] "r" (const_2_power_13), [input] "r" (input),
    ...
    __asm__ __volatile__ (
        ...
        : [load1] "=&r" (load1), [load2] "=&r" (load2), [load3] "=&r" (load3),
          ...
          [step1_21] "=r" (step1_21), [step1_26] "=r" (step1_26), [step1_27] "=r" (step1_27)
        : [const_2_power_13] "r" (const_2_power_13), [input] "r" (input),
    ...
    __asm__ __volatile__ (
        ...
        : [load1] "=&r" (load1), [load2] "=&r" (load2), [load3] "=&r" (load3),
          ...
          [step1_23] "=r" (step1_23), [step1_24] "=r" (step1_24), [step1_25] "=r" (step1_25)
        : [const_2_power_13] "r" (const_2_power_13), [input] "r" (input),
    ...
    __asm__ __volatile__ (
        ...
        : [load1] "=&r" (load1), [load2] "=&r" (load2), [load3] "=&r" (load3),
          ...
          [step2_9] "=r" (step2_9), [step2_14] "=r" (step2_14), [step2_15] "=r" (step2_15)
        : [const_2_power_13] "r" (const_2_power_13), [input] "r" (input),
    ...
    __asm__ __volatile__ (
        ...
        : [load1] "=&r" (load1), [load2] "=&r" (load2), [load3] "=&r" (load3),
          ...
          [step2_11] "=r" (step2_11), [step2_12] "=r" (step2_12), [step2_13] "=r" (step2_13)
        : [const_2_power_13] "r" (const_2_power_13), [input] "r" (input),
    ...
    __asm__ __volatile__ (
        ...
        : [temp0] "=&r" (temp0), [temp1] "=&r" (temp1), [step3_8] "=r" (step3_8),
          [step3_9] "=r" (step3_9), [step3_10] "=r" (step3_10), [step3_11] "=r" (step3_11),
          [step3_12] "=r" (step3_12), [step3_13] "=r" (step3_13), [step3_14] "=r" (step3_14),
          [step3_15] "=r" (step3_15)
        : [const_2_power_13] "r" (const_2_power_13), [step2_8] "r" (step2_8),
          [step2_9] "r" (step2_9), [step2_10] "r" (step2_10), [step2_11] "r" (step2_11),
          [step2_12] "r" (step2_12), [step2_13] "r" (step2_13), [step2_14] "r" (step2_14),
    ...
    __asm__ __volatile__ (
        ...
        : [load1] "=&r" (load1), [load2] "=&r" (load2), [load3] "=&r" (load3),
          [load4] "=&r" (load4), [result1] "=&r" (result1), [result2] "=&r" (result2),
          [temp0] "=&r" (temp0), [temp1] "=&r" (temp1), [temp2] "=&r" (temp2),
          [temp3] "=&r" (temp3), [step1_0] "=r" (step1_0), [step1_1] "=r" (step1_1),
    ...
    __asm__ __volatile__ (
        ...
        : [load1] "=&r" (load1), [load2] "=&r" (load2), [load3] "=&r" (load3),
          ...
          [step1_5] "=r" (step1_5), [step1_6] "=r" (step1_6), [step1_7] "=r" (step1_7)
        : [const_2_power_13] "r" (const_2_power_13), [input] "r" (input),
    ...
    __asm__ __volatile__ (
        ...
        : [cm] "r" (cm), [dest_stride] "r" (dest_stride), [step1_0] "r" (step1_0),
          [step1_1] "r" (step1_1), [step2_30] "r" (step2_30), [step2_31] "r" (step2_31),
          [step1_2] "r" (step1_2), [step1_3] "r" (step1_3), [step2_28] "r" (step2_28),
          [step2_29] "r" (step2_29)
    );
    ...
    __asm__ __volatile__ (
        ...
        : [cm] "r" (cm), [dest_stride] "r" (dest_stride), [step3_12] "r" (step3_12),
          [step3_13] "r" (step3_13), [step3_14] "r" (step3_14), [step3_15] "r" (step3_15)
    );
    ...
    __asm__ __volatile__ (
        ...
        : [cm] "r" (cm), [dest_stride] "r" (dest_stride), [step1_4] "r" (step1_4),
          [step1_5] "r" (step1_5), [step1_6] "r" (step1_6), [step1_7] "r" (step1_7),
          [step1_24] "r" (step1_24), [step1_25] "r" (step1_25), [step1_26] "r" (step1_26),
          [step1_27] "r" (step1_27)
    );
    ...
    __asm__ __volatile__ (
        ...
        : [cm] "r" (cm), [dest_stride] "r" (dest_stride), [step1_8] "r" (step1_8),
          [step1_9] "r" (step1_9), [step1_10] "r" (step1_10), [step1_11] "r" (step1_11),
          [step1_20] "r" (step1_20), [step1_21] "r" (step1_21), [step1_22] "r" (step1_22),
          [step1_23] "r" (step1_23)
    );
    ...
    __asm__ __volatile__ (
        ...
        : [cm] "r" (cm), [dest_stride] "r" (dest_stride),
          [step1_12] "r" (step1_12), [step1_13] "r" (step1_13), [step1_14] "r" (step1_14),
          [step1_15] "r" (step1_15), [step2_16] "r" (step2_16), [step2_17] "r" (step2_17),
