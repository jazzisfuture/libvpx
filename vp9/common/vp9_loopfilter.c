...
static void filter_block_plane_non420(VP9_COMMON *cm,
  ...
  for (r = 0; r < MI_BLOCK_SIZE && mi_row + r < cm->mi_rows; r += row_step) {
    ...
    if((mi_row == 0 && mi_col == 88 && plane->plane_type == 1 && r==1) ||
       (mi_row == 0 && mi_col == 88 && plane->plane_type == 1 && r==2) ||
       (mi_row == 0 && mi_col == 96 && plane->plane_type == 1 && r==1) ||
       (mi_row == 0 && mi_col == 96 && plane->plane_type == 1 && r==2))
      printf("got here");
