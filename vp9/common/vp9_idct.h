...
#if CONFIG_VP9_HIGH
void vp9_high_iwht4x4_add(const int16_t *input, uint8_t *dest, int stride, int eob, int bps);

void vp9_high_idct4x4_add(const int16_t *input, uint8_t *dest, int stride, int eob, int bps);
void vp9_high_idct8x8_add(const int16_t *input, uint8_t *dest, int stride, int eob, int bps);
void vp9_high_idct16x16_add(const int16_t *input, uint8_t *dest, int stride, int
                       eob, int bps);
