...
#if CONFIG_EXT_TX
void vp9_iklt32x32_add(const int16_t *input, uint8_t *dest, int stride, int eob);
void vp9_idst_add(const int16_t *input, uint8_t *dest, int stride, int eob, int size);
#endif
