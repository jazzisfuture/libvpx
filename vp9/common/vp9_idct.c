...
void vp9_high_iwht4x4_16_add_c(const int16_t *input, uint8_t *dest8, int stride, int bps) {
/* 4-point reversible, orthonormal inverse Walsh-Hadamard in 3.5 adds,
   0.5 shifts per pixel. */
  int i;
  int16_t output[16];
...
void vp9_high_iwht4x4_1_add_c(const int16_t *in, uint8_t *dest8, int dest_stride, int bps) {
  int i;
  int a1, e1;
  int16_t tmp[4];
  const int16_t *ip = in;
...
void vp9_high_idct4x4_16_add_c(const int16_t *input, uint8_t *dest8, int stride, int bps) {
  int16_t out[4 * 4];
  int16_t *outptr = out;
  int i, j;
  int16_t temp_in[4], temp_out[4];
  ...
  for (i = 0; i < 4; ++i) {
    ...
    for (j = 0; j < 4; ++j)
      dest[j * stride + i] = APPLY_CLIP(dest[j * stride + i],
                          ROUND_POWER_OF_TWO(temp_out[j], 4),bps);
  }
}

void vp9_high_idct4x4_1_add_c(const int16_t *input, uint8_t *dest8, int dest_stride, int bps) {
  int i;
  int a1;
  int16_t out = dct_const_round_shift(input[0] * cospi_16_64);
  uint16_t *dest = CONVERT_TO_SHORTPTR(dest8);
...
void vp9_high_idct8x8_64_add_c(const int16_t *input, uint8_t *dest8, int stride, int bps) {
  int16_t out[8 * 8];
  int16_t *outptr = out;
  int i, j;
  int16_t temp_in[8], temp_out[8];
...
void vp9_high_idct8x8_1_add_c(const int16_t *input, uint8_t *dest8, int stride, int bps) {
  int i, j;
  int a1;
  int16_t out = dct_const_round_shift(input[0] * cospi_16_64);
  uint16_t *dest = CONVERT_TO_SHORTPTR(dest8);
...
void vp9_high_idct8x8_10_add_c(const int16_t *input, uint8_t *dest8, int stride, int bps) {
  int16_t out[8 * 8] = { 0 };
  int16_t *outptr = out;
  int i, j;
  int16_t temp_in[8], temp_out[8];
...
void vp9_high_idct16x16_256_add_c(const int16_t *input, uint8_t *dest8, int stride, int bps) {
  int16_t out[16 * 16];
  int16_t *outptr = out;
  int i, j;
  int16_t temp_in[16], temp_out[16];
...
void vp9_high_iht16x16_256_add_c(const int16_t *input, uint8_t *dest8, int stride,
                            int tx_type, int bps) {
  int i, j;
  int16_t out[16 * 16];
  int16_t *outptr = out;
...
void vp9_high_idct16x16_10_add_c(const int16_t *input, uint8_t *dest8, int stride, int bps) {
  int16_t out[16 * 16] = { 0 };
  int16_t *outptr = out;
  int i, j;
  int16_t temp_in[16], temp_out[16];
...
void vp9_high_idct16x16_1_add_c(const int16_t *input, uint8_t *dest8, int stride, int bps) {
  int i, j;
  int a1;
  int16_t out = dct_const_round_shift(input[0] * cospi_16_64);
  uint16_t *dest = CONVERT_TO_SHORTPTR(dest8);
...
void vp9_high_idct32x32_1024_add_c(const int16_t *input, uint8_t *dest8, int stride, int bps) {
  int16_t out[32 * 32];
  int16_t *outptr = out;
  int i, j;
  int16_t temp_in[32], temp_out[32];
...
void vp9_high_idct32x32_34_add_c(const int16_t *input, uint8_t *dest8, int stride, int bps) {
  int16_t out[32 * 32] = {0};
  int16_t *outptr = out;
  int i, j;
  int16_t temp_in[32], temp_out[32];
...
void vp9_high_idct32x32_1_add_c(const int16_t *input, uint8_t *dest8, int stride, int bps) {
  int i, j;
  int a1;
  uint16_t *dest = CONVERT_TO_SHORTPTR(dest8);
