...
typedef struct frame_contexts {
  vp9_prob y_mode_prob[BLOCK_SIZE_TYPES][VP9_INTRA_MODES - 1]; /* interframe intra mode probs */
  ...
  vp9_prob pre_y_mode_prob[BLOCK_SIZE_TYPES][VP9_INTRA_MODES - 1];
  ...
  /* interframe intra mode probs */
  unsigned int y_mode_counts[BLOCK_SIZE_TYPES][VP9_INTRA_MODES];
