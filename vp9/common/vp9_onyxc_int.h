...
#if CONFIG_GLOBAL_MOTION
  int num_global_motion_last;
  int num_global_motion_golden;
  int num_global_motion_arf;
  Global_Motion_Params global_motion_last[MAX_GLOBAL_MOTION_MODELS];
  Global_Motion_Params global_motion_golden[MAX_GLOBAL_MOTION_MODELS];
  Global_Motion_Params global_motion_arf[MAX_GLOBAL_MOTION_MODELS];
#endif
} VP9_COMMON;
