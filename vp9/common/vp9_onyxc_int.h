...
typedef struct frame_contexts {
  ...
  vp9_prob pre_y_mode_prob[4][VP9_INTRA_MODES - 1];
  ...
  /* interframe intra mode probs */
  unsigned int y_mode_counts[4][VP9_INTRA_MODES];
  ...
  unsigned int intra_inter_counts[INTRA_INTER_CONTEXTS][2];
  unsigned int comp_inter_counts[COMP_INTER_CONTEXTS][2];
  unsigned int single_ref_counts[REF_CONTEXTS][2][2];
  unsigned int comp_ref_counts[REF_CONTEXTS][2];
} FRAME_CONTEXT;
