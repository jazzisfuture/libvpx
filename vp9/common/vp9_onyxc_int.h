...
typedef struct frame_contexts {
  ...
  /*
  vp9_prob tx_probs_32x32p[TX_SIZE_MAX_SB - 1];
  vp9_prob tx_probs_16x16p[TX_SIZE_MAX_SB - 2];
  vp9_prob tx_probs_8x8p[TX_SIZE_MAX_SB - 3];
  vp9_prob pre_tx_probs_32x32p[TX_SIZE_MAX_SB - 1];
  vp9_prob pre_tx_probs_16x16p[TX_SIZE_MAX_SB - 2];
  vp9_prob pre_tx_probs_8x8p[TX_SIZE_MAX_SB - 3];
