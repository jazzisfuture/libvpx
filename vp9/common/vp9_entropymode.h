...
typedef struct frame_contexts {
  ...
  vp9_prob inter_compound_mode_probs[INTER_MODE_CONTEXTS][INTER_MODES - 1];
#endif
} FRAME_CONTEXT;
...
#endif
#if CONFIG_COMPOUND_MODES
  unsigned int inter_compound_mode[INTER_MODE_CONTEXTS][INTER_MODES];
#endif
} FRAME_COUNTS;
