...
struct scale_factors_common {
  ...
  int (*scale_value_x)(int val, const void *scale);
  int (*scale_value_y)(int val, const void *scale);
  void (*set_scaled_offsets)(void *scale, int row, int col);
  MV32 (*scale_mv)(const MV *mv, const void *scale);
