...
#define DCT_CATEGORY1_TOKEN 5   // 5-6   Extra Bits 1+1
#define DCT_CATEGORY2_TOKEN 6   // 7-10  Extra Bits 2+1
#define DCT_CATEGORY3_TOKEN 7   // 11-18 Extra Bits 3+1
#define DCT_CATEGORY4_TOKEN 8   // 19-34 Extra Bits 4+1
#define DCT_CATEGORY5_TOKEN 9   // 35-66 Extra Bits 5+1
#define DCT_CATEGORY6_TOKEN 10  // 67+   Extra Bits 14+1
