...
#define OPC_LAST1        (MAX_ENTROPY_TOKENS + 4)
#define OPC_NOTLAST1     (MAX_ENTROPY_TOKENS + 5)

#define USE_ZPC_EOORIENT         1       /* 0: not used */
                                         /* 1: used */
#define USE_ZPC_EXTRA            2       /* 0: not used */
                                         /* 1: use zerorun as extra */
                                         /* 2: use zerotree root as extra */
#define USE_OPC_LAST1            0
...
int vp9_use_last1(int c, int eob, const int *scan, TX_SIZE tx_size,
                  int last1_indicated);
int vp9_is_last1(int c, int eob, const int *scan, TX_SIZE tx_size,
                 const int16_t *qcoeff_ptr, int last1_start);

#define ZPC_USEEOO_THRESH        4
#define ZPC_ONESSAVED            3   /* encoder only */
#define ZPC_ZEROSSAVED_IZR       7   /* encoder only */
#define ZPC_ZEROSSAVED_EXTRA     10  /* encoder only */
