...
#define NEWCOEFCONTEXT_BAND_COND(b)   ((b) >= 5)
...
extern DECLARE_ALIGNED(16, int, vp9_default_zig_zag1d_neighbors[
                       16 * MAX_NEIGHBORS]);
extern DECLARE_ALIGNED(16, int, vp9_row_scan_neighbors[
                       16 * MAX_NEIGHBORS]);
extern DECLARE_ALIGNED(16, int, vp9_col_scan_neighbors[
                       16 * MAX_NEIGHBORS]);
