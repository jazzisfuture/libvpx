...
#define COEF_BANDS 8
extern DECLARE_ALIGNED(16, const int, vp9_coef_bands[32]);
...
extern int vp9_initial_coef_context(ENTROPY_CONTEXT a_ec, ENTROPY_CONTEXT l_ec);
extern int vp9_get_coef_context(int * recent_energy, int token);
extern int vp9_get_coef_context_old(int * recent_energy, int token);
