...
typedef struct macroblockd {
  ...
  char sb_index;   // index of 32x32 block inside the 64x64 block
  char mb_index;   // index of 16x16 block inside the 32x32 block
  char b_index;    // index of 8x8 block inside the 16x16 block
  char ab_index;   // index of 4x4 block inside the 8x8 block

  int q_index;

} MACROBLOCKD;

static INLINE char *get_sb_index(MACROBLOCKD *xd, BLOCK_SIZE_TYPE subsize) {
  switch (subsize) {
