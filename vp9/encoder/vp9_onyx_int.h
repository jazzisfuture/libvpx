...
typedef struct {
  ...
  vp9_prob nzc_probs_32x32
           [MAX_NZC_CONTEXTS][REF_TYPES][BLOCK_TYPES_32X32][NZC32X32_NODES];
#endif
...
typedef struct VP9_COMP {
  ...
  unsigned int nzc_counts_4x4
               [MAX_NZC_CONTEXTS][REF_TYPES][BLOCK_TYPES][NZC4X4_TOKENS];
  ...
  unsigned int nzc_counts_8x8
               [MAX_NZC_CONTEXTS][REF_TYPES][BLOCK_TYPES][NZC8X8_TOKENS];
  ...
  unsigned int nzc_counts_16x16
               [MAX_NZC_CONTEXTS][REF_TYPES][BLOCK_TYPES][NZC16X16_TOKENS];
  vp9_prob frame_nzc_probs_32x32
           [MAX_NZC_CONTEXTS][REF_TYPES][BLOCK_TYPES_32X32][NZC32X32_NODES];
  unsigned int frame_nzc_branch_ct_32x32
               [MAX_NZC_CONTEXTS][REF_TYPES][BLOCK_TYPES_32X32][NZC32X32_NODES][2];
  unsigned int nzc_counts_32x32
               [MAX_NZC_CONTEXTS][REF_TYPES][BLOCK_TYPES_32X32][NZC32X32_TOKENS];
#endif
