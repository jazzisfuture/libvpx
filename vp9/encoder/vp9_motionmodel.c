...
void vp9_update_motionfield_stats(VP9_COMP *cpi, int ref, int blocksize,
  ...
  if (q_cur) {
    update_motionfield_frame_stats(cpi, &q_cur->img, ref_buf,
                                   blocksize, motionfield, confidence);
  }
}

void find_transform_by_motionfield(VP9_COMP *cpi) {
  MV motionfield[4096];
