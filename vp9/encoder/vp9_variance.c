...
static void high_var_filter_block2d_bil_first_pass(const uint8_t *src_ptr8,
                                              uint16_t *output_ptr,
                                              unsigned int src_pixels_per_line,
                                              int pixel_step,
                                              unsigned int output_height,
...
static void high_var_filter_block2d_bil_second_pass(const uint16_t *src_ptr,
                                               uint16_t *output_ptr,
                                               unsigned int src_pixels_per_line,
                                               unsigned int pixel_step,
                                               unsigned int output_height,
...
unsigned int vp9_high_variance64x32_c(const uint8_t *src_ptr,
  ...
  high_variance(src_ptr, source_stride, ref_ptr, recon_stride, 64, 32, &var, &avg);
  *sse = var;
  return (var - (((int64_t)avg * avg) >> 11));
}
...
unsigned int vp9_high_sub_pixel_variance64x32_c(const uint8_t *src_ptr,
  ...
  high_var_filter_block2d_bil_first_pass(src_ptr, fdata3, src_pixels_per_line,
                                    1, 33, 64, hfilter);
  high_var_filter_block2d_bil_second_pass(fdata3, temp2, 64, 64, 32, 64, vfilter);

  return vp9_high_variance64x32(CONVERT_TO_BYTEPTR(temp2), 64, dst_ptr, dst_pixels_per_line, sse);
}

unsigned int vp9_high_sub_pixel_avg_variance64x32_c(const uint8_t *src_ptr,
                                               int  src_pixels_per_line,
                                               int  xoffset,
                                               int  yoffset,
                                               const uint8_t *dst_ptr,
  ...
  high_var_filter_block2d_bil_first_pass(src_ptr, fdata3, src_pixels_per_line,
                                    1, 33, 64, hfilter);
  high_var_filter_block2d_bil_second_pass(fdata3, temp2, 64, 64, 32, 64, vfilter);
  high_comp_avg_pred(temp3, second_pred, 64, 32, CONVERT_TO_BYTEPTR(temp2), 64);
  return vp9_high_variance64x32(CONVERT_TO_BYTEPTR(temp3), 64, dst_ptr, dst_pixels_per_line, sse);
}
...
unsigned int vp9_high_variance32x64_c(const uint8_t *src_ptr,
  ...
  high_variance(src_ptr, source_stride, ref_ptr, recon_stride, 32, 64, &var, &avg);
  *sse = var;
  return (var - (((int64_t)avg * avg) >> 11));
}
...
unsigned int vp9_high_sub_pixel_variance32x64_c(const uint8_t *src_ptr,
  ...
  high_var_filter_block2d_bil_first_pass(src_ptr, fdata3, src_pixels_per_line,
                                    1, 65, 32, hfilter);
  high_var_filter_block2d_bil_second_pass(fdata3, temp2, 32, 32, 64, 32, vfilter);

  return vp9_high_variance32x64(CONVERT_TO_BYTEPTR(temp2), 32, dst_ptr, dst_pixels_per_line, sse);
}

unsigned int vp9_high_sub_pixel_avg_variance32x64_c(const uint8_t *src_ptr,
                                               int  src_pixels_per_line,
                                               int  xoffset,
                                               int  yoffset,
                                               const uint8_t *dst_ptr,
  ...
  return vp9_high_variance32x64(CONVERT_TO_BYTEPTR(temp3), 32, dst_ptr, dst_pixels_per_line, sse);
}
...
unsigned int vp9_high_variance32x16_c(const uint8_t *src_ptr,
  ...
  high_variance(src_ptr, source_stride, ref_ptr, recon_stride, 32, 16, &var, &avg);
  *sse = var;
  return (var - (((int64_t)avg * avg) >> 9));
}
...
unsigned int vp9_high_sub_pixel_variance32x16_c(const uint8_t *src_ptr,
  ...
  high_var_filter_block2d_bil_first_pass(src_ptr, fdata3, src_pixels_per_line,
                                    1, 17, 32, hfilter);
  high_var_filter_block2d_bil_second_pass(fdata3, temp2, 32, 32, 16, 32, vfilter);

  return vp9_high_variance32x16(CONVERT_TO_BYTEPTR(temp2), 32, dst_ptr, dst_pixels_per_line, sse);
}

unsigned int vp9_high_sub_pixel_avg_variance32x16_c(const uint8_t *src_ptr,
                                               int  src_pixels_per_line,
                                               int  xoffset,
                                               int  yoffset,
                                               const uint8_t *dst_ptr,
  ...
  return vp9_high_variance32x16(CONVERT_TO_BYTEPTR(temp3), 32, dst_ptr, dst_pixels_per_line, sse);
}
...
unsigned int vp9_high_variance16x32_c(const uint8_t *src_ptr,
  ...
  high_variance(src_ptr, source_stride, ref_ptr, recon_stride, 16, 32, &var, &avg);
  *sse = var;
  return (var - (((int64_t)avg * avg) >> 9));
}
...
unsigned int vp9_high_sub_pixel_variance16x32_c(const uint8_t *src_ptr,
  ...
  high_var_filter_block2d_bil_first_pass(src_ptr, fdata3, src_pixels_per_line,
                                    1, 33, 16, hfilter);
  high_var_filter_block2d_bil_second_pass(fdata3, temp2, 16, 16, 32, 16, vfilter);

  return vp9_high_variance16x32(CONVERT_TO_BYTEPTR(temp2), 16, dst_ptr, dst_pixels_per_line, sse);
}

unsigned int vp9_high_sub_pixel_avg_variance16x32_c(const uint8_t *src_ptr,
                                               int  src_pixels_per_line,
                                               int  xoffset,
                                               int  yoffset,
                                               const uint8_t *dst_ptr,
  ...
  return vp9_high_variance16x32(CONVERT_TO_BYTEPTR(temp3), 16, dst_ptr, dst_pixels_per_line, sse);
}
...
unsigned int vp9_high_variance64x64_c(const uint8_t *src_ptr,
  ...
  high_variance(src_ptr, source_stride, ref_ptr, recon_stride, 64, 64, &var, &avg);
  *sse = var;
  return (var - (((int64_t)avg * avg) >> 12));
}
...
unsigned int vp9_high_variance32x32_c(const uint8_t *src_ptr,
  ...
  high_variance(src_ptr, source_stride, ref_ptr, recon_stride, 32, 32, &var, &avg);
  *sse = var;
  return (var - (((int64_t)avg * avg) >> 10));
}
...
unsigned int vp9_high_variance16x16_c(const uint8_t *src_ptr,
  ...
  high_variance(src_ptr, source_stride, ref_ptr, recon_stride, 16, 16, &var, &avg);
  *sse = var;
  return (var - (((unsigned int)avg * avg) >> 8));
}
...
unsigned int vp9_high_variance8x16_c(const uint8_t *src_ptr,
  ...
  high_variance(src_ptr, source_stride, ref_ptr, recon_stride, 8, 16, &var, &avg);
  *sse = var;
  return (var - (((unsigned int)avg * avg) >> 7));
}
...
unsigned int vp9_high_variance16x8_c(const uint8_t *src_ptr,
  ...
  high_variance(src_ptr, source_stride, ref_ptr, recon_stride, 16, 8, &var, &avg);
  *sse = var;
  return (var - (((unsigned int)avg * avg) >> 7));
}
...
unsigned int vp9_high_variance8x8_c(const uint8_t *src_ptr,
  ...
  high_variance(src_ptr, source_stride, ref_ptr, recon_stride, 8, 8, &var, &avg);
  *sse = var;
  return (var - (((unsigned int)avg * avg) >> 6));
}
...
unsigned int vp9_high_variance8x4_c(const uint8_t *src_ptr,
  ...
  high_variance(src_ptr, source_stride, ref_ptr, recon_stride, 8, 4, &var, &avg);
  *sse = var;
  return (var - (((unsigned int)avg * avg) >> 5));
}
...
unsigned int vp9_high_variance4x8_c(const uint8_t *src_ptr,
  ...
  high_variance(src_ptr, source_stride, ref_ptr, recon_stride, 4, 8, &var, &avg);
  *sse = var;
  return (var - (((unsigned int)avg * avg) >> 5));
}
...
unsigned int vp9_high_variance4x4_c(const uint8_t *src_ptr,
  ...
  high_variance(src_ptr, source_stride, ref_ptr, recon_stride, 4, 4, &var, &avg);
  *sse = var;
  return (var - (((unsigned int)avg * avg) >> 4));
}
...
unsigned int vp9_high_sub_pixel_variance4x4_c(const uint8_t *src_ptr,
  ...
  high_var_filter_block2d_bil_second_pass(fdata3, temp2, 4,  4,  4,  4, vfilter);

  return vp9_high_variance4x4(CONVERT_TO_BYTEPTR(temp2), 4, dst_ptr, dst_pixels_per_line, sse);
}

unsigned int vp9_high_sub_pixel_avg_variance4x4_c(const uint8_t *src_ptr,
                                             int  src_pixels_per_line,
                                             int  xoffset,
                                             int  yoffset,
                                             const uint8_t *dst_ptr,
  ...
  return vp9_high_variance4x4(CONVERT_TO_BYTEPTR(temp3), 4, dst_ptr, dst_pixels_per_line, sse);
}
...
unsigned int vp9_high_sub_pixel_variance8x8_c(const uint8_t *src_ptr,
  ...
  return vp9_high_variance8x8(CONVERT_TO_BYTEPTR(temp2), 8, dst_ptr, dst_pixels_per_line, sse);
}
...
unsigned int vp9_high_sub_pixel_avg_variance8x8_c(const uint8_t *src_ptr,
  ...
  return vp9_high_variance8x8(CONVERT_TO_BYTEPTR(temp3), 8, dst_ptr, dst_pixels_per_line, sse);
}
...
unsigned int vp9_high_sub_pixel_variance16x16_c(const uint8_t *src_ptr,
  ...
  high_var_filter_block2d_bil_first_pass(src_ptr, fdata3, src_pixels_per_line,
                                    1, 17, 16, hfilter);
  high_var_filter_block2d_bil_second_pass(fdata3, temp2, 16, 16, 16, 16, vfilter);

  return vp9_high_variance16x16(CONVERT_TO_BYTEPTR(temp2), 16, dst_ptr, dst_pixels_per_line, sse);
}

unsigned int vp9_high_sub_pixel_avg_variance16x16_c(const uint8_t *src_ptr,
                                               int  src_pixels_per_line,
                                               int  xoffset,
                                               int  yoffset,
                                               const uint8_t *dst_ptr,
  ...
  return vp9_high_variance16x16(CONVERT_TO_BYTEPTR(temp3), 16, dst_ptr, dst_pixels_per_line, sse);
}
...
unsigned int vp9_high_sub_pixel_variance64x64_c(const uint8_t *src_ptr,
  ...
  high_var_filter_block2d_bil_first_pass(src_ptr, fdata3, src_pixels_per_line,
                                    1, 65, 64, hfilter);
  high_var_filter_block2d_bil_second_pass(fdata3, temp2, 64, 64, 64, 64, vfilter);

  return vp9_high_variance64x64(CONVERT_TO_BYTEPTR(temp2), 64, dst_ptr, dst_pixels_per_line, sse);
}

unsigned int vp9_high_sub_pixel_avg_variance64x64_c(const uint8_t *src_ptr,
                                               int  src_pixels_per_line,
                                               int  xoffset,
                                               int  yoffset,
                                               const uint8_t *dst_ptr,
  ...
  return vp9_high_variance64x64(CONVERT_TO_BYTEPTR(temp3), 64, dst_ptr, dst_pixels_per_line, sse);
}
...
unsigned int vp9_high_sub_pixel_variance32x32_c(const uint8_t *src_ptr,
  ...
  high_var_filter_block2d_bil_first_pass(src_ptr, fdata3, src_pixels_per_line,
                                    1, 33, 32, hfilter);
  high_var_filter_block2d_bil_second_pass(fdata3, temp2, 32, 32, 32, 32, vfilter);

  return vp9_high_variance32x32(CONVERT_TO_BYTEPTR(temp2), 32, dst_ptr, dst_pixels_per_line, sse);
}

unsigned int vp9_high_sub_pixel_avg_variance32x32_c(const uint8_t *src_ptr,
                                               int  src_pixels_per_line,
                                               int  xoffset,
                                               int  yoffset,
                                               const uint8_t *dst_ptr,
  ...
  return vp9_high_variance32x32(CONVERT_TO_BYTEPTR(temp3), 32, dst_ptr, dst_pixels_per_line, sse);
}
...
unsigned int vp9_high_sub_pixel_variance16x8_c(const uint8_t *src_ptr,
  ...
  high_var_filter_block2d_bil_first_pass(src_ptr, fdata3, src_pixels_per_line,
                                    1, 9, 16, hfilter);
  high_var_filter_block2d_bil_second_pass(fdata3, temp2, 16, 16, 8, 16, vfilter);

  return vp9_high_variance16x8(CONVERT_TO_BYTEPTR(temp2), 16, dst_ptr, dst_pixels_per_line, sse);
}
...
unsigned int vp9_high_sub_pixel_avg_variance16x8_c(const uint8_t *src_ptr,
  ...
  return vp9_high_variance16x8(CONVERT_TO_BYTEPTR(temp3), 16, dst_ptr, dst_pixels_per_line, sse);
}
...
unsigned int vp9_high_sub_pixel_variance8x16_c(const uint8_t *src_ptr,
  ...
  return vp9_high_variance8x16(CONVERT_TO_BYTEPTR(temp2), 8, dst_ptr, dst_pixels_per_line, sse);
}
...
unsigned int vp9_high_sub_pixel_avg_variance8x16_c(const uint8_t *src_ptr,
  ...
  return vp9_high_variance8x16(CONVERT_TO_BYTEPTR(temp3), 8, dst_ptr, dst_pixels_per_line, sse);
}
...
unsigned int vp9_high_sub_pixel_variance8x4_c(const uint8_t *src_ptr,
  ...
  return vp9_high_variance8x4(CONVERT_TO_BYTEPTR(temp2), 8, dst_ptr, dst_pixels_per_line, sse);
}
...
unsigned int vp9_high_sub_pixel_avg_variance8x4_c(const uint8_t *src_ptr,
  ...
  return vp9_high_variance8x4(CONVERT_TO_BYTEPTR(temp3), 8, dst_ptr, dst_pixels_per_line, sse);
}
...
unsigned int vp9_high_sub_pixel_variance4x8_c(const uint8_t *src_ptr,
  ...
  return vp9_high_variance4x8(CONVERT_TO_BYTEPTR(temp2), 4, dst_ptr, dst_pixels_per_line, sse);
}
...
unsigned int vp9_high_sub_pixel_avg_variance4x8_c(const uint8_t *src_ptr,
  ...
  return vp9_high_variance4x8(CONVERT_TO_BYTEPTR(temp3), 4, dst_ptr, dst_pixels_per_line, sse);
}
