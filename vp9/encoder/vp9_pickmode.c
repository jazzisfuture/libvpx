...
static void fwht_8x8_analyze(const uint8_t *src, int src_stride,
                             int *horizontal, int *vertical, int *diagonal) {
...
static PREDICTION_MODE pick_intra_mode(const MACROBLOCK *x) {
  int horizontal;
  int vertical;
  int diagonal;
