...
static void vp9_large_block_mv_bias(
    VP9_COMP *cpi, MACROBLOCK *x, PREDICTION_MODE this_mode,
    MV_REFERENCE_FRAME ref_frame, RD_COST *this_rdc, BLOCK_SIZE bsize,
    int_mv frame_mv[MB_MODE_COUNT][MAX_REF_FRAMES]) {
...
void vp9_pick_inter_mode(VP9_COMP *cpi, MACROBLOCK *x,
  ...
  for (idx = 0; idx < RT_INTER_MODES; ++idx) {
    ...
    vp9_large_block_mv_bias(cpi, x, this_mode, ref_frame, &this_rdc, bsize,
                            frame_mv);
