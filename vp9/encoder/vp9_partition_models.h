...
static const float vp9_var_part_nn_weights_16_layer0[FEATURES * 8] = {
  -0.151315f, 0.346603f,  -0.574866f, 1.309930f,  1.228663f,  1.487261f,
  -0.520274f, 0.117609f,  -0.322546f, -0.299070f, -0.665972f, -0.099344f,
  0.367716f,  -0.528243f, -0.346518f, -0.085908f, -0.408727f, -0.793494f,
  -0.070839f, -0.297088f, -0.015526f, -0.449003f, -0.845224f, 0.080914f,
  0.057826f,  -0.001851f, 3.396149f,  -2.601223f, 2.149334f,  -1.595776f,
  -0.927818f, 0.295643f,  1.520178f,  1.285212f,  -0.396590f, 1.149576f,
  0.528100f,  -0.680754f, 1.721833f,  1.693839f,  1.556884f,  1.637518f,
  0.529275f,  -0.521748f, 0.570598f,  0.073007f,  0.616215f,  -0.044969f,
};

static const float vp9_var_part_nn_bias_16_layer0[8] = {
  -2.238862f, -0.217737f, -0.237997f, -0.218322f,
  -0.392025f, 0.707371f,  2.096824f,  2.558247f,
};

static const float vp9_var_part_nn_weights_16_layer1[8] = {
  0.836506f, 0.337212f, -0.034652f, 0.356739f,
  0.577156f, 0.502687f, -2.170672f, -1.045030f,
};
