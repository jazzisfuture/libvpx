...
static void temporal_filter_predictors_mb_c(MACROBLOCKD *xd,
  ...
  vp9_build_scaled_inter_predictor(y_mb_ptr, stride,
                                   &pred[0], 16,
                                   &subpel_mv,
  ...
  vp9_build_scaled_inter_predictor_q4(u_mb_ptr, stride,
                                      &pred[256], 8,
                                      &fullpel_mv, &subpel_mv,
                                      &xd->scale_factor_uv[which_mv],
                                      8, 8, which_mv, &xd->subpix);

  vp9_build_scaled_inter_predictor_q4(v_mb_ptr, stride,
                                      &pred[320], 8,
                                      &fullpel_mv, &subpel_mv,
                                      &xd->scale_factor_uv[which_mv],
                                      8, 8, which_mv, &xd->subpix);
