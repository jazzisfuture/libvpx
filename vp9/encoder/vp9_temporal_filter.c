...
static void temporal_filter_iterate_c(VP9_COMP *cpi) {
  ...
  for (tile_row = 0; tile_row < tile_rows; ++tile_row) {
    for (tile_col = 0; tile_col < tile_cols; ++tile_col) {
      ...
      cpi->td.mb.m_search_count_ptr = &tile_data->m_search_count;
      cpi->td.mb.ex_search_count_ptr = &tile_data->ex_search_count;
#if CONFIG_MULTITHREAD
      cpi->td.mb.search_count_mutex = tile_data->search_count_mutex;
#endif
