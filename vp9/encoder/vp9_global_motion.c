...
int vp9_compute_global_motion_single_feature_based(struct VP9_COMP *cpi,
  ...
  num_frm_corners = FastCornerDetect(frm->y_buffer, frm->y_width, frm->y_height, frm->y_stride,
                                     frm_corners, MAX_CORNERS);
  num_ref_corners = FastCornerDetect(ref->y_buffer, ref->y_width, ref->y_height, ref->y_stride,
  ...
  num_correspondences = determine_correspondence(frm->y_buffer, (int*)frm_corners,
                                                 num_frm_corners,
                                                 ref->y_buffer, (int*)ref_corners,
                                                 num_ref_corners,
