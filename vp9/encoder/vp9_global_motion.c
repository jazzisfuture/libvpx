...
int ComputeGlobalTransformationSingle_FeatureBased(TransformationType type,
  ...
  printf("Error Score (inliers) = %g\n",
         ComputeErrorScore(type, correspondences, 4, correspondences + 2, 4,
...
int ComputeGlobalTransformationMultiple_FeatureBased(TransformationType type,
                                                     unsigned char *frmbuf,
                                                     unsigned char *refbuf,
                                                     int width,
                                                     int height,
