...
uint32_t motion_compensated_prediction(VP9_COMP *cpi, ThreadData *td,
  ...
  vp9_full_pixel_diamond_new(
      cpi, x, &best_ref_mv1_full, step_param, lambda,
      MAX_MVSEARCH_STEPS - 1 - step_param, 1, &cpi->fn_ptr[bsize], nb_full_mvs,
      &tpl_stats->mv_arr[rf_idx].as_mv, &tpl_stats->mv_dist[rf_idx],
