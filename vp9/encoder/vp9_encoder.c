...
static INLINE void configure_skippable_frame(VP9_COMP *cpi,
  ...
  cpi->skippable_frame = (!frame_is_intra_only(&cpi->common) &&
    twopass->stats_in_start[cpi->common.current_video_frame].pcnt_inter -
    twopass->stats_in_start[cpi->common.current_video_frame].pcnt_motion
    == 1  &&
    cpi->common.current_video_frame > 1 &&
    twopass->stats_in_start[cpi->common.current_video_frame-1].pcnt_inter -
    twopass->stats_in_start[cpi->common.current_video_frame-1].pcnt_motion
    == 1  &&
    twopass->stats_in_start + cpi->common.current_video_frame + 1
...
static void encode_frame_to_data_rate(VP9_COMP *cpi,
  ...
  if (cpi->pass == 2 &&
    ...
    const int is_spatial_svc = (cpi->use_svc &&
                                cpi->svc.number_temporal_layers == 1);
    TWO_PASS *twopass = is_spatial_svc ?
        &cpi->svc.layer_context[cpi->svc.spatial_layer_id].twopass :
        &cpi->twopass;
    configure_skippable_frame(cpi, twopass);
  }
