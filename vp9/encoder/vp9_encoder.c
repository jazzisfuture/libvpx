...
VP9_COMP *vp9_create_compressor(VP9EncoderConfig *oxcf,
  ...
  vp9_init_level_info(&cpi->level_info);
...
int vp9_get_compressed_data(VP9_COMP *cpi, unsigned int *frame_flags,
  ...
  *size = 0;
  ...
  if (cpi->keep_level_stats && oxcf->pass != 1) {
    VP9_LEVEL_INFO *level_info = &cpi->level_info;
...
VP9_LEVEL vp9_get_level(const VP9_LEVEL_SPEC * const level_spec) {
  int i;
...
void vp9_init_level_info(VP9_LEVEL_INFO *level_info) {
  VP9_LEVEL_STATS *level_stats = &level_info->level_stats;
  VP9_LEVEL_SPEC *level_spec = &level_info->level_spec;
