...
static void save_coding_context(VP9_COMP *cpi) {
  ...
  vpx_memcpy(cc->nmvcosts[0], cpi->nmvcosts[0], MV_VALS * sizeof(int));
  vpx_memcpy(cc->nmvcosts[1], cpi->nmvcosts[1], MV_VALS * sizeof(int));
  vpx_memcpy(cc->nmvcosts_hp[0], cpi->nmvcosts_hp[0], MV_VALS * sizeof(int));
  vpx_memcpy(cc->nmvcosts_hp[1], cpi->nmvcosts_hp[1], MV_VALS * sizeof(int));

//  vp9_copy(cc->nmvcosts,  cpi->nmvcosts);
//  vp9_copy(cc->nmvcosts_hp,  cpi->nmvcosts_hp);
...
static void restore_coding_context(VP9_COMP *cpi) {
  ...
  vpx_memcpy(cpi->nmvcosts[0], cc->nmvcosts[0], MV_VALS * sizeof(int));
  vpx_memcpy(cpi->nmvcosts[1], cc->nmvcosts[1], MV_VALS * sizeof(int));
  vpx_memcpy(cpi->nmvcosts_hp[0], cc->nmvcosts_hp[0], MV_VALS * sizeof(int));
  vpx_memcpy(cpi->nmvcosts_hp[1], cc->nmvcosts_hp[1], MV_VALS * sizeof(int));
...
VP9_COMP *vp9_create_compressor(VP9EncoderConfig *oxcf) {
  ...
  CHECK_MEM_ERROR(cm, cpi->nmvcosts[0], vpx_calloc(MV_VALS, sizeof(int)));
  CHECK_MEM_ERROR(cm, cpi->nmvcosts[1], vpx_calloc(MV_VALS, sizeof(int)));
  CHECK_MEM_ERROR(cm, cpi->nmvcosts_hp[0], vpx_calloc(MV_VALS, sizeof(int)));
  CHECK_MEM_ERROR(cm, cpi->nmvcosts_hp[1], vpx_calloc(MV_VALS, sizeof(int)));
  CHECK_MEM_ERROR(cm, cpi->nmvsadcosts[0], vpx_calloc(MV_VALS, sizeof(int)));
  CHECK_MEM_ERROR(cm, cpi->nmvsadcosts[1], vpx_calloc(MV_VALS, sizeof(int)));
  CHECK_MEM_ERROR(cm, cpi->nmvsadcosts_hp[0], vpx_calloc(MV_VALS, sizeof(int)));
  CHECK_MEM_ERROR(cm, cpi->nmvsadcosts_hp[1], vpx_calloc(MV_VALS, sizeof(int)));
