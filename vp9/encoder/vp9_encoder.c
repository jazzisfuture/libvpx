    ...
    switch (cm->bit_depth) {
      case VPX_BITS_8:
        ...
        HIGHBD_BFP(
            ...
            vpx_highbd_8_sub_pixel_avg_variance16x8, vpx_highbd_sad16x8x4d_bits8)
        ...
        HIGHBD_BFP(
            ...
            vpx_highbd_8_sub_pixel_avg_variance8x16, vpx_highbd_sad8x16x4d_bits8)
      ...
      case VPX_BITS_10:
        ...
        HIGHBD_BFP(
            ...
            vpx_highbd_10_sub_pixel_avg_variance4x4, vpx_highbd_sad4x4x4d_bits10)
        break;
      ...
      case VPX_BITS_12:
        ...
        HIGHBD_BFP(
            ...
            vpx_highbd_12_sub_pixel_avg_variance4x4, vpx_highbd_sad4x4x4d_bits12)
        break;
...
#define BFP(BT, SDF, SDAF, VF, SVF, SVAF, SDX4DF) \
  ...
  BFP(BLOCK_8X4, vpx_sad8x4, vpx_sad8x4_avg, vpx_variance8x4,
      vpx_sub_pixel_variance8x4, vpx_sub_pixel_avg_variance8x4,
      vpx_sad8x4x4d)

  BFP(BLOCK_4X8, vpx_sad4x8, vpx_sad4x8_avg, vpx_variance4x8,
      vpx_sub_pixel_variance4x8, vpx_sub_pixel_avg_variance4x8,
      vpx_sad4x8x4d)

  BFP(BLOCK_4X4, vpx_sad4x4, vpx_sad4x4_avg, vpx_variance4x4,
      vpx_sub_pixel_variance4x4, vpx_sub_pixel_avg_variance4x4,
      vpx_sad4x4x4d)
