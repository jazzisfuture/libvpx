...
void vp9_init_plane_quantizers(VP9_COMP *cpi, MACROBLOCK *x) {
...
#if CONFIG_NEW_QUANT
  // TODO(debargha, shunyao): see how did these newly defined var used
...
#endif  // CONFIG_NEW_QUANT
#if CONFIG_TX_SKIP
  // TODO(debargha, shunyao): see how did these newly defined vars are used
  ...
  x->plane[0].quant_thred_sr[0] =
      x->plane[0].zbin_sr[0] * x->plane[0].zbin_sr[0];
  x->plane[0].quant_thred_sr[1] =
      x->plane[0].zbin_sr[1] * x->plane[0].zbin_sr[1];
  ...
  for (i = 1; i < 3; i++) {
    ...
    x->plane[i].quant_thred_sr[0] =
        x->plane[i].zbin_sr[0] * x->plane[i].zbin_sr[0];
    x->plane[i].quant_thred_sr[1] =
        x->plane[i].zbin_sr[1] * x->plane[i].zbin_sr[1];
  }
#endif  // CONFIG_SR_MODE
