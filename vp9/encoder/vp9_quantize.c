...
void vp9_init_plane_quantizers(VP9_COMP *cpi, MACROBLOCK *x) {
  ...
  x->plane[0].quant_thed[0] = cm->y_dequant[qindex][0] *
                                  cm->y_dequant[qindex][0];
  x->plane[0].quant_thed[1] = cm->y_dequant[qindex][1] *
  ...
  for (i = 1; i < 3; i++) {
    ...
    x->plane[i].quant_thed[0] = cm->y_dequant[qindex][0] *
                                    cm->y_dequant[qindex][0];
    x->plane[i].quant_thed[1] = cm->y_dequant[qindex][1] *
                                    cm->y_dequant[qindex][1];
