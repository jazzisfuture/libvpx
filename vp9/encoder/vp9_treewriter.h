...
static FORCEINLINE unsigned int cost_branch(const unsigned int ct[2],
                                            vp9_prob p) {
...
static FORCEINLINE unsigned int cost_branch256(const unsigned int ct[2],
                                               vp9_prob p) {
  /* Imitate existing calculation */
  return ((ct[0] * vp9_cost_zero(p))
          + (ct[1] * vp9_cost_one(p)));
...
static FORCEINLINE void write_token(vp9_writer *const w,
                                    vp9_tree t,
                                    const vp9_prob *const p,
                                    vp9_token *const x) {
...
static FORCEINLINE int cost_token(vp9_tree t,
                                  const vp9_prob *const p,
                                  vp9_token *const x) {
