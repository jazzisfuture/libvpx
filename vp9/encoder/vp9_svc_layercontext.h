...
typedef struct SVC {
  ...
  // Flag to indicate scene change and high num of motion blocks at current superframe,
  // scene detection is currently checked for each superframe prior to encoding,
