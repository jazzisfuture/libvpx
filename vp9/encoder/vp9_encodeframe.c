...
static void rd_use_partition(VP9_COMP *cpi, const TileInfo *const tile,
  ...
  reset_rd_cost(&last_part_rdc);
  reset_rd_cost(&none_rdc);
  reset_rd_cost(&chosen_rdc);
...
static void rd_pick_partition(VP9_COMP *cpi, const TileInfo *const tile,
  ...
  init_rd_cost(&this_rdc);
  init_rd_cost(&sum_rdc);
  reset_rd_cost(&best_rdc);
