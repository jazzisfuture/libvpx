...
static int choose_partitioning(VP9_COMP *cpi, const TileInfo *const tile,
  ...
  for (i = 0; i < 4; i++) {
    ...
    if (!force_split[i + 1]) {
      ...
      max_var_32x32 = var_32x32 > max_var_32x32 ? var_32x32 : max_var_32x32;
      min_var_32x32 = var_32x32 < min_var_32x32 ? var_32x32 : min_var_32x32;
