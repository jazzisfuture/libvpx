...
static void select_in_frame_q_segment(VP9_COMP *cpi,
  ...
  if (!output_enabled) {
    ...
    if (projected_rate > (target_rate * 7 / 4)) {
      segment = 6;
    } else if (projected_rate < (target_rate * 6 / 4)) {
      segment = 5;
    } else if (projected_rate < (target_rate * 5 / 4)) {
      segment = 4;
    } else if (projected_rate < (target_rate * 3 / 4)) {
      segment = 3;
    } else if (projected_rate < (target_rate * 1 / 2)) {
      segment = 2;
    } else if (projected_rate < (target_rate * 1 / 4)) {
      segment = 1;
    } else {
      segment = 0;
    }
