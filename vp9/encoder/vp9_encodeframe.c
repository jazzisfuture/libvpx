  ...
  switch (partition) {
    ...
    case PARTITION_HORZ:
      if (bsize == BLOCK_8X8) {
        ...
        if (bsize < top_bsize)
          extend_all(cpi, tile, 2, bsize, top_bsize, mi_row, mi_col,
                     mi_row_top, mi_col_top, output_enabled,
    ...
    case PARTITION_VERT:
      if (bsize == BLOCK_8X8) {
        ...
        predict_b_extend(cpi, tile, 1, mi_row, mi_col, mi_row, mi_col,
                         ...
                         bsize, top_bsize, BLOCK_8X8, output_enabled, 1, 1);
        if (bsize < top_bsize)
          extend_all(cpi, tile, 1, bsize, top_bsize, mi_row, mi_col,
                     mi_row_top, mi_col_top, output_enabled,
                     dst_buf1, dst_stride1);
    ...
    case PARTITION_SPLIT:
      if (bsize == BLOCK_8X8) {
        ...
        if (bsize < top_bsize) {
          ...
          extend_all(cpi, tile, 3, bsize, top_bsize, mi_row, mi_col,
                     mi_row_top, mi_col_top, output_enabled,
