...
static void set_source_var_based_partition(VP9_COMP *cpi,
  ...
  if ((col8x8_remaining >= MI_BLOCK_SIZE) &&
    ...
    diff d32[4];
    int use16x16 = 0;
    int thr_32x32 = cpi->sf.source_var_thresh;
    int thr_64x64 = thr_32x32 << 1;
    ...
    for (i = 0; i < 4; i++) {
      ...
      for (j = 0; j < 4; j++) {
        ...
        d16[j].var = get_source_diff_16x16(cpi, x, mi_row, mi_col, b_offset,
                                           &d16[j].sse, &d16[j].sum);
