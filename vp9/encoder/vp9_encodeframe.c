...
static const float partition_breakout_weights_64[Q_CTX][FEATURES + 1] = {
    ...
    { -0.160867f, -0.002101f,  0.000011f,  0.002448f, 1.65738142f - 2.5f, },
};
...
static const float partition_breakout_weights_32[Q_CTX][FEATURES + 1] = {
    ...
    { -0.051489f, -0.007609f,  0.000016f,  0.009792f, 1.28089404f - 2.5f, },
};
...
static int ml_predict_breakout(const VP9_COMP *const cpi, BLOCK_SIZE bsize,
  ...
  switch (bsize) {
    case BLOCK_64X64:
      linear_weights = partition_breakout_weights_64[q_ctx]; break;
    case BLOCK_32X32:
      linear_weights = partition_breakout_weights_32[q_ctx]; break;
    case BLOCK_16X16:
      linear_weights = partition_breakout_weights_16[q_ctx]; break;
    case BLOCK_8X8:
      linear_weights = partition_breakout_weights_8[q_ctx]; break;
    default: assert(0 && "Unexpected block size."); return 0;
  }
