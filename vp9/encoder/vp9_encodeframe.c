...
static void rd_pick_partition(VP9_COMP *cpi, ThreadData *td,
  ...
  ref_part = pc_tree->partitioning;
  ref_rd = best_rdc.rdcost;
  ...
  *rd_cost = best_rdc;
  ...
  do {
    ...
    // bs, best partition, ref partition, tried_horz, tried_vert, best rd,
    // ref rd, none rd,
    ...
    fprintf(fp, "%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,%d,"
                "%d,%d,%d,%d,%d,%d,%d,%d,",
            bw, pc_tree->partitioning, ref_part, tried_horz, tried_vert,
            (int)VPXMIN(best_rdc.rdcost, INT_MAX),
            (int)VPXMIN(ref_rd, INT_MAX),
