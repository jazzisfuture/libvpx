...
static BLOCK_SIZE_TYPE min_partition_size[BLOCK_SIZE_TYPES] =
  {BLOCK_SIZE_AB4X4, BLOCK_SIZE_AB4X4, BLOCK_SIZE_AB4X4,
   BLOCK_SIZE_AB4X4, BLOCK_SIZE_SB8X8, BLOCK_SIZE_SB8X8,
   BLOCK_SIZE_SB8X8, BLOCK_SIZE_MB16X16, BLOCK_SIZE_MB16X16,
   BLOCK_SIZE_MB16X16, BLOCK_SIZE_SB32X32, BLOCK_SIZE_SB32X32,
   BLOCK_SIZE_SB32X32};
static BLOCK_SIZE_TYPE max_partition_size[BLOCK_SIZE_TYPES] =
  {BLOCK_SIZE_SB8X8, BLOCK_SIZE_SB8X8, BLOCK_SIZE_SB8X8,
   BLOCK_SIZE_MB16X16, BLOCK_SIZE_MB16X16, BLOCK_SIZE_MB16X16,
   BLOCK_SIZE_SB32X32, BLOCK_SIZE_SB32X32, BLOCK_SIZE_SB32X32,
   BLOCK_SIZE_SB64X64, BLOCK_SIZE_SB64X64, BLOCK_SIZE_SB64X64,
   BLOCK_SIZE_SB64X64};
...
static void rd_auto_partition_range(VP9_COMP *cpi,
  ...
  if (!left_in_image || !above_in_image) {
    *min_block_size = BLOCK_SIZE_SB8X8;
    *max_block_size = BLOCK_SIZE_SB64X64;
  } else {
    *min_block_size =
      min_partition_size[min(left_mbmi->sb_type, above_mbmi->sb_type)];
    *max_block_size = BLOCK_SIZE_SB32X32;
...
static void rd_pick_partition(VP9_COMP *cpi, TOKENEXTRA **tp, int mi_row,
  ...
  // PARTITION_SPLIT
  if (!cpi->sf.use_min_partition_size
      || (cpi->sf.use_min_partition_size
