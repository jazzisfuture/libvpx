    ...
    switch (partition) {
      ...
      case PARTITION_HORZ:
        ...
        if (subsize_high < BLOCK_64X64)
          set_block_size(cpi, x, xd, mi_row_high + bs_high, mi_col, subsize_high);
        break;
      case PARTITION_VERT:
        set_block_size(cpi, x, xd, mi_row_high, mi_col_high, subsize_high);
        if (subsize_high < BLOCK_64X64)
          set_block_size(cpi, x, xd, mi_row_high, mi_col_high + bs_high, subsize_high);
        break;
      case PARTITION_SPLIT:
        ...
        copy_partitioning_svc(cpi, x, xd, subsize, mi_rowref, mi_colref,
                              mi_row + bs, mi_col, mi_row_high + bs_high, mi_col_high);
        copy_partitioning_svc(cpi, x, xd, subsize, mi_rowref, mi_colref, mi_row,
