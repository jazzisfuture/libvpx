  ...
  if (cpi->tile_data == NULL || cpi->allocated_tiles < tile_cols * tile_rows) {
    ...
    for (tile_row = 0; tile_row < tile_rows; ++tile_row)
      for (tile_col = 0; tile_col < tile_cols; ++tile_col) {
        ...
        // tile_data->row_base_thresh_freq_fact =
        //     vpx_calloc(sb_rows * BLOCK_SIZES * MAX_MODES, sizeof(int));
        // memset(tile_data->row_base_thresh_freq_fact, 32,
        //        sb_rows * BLOCK_SIZES * MAX_MODES * sizeof(int));
#endif
