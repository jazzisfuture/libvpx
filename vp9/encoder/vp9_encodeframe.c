...
static void rd_auto_partition_range(VP9_COMP *cpi, const TileInfo *const tile,
  ...
  *min_block_size = MIN(*min_block_size, *max_block_size);
  ...
  // partition is allowed. Making min and max 3 partition type apart will
  // guarantee one square partition in between.
  // TODO (yaowu): using a look-up-table to make the code easier to read.
