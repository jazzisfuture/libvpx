...
static const float
partition_breakout_weights_64[RESOLUTION_CTX][Q_CTX][FEATURES + 1] = {
  {{
      -0.016673f,
      -0.001025f,
      -0.000032f,
  ...
  {
      { -0.064309f, -0.006121f,  0.000232f,  0.005778f, 0.7989465f - 2.5f, },
      { -0.314957f, -0.009346f, -0.000225f,  0.010072f, 2.80695581f - 4.0f, },
      { -0.635535f, -0.015135f,  0.000091f,  0.015247f, 2.90381241f - 3.5f, },
  },
};

static const float
partition_breakout_weights_32[RESOLUTION_CTX][Q_CTX][FEATURES + 1] = {
  {{
      -0.010554f,
      -0.003081f,
      -0.000134f,
  ...
  {
      { -0.024629f, -0.006492f, -0.000254f,  0.004895f, 1.27919173f - 2.0f, },
      { -0.083936f, -0.009827f, -0.000200f,  0.010399f, 2.73731065f - 3.0f, },
      { -0.279052f, -0.013334f,  0.000289f,  0.023203f, 2.43595719f - 2.0f, },
  },
};

static const float
partition_breakout_weights_16[RESOLUTION_CTX][Q_CTX][FEATURES + 1] = {
  {{
      -0.013154f,
      -0.002404f,
      -0.000977f,
  ...
  {
      { -0.007636f, -0.002751f, -0.000682f,  0.005968f, 0.19225763f - 2.0f, },
      { -0.047306f, -0.009113f, -0.000518f,  0.016007f, 2.61068869f - 2.5f, },
      { -0.069336f, -0.010448f, -0.001120f,  0.023083f, 1.47591054f - 4.0f, },
  },
};

static const float
partition_breakout_weights_8[RESOLUTION_CTX][Q_CTX][FEATURES + 1] = {
  {{
      -0.011807f,
      -0.009873f,
      -0.000931f,
  ...
  {
      { -0.003221f, -0.002125f,  0.000993f,  0.012768f, 0.03541421f + 0.5f, },
      { -0.006069f, -0.007335f,  0.000229f,  0.026104f, 0.17135315f - 0.0f, },
      { -0.039894f, -0.011419f,  0.000070f,  0.061817f, 0.6739977f - 0.0f, },
  },
};
...
static int ml_predict_breakout(const VP9_COMP *const cpi, BLOCK_SIZE bsize,
  ...
  //printf("mark %d\n",
    //     linear_score >= cpi->sf.ml_partition_search_breakout_thresh[q_ctx]);
...
#endif  // CONFIG_VP9_HIGHBITDEPTH
#if 0
      const int old_decision =
          (best_rdc.dist < (dist_breakout_thr >> 2)) ||
          (best_rdc.dist < dist_breakout_thr && best_rdc.rate < rate_breakout_thr);
      if (old_decision)
        printf("+++++old_decision %d\n", old_decision);
      else
        printf("old_decision %d\n", old_decision);
#endif
