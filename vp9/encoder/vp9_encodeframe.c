...
static unsigned int get_sby_variance(VP9_COMP *cpi, MACROBLOCK *x,
                                     BLOCK_SIZE_TYPE bs) {
...
static unsigned int get_sbuv_variance(VP9_COMP *cpi, MACROBLOCK *x,
                                      BLOCK_SIZE_TYPE bs) {
...
static void pick_sb_modes(VP9_COMP *cpi, int mi_row, int mi_col,
  ...
  x->source_variance = get_sby_variance(cpi, x, bsize);
...
static void rd_pick_partition(VP9_COMP *cpi, TOKENEXTRA **tp, int mi_row,
  ...
  if (cpi->sf.disable_split_var_thresh) {
    ...
    set_offsets(cpi, mi_row, mi_col, bsize);
    source_variancey = get_sby_variance(cpi, x, bsize);
