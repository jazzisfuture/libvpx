...
typedef struct SPEED_FEATURES {
  ...
  // this process based on block size. The sf becomes more aggressive from 0 to
  // 2 The following table indicates # iterations w.r.t bsize:
  //  --------------------------------------------------
  // |sf|bsize < 8X8|8X8 <= bsize <= 32X32|bsize > 32X32|
  // |0 |     4     |          4          |      4      |
  // |1 |     4     |          2          |      0      |
  // |2 |     0     |          0          |      0      |
  //  --------------------------------------------------
  ...
  int comp_inter_joint_search_num_iter;
