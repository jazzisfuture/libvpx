    ...
    for (h = 0; h < height; ++h) {
      ...
      if (h == 0 || h == (height - 1)) {
        mul_constants = _mm_setr_epi16(
            NEIGHBOR_CONSTANT_4, NEIGHBOR_CONSTANT_6, NEIGHBOR_CONSTANT_6, NEIGHBOR_CONSTANT_6,
            NEIGHBOR_CONSTANT_6, NEIGHBOR_CONSTANT_6, NEIGHBOR_CONSTANT_6, NEIGHBOR_CONSTANT_4);
      } else {
        mul_constants = _mm_setr_epi16(
            NEIGHBOR_CONSTANT_6, NEIGHBOR_CONSTANT_9, NEIGHBOR_CONSTANT_9, NEIGHBOR_CONSTANT_9,
            NEIGHBOR_CONSTANT_9, NEIGHBOR_CONSTANT_9, NEIGHBOR_CONSTANT_9, NEIGHBOR_CONSTANT_6);
      }
    ...
    for (h = 0; h < height; ++h) {
      ...
      if (h == 0 || h == (height - 1)) {
        mul_constants_0 = _mm_setr_epi16(
            NEIGHBOR_CONSTANT_4, NEIGHBOR_CONSTANT_6, NEIGHBOR_CONSTANT_6, NEIGHBOR_CONSTANT_6,
            NEIGHBOR_CONSTANT_6, NEIGHBOR_CONSTANT_6, NEIGHBOR_CONSTANT_6, NEIGHBOR_CONSTANT_6);
        ...
        mul_constants_0 = _mm_setr_epi16(
            NEIGHBOR_CONSTANT_6, NEIGHBOR_CONSTANT_9, NEIGHBOR_CONSTANT_9, NEIGHBOR_CONSTANT_9,
            NEIGHBOR_CONSTANT_9, NEIGHBOR_CONSTANT_9, NEIGHBOR_CONSTANT_9, NEIGHBOR_CONSTANT_9);
        mul_constants_1 = _mm_setr_epi16(
            NEIGHBOR_CONSTANT_9, NEIGHBOR_CONSTANT_9, NEIGHBOR_CONSTANT_9, NEIGHBOR_CONSTANT_9,
            NEIGHBOR_CONSTANT_9, NEIGHBOR_CONSTANT_9, NEIGHBOR_CONSTANT_9, NEIGHBOR_CONSTANT_6);
      }
