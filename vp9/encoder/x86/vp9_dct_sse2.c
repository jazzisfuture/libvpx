...
static INLINE void right_shift_8x8(int const bit, __m128i *res) {
...
static INLINE void right_shift_16x16(__m128i *res0, __m128i *res1) {
  ...
  right_shift_8x8(2, res0);
  right_shift_8x8(2, res0 + 8);
  right_shift_8x8(2, res1);
  right_shift_8x8(2, res1 + 8);
}
