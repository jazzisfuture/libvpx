...
static INLINE void right_shift_8x8(__m128i *res, int const bit) {
  ...
  if (bit > 1) {
    __m128i k_const_rounding = _mm_slli_epi16(kOne, bit_m01);
...
void fadst16_1d_8col(__m128i *in) {
  ...
  s[4] = _mm_packs_epi16(v[0], v[1]);
  s[5] = _mm_packs_epi16(v[2], v[3]);
  s[6] = _mm_packs_epi16(v[4], v[5]);
  s[7] = _mm_packs_epi16(v[6], v[7]);
  s[8] = _mm_add_epi16(x[8], x[10]);
  s[9] = _mm_add_epi16(x[9], x[11]);
  s[10] = _mm_sub_epi16(x[8], x[10]);
  s[11] = _mm_sub_epi16(x[9], x[11]);
  s[12] = _mm_packs_epi16(v[8], v[9]);
  s[13] = _mm_packs_epi16(v[10], v[11]);
  s[14] = _mm_packs_epi16(v[12], v[13]);
  s[15] = _mm_packs_epi16(v[14], v[15]);
