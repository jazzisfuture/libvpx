...
static INLINE void store_zero_tran_low(tran_low_t *a) {
  ...
  _mm256_storeu_si256((__m128i *)(a), zero);
  _mm256_storeu_si256((__m128i *)(a + 4), zero);
#else
...
// enable to match the ssse3 version, disable to match the sse2 version
#define USE_VPSIGNW
...
void vp9_quantize_fp_avx2(const tran_low_t *coeff_ptr, intptr_t n_coeffs,
...
#ifndef USE_VPSIGNW
      coeff256_sign = _mm256_srai_epi16(coeff256, 15);
      qcoeff256 = _mm256_xor_si256(coeff256, coeff256_sign);
      qcoeff256 = _mm256_sub_epi16(qcoeff256, coeff256_sign);
#else
...
#ifndef USE_VPSIGNW
      qcoeff256 = _mm256_xor_si256(qtmp256, coeff256_sign);
      qcoeff256 = _mm256_sub_epi16(qcoeff256, coeff256_sign);
#else
  ...
  while (n_coeffs < 0) {
    __m256i coeff256;
    {
      ...
      nzflag = _mm256_movemask_epi8(_mm256_cmpgt_epi16(qcoeff256, thr256));
  ...
  eob = _mm_max_epi16(_mm256_extracti128_si256(eob256, 0),
