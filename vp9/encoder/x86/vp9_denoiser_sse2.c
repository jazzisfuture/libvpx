...
static int vp9_denoiser_NxM_sse2_1(
...
static int vp9_denoiser_NxM_sse2_2(const uint8_t *sig, int sig_stride,
                                   const uint8_t *mc_running_avg_y,
                                   int mc_avg_y_stride,
                                   uint8_t *running_avg_y,
                                   int avg_y_stride,
...
int vp9_denoiser_filter_sse2(const uint8_t *sig, int sig_stride,
  ...
  if (bs == BLOCK_4X4 || bs == BLOCK_4X8) {
    return vp9_denoiser_NxM_sse2_1(sig, sig_stride,
    ...
    return vp9_denoiser_NxM_sse2_2(sig, sig_stride,
                                        mc_avg, mc_avg_stride,
                                        avg, avg_stride,
                                        increase_denoising,
                                        bs, motion_magnitude);
