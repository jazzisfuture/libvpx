...
static INLINE __m128i vp9_denoiser_16x1_sse2(
    ...
    uint8_t *running_avg_y, const __m128i *k_0, const __m128i *k_4,
    const __m128i *k_8, const __m128i *k_16, const __m128i *l3,
    const __m128i *l32, const __m128i *l21, __m128i acc_diff) {
...
static int vp9_denoiser_NxM_sse2_small(const uint8_t *sig, int sig_stride,
  ...
  for (r = 0; r < b_height; ++r) {
    ...
    acc_diff = vp9_denoiser_16x1_sse2(v_sig[r], v_mc_running_avg_y[r],
                                      running_buffer[r], &k_0, &k_4, &k_8, &k_16,
                                      &l3, &l32, &l21, acc_diff);
