...
SECTION_RODATA
pw_8:         times  8 dw  8
; FIXME(rbultje) merge each second line onto the one above it so they are
; filter pairs
...
; int vp9_sub_pixel_varianceNxh(const uint8_t *src, int src_stride,
...
%if ARCH_X86_64 ; FIXME(rbultje) make strides/offsets ptrdiff_t or intptr_t
