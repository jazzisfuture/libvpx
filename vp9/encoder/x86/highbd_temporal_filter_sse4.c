...
static void apply_temporal_filter_luma_8(
...
static void apply_temporal_filter_luma(
  ...
  apply_temporal_filter_luma_8(
      y_pre + blk_col, y_pre_stride,
      blk_col_step, block_height, ss_x, ss_y,
...
void vp9_highbd_apply_temporal_filter_sse4_1(
  ...
  apply_temporal_filter_luma(
      y_pre, y_pre_stride,
      block_width, block_height, ss_x, ss_y,
