    ...
    for (column_start = 0; column_start < 32; column_start += 8) {
      ...
      }
      {
        ...
        }
        {
          ...
          v[5]= _mm_cmplt_epi16(u[0], kZero);
          v[5]= _mm_add_epi16(v[5], k16_p16_p16);
          v[7]= _mm_cmplt_epi16(u[2], kZero);
          v[7]= _mm_add_epi16(v[7], k16_p16_p16);

          v[0]= _mm_madd_epi16(u[0], v[2]);
          v[1]= _mm_madd_epi16(u[1], k16_p16_m16);
          v[2]= _mm_madd_epi16(u[2], v[4]);
          v[3]= _mm_madd_epi16(u[3], k16_p16_m16);
          v[4]= _mm_madd_epi16(u[0], v[5]);
          v[5]= _mm_madd_epi16(u[1], k16_p16_p16);
          v[6]= _mm_madd_epi16(u[2], v[7]);
