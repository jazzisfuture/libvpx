...
unsigned int vp9_mse8x8_sse2(const unsigned char *src, int src_stride,
                             const unsigned char *ref, int ref_stride,
                             unsigned int *sse) {
...
unsigned int vp9_mse8x16_sse2(const unsigned char *src, int src_stride,
                              const unsigned char *ref, int ref_stride,
                              unsigned int *sse) {
...
unsigned int vp9_mse16x8_sse2(const unsigned char *src, int src_stride,
                              const unsigned char *ref, int ref_stride,
                              unsigned int *sse) {
