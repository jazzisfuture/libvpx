...
#include <assert.h>
#include <smmintrin.h>  // SSE4.1 for _mm_min_epu16()

#include "./vpx_config.h"
#include "vpx/vpx_integer.h"

// These are loaded using an instruction expecting int16_t values but is used
...
static __m128i average_8(__m128i sum, const __m128i mul_constants,
  ...
  // The mamximum input to this comparison is UINT16_MAX * NEIGHBOR_CONSTANT_4
  ...
  if (width == 8) {
    ...
    for (h = 0; h < height; ++h) {
      ...
      if (h == 0 || h == (height - 1)) {
        ...
        mul_constants = _mm_setr_epi16(
            NEIGHBOR_CONSTANT_6, NEIGHBOR_CONSTANT_9, NEIGHBOR_CONSTANT_9,
            NEIGHBOR_CONSTANT_9, NEIGHBOR_CONSTANT_9, NEIGHBOR_CONSTANT_9,
