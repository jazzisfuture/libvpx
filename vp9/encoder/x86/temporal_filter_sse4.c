...
static INLINE void read_dist_8(const int16_t *dist, __m128i *dist_reg) {
  *dist_reg = _mm_loadu_si128((const __m128i *)dist);
}

static INLINE void read_dist_16(const int16_t *dist, __m128i *reg_first,
                                __m128i *reg_second) {
...
static INLINE void get_sum_8(const int16_t *y_dist, __m128i *sum) {
...
static INLINE void get_sum_16(const int16_t *y_dist, __m128i *sum_first,
                              __m128i *sum_second) {
...
static INLINE void read_chroma_dist_row_16(int ss_x, const int16_t *u_dist,
                                           const int16_t *v_dist,
...
static INLINE void add_32_luma_to_chroma_mod(const int16_t *y_dist,
...
static INLINE void add_16_luma_to_chroma_mod(const int16_t *y_dist,
                                             unsigned int dist_stride, int ss_y,
                                             __m128i *u_mod_first,
                                             __m128i *v_mod_first,
                                             __m128i *u_mod_second,
...
static void vp9_apply_temporal_filter_luma_16(
    ...
    uint32_t *y_accum, uint16_t *y_count, const int16_t *y_dist,
    const int16_t *u_dist, const int16_t *v_dist, const int loc) {
  const int rounding = (1 << strength) >> 1;
...
static void vp9_apply_temporal_filter_luma(
    ...
    int ss_x, int ss_y, int strength, const int *const blk_fw, int use_32x32,
    uint32_t *y_accum, uint16_t *y_count, const int16_t *y_dist,
    const int16_t *u_dist, const int16_t *v_dist) {
...
static void vp9_apply_temporal_filter_chroma_16(
    ...
    const int16_t *y_dist, const int16_t *u_dist, const int16_t *v_dist,
    int loc) {
  const int rounding = (1 << strength) >> 1;
  const int dist_stride = 34;
...
void vp9_apply_temporal_filter_sse4_1(
  ...
  DECLARE_ALIGNED(16, int16_t, y_dist[32 * 34]) = { 0 };
  DECLARE_ALIGNED(16, int16_t, u_dist[32 * 34]) = { 0 };
  DECLARE_ALIGNED(16, int16_t, v_dist[32 * 34]) = { 0 };

  int16_t *y_dist_ptr = y_dist + 1, *u_dist_ptr = u_dist + 1,
          *v_dist_ptr = v_dist + 1;
