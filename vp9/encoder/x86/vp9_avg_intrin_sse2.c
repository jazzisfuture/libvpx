...
void vp9_int_pro_row_sse2(int16_t *hbuf, uint8_t *ref, int ref_stride,
                          int height) {
  int idx;
...
int16_t vp9_int_pro_col_sse2(uint8_t *ref, int width) {
  __m128i zero = _mm_setzero_si128();
  __m128i src_line = _mm_load_si128((const __m128i *)ref);
...
int vp9_vector_sad_sse2(int16_t *ref, int16_t *src, int width) {
  int idx;
  __m128i zero = _mm_setzero_si128();
