...
void vp9_quantize_sparse_sse2(int16_t *zbin_boost_orig_ptr,
  ...
  if (!skip_block) {
    ...
    // SIMD: do 8 coefficients at one time.
      ...
      __m128i zbin0;
      __m128i zbin1;
      __m128i zbin_extra = _mm_cvtsi32_si128(zbins[1]);
      ...
      union simd x_zbin, qcoeff, dqcoeff;
      int start = 0;
      int end;
      ...
      qs0 = 1 << qs0;
      qs1 = 1 << qs1;
      quant_shift1 = _mm_cvtsi32_si128(qs1);
      quant_shift1 = _mm_shufflelo_epi16(quant_shift1, 0);
      quant_shift1 = _mm_unpacklo_epi16(quant_shift1, quant_shift1);
      quant_shift0 = _mm_insert_epi16(quant_shift1, qs0, 0);

      // get dequant
      dequant1 = _mm_cvtsi32_si128(dequant_ptr[1]);
      dequant1 = _mm_shufflelo_epi16(dequant1, 0);
      dequant1 = _mm_unpacklo_epi16(dequant1, dequant1);
      dequant0 = _mm_insert_epi16(dequant1, dequant_ptr[0], 0);

      // get fixed zbin part
      zbin_extra = _mm_shufflelo_epi16(zbin_extra, 0);
      zbin1 = _mm_unpacklo_epi16(zbin_extra, zbin_extra);
      zbin0 = _mm_insert_epi16(zbin1, zbins[0], 0);
