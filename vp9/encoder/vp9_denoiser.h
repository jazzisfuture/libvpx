...
void vp9_denoiser_set_noise_level(struct VP9_COMP *const cpi,
                                  VP9_DENOISER *denoiser, int noise_level);

void reset_denoiser_on_first_frame(struct VP9_COMP *const cpi);
