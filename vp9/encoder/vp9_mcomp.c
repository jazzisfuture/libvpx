...
int vp9_find_best_masked_sub_pixel_step_iteratively(
    MACROBLOCK *x,
    uint8_t *mask, int mask_stride, int_mv *bestmv, int_mv *ref_mv,
...
int vp9_masked_full_pixel_diamond(VP9_COMP *cpi, MACROBLOCK *x,
  ...
  bestsme = vp9_masked_diamond_search_sad_c(x,
                                            // mask_index,
                                            mask, mask_stride,
                                            mvp_full, &temp_mv,
  ...
  while (n < further_steps) {
    ...
    if (num00) {
      ...
      thissme = vp9_masked_diamond_search_sad_c(x,
                                                mask, mask_stride,
                                                mvp_full, &temp_mv,
                                                step_param + n, sadpb,
                                                &num00,
  ...
  if (do_refine == 1) {
    ...
    thissme = vp9_masked_refining_search_sad_c(x,
                                               mask, mask_stride,
                                               &best_mv, sadpb,
                                               search_range,
                                               fn_ptr, x->nmvjointcost,
