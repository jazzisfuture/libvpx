...
#define DIST(r, c) \
    vfp->svf(PRE(r, c), y_stride, SP(c), SP(r), z, x->plane[0].src.stride, &sse)
...
int vp9_find_best_sub_pixel_step_iteratively(MACROBLOCK *x, BLOCKD *d,
  ...
  besterr = vfp->vf(y, y_stride, z, x->plane[0].src.stride, sse1);
  *distortion = besterr;
...
int vp9_find_best_sub_pixel_step(MACROBLOCK *x, BLOCKD *d,
  ...
  // calculate central point error
  bestmse = vfp->vf(y, y_stride, z, x->plane[0].src.stride, sse1);
  *distortion = bestmse;
  ...
  thismse = vfp->svf_halfpix_h(y - 1, y_stride, z, x->plane[0].src.stride, &sse);
  ...
  this_mv.as_mv.col += 8;
  thismse = vfp->svf_halfpix_h(y, y_stride, z, x->plane[0].src.stride, &sse);
  ...
  thismse =  vfp->svf_halfpix_v(y - y_stride, y_stride, z, x->plane[0].src.stride, &sse);
  ...
  this_mv.as_mv.row += 8;
  thismse = vfp->svf_halfpix_v(y, y_stride, z, x->plane[0].src.stride, &sse);
  ...
  switch (whichdir) {
    case 0:
      ...
      thismse = vfp->svf_halfpix_hv(y - 1 - y_stride, y_stride, z, x->plane[0].src.stride, &sse);
      break;
    case 1:
      this_mv.as_mv.col += 4;
      this_mv.as_mv.row = (this_mv.as_mv.row - 8) | 4;
      thismse = vfp->svf_halfpix_hv(y - y_stride, y_stride, z, x->plane[0].src.stride, &sse);
      break;
    case 2:
      this_mv.as_mv.col = (this_mv.as_mv.col - 8) | 4;
      this_mv.as_mv.row += 4;
      thismse = vfp->svf_halfpix_hv(y - 1, y_stride, z, x->plane[0].src.stride, &sse);
      break;
    case 3:
    default:
      this_mv.as_mv.col += 4;
      this_mv.as_mv.row += 4;
      thismse = vfp->svf_halfpix_hv(y, y_stride, z, x->plane[0].src.stride, &sse);
      break;
  }
...
//  {
  ...
  switch (whichdir) {
    case 0:
      ...
      if (startmv.as_mv.row & 7) {
        ...
        if (startmv.as_mv.col & 7) {
          this_mv.as_mv.col -= 2;
          thismse = vfp->svf(y, y_stride, SP(this_mv.as_mv.col), SP(this_mv.as_mv.row), z, x->plane[0].src.stride, &sse);
        } else {
          this_mv.as_mv.col = (startmv.as_mv.col - 8) | 6;
          thismse = vfp->svf(y - 1, y_stride, SP(6), SP(this_mv.as_mv.row), z, x->plane[0].src.stride, &sse);;
        }
      } else {
        this_mv.as_mv.row = (startmv.as_mv.row - 8) | 6;
        ...
        if (startmv.as_mv.col & 7) {
          this_mv.as_mv.col -= 2;
          thismse = vfp->svf(y - y_stride, y_stride, SP(this_mv.as_mv.col), SP(6), z, x->plane[0].src.stride, &sse);
        } else {
          this_mv.as_mv.col = (startmv.as_mv.col - 8) | 6;
          thismse = vfp->svf(y - y_stride - 1, y_stride, SP(6), SP(6), z, x->plane[0].src.stride, &sse);
        }
      }
  ...
  if (startmv.as_mv.row & 7) {
    ...
    thismse = vfp->svf(y - y_stride, y_stride, SP(this_mv.as_mv.col), SP(7), z, x->plane[0].src.stride, &sse);
  }
    ...
    case 0:
      ...
      if (startmv.as_mv.row & 7) {
        ...
        if (startmv.as_mv.col & 7) {
          ...
          this_mv.as_mv.col = (startmv.as_mv.col - 8) | 7;
          thismse = vfp->svf(y - 1, y_stride, SP(7), SP(this_mv.as_mv.row), z, x->plane[0].src.stride, &sse);;
        }
      } else {
        this_mv.as_mv.row = (startmv.as_mv.row - 8) | 7;
        ...
        if (startmv.as_mv.col & 7) {
          ...
          this_mv.as_mv.col = (startmv.as_mv.col - 8) | 7;
          thismse = vfp->svf(y - y_stride - 1, y_stride, SP(7), SP(7), z, x->plane[0].src.stride, &sse);
        }
      }
