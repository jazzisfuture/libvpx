...
void vp9_sad64x32x4d_c(const uint8_t *src_ptr, int src_stride,
  ...
  int i;
  for (i = 0; i < 4; ++i)
    sad_array[i] = vp9_sad64x32(src_ptr, src_stride,
                                ref_ptr[i], ref_stride, 0x7fffffff);
}
...
void vp9_sad4x4x8_c(const uint8_t *src_ptr, int  src_stride,
  ...
  int i;
  for (i = 0; i < 8; ++i)
    sad_array[0] = vp9_sad4x4(src_ptr, src_stride, ref_ptr + i, ref_stride,
                              0x7fffffff);
}
...
void vp9_sad8x4x8_c(const uint8_t *src_ptr, int  src_stride,
  ...
  int i;
  for (i = 0; i < 8; ++i)
    sad_array[0] = vp9_sad8x4(src_ptr, src_stride, ref_ptr + i, ref_stride,
                              0x7fffffff);
}
