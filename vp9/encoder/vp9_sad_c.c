...
void vp9_copy32xn_c(const uint8_t *src_ptr,
                    int  src_stride,
                    uint8_t *dst_ptr,
                    int  dst_stride,
                    int height) {
...
#else
    ((uint32_t *)dst_ptr)[0] = ((const uint32_t *)src_ptr)[0];
    ((uint32_t *)dst_ptr)[1] = ((const uint32_t *)src_ptr)[1];
    ((uint32_t *)dst_ptr)[2] = ((const uint32_t *)src_ptr)[2];
    ((uint32_t *)dst_ptr)[3] = ((const uint32_t *)src_ptr)[3];
    ((uint32_t *)dst_ptr)[4] = ((const uint32_t *)src_ptr)[4];
    ((uint32_t *)dst_ptr)[5] = ((const uint32_t *)src_ptr)[5];
    ((uint32_t *)dst_ptr)[6] = ((const uint32_t *)src_ptr)[6];
    ((uint32_t *)dst_ptr)[7] = ((const uint32_t *)src_ptr)[7];
#endif
    src_ptr += src_stride;
    dst_ptr += dst_stride;
