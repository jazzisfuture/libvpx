...
static void Pass0Encode(VP9_COMP *cpi, uint64_t *size, uint8_t *dest,
                        unsigned int *frame_flags) {
  encode_frame_to_data_rate(cpi, size, dest, frame_flags);
}

static void Pass1Encode(VP9_COMP *cpi, uint64_t *size, uint8_t *dest,
                        unsigned int *frame_flags) {
  (void) size;
  (void) dest;
  (void) frame_flags;
...
static void Pass2Encode(VP9_COMP *cpi, uint64_t *size,
