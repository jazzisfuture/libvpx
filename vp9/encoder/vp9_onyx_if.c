...
/*
  printf("%d %d %d %d %d %f %d %d %f %d %d %d %d %d %d \n",
              cpi->common.current_video_frame, q, cpi->rc.active_worst_quality, 0,
               cpi->target_bandwidth, cpi->output_framerate,
               cpi->rc.projected_frame_size, cpi->rc.av_per_frame_bandwidth, cpi->rc.rate_correction_factor,
               cpi->oxcf.starting_buffer_level, cpi->oxcf.optimal_buffer_level, cpi->oxcf.maximum_buffer_size,
               cpi->rc.buffer_level, cpi->rc.bits_off_target, cpi->rc.this_frame_target);
*/
