...
/*!\brief Resize and upload segmentation_map to self object
 *
 * \param    self             Instance of the class
 * \param    segmentation_map Segmentation map to upload
 * \param    height           Height of uploaded segmentation map after resize
 * \param    width            Width of uploaded segmentation map after resize
 */
