...
/*!\brief Upload segmentation map to the class
 *
 * \param    self               Instance of the class
 * \param    segmentation_map   The map itself
 * \param    deep_copy          Flag for deep/shallow upload
 */
void vp9_alt_ref_aq_upload_map(struct ALT_REF_AQ *self,
