...
static void set_rt_speed_feature(VP9_COMP *cpi, SPEED_FEATURES *sf,
  ...
  if (speed >= 4) {
    ...
    sf->inter_mode_mask[BLOCK_32X64] = INTER_NEAREST_NEAR_NEW;
    sf->inter_mode_mask[BLOCK_64X32] = INTER_NEAREST_NEAR_NEW;
    sf->inter_mode_mask[BLOCK_64X64] = INTER_NEAREST_NEAR_NEW;
    sf->max_intra_bsize = BLOCK_32X32;
    sf->allow_skip_recode = 1;
  }
