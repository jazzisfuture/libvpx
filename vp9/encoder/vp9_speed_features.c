...
static MESH_PATTERN best_quality_mesh_pattern[MAX_MESH_STEP] =
    {{64, 4}, {32, 2}, {15, 1}, {7, 1}, {1, 1}, {1, 1}};

#define MAX_MESH_SPEED 5  // Max speed setting for mesh motion method
static MESH_PATTERN good_quality_mesh_patterns[MAX_MESH_SPEED + 1]
                                              [MAX_MESH_STEP] =
    {{ {64, 8}, {32, 4}, {15, 1}, {7, 1}, {3, 1}, {2, 1}},
     { {64, 8}, {32, 4}, {15, 1}, {7, 1}, {3, 1}, {2, 1}},
     { {64, 16}, {32, 8}, {15, 2}, {7, 1}, {3, 1}, {2, 1}},
     { {64, 16}, {32, 8}, {15, 4}, {7, 1}, {3, 1 }, {2, 1 }},
     { {64, 16}, {32, 8}, {15, 4}, {7, 1}, {3, 1 }, {2, 1 }},
     { {64, 16}, {32, 8}, {15, 4}, {7, 1}, {3, 1 }, {2, 1 }},
    };
...
void vp9_set_speed_features_framesize_independent(VP9_COMP *cpi) {
  ...
  if (oxcf->mode == BEST) {
    ...
    if (cpi->twopass.fr_content_type == FC_GRAPHICS_ANIMATION)
      sf->exhaustive_searches_thresh = (1 << 22 + speed);
    else
      sf->exhaustive_searches_thresh = (1 << 23 + speed);
