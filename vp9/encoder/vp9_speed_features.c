...
static void set_good_speed_feature_framesize_dependent(VP9_COMP *cpi,
  ...
  if (is_480p_or_larger) {
    ...
    sf->rd_ml_partition_search_early_termination = 1;
  } else {
    sf->use_square_only_thresh_high = BLOCK_32X32;
  }

  if (!is_1080p_or_larger) {
    sf->rd_use_ml_partition_search_breakout = 1;
    if (is_720p_or_larger) {
      sf->rd_ml_partition_search_breakout_thresh[0] = 0.0f;
      sf->rd_ml_partition_search_breakout_thresh[1] = 0.0f;
      sf->rd_ml_partition_search_breakout_thresh[2] = 0.0f;
    } else {
      sf->rd_ml_partition_search_breakout_thresh[0] = 2.5f;
      sf->rd_ml_partition_search_breakout_thresh[1] = 1.5f;
      sf->rd_ml_partition_search_breakout_thresh[2] = 1.5f;
    }
  }

  if (speed >= 1) {
    sf->rd_ml_partition_search_early_termination = 0;
    sf->rd_use_ml_partition_search_breakout = 1;
    if (is_480p_or_larger)
    ...
    if (is_720p_or_larger) {
      ...
      sf->rd_ml_partition_search_breakout_thresh[0] = -5.0f;
      sf->rd_ml_partition_search_breakout_thresh[1] = -5.0f;
      sf->rd_ml_partition_search_breakout_thresh[2] = -9.0f;
    } else {
      sf->disable_split_mask = DISABLE_COMPOUND_SPLIT;
      sf->partition_search_breakout_thr.dist = (1 << 21);
      sf->rd_ml_partition_search_breakout_thresh[0] = -1.0f;
      sf->rd_ml_partition_search_breakout_thresh[1] = -1.0f;
      sf->rd_ml_partition_search_breakout_thresh[2] = -1.0f;
    }
  ...
  if (speed >= 2) {
    ...
    if (is_720p_or_larger) {
      ...
      sf->rd_use_ml_partition_search_breakout = 0;
    } else {
      ...
      sf->rd_ml_partition_search_breakout_thresh[0] = 0.0f;
      sf->rd_ml_partition_search_breakout_thresh[1] = -1.0f;
      sf->rd_ml_partition_search_breakout_thresh[2] = -4.0f;
    }
...
static void set_good_speed_feature_framesize_independent(VP9_COMP *cpi,
  ...
  sf->rd_ml_var_partition_pruning = 1;
  ...
  if (speed >= 1) {
    ...
    sf->rd_ml_var_partition_pruning = !boosted;
  ...
  if (speed >= 2) {
    sf->rd_ml_var_partition_pruning = 0;
...
static void set_rt_speed_feature_framesize_independent(
  ...
  if (speed >= 6) {
    ...
    if (!sf->nonrd_use_ml_partition) sf->partition_search_type = VAR_BASED_PARTITION;
