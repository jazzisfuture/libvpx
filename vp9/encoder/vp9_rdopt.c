...
static void rd_variance_adjustment(VP9_COMP *cpi, MACROBLOCK *x,
  ...
  if (source_variance > low_var_thresh[cpi->oxcf.content]) return;
  ...
  adj_max = max_var_adjust[cpi->oxcf.content];

  var_factor =
      (unsigned int)((int64_t)200 * absvar_diff) / VPXMAX(1, src_variance);
