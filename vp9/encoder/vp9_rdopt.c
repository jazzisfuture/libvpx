...
#if CONFIG_NEWMVREF
  {NEAREST_NEARFORNEWMV, {LAST_FRAME,   ALTREF_FRAME}},
  {NEAREST_NEARFORNEWMV, {GOLDEN_FRAME, ALTREF_FRAME}},
  {NEARFORNEW_NEARESTMV, {LAST_FRAME,   ALTREF_FRAME}},
  {NEARFORNEW_NEARESTMV, {GOLDEN_FRAME, ALTREF_FRAME}},

  {NEAR_NEARFORNEWMV, {LAST_FRAME,   ALTREF_FRAME}},
  {NEAR_NEARFORNEWMV, {GOLDEN_FRAME, ALTREF_FRAME}},
  {NEARFORNEW_NEARMV, {LAST_FRAME,   ALTREF_FRAME}},
  {NEARFORNEW_NEARMV, {GOLDEN_FRAME, ALTREF_FRAME}},

  {NEW_NEARFORNEWMV,  {LAST_FRAME,   ALTREF_FRAME}},
  {NEW_NEARFORNEWMV,  {GOLDEN_FRAME, ALTREF_FRAME}},
  {NEARFORNEW_NEWMV,  {LAST_FRAME,   ALTREF_FRAME}},
  {NEARFORNEW_NEWMV,  {GOLDEN_FRAME, ALTREF_FRAME}},
  {NEARFORNEW_NEARFORNEWMV, {LAST_FRAME,   ALTREF_FRAME}},
  {NEARFORNEW_NEARFORNEWMV, {GOLDEN_FRAME, ALTREF_FRAME}},
#endif  // CONFIG_NEWMVREF
...
static int set_and_cost_bmi_mvs(VP9_COMP *cpi, MACROBLOCKD *xd, int i,
  ...
  switch (mode) {
    ...
    case NEW_NEWMV:
#if CONFIG_NEWMVREF
    case NEW_NEARFORNEWMV:
    case NEARFORNEW_NEWMV:
    case NEARFORNEW_NEARFORNEWMV:
#endif  // CONFIG_NEWMVREF
      this_mv[0].as_int = frame_mv[mbmi->ref_frame[0]].as_int;
      thismvcost += vp9_mv_bit_cost(&this_mv[0].as_mv, &ref_mv[0]->as_mv,
                                    mvjcost, mvcost, MV_COST_WEIGHT_SUB);
    ...
    case NEW_NEARESTMV:
#if CONFIG_NEWMVREF
    case NEARFORNEW_NEARMV:
    case NEARFORNEW_NEARESTMV:
#endif  // CONFIG_NEWMVREF
      this_mv[0].as_int = frame_mv[mbmi->ref_frame[0]].as_int;
#if CONFIG_NEWMVREF
    ...
    case NEAREST_NEWMV:
#if CONFIG_NEWMVREF
    case NEAR_NEARFORNEWMV:
    case NEAREST_NEARFORNEWMV:
#endif  // CONFIG_NEWMVREF
      this_mv[0].as_int = frame_mv[mbmi->ref_frame[0]].as_int;
      this_mv[1].as_int = frame_mv[mbmi->ref_frame[1]].as_int;
#if CONFIG_NEWMVREF
...
static int64_t rd_pick_best_sub8x8_mode(
  ...
  bsi->mvp.as_int = mbmi->ref_mvs[refs[0]][0].as_int;
  bsi->mvthresh = mvthresh;

  for (i = 0; i < 1 + has_second_rf; ++i) {
    ref_mv_sub8x8[i].as_int =
        mbmi->ref_mvs[refs[i]][0].as_int;
  ...
  for (idy = 0; idy < 2; idy += num_4x4_blocks_high) {
    for (idx = 0; idx < 2; idx += num_4x4_blocks_wide) {
...
#endif  // CONFIG_NEWMVREF
#if CONFIG_NEWMVREF
        mv_ref_list[0].as_int = nearest_mv[ref].as_int;
        mv_ref_list[1].as_int = near_mv[ref].as_int;
        vp9_find_best_ref_mvs(xd, cm->allow_high_precision_mv, mv_ref_list,
                              &ref_mvs_sub8x8[0][ref], &ref_mvs_sub8x8[1][ref]);
#endif  // CONFIG_NEWMVREF

#if !CONFIG_NEWMVREF
        frame_mv[NEWMV][frame].as_int = seg_mvs[i][frame].as_int;
#endif  // !CONFIG_NEWMVREF

        if (has_second_rf) {
#if CONFIG_NEWMVREF
          frame_mv[NEWMV][frame].as_int = seg_mvs[i][0][frame].as_int;
          frame_mv[NEAR_FORNEWMV][frame].as_int = seg_mvs[i][1][frame].as_int;
#else
#if CONFIG_COMPOUND_MODES
          frame_mv[NEW_NEWMV][frame].as_int = seg_mvs[i][frame].as_int;
#endif  // CONFIG_COMPOUND_MODES
#endif  // CONFIG_NEWMVREF
          ...
          if (ref == 0) {
...
#if CONFIG_NEWMVREF
            frame_mv[NEAREST_NEARFORNEWMV][frame].as_int =
                frame_mv[NEARESTMV][frame].as_int;
            frame_mv[NEARFORNEW_NEARESTMV][frame].as_int =
                frame_mv[NEAR_FORNEWMV][frame].as_int;
#endif  // CONFIG_NEWMVREF
            ...
            frame_mv[NEW_NEARMV][frame].as_int =
                frame_mv[NEWMV][frame].as_int;
#if CONFIG_NEWMVREF
            frame_mv[NEAR_NEARFORNEWMV][frame].as_int =
                frame_mv[NEARMV][frame].as_int;
            frame_mv[NEARFORNEW_NEARMV][frame].as_int =
                frame_mv[NEAR_FORNEWMV][frame].as_int;
#endif  // CONFIG_NEWMVREF
          } else {
            frame_mv[NEAREST_NEARMV][frame].as_int =
...
#if CONFIG_NEWMVREF
           this_mode <=
           (has_second_rf ? NEARFORNEW_NEARFORNEWMV : NEAR_FORNEWMV);
...
#else  // CONFIG_COMPOUND_MODES
#if CONFIG_NEWMVREF
      for (this_mode = ZEROMV; this_mode <= NEAR_FORNEWMV; ++this_mode) {
#else  // CONFIG_NEWMVREF
      for (this_mode = NEARESTMV; this_mode <= NEWMV; ++this_mode) {
...
#if CONFIG_NEWMVREF
        // Specify reference mvs for each sub8x8 partition
#if CONFIG_COMPOUND_MODES
        vp9_get_mv_idx(mv_idx, has_second_rf, this_mode);
#else
        mv_idx[0] = mv_idx[1] = (this_mode == NEAR_FORNEWMV) ? 1 : 0;
#endif  // CONFIG_COMPOUND_MODES

        for (ref = 0; ref < 1 + has_second_rf; ++ref)
          ref_mv_sub8x8[ref].as_int = ref_mvs_sub8x8[mv_idx[ref]][ref].as_int;
#endif  // CONFIG_NEWMVREF
...
#if CONFIG_NEWMVREF
          seg_mvs[i][mv_idx[0]][refs[0]].as_int =
        ...
        if (has_second_rf) {
#if CONFIG_NEWMVREF
          if (seg_mvs[i][mv_idx[1]][refs[1]].as_int == INVALID_MV ||
              seg_mvs[i][mv_idx[0]][refs[0]].as_int == INVALID_MV)
#else
          ...
          for (ref = 0; ref < 2; ++ref) {
            ...
            seg_mv_sub8x8[refs[ref]].as_int =
                seg_mvs[i][mv_idx[ref]][refs[ref]].as_int;
#else
      ...
      // Specify reference mvs for each sub8x8 partition
#if CONFIG_COMPOUND_MODES
      vp9_get_mv_idx(mv_idx, has_second_rf, mode_selected);
#else
      mv_idx[0] = mv_idx[1] = (mode_selected == NEAR_FORNEWMV) ? 1 : 0;
#endif  // CONFIG_COMPOUND_MODES
      ...
      set_and_cost_bmi_mvs(cpi, xd, i, mode_selected, mode_mv[mode_selected],
                           frame_mv[mode_selected], bsi->ref_mv,
                           x->nmvjointcost, x->mvcost);
  ...
  if (is_comp_pred) {
    ...
    if (cpi->sf.adaptive_mode_search) {
      ...
      switch (this_mode) {
        ...
        case NEAREST_NEARFORNEWMV:
          if (single_filter[NEARESTMV][refs[0]] ==
              single_filter[NEAR_FORNEWMV][refs[1]])
            best_filter = single_filter[NEARESTMV][refs[0]];
          break;
        case NEARFORNEW_NEARESTMV:
          if (single_filter[NEAR_FORNEWMV][refs[0]] ==
              single_filter[NEARESTMV][refs[1]])
            best_filter = single_filter[NEAR_FORNEWMV][refs[0]];
          break;
        case NEAR_NEARFORNEWMV:
          if (single_filter[NEARMV][refs[0]] ==
              single_filter[NEAR_FORNEWMV][refs[1]])
...
#if CONFIG_NEWMVREF
    // Identify the reference mv indexes
    // 1: NEARMV as reference mv
    // 0: NEARESTMV as reference mv
#if CONFIG_COMPOUND_MODES
    vp9_get_mv_idx(mv_idx, is_comp_pred, this_mode);
#else
    mv_idx[0] = mv_idx[1] = (this_mode == NEAR_FORNEWMV) ? 1 : 0;
#endif  // CONFIG_COMPOUND_MODES
#endif  // CONFIG_NEWMVREF
...
#if CONFIG_NEWMVREF
      for (i = 0; i < 2; ++i) {
        ref_mv[i] = mbmi->ref_mvs[refs[i]][mv_idx[i]];
        single_newmv[refs[i]].as_int =
            single_newmvs[mv_idx[i]][refs[i]].as_int;
      }
#endif  // CONFIG_NEWMVREF
...
#if CONFIG_NEWMVREF
        single_newmvs[mv_idx[0]][refs[0]].as_int = tmp_mv.as_int;
        single_newmv_rates[mv_idx[0]][refs[0]] = rate_mv;
#else
...
#if CONFIG_NEWMVREF
        frame_mv[refs[0]].as_int = single_newmvs[mv_idx[0]][refs[0]].as_int;
        rate_mv = single_newmv_rates[mv_idx[0]][refs[0]];
#else
  ...
  for (i = 0; i < is_comp_pred + 1; ++i) {
    ...
    if (this_mode != NEWMV && this_mode != NEW_NEWMV
        ...
        && !((this_mode == NEAR_NEWMV ||
              ...
              this_mode == NEAREST_NEARFORNEWMV ||
#endif  // CONFIG_NEWMVREF
              this_mode == NEAREST_NEWMV) && i == 1)
        && !((this_mode == NEW_NEARMV ||
#if CONFIG_NEWMVREF
              this_mode == NEARFORNEW_NEARMV ||
              this_mode == NEARFORNEW_NEARESTMV ||
#endif  // CONFIG_NEWMVREF
              this_mode == NEW_NEARESTMV) && i == 0))
#else
#if CONFIG_NEWMVREF
    if (this_mode != NEWMV && this_mode != NEAR_FORNEWMV)
#else
  ...
  if (cpi->sf.adaptive_mode_search)
    if (is_comp_pred) {
      ...
      switch (this_mode) {
        ...
        case NEAREST_NEARFORNEWMV:
          if (single_skippable[NEARESTMV][refs[0]] &&
              single_skippable[NEAR_FORNEWMV][refs[1]])
            vpx_memset(skip_txfm, 1, sizeof(skip_txfm));
          break;
        case NEARFORNEW_NEARESTMV:
          if (single_skippable[NEAR_FORNEWMV][refs[0]] ==
              single_skippable[NEARESTMV][refs[1]])
            vpx_memset(skip_txfm, 1, sizeof(skip_txfm));
          break;
        case NEAR_NEARFORNEWMV:
...
void vp9_rd_pick_inter_mode_sb(VP9_COMP *cpi, MACROBLOCK *x,
  ...
  *returnrate_nocoef = INT_MAX;
...
#if CONFIG_NEWMVREF
    frame_mv[NEW_NEARFORNEWMV][ref_frame].as_int = INVALID_MV;
    frame_mv[NEARFORNEW_NEWMV][ref_frame].as_int = INVALID_MV;
    frame_mv[NEARFORNEW_NEARFORNEWMV][ref_frame].as_int = INVALID_MV;
#endif  // CONFIG_NEWMVREF
  ...
  for (midx = 0; midx < MAX_MODES; ++midx) {
    ...
    if (this_mode == NEAREST_NEARESTMV) {
      ...
      frame_mv[NEW_NEWMV][second_ref_frame].as_int =
          frame_mv[NEWMV][second_ref_frame].as_int;
#if CONFIG_NEWMVREF
    } else if (this_mode == NEAREST_NEARFORNEWMV) {
      frame_mv[NEAREST_NEARFORNEWMV][ref_frame].as_int =
          frame_mv[NEARESTMV][ref_frame].as_int;
      frame_mv[NEAREST_NEARFORNEWMV][second_ref_frame].as_int =
          frame_mv[NEAR_FORNEWMV][second_ref_frame].as_int;
    } else if (this_mode == NEARFORNEW_NEARESTMV) {
      frame_mv[NEARFORNEW_NEARESTMV][ref_frame].as_int =
          frame_mv[NEAR_FORNEWMV][ref_frame].as_int;
      frame_mv[NEARFORNEW_NEARESTMV][second_ref_frame].as_int =
          frame_mv[NEARESTMV][second_ref_frame].as_int;
    } else if (this_mode == NEAR_NEARFORNEWMV) {
      frame_mv[NEAR_NEARFORNEWMV][ref_frame].as_int =
        frame_mv[NEARMV][ref_frame].as_int;
      frame_mv[NEAR_NEARFORNEWMV][second_ref_frame].as_int =
          frame_mv[NEAR_FORNEWMV][second_ref_frame].as_int;
    } else if (this_mode == NEARFORNEW_NEARMV) {
      frame_mv[NEARFORNEW_NEARMV][ref_frame].as_int =
          frame_mv[NEAR_FORNEWMV][ref_frame].as_int;
      frame_mv[NEARFORNEW_NEARMV][second_ref_frame].as_int =
        frame_mv[NEARMV][second_ref_frame].as_int;
    } else if (this_mode == NEW_NEARFORNEWMV) {
      frame_mv[NEW_NEARFORNEWMV][ref_frame].as_int =
          frame_mv[NEWMV][ref_frame].as_int;
      frame_mv[NEW_NEARFORNEWMV][second_ref_frame].as_int =
        frame_mv[NEAR_FORNEWMV][second_ref_frame].as_int;
    } else if (this_mode == NEARFORNEW_NEWMV) {
      frame_mv[NEARFORNEW_NEWMV][ref_frame].as_int =
          frame_mv[NEAR_FORNEWMV][ref_frame].as_int;
      frame_mv[NEARFORNEW_NEWMV][second_ref_frame].as_int =
        frame_mv[NEWMV][second_ref_frame].as_int;
    } else if (this_mode == NEARFORNEW_NEARFORNEWMV) {
      frame_mv[NEARFORNEW_NEARFORNEWMV][ref_frame].as_int =
          frame_mv[NEAR_FORNEWMV][ref_frame].as_int;
      frame_mv[NEARFORNEW_NEARFORNEWMV][second_ref_frame].as_int =
          frame_mv[NEAR_FORNEWMV][second_ref_frame].as_int;
#endif  // CONFIG_NEWMVREF
    }
#endif  // CONFIG_COMPOUND_MODES
  ...
  if (best_mbmode.mode == NEW_NEWMV ||
      best_mbmode.mode == NEW_NEARFORNEWMV ||
      best_mbmode.mode == NEARFORNEW_NEWMV ||
      best_mbmode.mode == NEARFORNEW_NEARFORNEWMV) {
#else
  if (best_mbmode.mode == NEW_NEWMV) {
#endif  // CONFIG_NEWMVREF
    const MV_REFERENCE_FRAME refs[2] = {best_mbmode.ref_frame[0],
