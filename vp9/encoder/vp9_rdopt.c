...
static void mv_pred(VP9_COMP *cpi, MACROBLOCK *x,
  ...
  int_mv pred_mv[3];
  pred_mv[0].as_int = mbmi->ref_mvs[ref_frame][0].as_int;
  pred_mv[1].as_int = mbmi->ref_mvs[ref_frame][1].as_int;
  pred_mv[2].as_int = x->pred_mv[ref_frame].as_int;
...
static void single_motion_search(VP9_COMP *cpi, MACROBLOCK *x,
  ...
  int_mv pred_mv[3];
  pred_mv[0].as_int = mbmi->ref_mvs[ref][0].as_int;
  pred_mv[1].as_int = mbmi->ref_mvs[ref][1].as_int;
  pred_mv[2].as_int = x->pred_mv[ref].as_int;
