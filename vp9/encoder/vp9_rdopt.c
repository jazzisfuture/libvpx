...
static int rdcost_mby_8x8(MACROBLOCK *mb) {
  int cost = 0;
  int b;
  MACROBLOCKD *xd = &mb->e_mbd;
  ENTROPY_CONTEXT_PLANES t_above, t_left;
...
static int rdcost_mby_16x16(MACROBLOCK *mb) {
  ...
  return cost_coeffs(mb, 0, PLANE_TYPE_Y_WITH_DC, ta, tl, TX_16X16);
}
...
static void macro_block_yrd(VP9_COMP *cpi, MACROBLOCK *x, int *rate,
  ...
  macro_block_yrd_16x16(x, &r[TX_16X16][0], &d[TX_16X16], &s[TX_16X16]);
  macro_block_yrd_8x8(x, &r[TX_8X8][0], &d[TX_8X8], &s[TX_8X8]);
  macro_block_yrd_4x4(x, &r[TX_4X4][0], &d[TX_4X4], &s[TX_4X4]);
...
static int rdcost_sby_4x4(MACROBLOCK *x) {
  int cost = 0, b;
  MACROBLOCKD *const xd = &x->e_mbd;
  ...
  for (b = 0; b < 64; b++)
    cost += cost_coeffs(x, b, PLANE_TYPE_Y_WITH_DC,
...
static void super_block_yrd_4x4(MACROBLOCK *x,
  ...
  *rate       = rdcost_sby_4x4(x);
  *skippable  = vp9_sby_is_skippable_4x4(xd);
}

static int rdcost_sby_8x8(MACROBLOCK *x) {
  int cost = 0, b;
  MACROBLOCKD *const xd = &x->e_mbd;
  ENTROPY_CONTEXT_PLANES t_above[2], t_left[2];
  ENTROPY_CONTEXT *ta = (ENTROPY_CONTEXT *) &t_above;
...
static void super_block_yrd_8x8(MACROBLOCK *x,
  ...
  *distortion = vp9_sb_block_error_c(x->coeff, xd->dqcoeff, 1024);
  *rate       = rdcost_sby_8x8(x);
  *skippable  = vp9_sby_is_skippable_8x8(xd);
}

static int rdcost_sby_16x16(MACROBLOCK *x) {
  int cost = 0, b;
  MACROBLOCKD *const xd = &x->e_mbd;
  ENTROPY_CONTEXT_PLANES t_above[2], t_left[2];
  ENTROPY_CONTEXT *ta = (ENTROPY_CONTEXT *) &t_above;
...
static void super_block_yrd_16x16(MACROBLOCK *x,
                                  int *rate, int *distortion, int *skippable) {
  MACROBLOCKD *const xd = &x->e_mbd;
...
static void super_block_yrd(VP9_COMP *cpi,
  ...
  super_block_yrd_16x16(x, &r[TX_16X16][0], &d[TX_16X16], &s[TX_16X16]);
  super_block_yrd_8x8(x,   &r[TX_8X8][0],   &d[TX_8X8],   &s[TX_8X8]);
  super_block_yrd_4x4(x,   &r[TX_4X4][0],   &d[TX_4X4],   &s[TX_4X4]);
...
static int rdcost_sb64y_4x4(MACROBLOCK *x) {
  int cost = 0, b;
  MACROBLOCKD *const xd = &x->e_mbd;
...
static void super_block64_yrd_4x4(MACROBLOCK *x,
                                  int *rate, int *distortion, int *skippable) {
  MACROBLOCKD *const xd = &x->e_mbd;
  ...
  *distortion = vp9_sb_block_error_c(x->coeff, xd->dqcoeff, 4096);
  *rate       = rdcost_sb64y_4x4(x);
  *skippable  = vp9_sb64y_is_skippable_4x4(xd);
}

static int rdcost_sb64y_8x8(MACROBLOCK *x) {
  int cost = 0, b;
  MACROBLOCKD *const xd = &x->e_mbd;
  ENTROPY_CONTEXT_PLANES t_above[4], t_left[4];
  ENTROPY_CONTEXT *ta = (ENTROPY_CONTEXT *) &t_above;
...
static void super_block64_yrd_8x8(MACROBLOCK *x,
                                  int *rate, int *distortion, int *skippable) {
  MACROBLOCKD *const xd = &x->e_mbd;
  ...
  *distortion = vp9_sb_block_error_c(x->coeff, xd->dqcoeff, 4096);
  *rate       = rdcost_sb64y_8x8(x);
  *skippable  = vp9_sb64y_is_skippable_8x8(xd);
}

static int rdcost_sb64y_16x16(MACROBLOCK *x) {
  int cost = 0, b;
  MACROBLOCKD *const xd = &x->e_mbd;
  ENTROPY_CONTEXT_PLANES t_above[4], t_left[4];
  ENTROPY_CONTEXT *ta = (ENTROPY_CONTEXT *) &t_above;
...
static void super_block64_yrd_16x16(MACROBLOCK *x, int *rate, int *distortion,
                                    int *skippable) {
  MACROBLOCKD *const xd = &x->e_mbd;
  ...
  *distortion = vp9_sb_block_error_c(x->coeff, xd->dqcoeff, 4096);
  *rate       = rdcost_sb64y_16x16(x);
  *skippable  = vp9_sb64y_is_skippable_16x16(xd);
}

static int rdcost_sb64y_32x32(MACROBLOCK *x) {
  int cost = 0, b;
  MACROBLOCKD * const xd = &x->e_mbd;
  ENTROPY_CONTEXT_PLANES t_above[4], t_left[4];
  ENTROPY_CONTEXT *ta = (ENTROPY_CONTEXT *) &t_above;
...
static void super_block64_yrd_32x32(MACROBLOCK *x, int *rate, int *distortion,
                                    int *skippable) {
  MACROBLOCKD *const xd = &x->e_mbd;
...
static void super_block_64_yrd(VP9_COMP *cpi,
  ...
  vp9_subtract_sby_s_c(x->src_diff, src, src_y_stride, dst, dst_y_stride);
  super_block64_yrd_32x32(x, &r[TX_32X32][0], &d[TX_32X32], &s[TX_32X32]);
  super_block64_yrd_16x16(x, &r[TX_16X16][0], &d[TX_16X16], &s[TX_16X16]);
  super_block64_yrd_8x8(x,   &r[TX_8X8][0],   &d[TX_8X8],   &s[TX_8X8]);
  super_block64_yrd_4x4(x,   &r[TX_4X4][0],   &d[TX_4X4],   &s[TX_4X4]);
  choose_txfm_size_from_rd(cpi, x, r, rate, d, distortion, s, skip, txfm_cache,
                           TX_SIZE_MAX_SB - 1);
}
