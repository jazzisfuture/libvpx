...
static unsigned int low_var_thresh[VP9E_CONTENT_INVALID] = {10, 10, 10, 20};
static unsigned int max_var_adjust[VP9E_CONTENT_INVALID] = {16, 16, 100, 200};
static unsigned int var_multiplier[VP9E_CONTENT_INVALID] = {100, 100, 100, 200};
...
static void rd_variance_adjustment(VP9_COMP *cpi, MACROBLOCK *x,
  ...
  if (source_variance > low_var_thresh[content_type]) return;
  ...
  var_factor =
      (unsigned int)((int64_t)var_multiplier[content_type] * absvar_diff) /
