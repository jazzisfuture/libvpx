...
#if CONFIG_EXT_REFS
      vpx_prob ref_single_p3 = vp9_get_pred_prob_single_ref_p3(cm, xd);
      vpx_prob ref_single_p4 = vp9_get_pred_prob_single_ref_p4(cm, xd);
      vpx_prob ref_single_p5 = vp9_get_pred_prob_single_ref_p5(cm, xd);
#endif  // CONFIG_EXT_REFS
...
#if CONFIG_EXT_REFS
      vpx_prob ref_comp_p1 = vp9_get_pred_prob_comp_ref_p1(cm, xd);
      vpx_prob ref_comp_p2 = vp9_get_pred_prob_comp_ref_p2(cm, xd);
      vpx_prob ref_comp_p3 = vp9_get_pred_prob_comp_ref_p3(cm, xd);
#endif  // CONFIG_EXT_REFS
      unsigned int base_cost = vp9_cost_bit(intra_inter_p, 1);
