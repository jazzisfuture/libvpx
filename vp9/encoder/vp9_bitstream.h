...
#define ONE_BYTE_THRESH(type)   (ONE_BYTE_LIMIT(type) - (ONE_BYTE_LIMIT(type) >> 2))
#define TWO_BYTE_THRESH(type)   (TWO_BYTE_LIMIT(type) - (TWO_BYTE_LIMIT(type) >> 2))
#define THREE_BYTE_THRESH(type) (THREE_BYTE_LIMIT(type) - (THREE_BYTE_LIMIT(type) >> 2))
