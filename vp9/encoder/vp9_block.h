...
typedef unsigned int vp9_coeff_skipval_cost[PLANE_TYPES][REF_TYPES][COEF_BANDS]
                                           [COEFF_CONTEXTS];
typedef unsigned int vp9_zpc_cost[PLANE_TYPES][REF_TYPES][COEF_BANDS]
                                 [ZPC_PTOKS][ZPC_NODES + 1];
...
#endif  // CONFIG_TX_SKIP
#if CONFIG_CODE_ZEROGROUP
  vp9_coeff_skipval_cost token_skipval_costs[TX_SIZES];
  vp9_zpc_cost zpc_costs[TX_SIZES];
#endif  // CONFIG_CODE_ZEROGROUP
