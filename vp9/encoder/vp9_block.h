...
struct macroblock {
  ...
  DECLARE_ALIGNED(16, int16_t, coeff[MAX_MB_PLANE][TX_SIZES][64 * 64]);
  DECLARE_ALIGNED(16, int16_t, qcoeff[MAX_MB_PLANE][TX_SIZES][64 * 64]);
  DECLARE_ALIGNED(16, int16_t, dqcoeff[MAX_MB_PLANE][TX_SIZES][64 * 64]);
  DECLARE_ALIGNED(16, uint16_t, eobs[MAX_MB_PLANE][TX_SIZES][256]);
