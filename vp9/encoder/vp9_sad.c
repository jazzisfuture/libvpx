...
unsigned int vp9_high_sad##m##x##n##_avg_c(const uint8_t *src_ptr, int src_stride, \
                                      const uint8_t *ref_ptr, int ref_stride, \
                                      const uint8_t *second_pred, \
                                      unsigned int max_sad) { \
...
void vp9_high_sad64x32x4d_c(const uint8_t *src_ptr, int src_stride,
  ...
  int i;
  for (i = 0; i < 4; ++i)
    sad_array[i] = vp9_high_sad64x32(src_ptr, src_stride, ref_ptr[i], ref_stride,
                                0x7fffffff);
}
...
void vp9_high_sad32x64x4d_c(const uint8_t *src_ptr, int src_stride,
  ...
  int i;
  for (i = 0; i < 4; ++i)
    sad_array[i] = vp9_high_sad32x64(src_ptr, src_stride, ref_ptr[i], ref_stride,
                                0x7fffffff);
}
...
void vp9_high_sad32x16x4d_c(const uint8_t *src_ptr, int src_stride,
  ...
  int i;
  for (i = 0; i < 4; ++i)
    sad_array[i] = vp9_high_sad32x16(src_ptr, src_stride, ref_ptr[i], ref_stride,
                                0x7fffffff);
}
...
void vp9_high_sad16x32x4d_c(const uint8_t *src_ptr, int src_stride,
  ...
  int i;
  for (i = 0; i < 4; ++i)
    sad_array[i] = vp9_high_sad16x32(src_ptr, src_stride, ref_ptr[i], ref_stride,
                                0x7fffffff);
}
...
void vp9_high_sad64x64x3_c(const uint8_t *src_ptr, int src_stride,
  ...
  int i;
  for (i = 0; i < 3; ++i)
    sad_array[i] = vp9_high_sad64x64(src_ptr, src_stride, ref_ptr + i, ref_stride,
                                0x7fffffff);
}
...
void vp9_high_sad32x32x3_c(const uint8_t *src_ptr, int src_stride,
  ...
  int i;
  for (i = 0; i < 3; ++i)
    sad_array[i] = vp9_high_sad32x32(src_ptr, src_stride, ref_ptr + i, ref_stride,
                                0x7fffffff);
}
...
void vp9_high_sad16x16x3_c(const uint8_t *src_ptr, int src_stride,
  ...
  int i;
  for (i = 0; i < 3; ++i)
    sad_array[i] = vp9_high_sad16x16(src_ptr, src_stride, ref_ptr + i, ref_stride,
                                0x7fffffff);
}
...
void vp9_high_sad16x8x3_c(const uint8_t *src_ptr, int src_stride,
  ...
  int i;
  for (i = 0; i < 3; ++i)
    sad_array[i] = vp9_high_sad16x8(src_ptr, src_stride, ref_ptr + i, ref_stride,
                               0x7fffffff);
}
...
void vp9_high_sad8x8x3_c(const uint8_t *src_ptr, int src_stride,
  ...
  int i;
  for (i = 0; i < 3; ++i)
    sad_array[i] = vp9_high_sad8x8(src_ptr, src_stride, ref_ptr + i, ref_stride,
                              0x7fffffff);
}
...
void vp9_high_sad8x16x3_c(const uint8_t *src_ptr, int src_stride,
  ...
  int i;
  for (i = 0; i < 3; ++i)
    sad_array[i] = vp9_high_sad8x16(src_ptr, src_stride, ref_ptr + i, ref_stride,
                               0x7fffffff);
}
...
void vp9_high_sad4x4x3_c(const uint8_t *src_ptr, int src_stride,
  ...
  int i;
  for (i = 0; i < 3; ++i)
    sad_array[i] = vp9_high_sad4x4(src_ptr, src_stride, ref_ptr + i, ref_stride,
                              0x7fffffff);
}
...
void vp9_high_sad8x4x4d_c(const uint8_t *src_ptr, int src_stride,
  ...
  int i;
  for (i = 0; i < 4; ++i)
    sad_array[i] = vp9_high_sad8x4(src_ptr, src_stride, ref_ptr[i], ref_stride,
                              0x7fffffff);
}
...
void vp9_high_sad4x8x4d_c(const uint8_t *src_ptr, int src_stride,
  ...
  int i;
  for (i = 0; i < 4; ++i)
    sad_array[i] = vp9_high_sad4x8(src_ptr, src_stride, ref_ptr[i], ref_stride,
                              0x7fffffff);
}
