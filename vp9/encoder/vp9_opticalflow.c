...
static void lucas_kanade_base(double *smooth_frm, double *smooth_ref,
  ...
  pointwise_matrix_sub((unsigned char*)smooth_ref, (unsigned char*)smooth_frm,
                       ...
                       smooth_ref_stride, smooth_frm_stride, width);
