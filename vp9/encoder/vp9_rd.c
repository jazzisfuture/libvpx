...
void vp9_init_rd_parameters(VP9_COMP *cpi) {
  // RATE_CONTROL *const cpi = &cpi->cpi;
  ...
  if (1) {
    ...
    cpi->rd_mult_q_sq_inter_low_qp = 4.0;
    cpi->rd_mult_q_sq_inter_mid_qp = 4.5;
    cpi->rd_mult_q_sq_inter_high_qp = 3.0;
    cpi->rd_mult_q_sq_key_ultralow_qp = 4.0;
    cpi->rd_mult_q_sq_key_low_qp = 3.5;
    cpi->rd_mult_q_sq_key_mid_qp = 4.5;
    cpi->rd_mult_q_sq_key_high_qp = 7.5;
  } else if (screen_area <= 176 * 144) {
    cpi->rd_mult_q_sq_inter_high_qp = 4.295745965132044;
    cpi->rd_mult_q_sq_inter_low_qp = 4.0718581295922025;
    cpi->rd_mult_q_sq_inter_mid_qp = 4.031435609256739;
    cpi->rd_mult_q_sq_key_low_qp = 5.7037775720838155;
    cpi->rd_mult_q_sq_key_mid_qp = 4.72424015517201;
    cpi->rd_mult_q_sq_key_ultralow_qp = 4.290774097327333;
  } else if (screen_area <= 320 * 240) {
    cpi->rd_mult_q_sq_inter_high_qp = 4.388244213131458;
    cpi->rd_mult_q_sq_inter_low_qp = 4.506676356706102;
    cpi->rd_mult_q_sq_inter_mid_qp = 4.489349899621181;
    cpi->rd_mult_q_sq_key_low_qp = 4.497000582319771;
    cpi->rd_mult_q_sq_key_mid_qp = 4.2825894884789735;
    cpi->rd_mult_q_sq_key_ultralow_qp = 4.217074424696166;
  } else if (screen_area <= 640 * 360) {
    cpi->rd_mult_q_sq_inter_high_qp = 4.3702861603380025;
    cpi->rd_mult_q_sq_inter_low_qp = 4.730644123689013;
    cpi->rd_mult_q_sq_inter_mid_qp = 4.314589509578551;
    cpi->rd_mult_q_sq_key_low_qp = 6.068652999601526;
    cpi->rd_mult_q_sq_key_mid_qp = 4.817707474077241;
    cpi->rd_mult_q_sq_key_ultralow_qp = 4.576902541873747;
  } else if (screen_area <= 854 * 480) {
    cpi->rd_mult_q_sq_inter_high_qp = 3.969083125219539;
    cpi->rd_mult_q_sq_inter_low_qp = 4.811470143416073;
    cpi->rd_mult_q_sq_inter_mid_qp = 4.621618127750201;
    cpi->rd_mult_q_sq_key_low_qp = 5.073157238799473;
    cpi->rd_mult_q_sq_key_mid_qp = 5.7587672849242635;
    cpi->rd_mult_q_sq_key_ultralow_qp = 4.9854544277222566;
  } else if (screen_area <= 1280 * 720) {
    cpi->rd_mult_q_sq_inter_high_qp = 4.410712348825541;
    cpi->rd_mult_q_sq_inter_low_qp = 5.119381136011107;
    cpi->rd_mult_q_sq_inter_mid_qp = 4.518613675766538;
    cpi->rd_mult_q_sq_key_low_qp = 5.848703119971484;
    cpi->rd_mult_q_sq_key_mid_qp = 5.368947246228739;
    cpi->rd_mult_q_sq_key_ultralow_qp = 3.9468491666607326;
  } else if (screen_area <= 1920 * 1080) {
    cpi->rd_mult_q_sq_inter_high_qp = 3.2141187537667797;
    cpi->rd_mult_q_sq_inter_low_qp = 6.00569815296199;
    cpi->rd_mult_q_sq_inter_mid_qp = 3.932565684947023;
    cpi->rd_mult_q_sq_key_low_qp = 10.582906599488298;
    cpi->rd_mult_q_sq_key_mid_qp = 6.274162346360692;
    cpi->rd_mult_q_sq_key_ultralow_qp = 4.399795006320089;
  }
}
...
int vp9_compute_rd_mult_based_on_qindex(const VP9_COMP *cpi, int qindex) {
  ...
  if (cpi->common.frame_type != KEY_FRAME) {
    if (qindex < 128) {
      rdmult = (int)((double)rdmult * cpi->rd_mult_q_sq_inter_low_qp);
      // rdmult = (int)((double)rdmult * 4.0);
      // rdmult = (int)(rdmult * 4);
    } else if (qindex < 190) {
      rdmult = (int)((double)rdmult * cpi->rd_mult_q_sq_inter_mid_qp);
      // rdmult = (int)((double)rdmult * 4.5);
      // rdmult = (int)(rdmult * 4 + rdmult / 2);
    } else {
      rdmult = (int)((double)rdmult * cpi->rd_mult_q_sq_inter_high_qp);
      // rdmult = (int)((double)rdmult * 3.0);
      // rdmult = (int)(rdmult * 3);
    }
  } else {
    if (qindex < 64) {
      rdmult = (int)((double)rdmult * cpi->rd_mult_q_sq_key_ultralow_qp);
      // rdmult = (int)((double)rdmult * 4.0);
      // rdmult = (int)(rdmult * 4);
    } else if (qindex <= 128) {
      rdmult = (int)((double)rdmult * cpi->rd_mult_q_sq_key_low_qp);
      // rdmult = (int)((double)rdmult * 3.5);
      // rdmult = (int)(rdmult * 3 + rdmult / 2);
    } else if (qindex < 190) {
      rdmult = (int)((double)rdmult * cpi->rd_mult_q_sq_key_mid_qp);
      // rdmult = (int)((double)rdmult * 4.5);
      // rdmult = (int)(rdmult * 4 + rdmult / 2);
    } else {
      rdmult = (int)((double)rdmult * cpi->rd_mult_q_sq_key_high_qp);
