...
typedef struct {
#if CONFIG_NEW_QUANT
  DECLARE_ALIGNED(16, int16_t, y_quant_nuq[QINDEX_RANGE][8]);
  DECLARE_ALIGNED(16, int16_t, uv_quant_nuq[QINDEX_RANGE][8]);
  DECLARE_ALIGNED(16, tran_low_t, y_cumbins_nuq[QINDEX_RANGE][8][NUQ_KNOTES]);
  DECLARE_ALIGNED(16, tran_low_t, uv_cumbins_nuq[QINDEX_RANGE][8][NUQ_KNOTES]);
