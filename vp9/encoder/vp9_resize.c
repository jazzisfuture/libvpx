...
// Filters for interpolation (0.5) - note this also filters integer pels.
...
// Filters for interpolation (0.625) - note this also filters integer pels.
...
// Filters for interpolation (0.75) - note this also filters integer pels.
...
// Filters for interpolation (0.875) - note this also filters integer pels.
...
// This is a full-band filter - no filtering for integer pixels
