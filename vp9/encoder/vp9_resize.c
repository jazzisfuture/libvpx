...
static const int16_t vp9_down2_symeven_half_filter[] = {65, 4, -6, 1};
static const int16_t vp9_down2_symodd_half_filter[] = {64, 36, 0, -4};

static void interpolate(uint8_t *input, int inlength,
                        uint8_t *output, int outlength) {
  int64_t delta = (((uint64_t)inlength << 32) + outlength / 2) / outlength;
  int64_t offset = inlength > outlength ?
...
static void down2_symeven(uint8_t *input, int length, uint8_t *output) {
...
static void down2_symodd(uint8_t *input, int length, uint8_t *output) {
...
static void resize_multistep(uint8_t *input,
                             int length,
                             uint8_t *output,
                             int olength,
                             uint8_t *buf) {
  int steps, s, filteredlength;
  uint8_t *tmpbuf = NULL;
  uint8_t *otmp, *otmp2;
  uint8_t *in, *out;
  if (length == olength) {
  ...
  if (steps > 0) {
    ...
    for (s = 0; s < steps; ++s) {
      int proj_filteredlength = get_down2_length(filteredlength, 1);
      in = out;
...
void vp9_resize_frame420(uint8_t *y, int y_stride,
...
void vp9_resize_frame422(uint8_t *y, int y_stride,
                         uint8_t *u, uint8_t *v, int uv_stride,
                         int height, int width,
                         uint8_t *oy, int oy_stride,
                         uint8_t *ou, uint8_t *ov, int ouv_stride,
...
void vp9_resize_frame444(uint8_t *y, int y_stride,
                         uint8_t *u, uint8_t *v, int uv_stride,
                         int height, int width,
                         uint8_t *oy, int oy_stride,
                         uint8_t *ou, uint8_t *ov, int ouv_stride,
