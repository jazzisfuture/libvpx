...
// Test for intra step change
      if (intra_step_transition(this_frame, &last_frame, twopass->stats_in)) {
        FILE *fpfile;
        fpfile = fopen("testintrastep.stt", "a");
        fprintf(fpfile, "%10d\n", cpi->common.current_video_frame + i + 1);
        fclose(fpfile);
      }
