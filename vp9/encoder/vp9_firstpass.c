...
#define LAST_ALR_ACTIVE_BEST_QUALITY_ADJUSTMENT_FACTOR 0.2
  ...
  printf("show_index %d, coding_index %d, gf_interval %d, use_alt_ref %d, "
         "gop_coding_frames %d, source_alt_ref_pending %d --\n",
         cm->current_video_frame, cm->current_frame_coding_index,
         rc->baseline_gf_interval, use_alt_ref, gop_coding_frames,
