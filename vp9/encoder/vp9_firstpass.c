...
static double get_prediction_decay_rate(VP9_COMP *cpi,
  ...
  double sr_err_diff = (next_frame->sr_coded_error - next_frame->coded_error) /
                           cpi->common.MBs;
  double second_ref_decay = sr_err_diff <= 512.0
      ? fclamp(pow(1.0 - (sr_err_diff / 512.0), 0.5), 0.85, 1.0)
      : 0.85;
