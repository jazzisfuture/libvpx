...
double get_section_complexity(VP9_COMP *cpi,
  ...
  //const double power_term = fclamp(0.35, 0.1, 1.0);
  //const double clip_complexity =
  //    fclamp(pow(error_term, power_term), 0.10, 2.0);
...
double get_section_rate_adjustment(VP9_COMP *cpi,
                                   double section_err, double section_length) {
  const VP9EncoderConfig *const oxcf = &cpi->oxcf;
