...
static int calculate_boost_bits(VP9_COMP *cpi, int frame_count,
...
static void define_gf_group(VP9_COMP *cpi, FIRSTPASS_STATS *this_frame) {
  ...
  // Calculate the extra bits to be used for boosted frame(s)
  {
    ...
    // Calculate the extra bits to be used for boosted frame(s)
    twopass->gf_bits = calculate_boost_bits(cpi, rc->baseline_gf_interval,
...
static void find_next_key_frame(VP9_COMP *cpi, FIRSTPASS_STATS *this_frame) {
  ...
  // Calculate the bits to be used for boosted frame(s)
  twopass->kf_bits = calculate_boost_bits(cpi, (rc->frames_to_key - 1),
