...
static double get_linear_size_factor(const VP9_COMP *cpi) {
  ...
  return pow(BASE_SIZE / this_area, 0.5);
}
...
// increased size and hence coding cost of motion vectors. Some account of this
// is made through adjustment of the error divisor.
...
static int get_twopass_worst_quality(const VP9_COMP *cpi,
  ...
  if (target_rate <= 0) {
    ...
    ediv_size_correction =
        VPXMAX(0.1, VPXMIN(25.0, get_linear_size_factor(cpi)));
