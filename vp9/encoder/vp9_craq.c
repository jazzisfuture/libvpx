...
int vp9_candidate_refresh_aq(VP9_COMP *const cpi,
  ...
  // Separate rd from on-rd mode, as rate and distortion thresholds would be
  // different for each case. For now, non-rd does not use this as the
  // rate/distortion don't seem to be returned from vp9_pick_inter_mode().
