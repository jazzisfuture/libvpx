...
void vp9_fdct32x32_cl(int16_t *input, int16_t *out, int pitch) {
...
void vp9_fdct32x32_ch(int16_t *input, int16_t *out, int pitch) {
  int shortpitch = pitch >> 1;
  int i, j;
  int output[32 * 32];
...
void vp9_short_fdct32x32_c(int16_t *input, int16_t *out, int pitch) {
  ...
  for (i = 0; i < 32; ++i)
    for (j = 0; j < 32; ++j)
      sad32 += abs(input[j * shortpitch + i]);

  if (sad32 > 46160)
    vp9_fdct32x32_cl(input, out, pitch);
  else
    vp9_fdct32x32_ch(input, out, pitch);
}
