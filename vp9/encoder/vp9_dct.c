...
static void fdct8_1d(int16_t *input, int16_t *output) {
  ...
  // Stage 2
  t0 = (-step[5] + step[6]) * cospi_16_64;
  t1 = ( step[5] + step[6]) * cospi_16_64;
...
void vp9_short_fdct8x8_c(int16_t *input, int16_t *final_output, int pitch) {
  ...
  // Transform columns
  {
    ...
    for (i = 0; i < 8; i++) {
      // stage 1
      step[0] = (input[0 * stride] + input[7 * stride]) << 2;
      step[1] = (input[1 * stride] + input[6 * stride]) << 2;
      step[2] = (input[2 * stride] + input[5 * stride]) << 2;
      step[3] = (input[3 * stride] + input[4 * stride]) << 2;
      step[4] = (input[3 * stride] - input[4 * stride]) << 2;
      step[5] = (input[2 * stride] - input[5 * stride]) << 2;
      step[6] = (input[1 * stride] - input[6 * stride]) << 2;
      step[7] = (input[0 * stride] - input[7 * stride]) << 2;
