...
#include <stdio.h>
#include <stdint.h>
#include "vp9/encoder/vp9_denoising.h"
#include "vpx_scale/yv12config.h"

static const int widths[13]  = {4,4,8,8, 8,16,16,16,32,32,32,64,64};
static const int heights[13] = {4,8,4,8,16, 8,16,32,16,32,64,32,64};
