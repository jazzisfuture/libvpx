...
void vp9_high_resize_plane(const uint8_t *const input,
                           ...
                           int out_stride,
                           int bd);
void vp9_high_resize_frame420(const uint8_t *const y,
                              int y_stride,
                              const uint8_t *const u,
                              const uint8_t *const v,
                              int uv_stride,
                              ...
                              int owidth,
                              int bd);
void vp9_high_resize_frame422(const uint8_t *const y,
                              int y_stride,
                              const uint8_t *const u,
                              const uint8_t *const v,
                              int uv_stride,
                              ...
                              int owidth,
                              int bd);
void vp9_high_resize_frame444(const uint8_t *const y,
                              int y_stride,
                              const uint8_t *const u,
                              const uint8_t *const v,
                              int uv_stride,
