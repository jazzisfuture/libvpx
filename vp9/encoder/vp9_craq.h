...
/*
// For a given prediction block, update the segmentation map and cyclic
// refresh map, used for setting the segmentation map for the next frame.
...
// Loop through all superblocks of the current frame, and for each prediction
// block, update the segmentation map and the cyclic refresh map.
