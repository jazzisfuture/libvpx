...
int vp9_one_pass_cbr_svc_start_layer(VP9_COMP *const cpi) {
  ...
  cpi->svc.reference_last = (cpi->ref_frame_flags & flag_list[LAST_FRAME]);
  cpi->svc.reference_golden = (cpi->ref_frame_flags & flag_list[GOLDEN_FRAME]);
  cpi->svc.reference_altref = (cpi->ref_frame_flags & flag_list[ALTREF_FRAME]);
