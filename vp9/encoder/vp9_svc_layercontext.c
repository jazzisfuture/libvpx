...
// The function sets proper ref_frame_flags, buffer indices, and buffer update variables
// for temporal layering mode 3 - that does 0-2-1-2 temporal layering scheme.
...
// The function sets proper ref_frame_flags, buffer indices, and buffer update variables
// for temporal layering mode 2 - that does 0-1-0-1 temporal layering scheme.
...
// The function sets proper ref_frame_flags, buffer indices, and buffer update variables
// for temporal layering mode 0 - that has no temporal layering.
...
int vp9_one_pass_cbr_svc_start_layer(VP9_COMP *const cpi) {
  ...
  if (cpi->svc.temporal_layering_mode == VP9E_TEMPORAL_LAYERING_MODE_0212) {
    ...
    // However, since when spatial+temporal layering is used, the buffer indices cannot
    // be derived automatically, the bypass mode will only work
    // when the number of spatial layers equals 1.
  }
