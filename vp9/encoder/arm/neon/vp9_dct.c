...
static INLINE void load_buffer_4x4(const int16_t *input, int16x8_t *in,
                                   int stride) {
  const int16x8_t nonzero_bias_a = vextq_s16(vdupq_n_s16(0), vdupq_n_s16(1), 7); // { 0, 1, 1, 1, 1, 1, 1, 1 };
  const int16x8_t nonzero_bias_b = vextq_s16(vdupq_n_s16(1), vdupq_n_s16(0), 7); // { 1, 0, 0, 0, 0, 0, 0, 0 };
  int16x8_t mask;
