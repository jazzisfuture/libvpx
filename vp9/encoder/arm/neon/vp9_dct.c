...
static INLINE void load_buffer_4x4(const int16_t *input, int16x8_t *in, int stride) {
  const int16x8_t k__nonzero_bias_a = { 0, 1, 1, 1, 1, 1, 1, 1 };
  const int16x8_t k__nonzero_bias_b = { 1, 0, 0, 0, 0, 0, 0, 0 };
  int16x8_t mask;
  ...
  mask = (int16x8_t) vceqq_s16(in[0], k__nonzero_bias_a);
  in[0] = vaddq_s16(in[0], mask);
  in[0] = vaddq_s16(in[0], k__nonzero_bias_b);
}
...
static INLINE void fadst4x4_neon(int16x8_t *in) {
  ...
  u1 = t1;
  u2 = vsubq_s32(t2, t3);
  u3 = vsubq_s32(vaddq_s32(t2, t3), t0);
...
static INLINE void load_buffer_8x8(const int16_t *input, int16x8_t *in,  int stride) {
...
static INLINE void write_buffer_8x8(tran_low_t *output, int16x8_t *res, int stride) {
...
static INLINE void fadst8x8_neon(int16x8_t *in) {
  ...
  int16x4_t x0_lo, x0_hi, x1_lo, x1_hi, x2_lo, x2_hi, x3_lo, x3_hi, x4_lo, x4_hi, x5_lo, x5_hi, x6_lo, x6_hi, x7_lo, x7_hi;
  int32x4_t s0_lo, s0_hi, s1_lo, s1_hi, s2_lo, s2_hi, s3_lo, s3_hi, s4_lo, s4_hi, s5_lo, s5_hi, s6_lo, s6_hi, s7_lo, s7_hi;
  int32x4_t t0_lo, t0_hi, t1_lo, t1_hi, t2_lo, t2_hi, t3_lo, t3_hi, t4_lo, t4_hi, t5_lo, t5_hi, t6_lo, t6_hi, t7_lo, t7_hi;
  const int32x4_t k__DCT_CONST_ROUNDING = vdupq_n_s32(DCT_CONST_ROUNDING);
  ...
  s0_lo = vaddq_s32(vmull_n_s16(x0_lo, cospi_2_64), vmull_n_s16(x1_lo, cospi_30_64));
  s0_hi = vaddq_s32(vmull_n_s16(x0_hi, cospi_2_64), vmull_n_s16(x1_hi, cospi_30_64));
  // s1 = cospi_30_64 * x0 - cospi_2_64 * x1;
  s1_lo = vsubq_s32(vmull_n_s16(x0_lo, cospi_30_64), vmull_n_s16(x1_lo, cospi_2_64));
  s1_hi = vsubq_s32(vmull_n_s16(x0_hi, cospi_30_64), vmull_n_s16(x1_hi, cospi_2_64));
  // s2 = cospi_10_64 * x2 + cospi_22_64 * x3;
  s2_lo = vaddq_s32(vmull_n_s16(x2_lo, cospi_10_64), vmull_n_s16(x3_lo, cospi_22_64));
  s2_hi = vaddq_s32(vmull_n_s16(x2_hi, cospi_10_64), vmull_n_s16(x3_hi, cospi_22_64));
  // s3 = cospi_22_64 * x2 - cospi_10_64 * x3;
  s3_lo = vsubq_s32(vmull_n_s16(x2_lo, cospi_22_64), vmull_n_s16(x3_lo, cospi_10_64));
  s3_hi = vsubq_s32(vmull_n_s16(x2_hi, cospi_22_64), vmull_n_s16(x3_hi, cospi_10_64));
  // s4 = cospi_18_64 * x4 + cospi_14_64 * x5;
  s4_lo = vaddq_s32(vmull_n_s16(x4_lo, cospi_18_64), vmull_n_s16(x5_lo, cospi_14_64));
  s4_hi = vaddq_s32(vmull_n_s16(x4_hi, cospi_18_64), vmull_n_s16(x5_hi, cospi_14_64));
  // s5 = cospi_14_64 * x4 - cospi_18_64 * x5;
  s5_lo = vsubq_s32(vmull_n_s16(x4_lo, cospi_14_64), vmull_n_s16(x5_lo, cospi_18_64));
  s5_hi = vsubq_s32(vmull_n_s16(x4_hi, cospi_14_64), vmull_n_s16(x5_hi, cospi_18_64));
  // s6 = cospi_26_64 * x6 + cospi_6_64 * x7;
  s6_lo = vaddq_s32(vmull_n_s16(x6_lo, cospi_26_64), vmull_n_s16(x7_lo, cospi_6_64));
  s6_hi = vaddq_s32(vmull_n_s16(x6_hi, cospi_26_64), vmull_n_s16(x7_hi, cospi_6_64));
  // s7 = cospi_6_64 * x6 - cospi_26_64 * x7;
  s7_lo = vsubq_s32(vmull_n_s16(x6_lo, cospi_6_64), vmull_n_s16(x7_lo, cospi_26_64));
  s7_hi = vsubq_s32(vmull_n_s16(x6_hi, cospi_6_64), vmull_n_s16(x7_hi, cospi_26_64));
  ...
  s3_lo = t3_lo;
  s3_hi = t3_hi;
  s4_lo = vaddq_s32(vmulq_n_s32(t4_lo,  cospi_8_64),  vmulq_n_s32(t5_lo, cospi_24_64));
  s4_hi = vaddq_s32(vmulq_n_s32(t4_hi,  cospi_8_64),  vmulq_n_s32(t5_hi, cospi_24_64));
  s5_lo = vsubq_s32(vmulq_n_s32(t4_lo,  cospi_24_64), vmulq_n_s32(t5_lo, cospi_8_64));
  s5_hi = vsubq_s32(vmulq_n_s32(t4_hi,  cospi_24_64), vmulq_n_s32(t5_hi, cospi_8_64));
  s6_lo = vaddq_s32(vmulq_n_s32(t6_lo, -cospi_24_64), vmulq_n_s32(t7_lo, cospi_8_64));
  s6_hi = vaddq_s32(vmulq_n_s32(t6_hi, -cospi_24_64), vmulq_n_s32(t7_hi, cospi_8_64));
  s7_lo = vaddq_s32(vmulq_n_s32(t6_lo,  cospi_8_64),  vmulq_n_s32(t7_lo, cospi_24_64));
  s7_hi = vaddq_s32(vmulq_n_s32(t6_hi,  cospi_8_64),  vmulq_n_s32(t7_hi, cospi_24_64));
  ...
  transpose_s16_8x8(&in[0], &in[1], &in[2], &in[3], &in[4], &in[5], &in[6], &in[7]);
}
...
static void fdct16_8col(int16x8_t *in) {
  ...
  u_lo[1] = vaddq_s32(vmull_n_s16(t_lo[1], -cospi_8_64),  vmull_n_s16(t_lo[6], cospi_24_64));
  u_hi[1] = vaddq_s32(vmull_n_s16(t_hi[1], -cospi_8_64),  vmull_n_s16(t_hi[6], cospi_24_64));
  u_lo[2] = vaddq_s32(vmull_n_s16(t_lo[2], cospi_24_64),  vmull_n_s16(t_lo[5], cospi_8_64));
  u_hi[2] = vaddq_s32(vmull_n_s16(t_hi[2], cospi_24_64),  vmull_n_s16(t_hi[5], cospi_8_64));
  u_lo[5] = vaddq_s32(vmull_n_s16(t_lo[2],  cospi_8_64),  vmull_n_s16(t_lo[5], -cospi_24_64));
  u_hi[5] = vaddq_s32(vmull_n_s16(t_hi[2],  cospi_8_64),  vmull_n_s16(t_hi[5], -cospi_24_64));
  u_lo[6] = vaddq_s32(vmull_n_s16(t_lo[1], cospi_24_64),  vmull_n_s16(t_lo[6], cospi_8_64));
  u_hi[6] = vaddq_s32(vmull_n_s16(t_hi[1], cospi_24_64),  vmull_n_s16(t_hi[6], cospi_8_64));
  ...
  u_lo[0] = vaddq_s32(vmull_n_s16(t_lo[0], cospi_30_64),  vmull_n_s16(t_lo[7], cospi_2_64));
  u_hi[0] = vaddq_s32(vmull_n_s16(t_hi[0], cospi_30_64),  vmull_n_s16(t_hi[7], cospi_2_64));
  ...
  u_lo[2] = vaddq_s32(vmull_n_s16(t_lo[2],  cospi_22_64),  vmull_n_s16(t_lo[5], cospi_10_64));
  u_hi[2] = vaddq_s32(vmull_n_s16(t_hi[2],  cospi_22_64),  vmull_n_s16(t_hi[5], cospi_10_64));

  // step1[3] * cospi_6_64 + step1[4] * cospi_26_64;
  u_lo[3] = vaddq_s32(vmull_n_s16(t_lo[3], cospi_6_64),  vmull_n_s16(t_lo[4], cospi_26_64));
  u_hi[3] = vaddq_s32(vmull_n_s16(t_hi[3], cospi_6_64),  vmull_n_s16(t_hi[4], cospi_26_64));

  // step1[3] * -cospi_26_64 + step1[4] * cospi_6_64;
  u_lo[4] = vaddq_s32(vmull_n_s16(t_lo[3], -cospi_26_64),  vmull_n_s16(t_lo[4], cospi_6_64));
  u_hi[4] = vaddq_s32(vmull_n_s16(t_hi[3], -cospi_26_64),  vmull_n_s16(t_hi[4], cospi_6_64));

  // step1[2] * -cospi_10_64 + step1[5] * cospi_22_64;
  u_lo[5] = vaddq_s32(vmull_n_s16(t_lo[2], -cospi_10_64),  vmull_n_s16(t_lo[5], cospi_22_64));
  u_hi[5] = vaddq_s32(vmull_n_s16(t_hi[2], -cospi_10_64),  vmull_n_s16(t_hi[5], cospi_22_64));

  // step1[1] * -cospi_18_64 + step1[6] * cospi_14_64;
  u_lo[6] = vaddq_s32(vmull_n_s16(t_lo[1], -cospi_18_64),  vmull_n_s16(t_lo[6], cospi_14_64));
  u_hi[6] = vaddq_s32(vmull_n_s16(t_hi[1], -cospi_18_64),  vmull_n_s16(t_hi[6], cospi_14_64));

  // step1[0] * -cospi_2_64 + step1[7] * cospi_30_64;
  u_lo[7] = vaddq_s32(vmull_n_s16(t_lo[0], -cospi_2_64),  vmull_n_s16(t_lo[7], cospi_30_64));
  u_hi[7] = vaddq_s32(vmull_n_s16(t_hi[0], -cospi_2_64),  vmull_n_s16(t_hi[7], cospi_30_64));
...
static void fadst16_8col(int16x8_t *in) {
  ...
  s_lo[0] = vaddq_s32(vmull_n_s16(x_lo[0], cospi_1_64), vmull_n_s16(x_lo[1], cospi_31_64));
  s_hi[0] = vaddq_s32(vmull_n_s16(x_hi[0], cospi_1_64), vmull_n_s16(x_hi[1], cospi_31_64));
  // s1 = cospi_31_64 * x0 - cospi_1_64 * x1;
  s_lo[1] = vsubq_s32(vmull_n_s16(x_lo[0], cospi_31_64), vmull_n_s16(x_lo[1], cospi_1_64));
  s_hi[1] = vsubq_s32(vmull_n_s16(x_hi[0], cospi_31_64), vmull_n_s16(x_hi[1], cospi_1_64));
  // s2 = cospi_5_64 * x2 + cospi_27_64 * x3;
  s_lo[2] = vaddq_s32(vmull_n_s16(x_lo[2], cospi_5_64), vmull_n_s16(x_lo[3], cospi_27_64));
  s_hi[2] = vaddq_s32(vmull_n_s16(x_hi[2], cospi_5_64), vmull_n_s16(x_hi[3], cospi_27_64));
  // s3 = cospi_27_64 * x2 - cospi_5_64 * x3;
  s_lo[3] = vsubq_s32(vmull_n_s16(x_lo[2], cospi_27_64), vmull_n_s16(x_lo[3], cospi_5_64));
  s_hi[3] = vsubq_s32(vmull_n_s16(x_hi[2], cospi_27_64), vmull_n_s16(x_hi[3], cospi_5_64));
  // s4 = cospi_9_64 * x4 + cospi_23_64 * x5;
  s_lo[4] = vaddq_s32(vmull_n_s16(x_lo[4], cospi_9_64), vmull_n_s16(x_lo[5], cospi_23_64));
  s_hi[4] = vaddq_s32(vmull_n_s16(x_hi[4], cospi_9_64), vmull_n_s16(x_hi[5], cospi_23_64));
  // s5 = cospi_23_64 * x4 - cospi_9_64 * x5;
  s_lo[5] = vsubq_s32(vmull_n_s16(x_lo[4], cospi_23_64), vmull_n_s16(x_lo[5], cospi_9_64));
  s_hi[5] = vsubq_s32(vmull_n_s16(x_hi[4], cospi_23_64), vmull_n_s16(x_hi[5], cospi_9_64));
  // s6 = cospi_13_64 * x6 + cospi_19_64 * x7;
  s_lo[6] = vaddq_s32(vmull_n_s16(x_lo[6], cospi_13_64), vmull_n_s16(x_lo[7], cospi_19_64));
  s_hi[6] = vaddq_s32(vmull_n_s16(x_hi[6], cospi_13_64), vmull_n_s16(x_hi[7], cospi_19_64));
  // s7 = cospi_19_64 * x6 - cospi_13_64 * x7;
  s_lo[7] = vsubq_s32(vmull_n_s16(x_lo[6], cospi_19_64), vmull_n_s16(x_lo[7], cospi_13_64));
  s_hi[7] = vsubq_s32(vmull_n_s16(x_hi[6], cospi_19_64), vmull_n_s16(x_hi[7], cospi_13_64));
  // s8 = cospi_17_64 * x8 + cospi_15_64 * x9;
  s_lo[8] = vaddq_s32(vmull_n_s16(x_lo[8], cospi_17_64), vmull_n_s16(x_lo[9], cospi_15_64));
  s_hi[8] = vaddq_s32(vmull_n_s16(x_hi[8], cospi_17_64), vmull_n_s16(x_hi[9], cospi_15_64));
  // s9 = cospi_15_64 * x8 - cospi_17_64 * x9;
  s_lo[9] = vsubq_s32(vmull_n_s16(x_lo[8], cospi_15_64), vmull_n_s16(x_lo[9], cospi_17_64));
  s_hi[9] = vsubq_s32(vmull_n_s16(x_hi[8], cospi_15_64), vmull_n_s16(x_hi[9], cospi_17_64));
  // s10 = cospi_21_64 * x10 + cospi_11_64 * x11;
  s_lo[10] = vaddq_s32(vmull_n_s16(x_lo[10], cospi_21_64), vmull_n_s16(x_lo[11], cospi_11_64));
  s_hi[10] = vaddq_s32(vmull_n_s16(x_hi[10], cospi_21_64), vmull_n_s16(x_hi[11], cospi_11_64));
  // s11 = cospi_11_64 * x10 - cospi_21_64 * x11;
  s_lo[11] = vsubq_s32(vmull_n_s16(x_lo[10], cospi_11_64), vmull_n_s16(x_lo[11], cospi_21_64));
  s_hi[11] = vsubq_s32(vmull_n_s16(x_hi[10], cospi_11_64), vmull_n_s16(x_hi[11], cospi_21_64));
  // s12 = cospi_25_64 * x12 + cospi_7_64 * x13;
  s_lo[12] = vaddq_s32(vmull_n_s16(x_lo[12], cospi_25_64), vmull_n_s16(x_lo[13], cospi_7_64));
  s_hi[12] = vaddq_s32(vmull_n_s16(x_hi[12], cospi_25_64), vmull_n_s16(x_hi[13], cospi_7_64));
  // s13 = cospi_7_64 * x12 - cospi_25_64 * x13;
  s_lo[13] = vsubq_s32(vmull_n_s16(x_lo[12], cospi_7_64), vmull_n_s16(x_lo[13], cospi_25_64));
  s_hi[13] = vsubq_s32(vmull_n_s16(x_hi[12], cospi_7_64), vmull_n_s16(x_hi[13], cospi_25_64));
  // s14 = cospi_29_64 * x14 + cospi_3_64 * x15;
  s_lo[14] = vaddq_s32(vmull_n_s16(x_lo[14], cospi_29_64), vmull_n_s16(x_lo[15], cospi_3_64));
  s_hi[14] = vaddq_s32(vmull_n_s16(x_hi[14], cospi_29_64), vmull_n_s16(x_hi[15], cospi_3_64));
  // s15 = cospi_3_64 * x14 - cospi_29_64 * x15;
  s_lo[15] = vsubq_s32(vmull_n_s16(x_lo[14], cospi_3_64), vmull_n_s16(x_lo[15], cospi_29_64));
  s_hi[15] = vsubq_s32(vmull_n_s16(x_hi[14], cospi_3_64), vmull_n_s16(x_hi[15], cospi_29_64));
  ...
  s_lo[8] = vaddq_s32(vmulq_n_s32(t_lo[8], cospi_4_64), vmulq_n_s32(t_lo[9], cospi_28_64));
  s_hi[8] = vaddq_s32(vmulq_n_s32(t_hi[8], cospi_4_64), vmulq_n_s32(t_hi[9], cospi_28_64));
  // s9 = x8 * cospi_28_64 - x9 * cospi_4_64;
  s_lo[9] = vsubq_s32(vmulq_n_s32(t_lo[8], cospi_28_64), vmulq_n_s32(t_lo[9], cospi_4_64));
  s_hi[9] = vsubq_s32(vmulq_n_s32(t_hi[8], cospi_28_64), vmulq_n_s32(t_hi[9], cospi_4_64));
  // s10 = x10 * cospi_20_64 + x11 * cospi_12_64;
  s_lo[10] = vaddq_s32(vmulq_n_s32(t_lo[10], cospi_20_64), vmulq_n_s32(t_lo[11], cospi_12_64));
  s_hi[10] = vaddq_s32(vmulq_n_s32(t_hi[10], cospi_20_64), vmulq_n_s32(t_hi[11], cospi_12_64));
  // s11 = x10 * cospi_12_64 - x11 * cospi_20_64;
  s_lo[11] = vsubq_s32(vmulq_n_s32(t_lo[10], cospi_12_64), vmulq_n_s32(t_lo[11], cospi_20_64));
  s_hi[11] = vsubq_s32(vmulq_n_s32(t_hi[10], cospi_12_64), vmulq_n_s32(t_hi[11], cospi_20_64));
  // s12 = -x12 * cospi_28_64 + x13 * cospi_4_64;
  s_lo[12] = vaddq_s32(vmulq_n_s32(t_lo[12], -cospi_28_64), vmulq_n_s32(t_lo[13], cospi_4_64));
  s_hi[12] = vaddq_s32(vmulq_n_s32(t_hi[12], -cospi_28_64), vmulq_n_s32(t_hi[13], cospi_4_64));
  // s13 = x12 * cospi_4_64 + x13 * cospi_28_64;
  s_lo[13] = vaddq_s32(vmulq_n_s32(t_lo[12], cospi_4_64), vmulq_n_s32(t_lo[13], cospi_28_64));
  s_hi[13] = vaddq_s32(vmulq_n_s32(t_hi[12], cospi_4_64), vmulq_n_s32(t_hi[13], cospi_28_64));
  // s14 = -x14 * cospi_12_64 + x15 * cospi_20_64;
  s_lo[14] = vaddq_s32(vmulq_n_s32(t_lo[14], -cospi_12_64), vmulq_n_s32(t_lo[15], cospi_20_64));
  s_hi[14] = vaddq_s32(vmulq_n_s32(t_hi[14], -cospi_12_64), vmulq_n_s32(t_hi[15], cospi_20_64));
  // s15 = x14 * cospi_20_64 + x15 * cospi_12_64;
  s_lo[15] = vaddq_s32(vmulq_n_s32(t_lo[14], cospi_20_64), vmulq_n_s32(t_lo[15], cospi_12_64));
  s_hi[15] = vaddq_s32(vmulq_n_s32(t_hi[14], cospi_20_64), vmulq_n_s32(t_hi[15], cospi_12_64));
  ...
  s_lo[4] = vaddq_s32(vmulq_n_s32(t_lo[4], cospi_8_64), vmulq_n_s32(t_lo[5], cospi_24_64));
  s_hi[4] = vaddq_s32(vmulq_n_s32(t_hi[4], cospi_8_64), vmulq_n_s32(t_hi[5], cospi_24_64));
  // s5 = x4 * cospi_24_64 - x5 * cospi_8_64;
  s_lo[5] = vaddq_s32(vmulq_n_s32(t_lo[4], cospi_24_64), vmulq_n_s32(t_lo[5], -cospi_8_64));
  s_hi[5] = vaddq_s32(vmulq_n_s32(t_hi[4], cospi_24_64), vmulq_n_s32(t_hi[5], -cospi_8_64));
  // s6 = -x6 * cospi_24_64 + x7 * cospi_8_64;
  s_lo[6] = vaddq_s32(vmulq_n_s32(t_lo[6], -cospi_24_64), vmulq_n_s32(t_lo[7], cospi_8_64));
  s_hi[6] = vaddq_s32(vmulq_n_s32(t_hi[6], -cospi_24_64), vmulq_n_s32(t_hi[7], cospi_8_64));
  // s7 = x6 * cospi_8_64 + x7 * cospi_24_64;
  s_lo[7] = vaddq_s32(vmulq_n_s32(t_lo[6], cospi_8_64), vmulq_n_s32(t_lo[7], cospi_24_64));
  s_hi[7] = vaddq_s32(vmulq_n_s32(t_hi[6], cospi_8_64), vmulq_n_s32(t_hi[7], cospi_24_64));
  s_lo[8] = t_lo[8];
  s_hi[8] = t_hi[8];
  s_lo[9] = t_lo[9];
  s_hi[9] = t_hi[9];
  ...
  s_lo[12] = vaddq_s32(vmulq_n_s32(t_lo[12], cospi_8_64), vmulq_n_s32(t_lo[13], cospi_24_64));
  s_hi[12] = vaddq_s32(vmulq_n_s32(t_hi[12], cospi_8_64), vmulq_n_s32(t_hi[13], cospi_24_64));
  // s13 = x12 * cospi_24_64 - x13 * cospi_8_64;
  s_lo[13] = vaddq_s32(vmulq_n_s32(t_lo[12], cospi_24_64), vmulq_n_s32(t_lo[13], -cospi_8_64));
  s_hi[13] = vaddq_s32(vmulq_n_s32(t_hi[12], cospi_24_64), vmulq_n_s32(t_hi[13], -cospi_8_64));
  // s14 = -x14 * cospi_24_64 + x15 * cospi_8_64;
  s_lo[14] = vaddq_s32(vmulq_n_s32(t_lo[14], -cospi_24_64), vmulq_n_s32(t_lo[15], cospi_8_64));
  s_hi[14] = vaddq_s32(vmulq_n_s32(t_hi[14], -cospi_24_64), vmulq_n_s32(t_hi[15], cospi_8_64));
  // s15 = x14 * cospi_8_64 + x15 * cospi_24_64;
  s_lo[15] = vaddq_s32(vmulq_n_s32(t_lo[14], cospi_8_64), vmulq_n_s32(t_lo[15], cospi_24_64));
  s_hi[15] = vaddq_s32(vmulq_n_s32(t_hi[14], cospi_8_64), vmulq_n_s32(t_hi[15], cospi_24_64));
