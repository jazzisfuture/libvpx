...
static void sad_neon(const uint8x16_t *vec_src_00,
...
void vp9_sad64x64x4d_neon(const uint8_t *src,
                          int src_stride,
  ...
  for (i = 0; i < 64; ++i) {
    ...
    sad_neon(&vec_src_00, &vec_src_16, &vec_src_32, &vec_src_48, ref0,
             &vec_sum_ref0_lo, &vec_sum_ref0_hi);
    sad_neon(&vec_src_00, &vec_src_16, &vec_src_32, &vec_src_48, ref1,
             &vec_sum_ref1_lo, &vec_sum_ref1_hi);
    sad_neon(&vec_src_00, &vec_src_16, &vec_src_32, &vec_src_48, ref2,
             &vec_sum_ref2_lo, &vec_sum_ref2_hi);
    sad_neon(&vec_src_00, &vec_src_16, &vec_src_32, &vec_src_48, ref3,
