...
static INLINE void fadst4x4_neon(int16x8_t *in) {
  ...
  // fdct_round_shift
  out[0] = fdct_round_shift_s32_narrow(u[0]);
  out[1] = fdct_round_shift_s32_narrow(u[1]);
  out[2] = fdct_round_shift_s32_narrow(u[2]);
  out[3] = fdct_round_shift_s32_narrow(u[3]);
...
static INLINE void fadst8x8_neon(int16x8_t *in) {
  ...
  // fdct_round_shift
  t_lo[0] = fdct_round_shift_s32(vaddq_s32(s_lo[0], s_lo[4]));
  t_hi[0] = fdct_round_shift_s32(vaddq_s32(s_hi[0], s_hi[4]));
  t_lo[1] = fdct_round_shift_s32(vaddq_s32(s_lo[1], s_lo[5]));
  t_hi[1] = fdct_round_shift_s32(vaddq_s32(s_hi[1], s_hi[5]));
  t_lo[2] = fdct_round_shift_s32(vaddq_s32(s_lo[2], s_lo[6]));
  t_hi[2] = fdct_round_shift_s32(vaddq_s32(s_hi[2], s_hi[6]));
  t_lo[3] = fdct_round_shift_s32(vaddq_s32(s_lo[3], s_lo[7]));
  t_hi[3] = fdct_round_shift_s32(vaddq_s32(s_hi[3], s_hi[7]));
  t_lo[4] = fdct_round_shift_s32(vsubq_s32(s_lo[0], s_lo[4]));
  t_hi[4] = fdct_round_shift_s32(vsubq_s32(s_hi[0], s_hi[4]));
  t_lo[5] = fdct_round_shift_s32(vsubq_s32(s_lo[1], s_lo[5]));
  t_hi[5] = fdct_round_shift_s32(vsubq_s32(s_hi[1], s_hi[5]));
  t_lo[6] = fdct_round_shift_s32(vsubq_s32(s_lo[2], s_lo[6]));
  t_hi[6] = fdct_round_shift_s32(vsubq_s32(s_hi[2], s_hi[6]));
  t_lo[7] = fdct_round_shift_s32(vsubq_s32(s_lo[3], s_lo[7]));
  t_hi[7] = fdct_round_shift_s32(vsubq_s32(s_hi[3], s_hi[7]));
  ...
  // s4 + s6
  t_lo[4] = fdct_round_shift_s32(vaddq_s32(s_lo[4], s_lo[6]));
  t_hi[4] = fdct_round_shift_s32(vaddq_s32(s_hi[4], s_hi[6]));
  // s5 + s7
  t_lo[5] = fdct_round_shift_s32(vaddq_s32(s_lo[5], s_lo[7]));
  t_hi[5] = fdct_round_shift_s32(vaddq_s32(s_hi[5], s_hi[7]));
  // s4 - s6
  t_lo[6] = fdct_round_shift_s32(vsubq_s32(s_lo[4], s_lo[6]));
  t_hi[6] = fdct_round_shift_s32(vsubq_s32(s_hi[4], s_hi[6]));
  // s5 - s7
  t_lo[7] = fdct_round_shift_s32(vsubq_s32(s_lo[5], s_lo[7]));
  t_hi[7] = fdct_round_shift_s32(vsubq_s32(s_hi[5], s_hi[7]));
  ...
  x_lo[2] = fdct_round_shift_s32_narrow(s_lo[2]);
  x_hi[2] = fdct_round_shift_s32_narrow(s_hi[2]);
  x_lo[3] = fdct_round_shift_s32_narrow(s_lo[3]);
  x_hi[3] = fdct_round_shift_s32_narrow(s_hi[3]);
  x_lo[6] = fdct_round_shift_s32_narrow(s_lo[6]);
  x_hi[6] = fdct_round_shift_s32_narrow(s_hi[6]);
  x_lo[7] = fdct_round_shift_s32_narrow(s_lo[7]);
  x_hi[7] = fdct_round_shift_s32_narrow(s_hi[7]);
...
static void fdct16_8col(int16x8_t *in) {
  ...
  t_lo[2] = fdct_round_shift_s32_narrow(u_lo[2]);
  t_hi[2] = fdct_round_shift_s32_narrow(u_hi[2]);
  t_lo[3] = fdct_round_shift_s32_narrow(u_lo[3]);
  t_hi[3] = fdct_round_shift_s32_narrow(u_hi[3]);
  t_lo[4] = fdct_round_shift_s32_narrow(u_lo[4]);
  t_hi[4] = fdct_round_shift_s32_narrow(u_hi[4]);
  t_lo[5] = fdct_round_shift_s32_narrow(u_lo[5]);
  t_hi[5] = fdct_round_shift_s32_narrow(u_hi[5]);
  ...
  t_lo[1] = fdct_round_shift_s32_narrow(u_lo[1]);
  t_hi[1] = fdct_round_shift_s32_narrow(u_hi[1]);
  t_lo[2] = fdct_round_shift_s32_narrow(u_lo[2]);
  t_hi[2] = fdct_round_shift_s32_narrow(u_hi[2]);
  t_lo[5] = fdct_round_shift_s32_narrow(u_lo[5]);
  t_hi[5] = fdct_round_shift_s32_narrow(u_hi[5]);
  t_lo[6] = fdct_round_shift_s32_narrow(u_lo[6]);
  t_hi[6] = fdct_round_shift_s32_narrow(u_hi[6]);
  ...
  // final fdct_round_shift
  t_lo[0] = fdct_round_shift_s32_narrow(u_lo[0]);
  t_hi[0] = fdct_round_shift_s32_narrow(u_hi[0]);
  t_lo[1] = fdct_round_shift_s32_narrow(u_lo[1]);
  t_hi[1] = fdct_round_shift_s32_narrow(u_hi[1]);
  t_lo[2] = fdct_round_shift_s32_narrow(u_lo[2]);
  t_hi[2] = fdct_round_shift_s32_narrow(u_hi[2]);
  ...
  t_lo[6] = fdct_round_shift_s32_narrow(u_lo[6]);
  t_hi[6] = fdct_round_shift_s32_narrow(u_hi[6]);
  t_lo[7] = fdct_round_shift_s32_narrow(u_lo[7]);
  t_hi[7] = fdct_round_shift_s32_narrow(u_hi[7]);
...
static void fadst16_8col(int16x8_t *in) {
  ...
  // fdct_round_shift
  t_lo[0] = fdct_round_shift_s32(vaddq_s32(s_lo[0], s_lo[8]));
  t_hi[0] = fdct_round_shift_s32(vaddq_s32(s_hi[0], s_hi[8]));
  t_lo[1] = fdct_round_shift_s32(vaddq_s32(s_lo[1], s_lo[9]));
  t_hi[1] = fdct_round_shift_s32(vaddq_s32(s_hi[1], s_hi[9]));
  t_lo[2] = fdct_round_shift_s32(vaddq_s32(s_lo[2], s_lo[10]));
  t_hi[2] = fdct_round_shift_s32(vaddq_s32(s_hi[2], s_hi[10]));
  t_lo[3] = fdct_round_shift_s32(vaddq_s32(s_lo[3], s_lo[11]));
  t_hi[3] = fdct_round_shift_s32(vaddq_s32(s_hi[3], s_hi[11]));
  t_lo[4] = fdct_round_shift_s32(vaddq_s32(s_lo[4], s_lo[12]));
  t_hi[4] = fdct_round_shift_s32(vaddq_s32(s_hi[4], s_hi[12]));
  t_lo[5] = fdct_round_shift_s32(vaddq_s32(s_lo[5], s_lo[13]));
  t_hi[5] = fdct_round_shift_s32(vaddq_s32(s_hi[5], s_hi[13]));
  t_lo[6] = fdct_round_shift_s32(vaddq_s32(s_lo[6], s_lo[14]));
  t_hi[6] = fdct_round_shift_s32(vaddq_s32(s_hi[6], s_hi[14]));
  t_lo[7] = fdct_round_shift_s32(vaddq_s32(s_lo[7], s_lo[15]));
  t_hi[7] = fdct_round_shift_s32(vaddq_s32(s_hi[7], s_hi[15]));
  t_lo[8] = fdct_round_shift_s32(vsubq_s32(s_lo[0], s_lo[8]));
  t_hi[8] = fdct_round_shift_s32(vsubq_s32(s_hi[0], s_hi[8]));
  t_lo[9] = fdct_round_shift_s32(vsubq_s32(s_lo[1], s_lo[9]));
  t_hi[9] = fdct_round_shift_s32(vsubq_s32(s_hi[1], s_hi[9]));
  t_lo[10] = fdct_round_shift_s32(vsubq_s32(s_lo[2], s_lo[10]));
  t_hi[10] = fdct_round_shift_s32(vsubq_s32(s_hi[2], s_hi[10]));
  t_lo[11] = fdct_round_shift_s32(vsubq_s32(s_lo[3], s_lo[11]));
  t_hi[11] = fdct_round_shift_s32(vsubq_s32(s_hi[3], s_hi[11]));
  t_lo[12] = fdct_round_shift_s32(vsubq_s32(s_lo[4], s_lo[12]));
  t_hi[12] = fdct_round_shift_s32(vsubq_s32(s_hi[4], s_hi[12]));
  t_lo[13] = fdct_round_shift_s32(vsubq_s32(s_lo[5], s_lo[13]));
  t_hi[13] = fdct_round_shift_s32(vsubq_s32(s_hi[5], s_hi[13]));
  t_lo[14] = fdct_round_shift_s32(vsubq_s32(s_lo[6], s_lo[14]));
  t_hi[14] = fdct_round_shift_s32(vsubq_s32(s_hi[6], s_hi[14]));
  t_lo[15] = fdct_round_shift_s32(vsubq_s32(s_lo[7], s_lo[15]));
  t_hi[15] = fdct_round_shift_s32(vsubq_s32(s_hi[7], s_hi[15]));
  ...
  t_lo[8] = fdct_round_shift_s32(t_lo[8]);
  t_hi[8] = fdct_round_shift_s32(t_hi[8]);
  t_lo[9] = fdct_round_shift_s32(t_lo[9]);
  t_hi[9] = fdct_round_shift_s32(t_hi[9]);
  t_lo[10] = fdct_round_shift_s32(t_lo[10]);
  t_hi[10] = fdct_round_shift_s32(t_hi[10]);
  t_lo[11] = fdct_round_shift_s32(t_lo[11]);
  t_hi[11] = fdct_round_shift_s32(t_hi[11]);
  t_lo[12] = fdct_round_shift_s32(t_lo[12]);
  t_hi[12] = fdct_round_shift_s32(t_hi[12]);
  t_lo[13] = fdct_round_shift_s32(t_lo[13]);
  t_hi[13] = fdct_round_shift_s32(t_hi[13]);
  t_lo[14] = fdct_round_shift_s32(t_lo[14]);
  t_hi[14] = fdct_round_shift_s32(t_hi[14]);
  t_lo[15] = fdct_round_shift_s32(t_lo[15]);
  t_hi[15] = fdct_round_shift_s32(t_hi[15]);
  ...
  t_lo[4] = fdct_round_shift_s32(t_lo[4]);
  t_hi[4] = fdct_round_shift_s32(t_hi[4]);
  t_lo[5] = fdct_round_shift_s32(t_lo[5]);
  t_hi[5] = fdct_round_shift_s32(t_hi[5]);
  t_lo[6] = fdct_round_shift_s32(t_lo[6]);
  t_hi[6] = fdct_round_shift_s32(t_hi[6]);
  t_lo[7] = fdct_round_shift_s32(t_lo[7]);
  t_hi[7] = fdct_round_shift_s32(t_hi[7]);
  t_lo[12] = fdct_round_shift_s32(t_lo[12]);
  t_hi[12] = fdct_round_shift_s32(t_hi[12]);
  t_lo[13] = fdct_round_shift_s32(t_lo[13]);
  t_hi[13] = fdct_round_shift_s32(t_hi[13]);
  ...
  x_lo[7] = fdct_round_shift_s32_narrow(s_lo[7]);
  x_hi[7] = fdct_round_shift_s32_narrow(s_hi[7]);
  x_lo[10] = fdct_round_shift_s32_narrow(s_lo[10]);
  x_hi[10] = fdct_round_shift_s32_narrow(s_hi[10]);
  x_lo[11] = fdct_round_shift_s32_narrow(s_lo[11]);
  x_hi[11] = fdct_round_shift_s32_narrow(s_hi[11]);
  x_lo[14] = fdct_round_shift_s32_narrow(s_lo[14]);
  x_hi[14] = fdct_round_shift_s32_narrow(s_hi[14]);
  x_lo[15] = fdct_round_shift_s32_narrow(s_lo[15]);
  x_hi[15] = fdct_round_shift_s32_narrow(s_hi[15]);
...
static INLINE void highbd_fadst4x4_neon(int32x4_t *in /*[4]*/) {
  ...
  // fdct_round_shift
  in[0] = vcombine_s32(fdct_round_shift_s64_narrow(u_lo[0]),
                       fdct_round_shift_s64_narrow(u_hi[0]));
  in[1] = vcombine_s32(fdct_round_shift_s64_narrow(u_lo[1]),
                       fdct_round_shift_s64_narrow(u_hi[1]));
  in[2] = vcombine_s32(fdct_round_shift_s64_narrow(u_lo[2]),
                       fdct_round_shift_s64_narrow(u_hi[2]));
  in[3] = vcombine_s32(fdct_round_shift_s64_narrow(u_lo[3]),
                       fdct_round_shift_s64_narrow(u_hi[3]));
