...
void vp9_fdct8x8_neon(const int16_t *input, int16_t *final_output, int stride) {
  ...
  for (i = 0; i < 2; i++) {
    ...
    int16x8_t v_s0 = vaddq_s16(input_0, input_7);
    int16x8_t v_s1 = vaddq_s16(input_1, input_6);
    int16x8_t v_s2 = vaddq_s16(input_2, input_5);
    int16x8_t v_s3 = vaddq_s16(input_3, input_4);
    int16x8_t v_s4 = vsubq_s16(input_3, input_4);
    int16x8_t v_s5 = vsubq_s16(input_2, input_5);
    int16x8_t v_s6 = vsubq_s16(input_1, input_6);
    int16x8_t v_s7 = vsubq_s16(input_0, input_7);
    // fdct4(step, step);
