...
void vp9_quantize_fp_32x32_neon(const tran_low_t *coeff_ptr, intptr_t count,
...

  {
    ...
    dqcoeff_0 =
        vaddq_s32(dqcoeff_0, vreinterpretq_s32_u32(vshrq_n_u32(dqcoeff_0, 31)));
    dqcoeff_1 =
        vaddq_s32(dqcoeff_1, vreinterpretq_s32_u32(vshrq_n_u32(dqcoeff_1, 31)));
...

  {
    ...
    for (i = 8; i < 32 * 32; i += 8) {
      ...
      dqcoeff_0 = vaddq_s32(dqcoeff_0,
                            vreinterpretq_s32_u32(vshrq_n_u32(dqcoeff_0, 31)));
      dqcoeff_1 = vaddq_s32(dqcoeff_1,
                            vreinterpretq_s32_u32(vshrq_n_u32(dqcoeff_1, 31)));
