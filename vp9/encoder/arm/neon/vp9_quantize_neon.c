...
static VPX_FORCE_INLINE void load_fp_values(
    const int16_t *round_ptr, int16x8_t *round, const int16_t *quant_ptr,
    int16x8_t *quant, const int16_t *dequant_ptr, int16x8_t *dequant) {
...
void vp9_quantize_fp_neon(const tran_low_t *coeff_ptr, intptr_t count,
  ...
  load_fp_values(round_ptr, &v_round, quant_ptr, &v_quant, dequant_ptr,
                 &v_dequant);
