...
#else
      const uint32x2_t horiz_max_0 =
          vmax_u32(vget_low_u32(vreinterpretq_u32_s8(v_inside_d)),
                   vget_high_u32(vreinterpretq_u32_s8(v_inside_d)));
      const uint32x2_t horiz_max_1 = vpmax_u32(horiz_max_0, horiz_max_0);
