...
int update_running_avg(uint8_t *mc_avg, int mc_avg_stride, uint8_t *avg, int avg_stride,
                       uint8_t *sig, int sig_stride, BLOCK_SIZE bs) {
  //                     Indices: 0, 1, 2, 3, 4, 5 ,6, 7,
  static uint8_t adjustments[] = {0, 0, 0, 0, 3, 3, 3, 3,
...
void vp9_denoiser_denoise(VP9_DENOISER *denoiser,
  ...
  update_running_avg(denoiser->mc_running_avg_y.buf, denoiser->mc_running_avg_y.stride,
                     denoiser->running_avg_y.buf, denoiser->running_avg_y.stride,
