...
int vp9_denoiser_alloc(VP9_DENOISER *denoiser, int width, int height,
  ...
  for (i = 0; i < MAX_REF_FRAMES; ++i) {
    // NOTE: 1s are hardcoded here rather than using ssx and ssy, which means
    // that we are forcing YUV 420. At the time of writing ssx and ssy do not
    // get updated properly for YUV 420.
  ...
  // We use the given ssx and ssy here to avoid memory errors when calling
