...
void vp9_change_config(VP9_PTR ptr, VP9_CONFIG *oxcf) {
  ...
  cpi->mb.e_mbd.inv_4x4_1_x8    = vp9_short_idct4x4llm_1;
  cpi->mb.e_mbd.inv_4x4_x8      = vp9_short_idct4x4llm;
  cpi->mb.e_mbd.inv_1           = vp9_short_inv_walsh4x4_1;
  cpi->mb.e_mbd.inv_lossless    = vp9_short_inv_walsh4x4;

#if CONFIG_LOSSLESS
  cpi->oxcf.lossless = oxcf->lossless;
  if (cpi->oxcf.lossless) {
    cpi->mb.e_mbd.inv_4x4_1_x8    = vp9_short_inv_walsh4x4_1_x8;
    cpi->mb.e_mbd.inv_4x4_x8      = vp9_short_inv_walsh4x4_x8;
    cpi->mb.e_mbd.inv_1           = vp9_short_inv_walsh4x4_1_lossless;
    cpi->mb.e_mbd.inv_lossless    = vp9_short_inv_walsh4x4_lossless;
  }
#endif
