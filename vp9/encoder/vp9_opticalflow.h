...
void iterative_refinement(unsigned char *ref, double *smooth_frm, double *frm_dx,
                          double *frm_dy, flowMV *flow, int width, int height,
                          int ref_stride, int smooth_frm_stride, int n_refinements);
...
int save_img(const char *file_loc, unsigned char *img, int width, int height,
             size_t elem_size);
