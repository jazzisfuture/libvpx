...
typedef struct VP9_COMP {
  ...
  struct twopass_rc {
    ...
    int kf_bits;
    double gf_group_error_left;           // Remaining error from uncoded frames in a gf group. Two pass use only
    ...
    int64_t gf_group_bits;                // Projected Bits available for a group of frames including 1 GF or ARF
