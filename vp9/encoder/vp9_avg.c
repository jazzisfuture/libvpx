...
// integer projection onto 8 16-bit integer row vector
void vp9_int_pro_row_c(int16_t *hbuf, uint8_t *ref, int ref_stride,
                       int height) {
  int idx;
...
int16_t vp9_int_pro_col_c(uint8_t *ref, int width) {
  int idx;
  int16_t sum = 0;
...
int vp9_vector_sad_c(int16_t *ref, int16_t *src, int width) {
  int i;
  int this_sad = 0;
  for (i = 0; i < width; ++i)
