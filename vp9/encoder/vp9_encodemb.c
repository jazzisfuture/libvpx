...
static void fdct32x32(int rd_transform,
                             ...
                             int src_stride, BLOCK_SIZE bsize, int64_t *psse) {
...
//
//    if (*psse && bsize == BLOCK_32X32 && coeff_sse < tmp_sse * 1.2)
//      fprintf(stderr, "overall pixel sse %d, overall coeff sse %d, return sse %d\n",
