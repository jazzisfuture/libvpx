...
void vp9_xform_quant(MACROBLOCK *x, int plane, int block,
  ...
  switch (tx_size) {
    case TX_32X32:
      ...
      vp9_quantize_b_32x32_c(coeff, 1024, x->skip_block, p->zbin, p->round,
    ...
    case TX_16X16:
      ...
      vp9_quantize_b_c(coeff, 256, x->skip_block, p->zbin, p->round,
                     p->quant, p->quant_shift, qcoeff, dqcoeff,
    ...
    case TX_8X8:
      ...
      vp9_quantize_b_c(coeff, 64, x->skip_block, p->zbin, p->round,
                     p->quant, p->quant_shift, qcoeff, dqcoeff,
                     pd->dequant, p->zbin_extra, eob,
                     scan_order->scan, scan_order->iscan);
      break;
    case TX_4X4:
      ...
      vp9_quantize_b_c(coeff, 16, x->skip_block, p->zbin, p->round,
                     p->quant, p->quant_shift, qcoeff, dqcoeff,
                     pd->dequant, p->zbin_extra, eob,
                     scan_order->scan, scan_order->iscan);
      break;
  ...
  switch (tx_size) {
    ...
    case TX_8X8:
      ...
      if (!x->skip_recode) {
        ...
        vp9_quantize_b_c(coeff, 64, x->skip_block, p->zbin, p->round, p->quant,
    ...
    case TX_4X4:
      ...
      if (!x->skip_recode) {
        ...
        if (tx_type != DCT_DCT)
          ...
          x->fwd_txm4x4(src_diff, coeff, diff_stride);
        vp9_quantize_b_c(coeff, 16, x->skip_block, p->zbin, p->round, p->quant,
                       p->quant_shift, qcoeff, dqcoeff,
                       pd->dequant, p->zbin_extra, eob, scan_order->scan,
                       scan_order->iscan);
      }
