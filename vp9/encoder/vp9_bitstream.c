  ...
  for (c = 0; c < MAX_NZC_CONTEXTS; ++c) {
    ...
    for (t = 0; t < NZC_TOKENS_EXTRA; ++t) {
      ...
      for (b = 0; b < NZC_BITS_EXTRA; ++b) {
        printf(" %d/%d,", nzc_pcat_stats[c][t][b][0], nzc_pcat_stats[c][t][b][1]);
      }
      printf(" },\n");
    }
    printf("  },\n");
    ...
    for (r = 0; r < REF_TYPES; ++r) {
      ...
      for (b = 0; b < BLOCK_TYPES; ++b) {
        ...
        vp9_tree_probs_from_distribution(NZC8X8_TOKENS,
                                         vp9_nzc8x8_encodings, vp9_nzc8x8_tree,
                                         probs, branch_ct,
                                         nzc_stats_8x8[c][r][b]);
        printf("      {");
    ...
    for (r = 0; r < REF_TYPES; ++r) {
      ...
      for (b = 0; b < BLOCK_TYPES; ++b) {
        ...
        vp9_tree_probs_from_distribution(NZC16X16_TOKENS,
                                         vp9_nzc16x16_encodings, vp9_nzc16x16_tree,
                                         probs, branch_ct,
    ...
    for (r = 0; r < REF_TYPES; ++r) {
      ...
      for (b = 0; b < BLOCK_TYPES; ++b) {
        ...
        vp9_tree_probs_from_distribution(NZC32X32_TOKENS,
                                         vp9_nzc32x32_encodings, vp9_nzc32x32_tree,
                                         probs, branch_ct,
