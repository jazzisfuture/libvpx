...
#endif
                          cpi->frame_hybrid_branch_ct_4x4, BLOCK_TYPES_4X4_HYBRID);
...
#endif
                          cpi->frame_hybrid_branch_ct_8x8, BLOCK_TYPES_8X8_HYBRID);
...
#endif
                          cpi->frame_hybrid_branch_ct_16x16, BLOCK_TYPES_16X16_HYBRID);
...
void print_tree_update_probs() {
  ...
  print_tree_update_for_type(f, hybrid_tree_update_hist_4x4, BLOCK_TYPES_4X4_HYBRID,
                             "vp9_coef_update_probs_4x4[BLOCK_TYPES_4X4_HYBRID]");
  print_tree_update_for_type(f, tree_update_hist_8x8, BLOCK_TYPES_8X8,
                             "vp9_coef_update_probs_8x8[BLOCK_TYPES_8X8]");
  print_tree_update_for_type(f, hybrid_tree_update_hist_8x8, BLOCK_TYPES_8X8_HYBRID,
                             "vp9_coef_update_probs_8x8[BLOCK_TYPES_8X8_HYBRID]");
  ...
  print_tree_update_for_type(f, hybrid_tree_update_hist_16x16,
                             BLOCK_TYPES_16X16_HYBRID,
                             "vp9_coef_update_probs_16x16[BLOCK_TYPES_16X16_HYBRID]");
