...
static void pack_mb_tokens(vp9_writer* const bc,
  ...
  while (p < stop) {
    ...
    if (t == ZPC_ISOLATED || t == ZPC_NOTISOLATED) {
      ...
      ++p;
      continue;
    } else if (t == ZPC_ZEROEXTRA || t == ZPC_EOORIENT) {
...
void print_zpcstats() {
  ...
  printf(
    "static const unsigned int default_zpc_counts_4x4[REF_TYPES]\n"
    "                                                [ZPC_BANDS]\n"
    "                                                [ZPC_PTOKS]\n"
    "                                                [ZPC_NODES] = {\n");
  for (r = 0; r < REF_TYPES; ++r) {
  ...
  printf("};\n");
  printf(
    "static const unsigned int default_zpc_counts_8x8[REF_TYPES]\n"
    "                                                [ZPC_BANDS]\n"
    "                                                [ZPC_PTOKS]\n"
    "                                                [ZPC_NODES] = {\n");
  for (r = 0; r < REF_TYPES; ++r) {
  ...
  printf("};\n");
  printf(
    "static const unsigned int default_zpc_counts_16x16[REF_TYPES]\n"
    "                                                  [ZPC_BANDS]\n"
    "                                                  [ZPC_PTOKS]\n"
    "                                                  [ZPC_NODES] = {\n");
  for (r = 0; r < REF_TYPES; ++r) {
  ...
  printf("};\n");
  printf(
    "static const unsigned int default_zpc_counts_32x32[REF_TYPES]\n"
    "                                                  [ZPC_BANDS]\n"
    "                                                  [ZPC_PTOKS]\n"
    "                                                  [ZPC_NODES] = {\n");
  for (r = 0; r < REF_TYPES; ++r) {
