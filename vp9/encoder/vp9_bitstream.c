...
static void encode_txfm(VP9_COMP *cpi, vp9_writer *w) {
  ...
  if (cm->txfm_mode == TX_MODE_SELECT) {
    ...
    ct[0][0] = cpi->txfm_count_8x8p[TX_4X4];
    ct[0][1] = cpi->txfm_count_8x8p[TX_8X8];
    ct[1][0] = cpi->txfm_count_16x16p[TX_4X4] +
               cpi->txfm_count_8x8p[TX_4X4];
    ct[1][1] = cpi->txfm_count_16x16p[TX_16X16] +
               cpi->txfm_count_16x16p[TX_8X8] +
               cpi->txfm_count_8x8p[TX_8X8];
    ct[2][0] = cpi->txfm_count_16x16p[TX_8X8];
    ct[2][1] = cpi->txfm_count_16x16p[TX_16X16];
    ct[3][0] = cpi->txfm_count_32x32p[TX_4X4] +
               cpi->txfm_count_16x16p[TX_4X4] +
               cpi->txfm_count_8x8p[TX_4X4];
    ct[3][1] = cpi->txfm_count_32x32p[TX_8X8] +
               cpi->txfm_count_32x32p[TX_16X16] +
               cpi->txfm_count_32x32p[TX_32X32] +
               cpi->txfm_count_16x16p[TX_8X8] +
               cpi->txfm_count_16x16p[TX_16X16] +
               cpi->txfm_count_8x8p[TX_8X8];
    ct[4][0] = cpi->txfm_count_32x32p[TX_8X8] +
               cpi->txfm_count_16x16p[TX_8X8];
    ct[4][1] = cpi->txfm_count_32x32p[TX_16X16] +
               cpi->txfm_count_32x32p[TX_32X32] +
               cpi->txfm_count_16x16p[TX_16X16];
    ct[5][0] = cpi->txfm_count_32x32p[TX_16X16];
    ct[5][1] = cpi->txfm_count_32x32p[TX_32X32];
