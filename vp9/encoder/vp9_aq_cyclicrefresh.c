...
int vp9_cyclic_refresh_rc_bits_per_mb(const VP9_COMP *cpi, int i,
  ...
  // cr->target_num_seg_block actually used in encoding the frame. For the
  // current use case of fixed cr->percent_refresh and cr->time_for_refresh = 0,
  // mismatch does not occur/is very small.
