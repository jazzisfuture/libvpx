...
static int compute_deltaq(const VP9_COMP *cpi, int q, int rate_factor) {
...
void vp9_cyclic_refresh_update_segment(VP9_COMP *const cpi,
  ...
  const int refresh_this_block = candidate_refresh_aq(cr, mbmi, rate, dist, bsize);
