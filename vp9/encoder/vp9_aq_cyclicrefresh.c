...
struct CYCLIC_REFRESH {
  // Percentage of superblocks per frame that are targeted as candidates
  // for cyclic refresh.
  int percent_refresh;
...
int vp9_cyclic_refresh_rc_bits_per_mb(const VP9_COMP *cpi, int i,
  ...
  // frame to be encoded. Note number of blocks here is in 8x8 units.
...
void vp9_cyclic_refresh_update_map(VP9_COMP *const cpi) {
  ...
  block_count = cr->percent_refresh * sbs_in_frame / 100;
