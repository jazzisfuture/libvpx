...
static int kf_low_motion_minq_8[QINDEX_RANGE_MAX];
static int kf_high_motion_minq_8[QINDEX_RANGE_MAX];
static int arfgf_low_motion_minq_8[QINDEX_RANGE_MAX];
static int arfgf_high_motion_minq_8[QINDEX_RANGE_MAX];
static int inter_minq_8[QINDEX_RANGE_MAX];
static int rtc_minq_8[QINDEX_RANGE_MAX];
static int kf_low_motion_minq_10[QINDEX_RANGE_MAX];
static int kf_high_motion_minq_10[QINDEX_RANGE_MAX];
static int arfgf_low_motion_minq_10[QINDEX_RANGE_MAX];
static int arfgf_high_motion_minq_10[QINDEX_RANGE_MAX];
static int inter_minq_10[QINDEX_RANGE_MAX];
static int rtc_minq_10[QINDEX_RANGE_MAX];
static int kf_low_motion_minq_12[QINDEX_RANGE_MAX];
static int kf_high_motion_minq_12[QINDEX_RANGE_MAX];
static int arfgf_low_motion_minq_12[QINDEX_RANGE_MAX];
static int arfgf_high_motion_minq_12[QINDEX_RANGE_MAX];
static int inter_minq_12[QINDEX_RANGE_MAX];
static int rtc_minq_12[QINDEX_RANGE_MAX];
...
#else
  ASSIGN_MINQ_TABLE(VPX_BITS_8, kf_low_motion_minq);
  ASSIGN_MINQ_TABLE(VPX_BITS_8, kf_high_motion_minq);
  ASSIGN_MINQ_TABLE(VPX_BITS_8, arfgf_low_motion_minq);
  ASSIGN_MINQ_TABLE(VPX_BITS_8, arfgf_high_motion_minq);
  ASSIGN_MINQ_TABLE(VPX_BITS_8, rtc_minq);
#endif
...
static int rc_pick_q_and_bounds_one_pass_vbr(const VP9_COMP *cpi,
  ...
  ASSIGN_MINQ_TABLE(VPX_BITS_8, arfgf_low_motion_minq);
  ASSIGN_MINQ_TABLE(VPX_BITS_8, arfgf_high_motion_minq);
  ASSIGN_MINQ_TABLE(VPX_BITS_8, inter_minq);
#endif
