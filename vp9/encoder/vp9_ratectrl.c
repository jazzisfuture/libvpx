...
void vp9_save_coding_context(VP9_COMP *cpi) {
  ...
  vp9_copy(cc->hybrid_nzc_probs_4x4, cm->fc.hybrid_nzc_probs_4x4);
  vp9_copy(cc->nzc_probs_8x8, cm->fc.nzc_probs_8x8);
  vp9_copy(cc->hybrid_nzc_probs_8x8, cm->fc.hybrid_nzc_probs_8x8);
  vp9_copy(cc->nzc_probs_16x16, cm->fc.nzc_probs_16x16);
  vp9_copy(cc->hybrid_nzc_probs_16x16, cm->fc.hybrid_nzc_probs_16x16);
...
void vp9_restore_coding_context(VP9_COMP *cpi) {
  ...
  vp9_copy(cm->fc.hybrid_nzc_probs_4x4, cc->hybrid_nzc_probs_4x4);
  vp9_copy(cm->fc.nzc_probs_8x8, cc->nzc_probs_8x8);
  vp9_copy(cm->fc.hybrid_nzc_probs_8x8, cc->hybrid_nzc_probs_8x8);
  vp9_copy(cm->fc.nzc_probs_16x16, cc->nzc_probs_16x16);
  vp9_copy(cm->fc.hybrid_nzc_probs_16x16, cc->hybrid_nzc_probs_16x16);
