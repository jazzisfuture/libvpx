...
void vp9_rc_init(const VP9EncoderConfig *oxcf, int pass, RATE_CONTROL *rc) {
  ...
  // When a frame is scaled down it will likely require more bits per MB
  // to encode it. We use multipliers on the rate correction factors to account
  // for this, and assume that downscaling will generate twice as many bits.
  rc->rcf_mult[0] = 1.0;
  rc->rcf_mult[1] = 2.0;
}
