...
int vp9_encodedframe_overshoot(VP9_COMP *cpi, int frame_size, int *q) {
  ...
  // If this decision is not based on an encoded frame size but just on scene/slide
  // change detection (i.e., re_encode_overshoot_rt = 0), adjust the qp_thresh and
  // skip the thresh_rate in this case.
