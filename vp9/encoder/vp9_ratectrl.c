...
void vp9_rc_get_svc_params(VP9_COMP *cpi) {
  ...
  // layer frame.
  if (svc->use_longterm_ref_current_layer) {
    // Only used gf longterm prediction  on non-key superframes.
    ...
    // Check for update/refresh of reference: only refresh on base temporal layer.
