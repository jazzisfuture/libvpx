...
const vp9_tree_index vp9_coef_tree[TREE_SIZE(ENTROPY_TOKENS)] = {
  ...
  14, 16,                                      // 6  = HIGH_LOW
  -DCT_CATEGORY1_TOKEN, -DCT_CATEGORY2_TOKEN,  // 7  = CAT_ONE
  18, 20,                                      // 8  = CAT_THREEFOUR
  -DCT_CATEGORY3_TOKEN, -DCT_CATEGORY4_TOKEN,  // 9  = CAT_THREE
  -DCT_CATEGORY5_TOKEN, -DCT_CATEGORY6_TOKEN   // 10 = CAT_FIVE
};
...
const vp9_tree_index vp9_coef_con_tree[TREE_SIZE(ENTROPY_TOKENS)] = {
  ...
  8, 10,                                       // 3 = HIGH_LOW
  -DCT_CATEGORY1_TOKEN, -DCT_CATEGORY2_TOKEN,  // 4 = CAT_ONE
  12, 14,                                      // 5 = CAT_THREEFOUR
  -DCT_CATEGORY3_TOKEN, -DCT_CATEGORY4_TOKEN,  // 6 = CAT_THREE
  -DCT_CATEGORY5_TOKEN, -DCT_CATEGORY6_TOKEN   // 7 = CAT_FIVE
};
...
const vp9_extra_bit vp9_extra_bits[ENTROPY_TOKENS] = {
  ...
  {0, 0, 0, 3},           // THREE_TOKEN
  {0, 0, 0, 4},           // FOUR_TOKEN
  {cat1, Pcat1, 1, 5},    // DCT_CATEGORY1_TOKEN
  {cat2, Pcat2, 2, 7},    // DCT_CATEGORY2_TOKEN
  {cat3, Pcat3, 3, 11},   // DCT_CATEGORY3_TOKEN
  {cat4, Pcat4, 4, 19},   // DCT_CATEGORY4_TOKEN
  {cat5, Pcat5, 5, 35},   // DCT_CATEGORY5_TOKEN
  {cat6, Pcat6, 14, 67},  // DCT_CATEGORY6_TOKEN
