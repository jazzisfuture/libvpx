...
typedef struct MultiThreadHandle {
  ...
  TileWPPInfo tile_wpp_info[MAX_NUM_TILE_COLS];
...
typedef struct VP9_COMP {
  ...
  void (*wpp_sync_read_ptr)(VP9WPPSync *const, int, int);
  void (*wpp_sync_write_ptr)(VP9WPPSync *const, int, int, const int);
  int newMT;
} VP9_COMP;
