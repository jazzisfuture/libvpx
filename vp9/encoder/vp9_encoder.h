...
static INLINE char const *get_component_name(int index) {
  switch (index) {
    ...
    case interp_filter_time:
      return "interp_filter_time";
      //    case encode_with_recode_loop_time: return
      //    "encode_with_recode_loop_time"; case encode_with_recode_loop_time:
      //    return "encode_with_recode_loop_time"; case
      //    encode_with_recode_loop_time: return "encode_with_recode_loop_time";
      //    case encode_with_recode_loop_time: return
      //    "encode_with_recode_loop_time"; case encode_with_recode_loop_time:
