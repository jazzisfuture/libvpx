...
#if CONFIG_NEWMVREF
#define MAX_MODES 69
#define INTERINTRA_START_MODE 57
#else
#define MAX_MODES 52
...
typedef enum {
...
#if CONFIG_NEWMVREF
  THR_COMP_NEARFORNEW_NEARESTLA,
  THR_COMP_NEARFORNEW_NEARESTGA,
  THR_COMP_NEAREST_NEARFORNEWLA,
  THR_COMP_NEAREST_NEARFORNEWGA,
#endif  // CONFIG_NEWMVREF
  ...
  THR_COMP_NEAR_NEWGA,
#if CONFIG_NEWMVREF
  THR_COMP_NEARFORNEW_NEARLA,
  THR_COMP_NEARFORNEW_NEARGA,
  THR_COMP_NEAR_NEARFORNEWLA,
  THR_COMP_NEAR_NEARFORNEWGA,
#endif  // CONFIG_NEWMVREF

  THR_COMP_NEW_NEWLA,
  THR_COMP_NEW_NEWGA,
#if CONFIG_NEWMVREF
  THR_COMP_NEW_NEARFORNEWLA,
  THR_COMP_NEW_NEARFORNEWGA,
  THR_COMP_NEARFORNEW_NEWLA,
  THR_COMP_NEARFORNEW_NEWGA,
  THR_COMP_NEARFORNEW_NEARFORNEWLA,
  THR_COMP_NEARFORNEW_NEARFORNEWGA,
#endif  // CONFIG_NEWMVREF
