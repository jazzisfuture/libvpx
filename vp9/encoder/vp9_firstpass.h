...
#if CONFIG_RATE_CTRL
/*!\brief Calls this function before coding a new group of picture to get
 * information of the new group of picture.
 ...
 * \param[in] show_idx             Show_idx of the first frame in the group
 * \param[in] multi_layer_arf      Is multi-layer arf used
