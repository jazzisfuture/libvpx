...
void initializePPA() {
  ...
  PPAStartCpuEvent              = (FUNC_PPAStartCpuEvent *)GetProcAddress(ppaHandle,"mcw_ppaStartCpuEvent");
  PPAStopCpuEvent               = (FUNC_PPAStopCpuEvent *)GetProcAddress(ppaHandle,"mcw_ppaStopCpuEvent");
  PPAIsEventEnable              = (FUNC_PPAIsEventEnable *)GetProcAddress(ppaHandle,"mcw_ppaIsEventEnable");
  PPARegisterCpuEvent           = (FUNC_PPARegisterCpuEvent *)GetProcAddress(ppaHandle,"mcw_ppaRegisterCpuEvent");
  PPARegisterGrpName            = (FUNC_PPARegisterGrpName *)GetProcAddress(ppaHandle,"mcw_ppaRegisterGrpName");
  PPATIDCpuEvent                = (FUNC_PPATIDCpuEvent *)GetProcAddress(ppaHandle,"mcw_ppaTIDCpuEvent");
  PPADebugCpuEvent              = (FUNC_PPADebugCpuEvent *)GetProcAddress(ppaHandle,"mcw_ppaDebugCpuEvent");
  PPARegisterCpuEventExGrpID    = (FUNC_PPARegisterCpuEventExGrpID *)GetProcAddress(ppaHandle,"mcw_ppaRegisterCpuEventExGrpID");
  PPASetGrpCpuEventEnDis        = (FUNC_PPASetGrpCpuEventEnDis *)GetProcAddress(ppaHandle,"mcw_ppaSetGrpCpuEventEnDis");
