...
bool VP9RateControlRTC::UpdateRateControl(
  ...
  // Even though VPX_SS_MAX_LAYERS and VPX_TS_MAX_LAYERS are both defined as 5,
  // VPX_MAX_LAYERS is defined as only 12 with the comment
