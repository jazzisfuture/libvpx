...
class SimpleEncode {
 ...
 private:
  ...
  // The coding indexes of reference frames of to-be-coded-frame.
  ...
  // reference frame type. vp9 always keeps three reference types of
  // referenceavailable. However, the duplicated reference frames will not be
