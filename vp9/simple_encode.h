...
enum GopMapFlag {
  kGopMapFlagStart =
      1 << 0,  // Indicate this location is the start of a group of picture.
  kGopMapFlagUseAltRef =
      1 << 1,  // Indicate this group of picture will use an alt ref. Only set
...
struct GroupOfPicture {
  ...
  // Indicates whether this group of pictures use an alt ref.
  int use_alt_ref;

  // Indicates whether previous group of pictures use an alt ref.
...
class SimpleEncode {
 public:
  ...
  // Sets group of picture map for coding the entire video.
