...
static unsigned long vp9_priv_sz(const vpx_codec_dec_cfg_t *si, vpx_codec_flags_t);

static const mem_req_t vp9_mem_req_segs[] = {
  {VP9_SEG_ALG_PRIV, 0, 8, VPX_CODEC_MEM_ZERO, vp9_priv_sz},
...
static unsigned long vp9_priv_sz(const vpx_codec_dec_cfg_t *si,
