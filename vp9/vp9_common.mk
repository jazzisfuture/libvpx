...
VP9_COMMON_SRCS-yes += common/arm/neon/vp9_iht4x4_add_neon_asm$(ASM)
VP9_COMMON_SRCS-yes += common/arm/neon/vp9_iht8x8_add_neon_asm$(ASM)
...
ifeq ($(HAVE_NEON), yes)
VP9_COMMON_SRCS-yes += common/arm/neon/vp9_iht4x4_add_neon.c
VP9_COMMON_SRCS-yes += common/arm/neon/vp9_iht8x8_add_neon.c
