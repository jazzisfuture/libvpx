...
static vpx_codec_err_t set_encoder_config(
  ...
  raw_target_rate =
      (unsigned int)((oxcf->width * oxcf->height * oxcf->bit_depth * 3) *
                     (int64_t)(oxcf->init_framerate) / (int64_t)8000);
  // Cap target bitrate to raw rate
  cfg->rc_target_bitrate = (cfg->rc_target_bitrate > raw_target_rate)
                               ? raw_target_rate
