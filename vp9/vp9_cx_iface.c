...
VP9EncoderConfig vp9_get_encoder_config(int frame_width, int frame_height,
   ...
   * vpxenc command given bellow.
   * The configs in vpxenc command are corresponding to parameters of
   ...
   *  --minsection-pct=0 --maxsection-pct=2000 --arnr-maxframes=7 --psnr \
  ...
  // These settings are make to match the settings of the vpxenc command.
  oxcf.key_freq = 150;
