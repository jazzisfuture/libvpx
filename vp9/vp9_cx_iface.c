...
static vpx_codec_err_t validate_config(vpx_codec_alg_priv_t *ctx,
  ...
  RANGE_CHECK(cfg, cfg->active_wq_factor.den, 1, 1000);
  RANGE_CHECK(cfg, cfg->base_err_per_mb.den, 1, 1000);
  RANGE_CHECK(cfg, cfg->sr_default_decay_limit.den, 1, 1000);
  RANGE_CHECK(cfg, cfg->sr_diff_factor.den, 1, 1000);
  RANGE_CHECK(cfg, cfg->kf_err_per_mb.den, 1, 1000);
  RANGE_CHECK(cfg, cfg->kf_frame_min_boost.den, 1, 1000);
  RANGE_CHECK(cfg, cfg->kf_frame_max_boost_subs.den, 1, 1000);
  RANGE_CHECK(cfg, cfg->kf_max_total_boost.den, 1, 1000);
  RANGE_CHECK(cfg, cfg->gf_max_total_boost.den, 1, 1000);
  RANGE_CHECK(cfg, cfg->gf_frame_max_boost.den, 1, 1000);
  RANGE_CHECK(cfg, cfg->zm_power_factor.den, 1, 1000);
