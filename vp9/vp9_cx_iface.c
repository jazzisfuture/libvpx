...
static vpx_codec_err_t set_twopass_params_from_config(
  ...
  cpi->twopass.sr_default_decay_limit =
      (double)cfg->sr_default_decay_limit.num / (double)cfg->sr_default_decay_limit.den;
  cpi->twopass.sr_diff_part =
      (double)cfg->sr_diff_part.num / (double)cfg->sr_diff_part.den;
  ...
  cpi->twopass.kf_frame_max_boost_first =
      (double)cfg->kf_frame_max_boost_first.num / (double)cfg->kf_frame_max_boost_first.den;
  cpi->twopass.kf_frame_max_boost_subs =
      (double)cfg->kf_frame_max_boost_subs.num / (double)cfg->kf_frame_max_boost_subs.den;
  cpi->twopass.kf_max_total_boost =
      (int)((double)cfg->kf_max_total_boost.num / (double)cfg->kf_max_total_boost.den);
  cpi->twopass.gf_max_total_boost =
      (int)((double)cfg->gf_max_total_boost.num / (double)cfg->gf_max_total_boost.den);
