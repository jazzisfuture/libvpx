...
struct vp9_extracfg {
  ...
  AQ_MODE                     aq_mode;
  unsigned int                frame_periodic_deltaq;
};
...
static vpx_codec_err_t validate_config(vpx_codec_alg_priv_t *ctx,
  ...
  RANGE_CHECK(extra_cfg, frame_periodic_deltaq, 0, 1);
...
static vpx_codec_err_t set_vp9e_config(VP9_CONFIG *oxcf,
  ...
  oxcf->frame_periodic_deltaq =  extra_cfg->frame_periodic_deltaq;
...
#define MAP(id, var) case id: var = CAST(id, args); break;
  ...
  switch (ctrl_id) {
    ...
    MAP(VP9E_SET_FRAME_PERIODIC_DELTAQ,   extra_cfg.frame_periodic_deltaq);
  }
...
static vpx_codec_ctrl_fn_map_t vp9e_ctf_maps[] = {
  ...
  {VP9E_SET_FRAME_PERIODIC_DELTAQ,    set_param},
