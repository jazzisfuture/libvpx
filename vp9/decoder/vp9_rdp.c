...
void vp9_reconstruct_iwalsh_1_4x4_c_recon(int16_t *input, uint8_t *dest,
                                          int dest_stride) {
  int i;
  int a1, e1;
  int16_t tmp[4];
...
void vp9_reconstruct_iwalsh_4x4_c_recon(int16_t *input, uint8_t *dest,
                                        int dest_stride) {
  int i;
  int a1, b1, c1, d1, e1;
...
void vp9_reconstruct_4x4_1_c_recon(int16_t input, uint8_t *dest,
                                   int dest_stride) {
  int i, a1;
...
void vp_reconstruct_4x4_c_recon(int16_t *input, uint8_t *dest,
                                int dest_stride) {
  int i, j;
...
void vp_reconstruct_8x8_c_recon(int16_t *input, uint8_t *dest,
                                int dest_stride) {
  int i, j;
...
void vp_reconstruct_8x8_10_c_recon(int16_t *input, uint8_t *dest,
                                   int dest_stride) {
  int i, j;
...
void vp_reconstruct_8x8_1_c_recon(int16_t input, uint8_t *dest,
                                  int dest_stride) {
  int i, j, a1;
...
void vp_reconstruct_16x16_c_recon(int16_t *input, uint8_t *dest,
                                  int dest_stride) {
  int i, j;
...
void vp_reconstruct_16x16_10_c_recon(int16_t *input, uint8_t *dest,
                                     int dest_stride) {
  int i, j;
...
void vp_reconstruct_16x16_1_c_recon(int16_t input, uint8_t *dest,
                                    int dest_stride) {
  int i, j, a1;
...
void vp9_reconstruct_32x32_c_recon(int16_t *input, uint8_t *dest,
                                   int dest_stride, int eob) {
  int i, j;
