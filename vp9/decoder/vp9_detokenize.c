...
int vp9_decode_sb_tokens(VP9D_COMP* const pbi,
  ...
  vpx_memcpy(xd->above_context + 1, xd->above_context, sizeof(ENTROPY_CONTEXT_PLANES));
  vpx_memcpy(xd->left_context + 1, xd->left_context, sizeof(ENTROPY_CONTEXT_PLANES));
