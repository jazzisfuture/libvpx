...
int vp9_decode_sb64_tokens(VP9D_COMP* const pbi,
  ...
  foreach_transformed_block(xd, BLOCK_64X64_LG2, decode_block, &args);
  return eobtotal;
#else
...
int vp9_decode_sb_tokens(VP9D_COMP* const pbi,
  ...
  foreach_transformed_block(xd, BLOCK_32X32_LG2, decode_block, &args);
  return eobtotal;
}
...
int vp9_decode_mb_tokens(VP9D_COMP* const pbi,
  ...
  foreach_transformed_block(xd, BLOCK_16X16_LG2, decode_block, &args);
  return eobtotal;
}
