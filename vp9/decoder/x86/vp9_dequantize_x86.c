...
void vp9_add_residual_4x4_sse2(const int16_t *diff, const uint8_t *pred, int pitch,
...
void vp9_add_residual_8x8_sse2(const int16_t *diff, const uint8_t *pred, int pitch,
                           uint8_t *dest, int stride) {
  const int width = 8;
  const __m128i zero = _mm_setzero_si128();
