...
void vp9_add_residual_16x16_c(const int16_t *diff, const uint8_t *pred, int pitch,
                         uint8_t *dest, int stride) {
  add_residual(diff, pred, pitch, dest, stride, 16, 16);
}

void vp9_add_residual_32x32_c(const int16_t *diff, const uint8_t *pred, int pitch,
                         uint8_t *dest, int stride) {
