...
#if CONFIG_LOSSLESS
  if (!QIndex) {
    pbi->mb.inv_4x4_1_x8     = vp9_short_inv_walsh4x4_1_x8;
    pbi->mb.inv_4x4_x8       = vp9_short_inv_walsh4x4_x8;
    pbi->mb.inv_1            = vp9_short_inv_walsh4x4_1_lossless;
    pbi->mb.inv_lossless     = vp9_short_inv_walsh4x4_lossless;
    ...
    pbi->mb.inv_4x4_1_x8     = vp9_short_idct4x4llm_1;
    pbi->mb.inv_4x4_x8       = vp9_short_idct4x4llm;
    pbi->mb.inv_1            = vp9_short_inv_walsh4x4_1;
    pbi->mb.inv_lossless     = vp9_short_inv_walsh4x4;
