...
typedef struct inter_pre_recon {
  ...
  int skip_coeff;
  int16_t offset;
  // it choose whether to do inv-transformation in the inter block
  int eobtotal;
  ...
  // the macroblock address and stride in every frames.
...
typedef struct VP9_decoder_recon {
  ...
  /* The infomation of inter prediction block */
  INTER_PRE_RECON *inter_pre_recon;
  /* The infomation of intra prediction block */
  INTRA_PRE_RECON *intra_pre_recon;
  /* The infomation of dequant progress*/
  DEQUANT_RECON *dequant_recon;
  /* This is a count for statistics inter block numbers  */
  int inter_blocks_count;
  /* This is a count for statistics intra block numbers  */
  int intra_blocks_count;
  int dequant_count;
