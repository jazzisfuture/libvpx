...
int vp9_decode_frame(VP9D_COMP *pbi, const unsigned char **p_data_end) {
  ...
  /* Read the default quantizers. */
  {
    ...
    pc->y2dc_delta_q_unused = get_delta_q(&header_bc, pc->y2dc_delta_q_unused, &q_update);
    pc->y2ac_delta_q_unused = get_delta_q(&header_bc, pc->y2ac_delta_q_unused, &q_update);
