...
typedef struct FrameWorkerData {
  ...
  // The following two variables could be got in other ways. But saved here
  // could save a lot of time during accessing.
  ...
  int decoding_done;        // Finishe decoding current frame.
} FrameWorkerData;
