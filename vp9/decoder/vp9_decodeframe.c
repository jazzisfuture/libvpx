...
static void setup_nv12_buffer(VP9Decoder *pbi) {
  ...
  // Re-allocate the memory if uv plane size is bigger than current one.
  if (pbi->nv12_temp_buffer != NULL && uvplane_size > pbi->nv12_buffer_size) {
