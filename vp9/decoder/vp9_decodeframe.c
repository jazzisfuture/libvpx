...
static void dec_predict_b_extend(VP9_COMMON *const cm, MACROBLOCKD *const xd,
  ...
  if (!b_sub8x8)
    ...
    vp9_dec_build_inter_predictors_sb_sub8x8_extend(xd, mi_row_ori, mi_col_ori,
                                           mi_row_pred, mi_col_pred,
                                           bsize_pred, block);
#else
...
static void dec_lower_extend(VP9_COMMON *const cm, MACROBLOCKD *const xd,
                             const TileInfo *const tile, int block,
...
static void dec_upper_extend(VP9_COMMON *const cm, MACROBLOCKD *const xd,
                             const TileInfo *const tile, int block,
                             BLOCK_SIZE bsize, BLOCK_SIZE top_bsize,
                             int mi_row, int mi_col,
                             int mi_row_top, int mi_col_top,
...
static void dec_right_extend(VP9_COMMON *const cm, MACROBLOCKD *const xd,
                             const TileInfo *const tile, int block,
                             BLOCK_SIZE bsize, BLOCK_SIZE top_bsize,
                             int mi_row, int mi_col,
                             int mi_row_top, int mi_col_top,
...
static void dec_left_extend(VP9_COMMON *const cm, MACROBLOCKD *const xd,
                            const TileInfo *const tile, int block,
                            BLOCK_SIZE bsize, BLOCK_SIZE top_bsize,
                            int mi_row, int mi_col,
                            int mi_row_top, int mi_col_top,
...
static void dec_upperleft_extend(VP9_COMMON *const cm, MACROBLOCKD *const xd,
                                 const TileInfo *const tile, int block,
                                 BLOCK_SIZE bsize, BLOCK_SIZE top_bsize,
                                 int mi_row, int mi_col,
                                 int mi_row_top, int mi_col_top,
...
static void dec_upperright_extend(VP9_COMMON *const cm, MACROBLOCKD *const xd,
                                  const TileInfo *const tile, int block,
                                  BLOCK_SIZE bsize, BLOCK_SIZE top_bsize,
                                  int mi_row, int mi_col,
                                  int mi_row_top, int mi_col_top,
...
static void dec_lowerleft_extend(VP9_COMMON *const cm, MACROBLOCKD *const xd,
                                 const TileInfo *const tile, int block,
                                 BLOCK_SIZE bsize, BLOCK_SIZE top_bsize,
                                 int mi_row, int mi_col,
                                 int mi_row_top, int mi_col_top,
...
static void dec_lowerright_extend(VP9_COMMON *const cm, MACROBLOCKD *const xd,
                                  const TileInfo *const tile, int block,
                                  BLOCK_SIZE bsize, BLOCK_SIZE top_bsize,
                                  int mi_row, int mi_col,
                                  int mi_row_top, int mi_col_top,
...
static void dec_extend_all(VP9_COMMON *const cm, MACROBLOCKD *const xd,
                           ...
                           int mi_row_top, int mi_col_top,
                           uint8_t * dst_buf[3], int dst_stride[3]) {
  dec_lower_extend(cm, xd, tile, block, bsize, top_bsize, mi_row, mi_col,
                   mi_row_top, mi_col_top, dst_buf, dst_stride);
  dec_upper_extend(cm, xd, tile, block, bsize, top_bsize, mi_row, mi_col,
                   mi_row_top, mi_col_top, dst_buf, dst_stride);
  dec_left_extend(cm, xd, tile, block, bsize, top_bsize, mi_row, mi_col,
                  mi_row_top, mi_col_top, dst_buf, dst_stride);
  dec_right_extend(cm, xd, tile, block, bsize, top_bsize, mi_row, mi_col,
                   mi_row_top, mi_col_top, dst_buf, dst_stride);
  dec_upperleft_extend(cm, xd, tile, block, bsize, top_bsize, mi_row, mi_col,
                       mi_row_top, mi_col_top, dst_buf, dst_stride);
  dec_upperright_extend(cm, xd, tile, block, bsize, top_bsize, mi_row, mi_col,
                        mi_row_top, mi_col_top, dst_buf, dst_stride);
  dec_lowerleft_extend(cm, xd, tile, block, bsize, top_bsize, mi_row, mi_col,
                       mi_row_top, mi_col_top, dst_buf, dst_stride);
  dec_lowerright_extend(cm, xd, tile, block, bsize, top_bsize, mi_row, mi_col,
                        mi_row_top, mi_col_top, dst_buf, dst_stride);
}
    ...
    case PARTITION_HORZ:
      if (bsize == BLOCK_8X8) {
        ...
        if (bsize < top_bsize)
          ...
          dec_lower_extend(cm, xd, tile, 0, subsize, top_bsize, mi_row, mi_col,
                           mi_row_top, mi_col_top, dst_buf, dst_stride);
        ...
        if (mi_row + hbs < cm->mi_rows) {
          ...
          if (bsize < top_bsize)
            ...
            dec_upper_extend(cm, xd, tile, 0, subsize, top_bsize,
                             mi_row + hbs, mi_col,
                             mi_row_top, mi_col_top,
                             dst_buf1, dst_stride1);
    ...
    case PARTITION_VERT:
      if (bsize == BLOCK_8X8) {
        ...
        if (bsize < top_bsize)
          ...
          dec_right_extend(cm, xd, tile, 0, subsize, top_bsize, mi_row, mi_col,
                           mi_row_top, mi_col_top, dst_buf, dst_stride);
        ...
        if (mi_col + hbs < cm->mi_cols) {
          ...
          if (bsize < top_bsize)
            ...
            dec_left_extend(cm, xd, tile, 0, subsize, top_bsize,
                            mi_row, mi_col + hbs, mi_row_top, mi_col_top,
                            dst_buf1, dst_stride1);
