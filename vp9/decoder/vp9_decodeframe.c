...
static MB_MODE_INFO *set_offsets(VP9_COMMON *const cm, MACROBLOCKD *const xd,
  ...
  *mode_node = get_free_mi(cm);
  ...
  mode_node = cm->mi_grid + offset - cm->mi_stride;
  xd->above_mi = xd->up_available ? *mode_node : NULL;
  mode_node = cm->mi_grid + offset - 1;
  xd->left_mi = xd->left_available ? *mode_node : NULL;
