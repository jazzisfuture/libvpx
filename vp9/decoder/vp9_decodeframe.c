...
static void recon_tile_row(TileWorkerData *tile_data, VP9Decoder *pbi, int mi_row,
...
static void parse_tile_row(TileWorkerData *tile_data, VP9Decoder *pbi, int mi_row,
