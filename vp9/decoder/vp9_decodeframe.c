...
#if CONFIG_SR_MODE
static void inverse_transform_block_sr(MACROBLOCKD* xd, int plane, int block,
                                    TX_SIZE tx_size, int16_t *dst, int stride,
                                    int eob) {
...
#if CONFIG_SR_MODE
static int dec_sr_trfm_quant(VP9_COMMON *cm, MACROBLOCKD *xd, int plane, int block,
