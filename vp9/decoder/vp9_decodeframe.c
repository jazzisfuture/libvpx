...
static const uint8_t *decode_tiles(VP9Decoder *pbi,
  ...
  if (pbi->tile_worker0_data == NULL ||
      (tile_cols * tile_rows) != pbi->total_tiles) {
    vpx_free(pbi->tile_worker0_data);
    CHECK_MEM_ERROR(
        cm,
        pbi->tile_worker0_data,
        vpx_memalign(32, tile_cols * tile_rows *
                     (sizeof(*pbi->tile_worker0_data))));
  ...
  for (tile_row = 0; tile_row < tile_rows; ++tile_row) {
    for (tile_col = 0; tile_col < tile_cols; ++tile_col) {
      ...
      tile_data = pbi->tile_worker0_data + tile_cols * tile_row + tile_col;
      tile_data->xd = pbi->mb;
  ...
  for (tile_row = 0; tile_row < tile_rows; ++tile_row) {
    ...
    for (mi_row = tile.mi_row_start; mi_row < tile.mi_row_end;
      ...
      for (tile_col = 0; tile_col < tile_cols; ++tile_col) {
        ...
        tile_data = pbi->tile_worker0_data + tile_cols * tile_row + col;
  ...
  // Get last tile data.
  tile_data = pbi->tile_worker0_data + tile_cols * tile_rows - 1;
