...
vpx_codec_err_t vp9_get_reference_dec(VP9D_PTR ptr, unsigned int ref_index,
                                      YV12_BUFFER_CONFIG *sd) {
  VP9D_COMP *pbi = (VP9D_COMP *) ptr;
  VP9_COMMON *cm = &pbi->common;
  int ref_fb_idx = cm->active_ref_idx[ref_index];

  if (ref_index > NUM_REF_FRAMES) {
...
vpx_codec_err_t vp9_set_reference_dec(VP9D_PTR ptr, unsigned int ref_index,
                                      YV12_BUFFER_CONFIG *sd) {
  VP9D_COMP *pbi = (VP9D_COMP *) ptr;
  VP9_COMMON *cm = &pbi->common;
  int *ref_fb_ptr = NULL;
