...
static void kfread_modes(VP9D_COMP *pbi, MODE_INFO *m,
  ...
  lvl_skip = vp9_segfeature_active(xd, m->mbmi.segment_id, SEG_LVL_SKIP);
  m->mbmi.mb_skip_coeff = cm->mb_no_coeff_skip && !lvl_skip ?
...
static void read_mb_modes_mv(VP9D_COMP *pbi, MODE_INFO *mi, MB_MODE_INFO *mbmi,
  ...
  // else default to 0
  lvl_skip = vp9_segfeature_active(xd, mbmi->segment_id, SEG_LVL_SKIP);
  mbmi->mb_skip_coeff = cm->mb_no_coeff_skip && !lvl_skip ?
      vp9_read(r, vp9_get_pred_prob(cm, xd, PRED_MBSKIP)) :
      lvl_skip;
