...
static int find_intra_segment_id(VP9D_COMP *pbi, int mi_row, int mi_col,
                                 vp9_reader *r) {
  VP9_COMMON *const cm = &pbi->common;
  MACROBLOCKD *const xd = &pbi->mb;
...
static void kfread_modes(VP9D_COMP *pbi, MODE_INFO *m,
  ...
  m->mbmi.segment_id = find_intra_segment_id(pbi, mi_row, mi_col, r);
...
static int find_inter_segment_id(VP9D_COMP *pbi, int mi_row, int mi_col,
                                 vp9_reader *r) {
  VP9_COMMON *const cm = &pbi->common;
  MACROBLOCKD *const xd = &pbi->mb;
  const BLOCK_SIZE_TYPE bsize = xd->mode_info_context->mbmi.sb_type;
...
static void read_mb_modes_mv(VP9D_COMP *pbi, MODE_INFO *mi, MB_MODE_INFO *mbmi,
  ...
  mbmi->segment_id = find_inter_segment_id(pbi, mi_row, mi_col, r);
