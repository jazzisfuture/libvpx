...
static void fpm_sync(void *const data, int mi_row) {
  VP9Decoder *const pbi = (VP9Decoder *const)data;
  // TODO(hkuang): Fix "mi_rwo << 3" after addressing loopfilter issue.
  vp9_frameworker_wait(pbi->owner_frame_worker, pbi->prev_buf, mi_row << 3);
}
