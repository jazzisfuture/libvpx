...
static PREDICTION_MODE read_intra_mode_exp(vp9_reader *r, const MODE_INFO *mi,
...
static void read_intra_frame_mode_info(VP9_COMMON *const cm,
  ...
  switch (bsize) {
    case BLOCK_4X4:
      for (i = 0; i < 4; ++i)
        mi->bmi[i].as_mode =
            read_intra_mode_exp(r, mi, above_mi, left_mi, i);
//            read_intra_mode(r, get_y_mode_probs(mi, above_mi, left_mi, i));
      mbmi->mode = mi->bmi[3].as_mode;
      break;
    case BLOCK_4X8:
      mi->bmi[0].as_mode = mi->bmi[2].as_mode =
          read_intra_mode_exp(r, mi, above_mi, left_mi, 0);
//          read_intra_mode(r, get_y_mode_probs(mi, above_mi, left_mi, 0));
      mi->bmi[1].as_mode = mi->bmi[3].as_mode = mbmi->mode =
          read_intra_mode_exp(r, mi, above_mi, left_mi, 1);
...
//          read_intra_mode(r, get_y_mode_probs(mi, above_mi, left_mi, 0));
      mi->bmi[2].as_mode = mi->bmi[3].as_mode = mbmi->mode =
          read_intra_mode_exp(r, mi, above_mi, left_mi, 2);
