...
static VP9EncoderConfig GetEncodeConfig(
  ...
  for (auto config : encode_config_list) {
...
void SimpleEncode::SetEncodeConfig(const char *name, const char *value) {
  EncodeConfig config;
...
void SimpleEncode::DumpEncodeConfigs(int pass, FILE *fp) {
