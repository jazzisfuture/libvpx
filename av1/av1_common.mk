...
VP10_COMMON_SRCS-yes += common/av1_txfm.h
VP10_COMMON_SRCS-yes += common/av1_fwd_txfm1d.h
VP10_COMMON_SRCS-yes += common/av1_fwd_txfm1d.c
VP10_COMMON_SRCS-yes += common/av1_inv_txfm1d.h
VP10_COMMON_SRCS-yes += common/av1_inv_txfm1d.c
VP10_COMMON_SRCS-yes += common/av1_fwd_txfm2d.c
VP10_COMMON_SRCS-yes += common/av1_fwd_txfm2d_cfg.h
VP10_COMMON_SRCS-yes += common/av1_inv_txfm2d.c
VP10_COMMON_SRCS-yes += common/av1_inv_txfm2d_cfg.h
VP10_COMMON_SRCS-$(HAVE_SSSE3) += common/x86/av1_convolve_ssse3.c
VP10_COMMON_SRCS-$(HAVE_SSSE3) += common/x86/av1_convolve_filters_ssse3.c
ifeq ($(CONFIG_AOM_HIGHBITDEPTH),yes)
VP10_COMMON_SRCS-$(HAVE_SSE4_1) += common/x86/av1_highbd_convolve_sse4.c
VP10_COMMON_SRCS-$(HAVE_SSE4_1) += common/x86/av1_highbd_convolve_filters_sse4.c
endif
VP10_COMMON_SRCS-yes += common/av1_convolve.c
VP10_COMMON_SRCS-yes += common/av1_convolve.h
...
VP10_COMMON_SRCS-$(HAVE_SSE4_1) += common/x86/av1_txfm1d_sse4.h
VP10_COMMON_SRCS-$(HAVE_SSE4_1) += common/x86/av1_fwd_txfm1d_sse4.c
VP10_COMMON_SRCS-$(HAVE_SSE4_1) += common/x86/av1_fwd_txfm2d_sse4.c
