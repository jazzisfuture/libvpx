...
void av1_write_prob_diff_update(struct av1_writer *w, aom_prob newp,
                                aom_prob oldp);

void av1_cond_prob_diff_update(struct av1_writer *w, aom_prob *oldp,
...
void av1_write_primitive_symmetric(av1_writer *w, int word,
