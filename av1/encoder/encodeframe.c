...
static void set_offsets_without_segment_id(const AV1_COMP *const cpi,
  ...
  av1_setup_bipred_planes(x, cpi->img_bipred, mi_row, mi_col);
...
#if CONFIG_EXT_REFS && CONFIG_REFS_SEGMENT
void av1_setup_bipred_planes(MACROBLOCK *x, const YV12_BUFFER_CONFIG *img_bipred,
                             int mi_row, int mi_col) {
...
#if CONFIG_EXT_REFS && CONFIG_REFS_SEGMENT
  av1_setup_bipred_planes(x, cpi->img_bipred, 0, 0);
#endif  // CONFIG_EXT_REFS && CONFIG_REFS_SEGMENT
