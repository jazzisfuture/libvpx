...
int av1_compute_rd_mult(const struct VP10_COMP *cpi, int qindex);

void av1_initialize_rd_consts(struct VP10_COMP *cpi);

void av1_initialize_me_consts(const struct VP10_COMP *cpi, MACROBLOCK *x,
                              int qindex);

void av1_model_rd_from_var_lapndz(int64_t var, unsigned int n,
                                  unsigned int qstep, int *rate, int64_t *dist);

int av1_get_switchable_rate(const struct VP10_COMP *cpi,
...
YV12_BUFFER_CONFIG *av1_get_scaled_ref_frame(const struct VP10_COMP *cpi,
                                             int ref_frame);
...
void av1_set_rd_speed_thresholds(struct VP10_COMP *cpi);

void av1_set_rd_speed_thresholds_sub8x8(struct VP10_COMP *cpi);

void av1_update_rd_thresh_fact(const VP10_COMMON *const cm,
...
void av1_mv_pred(struct VP10_COMP *cpi, MACROBLOCK *x, uint8_t *ref_y_buffer,
