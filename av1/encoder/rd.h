...
typedef enum {
...
#if CONFIG_NEW_REFS
  THR_COMP_NEAR_NEARESTLA2,
  THR_COMP_NEAREST_NEARLA2,
  ...
  THR_COMP_NEAR_NEARESTL2A2,
  THR_COMP_NEAREST_NEARL2A2,
  ...
  THR_COMP_NEAR_NEARESTL3A2,
  THR_COMP_NEAREST_NEARL3A2,
  ...
  THR_COMP_NEAR_NEARESTGA2,
  THR_COMP_NEAREST_NEARGA2,
