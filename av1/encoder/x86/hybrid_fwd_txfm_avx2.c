...
static void write_buffer_16x16(const __m256i *in, int stride,
                               tran_low_t *output) {
...
static void fdct16_avx2(__m256i *in) {
  ...
  in[0] = butter_fly(x0, x1, cospi_p16_p16);
  in[8] = butter_fly(x0, x1, cospi_p16_m16);
  ...
  in[4] = butter_fly(x0, x1, cospi_p24_p08);
  in[12] = butter_fly(x0, x1, cospi_m08_p24);
  ...
  v3 = butter_fly(x0, x1, cospi_p16_m16);  // output[7]
  ...
  in[2] = butter_fly(x0, x1, cospi_p28_p04);
  in[14] = butter_fly(x0, x1, cospi_m04_p28);

  // 10, 6
  x0 = _mm256_unpacklo_epi16(s1, s2);
  x1 = _mm256_unpackhi_epi16(s1, s2);
  in[10] = butter_fly(x0, x1, cospi_p12_p20);
  in[6] = butter_fly(x0, x1, cospi_m20_p12);

  // 1, 3, 5, 7, 9, 11, 13, 15
  s0 = _mm256_add_epi16(in[7], in[8]);   // step[8]
  s1 = _mm256_add_epi16(in[6], in[9]);   // step[9]
  u2 = _mm256_add_epi16(in[5], in[10]);
  u3 = _mm256_add_epi16(in[4], in[11]);
  u4 = _mm256_add_epi16(in[3], in[12]);
  u5 = _mm256_add_epi16(in[2], in[13]);
  s6 = _mm256_add_epi16(in[1], in[14]);  // step[14]
  s7 = _mm256_add_epi16(in[0], in[15]);  // step[15]

  x0 = _mm256_unpacklo_epi16(u5, u2);
  x1 = _mm256_unpackhi_epi16(u5, u2);

  s2 = butter_fly(x0, x1, cospi_p16_p16);
  s5 = butter_fly(x0, x1, cospi_p16_m16);

  x0 = _mm256_unpacklo_epi16(u4, u3);
  x1 = _mm256_unpackhi_epi16(u4, u3);

  s3 = butter_fly(x0, x1, cospi_p16_p16);
  s4 = butter_fly(x0, x1, cospi_p16_m16);

  u0 = _mm256_add_epi16(s0, s3);
  u1 = _mm256_add_epi16(s1, s7);
  u2 = _mm256_sub_epi16(s1, s7);
  u3 = _mm256_sub_epi16(s0, s3);
  u4 = _mm256_sub_epi16(s7, s4);
  u5 = _mm256_sub_epi16(s6, s5);
  u6 = _mm256_add_epi16(s6, s5);
  u7 = _mm256_add_epi16(s7, s4);
...
void fadst16_avx2(__m256i *in) {
  ...
  s0 = butter_fly(y0, y1, cospi_p01_p31);
  s1 = butter_fly(y0, y1, cospi_p31_m01);

  y0 = _mm256_unpacklo_epi16(in[13], in[2]);
  y1 = _mm256_unpackhi_epi16(in[13], in[2]);
  s2 = butter_fly(y0, y1, cospi_p05_p27);
  s3 = butter_fly(y0, y1, cospi_p27_m05);

  y0 = _mm256_unpacklo_epi16(in[11], in[4]);
  y1 = _mm256_unpackhi_epi16(in[11], in[4]);
  s4 = butter_fly(y0, y1, cospi_p09_p23);
  s5 = butter_fly(y0, y1, cospi_p23_m09);

  y0 = _mm256_unpacklo_epi16(in[9], in[6]);
  y1 = _mm256_unpackhi_epi16(in[9], in[6]);
  s6 = butter_fly(y0, y1, cospi_p13_p19);
  s7 = butter_fly(y0, y1, cospi_p19_m13);

  y0 = _mm256_unpacklo_epi16(in[7], in[8]);
  y1 = _mm256_unpackhi_epi16(in[7], in[8]);
  s8 = butter_fly(y0, y1, cospi_p17_p15);
  s9 = butter_fly(y0, y1, cospi_p15_m17);

  y0 = _mm256_unpacklo_epi16(in[5], in[10]);
  y1 = _mm256_unpackhi_epi16(in[5], in[10]);
  s10 = butter_fly(y0, y1, cospi_p21_p11);
  s11 = butter_fly(y0, y1, cospi_p11_m21);

  y0 = _mm256_unpacklo_epi16(in[3], in[12]);
  y1 = _mm256_unpackhi_epi16(in[3], in[12]);
  s12 = butter_fly(y0, y1, cospi_p25_p07);
  s13 = butter_fly(y0, y1, cospi_p07_m25);

  y0 = _mm256_unpacklo_epi16(in[1], in[14]);
  y1 = _mm256_unpackhi_epi16(in[1], in[14]);
  s14 = butter_fly(y0, y1, cospi_p29_p03);
  s15 = butter_fly(y0, y1, cospi_p03_m29);

  x0 = _mm256_add_epi16(s0, s8);
  x1 = _mm256_add_epi16(s1, s9);
  x2 = _mm256_add_epi16(s2, s10);
  x3 = _mm256_add_epi16(s3, s11);
  x4 = _mm256_add_epi16(s4, s12);
  x5 = _mm256_add_epi16(s5, s13);
  x6 = _mm256_add_epi16(s6, s14);
  x7 = _mm256_add_epi16(s7, s15);

  x8 = _mm256_sub_epi16(s0, s8);
  x9 = _mm256_sub_epi16(s1, s9);
  x10 = _mm256_sub_epi16(s2, s10);
  x11 = _mm256_sub_epi16(s3, s11);
  x12 = _mm256_sub_epi16(s4, s12);
  x13 = _mm256_sub_epi16(s5, s13);
  x14 = _mm256_sub_epi16(s6, s14);
  x15 = _mm256_sub_epi16(s7, s15);
  ...
  s8 = butter_fly(y0, y1, cospi_p04_p28);
  s9 = butter_fly(y0, y1, cospi_p28_m04);

  y0 = _mm256_unpacklo_epi16(x10, x11);
  y1 = _mm256_unpackhi_epi16(x10, x11);
  s10 = butter_fly(y0, y1, cospi_p20_p12);
  s11 = butter_fly(y0, y1, cospi_p12_m20);

  y0 = _mm256_unpacklo_epi16(x12, x13);
  y1 = _mm256_unpackhi_epi16(x12, x13);
  s12 = butter_fly(y0, y1, cospi_m28_p04);
  s13 = butter_fly(y0, y1, cospi_p04_p28);

  y0 = _mm256_unpacklo_epi16(x14, x15);
  y1 = _mm256_unpackhi_epi16(x14, x15);
  s14 = butter_fly(y0, y1, cospi_m12_p20);
  s15 = butter_fly(y0, y1, cospi_p20_p12);
  ...
  x8 = _mm256_add_epi16(s8, s12);
  x9 = _mm256_add_epi16(s9, s13);
  x10 = _mm256_add_epi16(s10, s14);
  x11 = _mm256_add_epi16(s11, s15);
  x12 = _mm256_sub_epi16(s8, s12);
  x13 = _mm256_sub_epi16(s9, s13);
  x14 = _mm256_sub_epi16(s10, s14);
  x15 = _mm256_sub_epi16(s11, s15);
  ...
  s4 = butter_fly(y0, y1, cospi_p08_p24);
  s5 = butter_fly(y0, y1, cospi_p24_m08);

  y0 = _mm256_unpacklo_epi16(x6, x7);
  y1 = _mm256_unpackhi_epi16(x6, x7);
  s6 = butter_fly(y0, y1, cospi_m24_p08);
  s7 = butter_fly(y0, y1, cospi_p08_p24);
  ...
  y0 = _mm256_unpacklo_epi16(x12, x13);
  y1 = _mm256_unpackhi_epi16(x12, x13);
  s12 = butter_fly(y0, y1, cospi_p08_p24);
  s13 = butter_fly(y0, y1, cospi_p24_m08);

  y0 = _mm256_unpacklo_epi16(x14, x15);
  y1 = _mm256_unpackhi_epi16(x14, x15);
  x14 = butter_fly(y0, y1, cospi_m24_p08);
  x15 = butter_fly(y0, y1, cospi_p08_p24);

  in[0] = _mm256_add_epi16(s0, s2);
  x1 = _mm256_add_epi16(s1, s3);
  x2 = _mm256_sub_epi16(s0, s2);
  x3 = _mm256_sub_epi16(s1, s3);
  x4 = _mm256_add_epi16(s4, s6);
  in[12] = _mm256_add_epi16(s5, s7);
  x6 = _mm256_sub_epi16(s4, s6);
  x7 = _mm256_sub_epi16(s5, s7);

  x8 = _mm256_add_epi16(s8, s10);
  in[14] = _mm256_add_epi16(s9, s11);
  x10 = _mm256_sub_epi16(s8, s10);
  x11 = _mm256_sub_epi16(s9, s11);
  in[2] = _mm256_add_epi16(s12, s14);
  x13 = _mm256_add_epi16(s13, s15);
  in[5] = _mm256_sub_epi16(s12, s14);
  x15 = _mm256_sub_epi16(s13, s15);

  // stage 4

  y0 = _mm256_unpacklo_epi16(x2, x3);
  y1 = _mm256_unpackhi_epi16(x2, x3);
  in[7] = butter_fly(y0, y1, cospi_m16_p16);
  in[8] = butter_fly(y0, y1, cospi_p16_m16);

  y0 = _mm256_unpacklo_epi16(x6, x7);
  y1 = _mm256_unpackhi_epi16(x6, x7);
  in[4] = butter_fly(y0, y1, cospi_p16_p16);
  in[11] = butter_fly(y0, y1, cospi_m16_p16);

  y0 = _mm256_unpacklo_epi16(x10, x11);
  y1 = _mm256_unpackhi_epi16(x10, x11);
  in[6] = butter_fly(y0, y1, cospi_p16_p16);
  in[9] = butter_fly(y0, y1, cospi_m16_p16);

  y0 = _mm256_unpacklo_epi16(x14, x15);
  y1 = _mm256_unpackhi_epi16(x14, x15);
  in[4] = butter_fly(y0, y1, cospi_m16_m16);
  in[10] = butter_fly(y0, y1, cospi_p16_m16);
...
void vp10_fht16x16_avx2(const int16_t *input, tran_low_t *output, int stride,
  ...
  switch (tx_type) {
    case DCT_DCT:
      ...
      fdct16_avx2(in);
      write_buffer_16x16(in, stride, output);
    case ADST_DCT:
      load_buffer_16x16(input, stride, 0, 0, in);
      fadst16_avx2(in);
      right_shift_16x16(in);
