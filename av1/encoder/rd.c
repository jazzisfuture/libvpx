...
int av1_compute_rd_mult(const VP10_COMP *cpi, int qindex) {
...
void av1_initialize_me_consts(const VP10_COMP *cpi, MACROBLOCK *x, int qindex) {
#if CONFIG_AOM_HIGHBITDEPTH
  switch (cpi->common.bit_depth) {
    case AOM_BITS_8:
...
void av1_initialize_rd_consts(VP10_COMP *cpi) {
...
void av1_mv_pred(VP10_COMP *cpi, MACROBLOCK *x, uint8_t *ref_y_buffer,
...
YV12_BUFFER_CONFIG *av1_get_scaled_ref_frame(const VP10_COMP *cpi,
                                             int ref_frame) {
...
int av1_get_switchable_rate(const VP10_COMP *cpi, const MACROBLOCKD *const xd) {
...
void av1_set_rd_speed_thresholds(VP10_COMP *cpi) {
  int i;
  RD_OPT *const rd = &cpi->rd;
...
void av1_set_rd_speed_thresholds_sub8x8(VP10_COMP *cpi) {
