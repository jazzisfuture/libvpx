...
void av1_set_rd_speed_thresholds(AV1_COMP *cpi) {
...
#if CONFIG_NEW_REFS
  rd->thresh_mult[THR_NEWFROMNEARA2] += 1000;
#endif  // CONFIG_NEW_REFS
#endif  // CONFIG_EXT_REFS
...
#if CONFIG_NEW_REFS
  rd->thresh_mult[THR_COMP_NEAREST_NEARLA2] += 1200;
  rd->thresh_mult[THR_COMP_NEAR_NEARESTLA2] += 1200;
  ...
  rd->thresh_mult[THR_COMP_NEAREST_NEARL2A2] += 1200;
  rd->thresh_mult[THR_COMP_NEAR_NEARESTL2A2] += 1200;
  ...
  rd->thresh_mult[THR_COMP_NEAREST_NEARL3A2] += 1200;
  rd->thresh_mult[THR_COMP_NEAR_NEARESTL3A2] += 1200;
  ...
  rd->thresh_mult[THR_COMP_NEAREST_NEARGA2] += 1200;
  rd->thresh_mult[THR_COMP_NEAR_NEARESTGA2] += 1200;
...
#if CONFIG_EXT_REFS
#if CONFIG_NEW_REFS
    { 2500, 2500, 2500, 2500, 2500, 2500, 2500, 4500, 4500, 4500,
      4500, 4500, 4500, 4500, 4500, 4500, 4500, 4500, 4500, 2500 },
    { 2000, 2000, 2000, 2000, 2000, 2000, 2000, 4000, 4000, 4000,
      4000, 4000, 4000, 4000, 4000, 4000, 4000, 4000, 4000, 2000 }
