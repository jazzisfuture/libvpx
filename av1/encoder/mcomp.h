...
int av1_full_pixel_diamond(const struct VP10_COMP *cpi, MACROBLOCK *x,
...
unsigned int av1_int_pro_motion_estimation(const struct VP10_COMP *cpi,
...
int av1_full_pixel_search(struct VP10_COMP *cpi, MACROBLOCK *x,
...
int av1_masked_full_pixel_diamond(const struct VP10_COMP *cpi, MACROBLOCK *x,
...
#if CONFIG_OBMC
int av1_obmc_full_pixel_diamond(const struct VP10_COMP *cpi, MACROBLOCK *x,
