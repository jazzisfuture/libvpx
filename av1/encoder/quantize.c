...
void av1_quantize_fp_facade(const tran_low_t *coeff_ptr, intptr_t n_coeffs,
                            ...
                            const qm_val_t *qm_ptr, const qm_val_t *iqm_ptr
                              ...
                              if (qparam->log_scale == 0) {
                                av1_quantize_fp(
                                    coeff_ptr, n_coeffs, skip_block, p->zbin,
                            ...
                            void av1_quantize_b_facade(
                              ...
                              if (qparam->log_scale == 0) {
                                aom_quantize_b(coeff_ptr, n_coeffs, skip_block,
                                               p->zbin, p->round, p->quant,
                                               p->quant_shift, qcoeff_ptr,
                            ...
                            void av1_quantize_dc_facade(
                              ...
                              if (qparam->log_scale == 0) {
                                aom_quantize_dc(
                                    coeff_ptr, (int)n_coeffs, skip_block,
                                    p->round, p->quant_fp[0], qcoeff_ptr,
                                    dqcoeff_ptr, pd->dequant[0], eob_ptr
#if CONFIG_AOM_QM
                                    ,
                                    qm_ptr, iqm_ptr
#endif
                                ...
                                aom_quantize_dc_32x32(coeff_ptr, skip_block,
                                                      p->round, p->quant_fp[0],
