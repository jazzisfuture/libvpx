...
// Note: This one and some other enums use the attribute 'packed' to use
// smallest possible integer type, so that we can save memory when they are
// used in structs/arrays.
