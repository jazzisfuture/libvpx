...
#if CONFIG_FILTER_INTRA
static const uint8_t filter_intra_extend_modes[FILTER_INTRA_MODES] = {
...
// 129  G   H  ..  S   T   T   T   T   T
  ...
  if (filter_intra_mode_info->use_filter_intra_mode[plane != 0]) {
    FILTER_INTRA_MODE filter_intra_mode =
        filter_intra_mode_info->filter_intra_mode[plane != 0];
    need_left = filter_intra_extend_modes[filter_intra_mode] & NEED_LEFT;
    need_above = filter_intra_extend_modes[filter_intra_mode] & NEED_ABOVE;
    need_above_left = 1;
  }
#endif  // CONFIG_FILTER_INTRA
...
#if CONFIG_FILTER_INTRA
  if (filter_intra_mode_info->use_filter_intra_mode[plane != 0]) {
    FILTER_INTRA_MODE ext_intra_mode =
        filter_intra_mode_info->filter_intra_mode[plane != 0];
    need_left = filter_intra_extend_modes[ext_intra_mode] & NEED_LEFT;
    need_above = filter_intra_extend_modes[ext_intra_mode] & NEED_ABOVE;
    need_above_left = 1;
  }
#endif  // CONFIG_FILTER_INTRA
