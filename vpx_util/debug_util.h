 ...
 * Arithmetic coder, it pops out the reference bit and probability from the queue
 * as well. If the two results do not match, this debug tool will report an error.
