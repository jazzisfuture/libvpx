...
EXAMPLES-$(CONFIG_VP8_DECODER)     += api_simple_decoder.c
api_simple_decoder.GUID                 = A3BBF1E9-2427-450D-BBFF-B2843C1D44CC
api_simple_decoder.SRCS                += ivfdec.h ivfdec.c
api_simple_decoder.SRCS                += tools_common.h tools_common.c
api_simple_decoder.SRCS                += video_common.h
api_simple_decoder.SRCS                += video_reader.h video_reader.c
api_simple_decoder.SRCS                += vpx_ports/mem_ops.h
api_simple_decoder.SRCS                += vpx_ports/mem_ops_aligned.h
api_simple_decoder.DESCRIPTION          = New simplified decoder loop
...
EXAMPLES-$(CONFIG_VP8_ENCODER)  += api_simple_encoder.c
api_simple_encoder.SRCS         += ivfenc.h ivfenc.c
api_simple_encoder.SRCS         += tools_common.h tools_common.c
api_simple_encoder.SRCS         += video_common.h
api_simple_encoder.SRCS         += video_writer.h video_writer.c
api_simple_encoder.GUID         = 4607D299-8A71-4D2C-9B1D-071899B6FBFD
api_simple_encoder.DESCRIPTION  = Simplified encoder loop
