...
static const arg_def_t scale_factors_arg = ARG_DEF(
    "r", "scale-factors", 1, "scale factors (lowest to highest layer)");
...
static const arg_def_t *svc_args[] = {
    &encoding_mode_arg, &frames_arg,         &width_arg,
    &height_arg,        &timebase_num_arg,   &timebase_den_arg,
    &bitrate_arg,       &skip_frames_arg,    &layers_arg,
    &gop_size_arg,      &scale_factors_arg, &quantizers_arg,
