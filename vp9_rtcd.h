...
void vp9_ssim_parms_8x8_c(uint8_t *s, int sp, uint8_t *r, int rp, unsigned long *sum_s, unsigned long *sum_r, unsigned long *sum_sq_s, unsigned long *sum_sq_r, unsigned long *sum_sxr);
void vp9_ssim_parms_8x8_sse2(uint8_t *s, int sp, uint8_t *r, int rp, unsigned long *sum_s, unsigned long *sum_r, unsigned long *sum_sq_s, unsigned long *sum_sq_r, unsigned long *sum_sxr);
#define vp9_ssim_parms_8x8 vp9_ssim_parms_8x8_sse2

void vp9_ssim_parms_16x16_c(uint8_t *s, int sp, uint8_t *r, int rp, unsigned long *sum_s, unsigned long *sum_r, unsigned long *sum_sq_s, unsigned long *sum_sq_r, unsigned long *sum_sxr);
void vp9_ssim_parms_16x16_sse2(uint8_t *s, int sp, uint8_t *r, int rp, unsigned long *sum_s, unsigned long *sum_r, unsigned long *sum_sq_s, unsigned long *sum_sq_r, unsigned long *sum_sxr);
#define vp9_ssim_parms_16x16 vp9_ssim_parms_16x16_sse2
...
void vp9_short_fht4x4_avx2(const int16_t *input, int16_t *output, int stride, int tx_type);
...
void vp9_short_fht8x8_avx2(const int16_t *input, int16_t *output, int stride, int tx_type);
...
void vp9_short_fht16x16_avx2(const int16_t *input, int16_t *output, int stride, int tx_type);
...
static void setup_rtcd_internal(void)
{
    ...
    vp9_short_fht4x4 = vp9_short_fht4x4_sse2;
    if (flags & HAS_AVX2) vp9_short_fht4x4 = vp9_short_fht4x4_avx2;

    vp9_short_fht8x8 = vp9_short_fht8x8_sse2;
    if (flags & HAS_AVX2) vp9_short_fht8x8 = vp9_short_fht8x8_avx2;

    vp9_short_fht16x16 = vp9_short_fht16x16_sse2;
    if (flags & HAS_AVX2) vp9_short_fht16x16 = vp9_short_fht16x16_avx2;
