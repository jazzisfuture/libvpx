...
// Reads frame bytes from the file and stores them into internal buffer.
int vpx_video_reader_read_frame(VpxVideoReader *reader);

// Returns the pointer to memory buffer with frame bytes read from
// last call to vpx_video_reader_read_frame().
