...
/* Shift constant for first/second pass bilinear filter. */
...
// taps should sum to VP[89]_FILTER_WEIGHT (128). pixel_step defines whether
// the filter is applied horizontally (pixel_step = 1) or vertically
...
// filter taps should sum to VP[89]_FILTER_WEIGHT (128). pixel_step defines
// whether the filter is applied horizontally (pixel_step = 1) or vertically
// (pixel_step = stride). It defines the offset required to move from one input
