...
DSP_SRCS-$(CONFIG_INTERNAL_STATS) += vpx_ssim.c
DSP_SRCS-$(CONFIG_INTERNAL_STATS) += vpx_ssim.h
DSP_SRCS-$(CONFIG_INTERNAL_STATS) += vpx_psnrhvs.c
DSP_SRCS-$(CONFIG_INTERNAL_STATS) += vpx_fastssim.c
endif
...
ifeq ($(ARCH_X86_64),yes)
DSP_SRCS-$(HAVE_SSE2)   += x86/vpx_ssim_opt_x86_64.asm
endif  # ARCH_X86_64
