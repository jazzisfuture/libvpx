...
DSP_SRCS-$(HAVE_NEON_ASM)  += arm/loopfilter_mb_neon$(ASM)
DSP_SRCS-$(HAVE_NEON_ASM)  += arm/loopfilter_16_neon$(ASM)
DSP_SRCS-$(HAVE_NEON_ASM)  += arm/loopfilter_8_neon$(ASM)
DSP_SRCS-$(HAVE_NEON_ASM)  += arm/loopfilter_4_neon$(ASM)
