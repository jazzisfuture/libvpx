...
if (vpx_config("CONFIG_VP9_HIGHBITDEPTH") eq "yes") {
  ...
  add_proto qw/void vpx_highbd_idct4x8_1_add/, "const tran_low_t *input, uint8_t *dest, int dest_stride, int bd";
  specialize qw/vpx_highbd_idct4x8_1_add/;
  ...
  if (vpx_config("CONFIG_EMULATE_HARDWARE") eq "yes") {
    ...
    add_proto qw/void vpx_highbd_idct4x8_64_add/, "const tran_low_t *input, uint8_t *dest, int dest_stride, int bd";
    specialize qw/vpx_highbd_idct4x8_64_add/;

    add_proto qw/void vpx_highbd_idct4x8_10_add/, "const tran_low_t *input, uint8_t *dest, int dest_stride, int bd";
    specialize qw/vpx_highbd_idct4x8_10_add/;
    ...
    add_proto qw/void vpx_highbd_idct4x8_64_add/, "const tran_low_t *input, uint8_t *dest, int dest_stride, int bd";
    specialize qw/vpx_highbd_idct4x8_64_add sse2/;

    add_proto qw/void vpx_highbd_idct4x8_10_add/, "const tran_low_t *input, uint8_t *dest, int dest_stride, int bd";
    specialize qw/vpx_highbd_idct4x8_10_add sse2/;
