...
if (vpx_config("CONFIG_VP9_ENCODER") eq "yes") {
  ...
  # Disabled neon optimization since it causes mismatch. See details in:
  ...
  specialize qw/vpx_int_pro_row sse2 msa/;   #neon
  add_proto qw/int16_t vpx_int_pro_col/, "const uint8_t *ref, const int width";
  specialize qw/vpx_int_pro_col sse2 msa/;  #neon
