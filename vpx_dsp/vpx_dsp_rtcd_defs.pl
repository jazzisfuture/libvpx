...
if ((vpx_config("CONFIG_PAETH_PREDICTOR") eq "yes")) {
  add_proto qw/void vpx_paeth_predictor_4x4/, "uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left";
} else {
...
if ((vpx_config("CONFIG_PAETH_PREDICTOR") eq "yes")) {
  add_proto qw/void vpx_paeth_predictor_8x8/, "uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left";
} else {
...
if ((vpx_config("CONFIG_PAETH_PREDICTOR") eq "yes")) {
  add_proto qw/void vpx_paeth_predictor_16x16/, "uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left";
} else {
...
if ((vpx_config("CONFIG_PAETH_PREDICTOR") eq "yes")) {
  add_proto qw/void vpx_paeth_predictor_32x32/, "uint8_t *dst, ptrdiff_t y_stride, const uint8_t *above, const uint8_t *left";
} else {
...
if (vpx_config("CONFIG_VP9_HIGHBITDEPTH") eq "yes") {
  ...
  if ((vpx_config("CONFIG_PAETH_PREDICTOR") eq "yes")) {
    add_proto qw/void vpx_highbd_paeth_predictor_4x4/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left, int bd";
  } else {
  ...
  if ((vpx_config("CONFIG_PAETH_PREDICTOR") eq "yes")) {
    add_proto qw/void vpx_highbd_paeth_predictor_8x8/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left, int bd";
  } else {
  ...
  if ((vpx_config("CONFIG_PAETH_PREDICTOR") eq "yes")) {
    add_proto qw/void vpx_highbd_paeth_predictor_16x16/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left, int bd";
  } else {
  ...
  if ((vpx_config("CONFIG_PAETH_PREDICTOR") eq "yes")) {
    add_proto qw/void vpx_highbd_paeth_predictor_32x32/, "uint16_t *dst, ptrdiff_t y_stride, const uint16_t *above, const uint16_t *left, int bd";
  } else {
