...
if (vpx_config("CONFIG_POSTPROC") eq "yes" || vpx_config("CONFIG_VP9_POSTPROC") eq "yes") {
    add_proto qw/void vpx_plane_add_noise/, "uint8_t *Start, const int8_t *noise, int blackclamp, int whiteclamp, int bothclamp, unsigned int Width, unsigned int Height, int Pitch";
