...
void vpx_convolve8_horiz_filter_type1_c(const uint8_t *src,
...
void vpx_convolve8_avg_horiz_filter_type1_c(const uint8_t *src,
                                            ptrdiff_t src_stride, uint8_t *dst,
                                            ptrdiff_t dst_stride,
...
void vpx_convolve8_horiz_filter_type2_c(const uint8_t *src,
                                        ptrdiff_t src_stride, uint8_t *dst,
                                        ptrdiff_t dst_stride,
                                        const InterpKernel *filter, int x0_q4,
                                        int x_step_q4, int y0_q4, int y_step_q4,
...
void vpx_convolve8_avg_horiz_filter_type2_c(const uint8_t *src,
                                            ptrdiff_t src_stride, uint8_t *dst,
                                            ptrdiff_t dst_stride,
                                            const InterpKernel *filter,
                                            int x0_q4, int x_step_q4, int y0_q4,
...
void vpx_convolve8_vert_filter_type1_c(const uint8_t *src, ptrdiff_t src_stride,
                                       uint8_t *dst, ptrdiff_t dst_stride,
                                       const InterpKernel *filter, int x0_q4,
                                       int x_step_q4, int y0_q4, int y_step_q4,
                                       int w, int h) {
  (void)y0_q4;
  (void)y_step_q4;
  convolve_vert(src, src_stride, dst, dst_stride, filter, x0_q4, x_step_q4, w,
                h);
}

void vpx_convolve8_avg_vert_filter_type1_c(const uint8_t *src,
                                           ptrdiff_t src_stride, uint8_t *dst,
                                           ptrdiff_t dst_stride,
                                           const InterpKernel *filter,
                                           int x0_q4, int x_step_q4, int y0_q4,
  ...
  (void)y0_q4;
  (void)y_step_q4;
  convolve_avg_vert(src, src_stride, dst, dst_stride, filter, x0_q4, x_step_q4,
                    w, h);
}

void vpx_convolve8_vert_filter_type2_c(const uint8_t *src, ptrdiff_t src_stride,
                                       uint8_t *dst, ptrdiff_t dst_stride,
                                       const InterpKernel *filter, int x0_q4,
                                       int x_step_q4, int y0_q4, int y_step_q4,
                                       int w, int h) {
...
void vpx_convolve8_avg_vert_filter_type2_c(const uint8_t *src,
                                           ptrdiff_t src_stride, uint8_t *dst,
                                           ptrdiff_t dst_stride,
                                           const InterpKernel *filter,
                                           int x0_q4, int x_step_q4, int y0_q4,
...
void vpx_convolve8_horz_t2_vert_t2_c(const uint8_t *src, ptrdiff_t src_stride,
                                     uint8_t *dst, ptrdiff_t dst_stride,
                                     const InterpKernel *filter, int x0_q4,
                                     int x_step_q4, int y0_q4, int y_step_q4,
                                     int w, int h) {
...
void vpx_convolve8_avg_horz_t2_vert_t2_c(const uint8_t *src,
                                         ptrdiff_t src_stride, uint8_t *dst,
                                         ptrdiff_t dst_stride,
                                         const InterpKernel *filter, int x0_q4,
...
void vpx_convolve8_horz_t2_vert_t1_c(const uint8_t *src, ptrdiff_t src_stride,
                                     uint8_t *dst, ptrdiff_t dst_stride,
                                     const InterpKernel *filter, int x0_q4,
                                     int x_step_q4, int y0_q4, int y_step_q4,
                                     int w, int h) {
...
void vpx_convolve8_avg_horz_t2_vert_t1_c(const uint8_t *src,
                                         ptrdiff_t src_stride, uint8_t *dst,
                                         ptrdiff_t dst_stride,
                                         const InterpKernel *filter, int x0_q4,
                                         int x_step_q4, int y0_q4,
...
void vpx_convolve8_horz_t1_vert_t2_c(const uint8_t *src, ptrdiff_t src_stride,
                                     uint8_t *dst, ptrdiff_t dst_stride,
                                     const InterpKernel *filter, int x0_q4,
                                     int x_step_q4, int y0_q4, int y_step_q4,
                                     int w, int h) {
...
void vpx_convolve8_avg_horz_t1_vert_t2_c(const uint8_t *src,
                                         ptrdiff_t src_stride, uint8_t *dst,
                                         ptrdiff_t dst_stride,
                                         const InterpKernel *filter, int x0_q4,
                                         int x_step_q4, int y0_q4,
...
void vpx_convolve8_horz_t1_vert_t1_c(const uint8_t *src, ptrdiff_t src_stride,
                                     uint8_t *dst, ptrdiff_t dst_stride,
                                     const InterpKernel *filter, int x0_q4,
                                     int x_step_q4, int y0_q4, int y_step_q4,
                                     int w, int h) {
...
void vpx_convolve8_avg_horz_t1_vert_t1_c(const uint8_t *src,
                                         ptrdiff_t src_stride, uint8_t *dst,
                                         ptrdiff_t dst_stride,
                                         const InterpKernel *filter, int x0_q4,
                                         int x_step_q4, int y0_q4,
