...
void vpx_filter_block1d16_h4_sse2(const uint8_t *src_ptr,
...
void vpx_filter_block1d16_v4_sse2(const uint8_t *src_ptr,
                                  ptrdiff_t src_stride,
                                  uint8_t *dst_ptr, ptrdiff_t dst_stride,
                                  uint32_t height, const int16_t *kernel) {
  ...
  __m128i src_reg_m10_lo_1, src_reg_m10_lo_2, src_reg_m10_hi_1, src_reg_m10_hi_2;
  ...
  // We will load two rows of pixels as 8-bit words, rearrange them as 16-bit words,
