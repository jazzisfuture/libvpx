  ...
  if (width > 8) {
    ...
    for (i = 0; i < elements; i += 16) {
      ...
      if (width == 4) {
        ...
        const __m128i r_0_2 = (__m128i)_mm_loadh_pi((__m128)r_0,
                                              (const __m64 *)(ref + 2 * ref_stride));
        const __m128i r_1 = _mm_loadl_epi64((const __m128i *)(ref + ref_stride));
        const __m128i r_1_3 = (__m128i)_mm_loadh_pi((__m128)r_1,
                                              (const __m64 *)(ref + 3 * ref_stride));
