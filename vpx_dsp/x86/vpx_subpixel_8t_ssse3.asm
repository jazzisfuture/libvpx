...
cglobal filter_block1d8_%1, 6, 6+(ARCH_X86_64*2), 13, LOCAL_VARS_SIZE, \
                            src, sstride, dst, dstride, height, filter, \
                            height2, goffset
    GET_GOT        goffsetmp
    mova                 m4, [filterq]
...
cglobal filter_block1d16_%1, 6, 6+(ARCH_X86_64*1), 13, LOCAL_VARS_SIZE, \
...
cglobal filter_block1d16_%1, 6, 6+(ARCH_X86_64*3), 13, LOCAL_VARS_SIZE, \
                             src, sstride, dst, dstride, height, filter, \
                             goffset
    GET_GOT goffsetmp
    mova          m4, [filterq]
