...
.loop:
    ;Do two rows at once
    pmaddubsw                m0, k0k1
    pmaddubsw                m8, m4, k4k5
    paddsw                   m8, m0
    mova                     m0, m2
    pmaddubsw                m1, k0k1
    pmaddubsw                m9, m5, k4k5
    paddsw                   m9, m1
    mova                     m1, m3
    movx                     m7, [srcq + sstrideq]          ;H
    lea                    srcq, [srcq + sstrideq * 2 ]
    movx                    m13, [srcq]                     ;H next iter
    punpcklbw                m6, m7                         ;G H
    punpcklbw                m7, m13                        ;G H next iter
    pmaddubsw               m10, m2, k2k3
    mova                     m2, m4
    pmaddubsw               m14, m6, k6k7
    paddsw                  m10, m14
    paddsw                   m8, m10
    paddsw                   m8, krd
    psraw                    m8, 7
