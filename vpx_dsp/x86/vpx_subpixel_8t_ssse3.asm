...
%if ARCH_X86_64
    ...
    packsswb     m4, m4
    pshuflw    k0k1, m4, 0b              ;k0_k1
    pshuflw    k2k3, m4, 01010101b       ;k2_k3
    pshuflw    k4k5, m4, 10101010b       ;k4_k5
    pshuflw    k6k7, m4, 11111111b       ;k6_k7
    punpcklqdq k0k1, k0k1
    punpcklqdq k2k3, k2k3
    punpcklqdq k4k5, k4k5
    punpcklqdq k6k7, k6k7
%else
