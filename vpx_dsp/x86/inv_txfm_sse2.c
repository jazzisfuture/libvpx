...
static void multiplication_and_add_2(const __m128i lo_0, const __m128i hi_0,
                                     const __m128i cst0, const __m128i cst1,
...
static INLINE void idct8(const __m128i *const in, __m128i *const out) {
  ...
  /* Stage1 */
  {
    ...
    multiplication_and_add(lo_17, hi_17, lo_35, hi_35, stg1_0, stg1_1, stg1_2,
                           stg1_3, &stp1_4, &stp1_7, &stp1_5, &stp1_6);
  }

  /* Stage2 */
  {
    const __m128i lo_04 = _mm_unpacklo_epi16(in[0], in[4]);
    const __m128i hi_04 = _mm_unpackhi_epi16(in[0], in[4]);
    const __m128i lo_26 = _mm_unpacklo_epi16(in[2], in[6]);
    const __m128i hi_26 = _mm_unpackhi_epi16(in[2], in[6]);

    multiplication_and_add(lo_04, hi_04, lo_26, hi_26, stg2_0, stg2_1, stg2_2,
                           stg2_3, &stp2_0, &stp2_1, &stp2_2, &stp2_3);
...
#define IDCT16_10                                                              \
  ...
  {                                                                            \
    ...
    const __m128i hi_2_14 = _mm_unpackhi_epi16(in[2], zero);                   \
                                                                               \
    multiplication_and_add_2(lo_2_14, hi_2_14, stg3_0, stg3_1, &stp2_4,        \
                             &stp2_7);                                         \
                                                                               \
    stp1_9 = stp1_8_0;                                                         \
    stp1_10 = stp1_11;                                                         \
  ...
  {                                                                            \
    ...
    const __m128i hi_10_13 = _mm_unpackhi_epi16(stp1_10, stp1_13);             \
                                                                               \
    multiplication_and_add_2(lo_0_8, hi_0_8, stg4_0, stg4_1, &stp1_0,          \
                             &stp1_1);                                         \
    stp2_5 = stp2_4;                                                           \
    stp2_6 = stp2_7;                                                           \
                                                                               \
