...
void idct4_sse2(__m128i *in) {
  ...
  step[0] = _mm_packs_epi32(step[0], step[1]);
  step[1] = _mm_packs_epi32(step[3], step[2]);
  in[0] = _mm_add_epi16(step[0], step[1]);
  in[1] = _mm_sub_epi16(step[0], step[1]);
...
void vpx_idct8x8_12_add_sse2(const tran_low_t *input, uint8_t *dest,
  ...
  // Stage1
  {
    ...
    stp1_4 = idct_calc_wraplow2_sse2(stg1_0, stg1_1, lo_17);
    stp1_5 = idct_calc_wraplow2_sse2(stg1_2, stg1_3, lo_35);
  }
  ...
  // Stage2
  {
    ...
    stp2_0 = idct_calc_wraplow2_sse2(stg2_0, stg2_1, lo_04);
    stp2_2 = idct_calc_wraplow2_sse2(stg2_3, stg2_2, lo_26);
  ...
  // Stage3
  {
    ...
    stp1_5 = idct_calc_wraplow2_sse2(stg3_0, stg2_0, lo_56);  // stg3_1 = stg2_0
  }
...
void vpx_idct16x16_10_add_sse2(const tran_low_t *input, uint8_t *dest,
  ...
  // Stage2
  {
    ...
    stp2_8 = idct_calc_wraplow2_sse2(stg2_0, stg2_1, lo_1_15);
    stp2_11 = idct_calc_wraplow2_sse2(stg2_6, stg2_7, lo_13_3);
  }
  ...
  // Stage3
  {
    ...
    stp1_4 = idct_calc_wraplow2_sse2(stg3_0, stg3_1, lo_2_14);
  ...
  // Stage4
  {
    ...
    stp2_9 = idct_calc_wraplow2_sse2(stg4_4, stg4_5, lo_9_14);
    stp2_10 = idct_calc_wraplow2_sse2(stg4_6, stg4_7, lo_10_13);
  ...
  // Stage6
  {
    ...
    stp1_6 = idct_calc_wraplow2_sse2(stg4_0, stg4_1, lo_6_5);
