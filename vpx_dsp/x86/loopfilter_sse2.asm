...
global sym(vpx_lpf_horizontal_8_dual_sse2) PRIVATE
sym(vpx_lpf_horizontal_8_dual_sse2):
  push    rbp
  mov     rbp, rsp
...
%endif
  ...
  psubusb xmm0, [rcx]          ; mask = _mm_subs_epu8(_mm_adds_epu8(abs_diff(p0,q0),abs_diff(p1,q1)), blimit)
  movdqa  xmm1, xmm7
  pcmpeqb xmm0, xmm6
  movdqa  [p2], xmm3
  ...
  movdqa  xmm6, [q0]
  psubusb xmm0, [rcx]             ; mask = _mm_subs_epu8(mask, limit)
  pxor    xmm7, xmm7
  movdqa  xmm3, xmm6
