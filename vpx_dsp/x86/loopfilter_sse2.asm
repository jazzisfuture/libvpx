...
%macro ABS_SUB_Q0 3
    mova       [q%3], %1
    mova       [p%3], %2
    ABS_SUB       m3, m6, m1, m5, m3, %1, m1, %2, %1, %2
%endm
...
cglobal mb_lpf_horizontal_edge_w_sse2_16, 6, 6+(ARCH_X86_64*1), \
...
thresh, count
    ...
    SET_SOURCE_POINTER
%if ARCH_X86
    %xdefine thresh  [esp + stack_offset + 4*4 + 4]
%endif
...
%if ARCH_X86
    ...
    ABS_SUB       m3, m6, m2, m5, m3, \
    m1, m2, m4, m1, m4                  ; |p3-p0| , |q3-q0|

    mova          m7, [q2]
    mova          m2, [p2]
    pmaxub        m4, m1                ; flat=max(|p3-p0|, |q3-q0|)
    ABS_SUB       m3, m6, m1, m5, m3, \
    m7, m1, m2, m7, m2

    mov          r4q, dword thresh
%else
    psubusb       m0, m2                ; mask=_mm_subs_epu8(mask, limit)
    pxor          m7, m7
    pcmpeqb       m0, m7                ; mask = _mm_cmpeq_epi8(mask, zero)
    ABS_SUB       m3, m8, m2, m9, m3, \
    m1, m2, m4, m1, m4                  ; |p3-p0| , |q3-q0|

    mova          m7, m12
    mova          m2, m13
    pmaxub        m4, m1                ; flat=max(|p3-p0|, |q3-q0|)
    ABS_SUB       m3, m8, m1, m9, m3, \
    m7, m1, m2, m7, m2
%endif
