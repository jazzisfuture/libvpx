...
static void highbd_idct8x8_half1d(__m128i *const io) {
  ...
  step1[1] = io[2];
  step1[3] = io[6];
  multiplication_and_add_2_sse4_1(io[1], io[7], &cp_28q_28q, &cp_4q_4q,
                                  &step1[4], &step1[7]);
  multiplication_and_add_2_sse4_1(io[5], io[3], &cp_12q_12q, &cp_20q_20q,
                                  &step1[5], &step1[6]);

  // stage 2
  temp2[0] = _mm_add_epi32(step1[0], step1[2]);
  extend_64bit(temp2[0], temp1);
  step2[0] = multiplication_round_shift_sse4_1(temp1, cp_16q_16q);
  temp2[0] = _mm_sub_epi32(step1[0], step1[2]);
  extend_64bit(temp2[0], temp1);
  step2[1] = multiplication_round_shift_sse4_1(temp1, cp_16q_16q);
  multiplication_and_add_2_sse4_1(step1[1], step1[3], &cp_24q_24q, &cp_8q_8q,
                                  &step2[2], &step2[3]);
  ...
  extend_64bit(temp2[0], temp1);
  step1[5] = multiplication_round_shift_sse4_1(temp1, cp_16q_16q);
  temp2[0] = _mm_add_epi32(step2[6], step2[5]);
  extend_64bit(temp2[0], temp1);
  step1[6] = multiplication_round_shift_sse4_1(temp1, cp_16q_16q);
  step1[7] = step2[7];
...
static void highbd_idct8x8_12_half1d(__m128i *const io) {
  ...
  step1[4] = multiplication_round_shift_sse4_1(temp1, cp_28q_28q);
  step1[7] = multiplication_round_shift_sse4_1(temp1, cp_4q_4q);
  extend_64bit(io[3], temp1);
  step1[5] = multiplication_round_shift_sse4_1(temp1, cp_n20q_n20q);
  step1[6] = multiplication_round_shift_sse4_1(temp1, cp_12q_12q);

  // stage 2
  extend_64bit(step1[0], temp1);
  step2[0] = multiplication_round_shift_sse4_1(temp1, cp_16q_16q);
  extend_64bit(step1[1], temp1);
  step2[2] = multiplication_round_shift_sse4_1(temp1, cp_24q_24q);
  step2[3] = multiplication_round_shift_sse4_1(temp1, cp_8q_8q);
  step2[4] = _mm_add_epi32(step1[4], step1[5]);
  step2[5] = _mm_sub_epi32(step1[4], step1[5]);
  step2[6] = _mm_sub_epi32(step1[7], step1[6]);
  step2[7] = _mm_add_epi32(step1[7], step1[6]);
