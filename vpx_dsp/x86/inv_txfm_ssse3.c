...
static INLINE void idct32_135_8x32_quarter_1_2(
    const __m128i *const in /*in[16]*/, __m128i *const out /*out[32]*/) {
  __m128i temp[16];
...
static void idct32_135_8x32(const __m128i *const in /*in[32]*/,
                            __m128i *const out /*out[32]*/) {
  __m128i temp[32];
