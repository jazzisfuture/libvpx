...
static void idct32_full_8x32_quarter_2(const __m128i in[32], __m128i out[16]) {
...
static void idct32_full_8x32_quarter_1(const __m128i in[32], __m128i out[8]) {
...
// array out[16]
static void idct32_full_8x32_quarter_3_4(const __m128i in[32],
                                         __m128i out[16]) {
  __m128i v16, v17, v18, v19, v20, v21, v22, v23;
  __m128i v24, v25, v26, v27, v28, v29, v30, v31;
  __m128i u16, u17, u18, u19, u20, u21, u22, u23;
...
static void idct32_full_8x32_quarter_1_2(const __m128i in[32],
                                         __m128i out[32]) {
  __m128i temp[16];
...
static void idct32_full_8x32(const __m128i in[32], __m128i out[32]) {
  __m128i temp[32];
