...
// size = 16, 32
static INLINE void late_stage_butterfly(const __m128i *in, __m128i *out,
                                        int size) {
  int i = 0;
...
static INLINE void simple_group_butterfly(const __m128i *in, __m128i *out) {
  late_stage_butterfly(in, out, 32);
}
...
// Stage (A): 0, 1, 2, 3, 4, 5, 6, 7
static void idct32_8x16_135_first_half_1(__m128i *in, __m128i *out) {
  const __m128i stk3_0 = pair_set_epi16(2 * cospi_28_64, 2 * cospi_28_64);
  const __m128i stk3_1 = pair_set_epi16(2 * cospi_4_64, 2 * cospi_4_64);
  ...
  u1 = _mm_mulhrs_epi16(in[0], stk4_0);  // stk4_1 = stk4_0
...
// Stage (A): 8, 9, 10, 11, 12, 13, 14, 15
static void idct32_8x16_135_first_half_2(const __m128i *in, __m128i *out) {
  const __m128i stk2_0 = pair_set_epi16(2 * cospi_30_64, 2 * cospi_30_64);
  const __m128i stk2_1 = pair_set_epi16(2 * cospi_2_64, 2 * cospi_2_64);
  ...
  out[8] = _mm_add_epi16(v8, v11);
  out[9] = _mm_add_epi16(v9, v10);
  out[10] = _mm_sub_epi16(v9, v10);
  out[11] = _mm_sub_epi16(v8, v11);
  out[12] = _mm_sub_epi16(v15, v12);
  out[13] = _mm_sub_epi16(v14, v13);
  out[14] = _mm_add_epi16(v14, v13);
  out[15] = _mm_add_epi16(v15, v12);

  butterfly_self(&out[10], &out[13], stg6_0, stg4_0);
  butterfly_self(&out[11], &out[12], stg6_0, stg4_0);
}

// 8x16 block even indexed 8 inputs of in[16],
// output first half 16 to out[32]
static void idct32_8x16_first_half(__m128i *in, __m128i *out) {
  __m128i temp[16];
  idct32_8x16_135_first_half_1(in, temp);
  idct32_8x16_135_first_half_2(in, temp);
  late_stage_butterfly(temp, out, 16);
}

// 8x16 block odd indexed 8 inputs of in[16],
// output second half 16 to out[32]
static void idct32_8x16_second_half(__m128i *in, __m128i *out) {
  const __m128i stk1_0 = pair_set_epi16(2 * cospi_31_64, 2 * cospi_31_64);
  const __m128i stk1_1 = pair_set_epi16(2 * cospi_1_64, 2 * cospi_1_64);
  ...
  out[16] = _mm_add_epi16(u16, u23);
  out[17] = _mm_add_epi16(u17, u22);
  out[18] = _mm_add_epi16(u18, u21);
  out[19] = _mm_add_epi16(u19, u20);
  v20 = _mm_sub_epi16(u19, u20);
  v21 = _mm_sub_epi16(u18, u21);
  v22 = _mm_sub_epi16(u17, u22);
  v23 = _mm_sub_epi16(u16, u23);
  ...
  v26 = _mm_sub_epi16(u29, u26);
  v27 = _mm_sub_epi16(u28, u27);
  out[28] = _mm_add_epi16(u27, u28);
  out[29] = _mm_add_epi16(u26, u29);
  out[30] = _mm_add_epi16(u25, u30);
  out[31] = _mm_add_epi16(u24, u31);

  butterfly(v20, v27, stg6_0, stg4_0, &out[20], &out[27]);
  butterfly(v21, v26, stg6_0, stg4_0, &out[21], &out[26]);
  butterfly(v22, v25, stg6_0, stg4_0, &out[22], &out[25]);
  butterfly(v23, v24, stg6_0, stg4_0, &out[23], &out[24]);
}

// 8x16 block __m128i in[16], output __m128i in[32]
static void idct32_8x16_135(__m128i *in) {
  __m128i out[32];
  idct32_8x16_first_half(in, out);
  idct32_8x16_second_half(in, out);
  simple_group_butterfly(out, in);
}
...
// coefficents 8-15
static void idct32_8x32_even_2_0(const __m128i *in, __m128i *out) {
...
// coefficents 0-7
static void idct32_8x32_even_2_1(const __m128i *in, __m128i *out) {
...
// coefficents 16-31
static void idct32_8x32_odd(const __m128i *in, __m128i *out) {
  ...
  out[18] = _mm_add_epi16(u18, u21);
  out[19] = _mm_add_epi16(u19, u20);
  out[20] = _mm_sub_epi16(u19, u20);
  out[21] = _mm_sub_epi16(u18, u21);
  out[22] = _mm_sub_epi16(u17, u22);
  out[23] = _mm_sub_epi16(u16, u23);

  out[24] = _mm_sub_epi16(u31, u24);
  out[25] = _mm_sub_epi16(u30, u25);
  out[26] = _mm_sub_epi16(u29, u26);
  out[27] = _mm_sub_epi16(u28, u27);
  out[28] = _mm_add_epi16(u27, u28);
  out[29] = _mm_add_epi16(u26, u29);
  out[30] = _mm_add_epi16(u25, u30);
  out[31] = _mm_add_epi16(u24, u31);

  butterfly_self(&out[20], &out[27], stg6_0, stg4_0);
  butterfly_self(&out[21], &out[26], stg6_0, stg4_0);
  butterfly_self(&out[22], &out[25], stg6_0, stg4_0);
  butterfly_self(&out[23], &out[24], stg6_0, stg4_0);
}

static void idct32_8x32_even(__m128i *in, __m128i *out) {
  __m128i temp[16];
  idct32_8x32_even_2_0(in, temp);
  idct32_8x32_even_2_1(in, temp);
  late_stage_butterfly(temp, out, 16);
}

static void idct32_8x32(__m128i *in, __m128i *out) {
  __m128i temp[32];
  idct32_8x32_even(in, temp);
  idct32_8x32_odd(in, temp);
  simple_group_butterfly(temp, out);
}
