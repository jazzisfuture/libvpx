...
unsigned int vpx_variance_halfpixvar16x16_h_sse2(const unsigned char *src,
                                                 int src_stride,
...
unsigned int vpx_variance_halfpixvar16x16_v_sse2(const unsigned char *src,
                                                  int src_stride,
                                                  const unsigned char *dst,
                                                  int dst_stride,
                                                  unsigned int *sse) {
...
unsigned int vpx_variance_halfpixvar16x16_hv_sse2(const unsigned char *src,
                                                  int src_stride,
                                                  const unsigned char *dst,
                                                  int dst_stride,
                                                  unsigned int *sse) {
