...
void vpx_lpf_horizontal_edge_w_sse2_16(unsigned char *s,
                                             int p,
                                             const unsigned char *_blimit,
                                             const unsigned char *_limit,
                                             const unsigned char *_thresh);
...
void vpx_lpf_horizontal_16_sse2(unsigned char *s, int p,
  ...
  if (count == 1)
    ...
    vpx_lpf_horizontal_edge_w_sse2_16(s, p, _blimit, _limit, _thresh);
}
...
void vpx_lpf_vertical_16_dual_sse2(unsigned char *s, int p,
  ...
  // Loop filtering
  vpx_lpf_horizontal_edge_w_sse2_16(t_dst + 8 * 16, 16, blimit, limit,
                                   thresh);
