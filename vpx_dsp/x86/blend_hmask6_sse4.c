...
void vpx_blend_hmask6_sse4_1(uint8_t *dst, uint32_t dst_stride,
                             uint8_t *src0, uint32_t src0_stride,
                             uint8_t *src1, uint32_t src1_stride,
                             const uint8_t *mask, int h, int w) {
  vpx_blend_mask6_sse4_1(dst, dst_stride,
                         src0, src0_stride,
                         src1, src1_stride,
                         mask, 0, h, w, 0, 0);
}
...
void vpx_highbd_blend_hmask6_sse4_1(uint8_t *dst_8, uint32_t dst_stride,
                                    uint8_t *src0_8, uint32_t src0_stride,
                                    uint8_t *src1_8, uint32_t src1_stride,
                                    const uint8_t *mask, int h, int w, int bd) {
  vpx_highbd_blend_mask6_sse4_1(dst_8, dst_stride,
                                src0_8, src0_stride,
                                src1_8, src1_stride,
                                mask, 0, h, w, 0, 0, bd);
}
