...
static void highbd_idct8x8_half1d(__m128i *const io) {
  ...
  step1[1] = io[2];
  step1[3] = io[6];
  multiplication_and_add_2_sse2(io[1], io[7], (int)cospi_28_64, (int)cospi_4_64,
                                &step1[4], &step1[7]);
  multiplication_and_add_2_sse2(io[5], io[3], (int)cospi_12_64,
  ...
  multiplication_and_add_2_sse2(step1[1], step1[3], (int)cospi_24_64,
