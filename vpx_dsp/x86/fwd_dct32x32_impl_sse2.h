...
// check for overflow and accumulate with previous checks via or
#define _mm_check_epi32_overflow_2(preg0, preg1, or_reg, zero)             \
  do {                                                                     \
    ...
    __m128i top_dwords_01 =                                                \
        _mm_unpacklo_epi64(reg0_top_dwords, reg1_top_dwords);              \
    ...
    __m128i overflow_01 =                                                  \
        _mm_cmpeq_epi32(valid_positive_01, valid_negative_01);             \
