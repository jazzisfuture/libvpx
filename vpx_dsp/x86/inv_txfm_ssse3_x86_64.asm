...
%else
  ...
  pxor             m2, m2 ; in29
  BUTTERFLY_4X      2,  3, 16207,  2404,  m8,  9, 10 ; stp1_23, stp1_24
  SWAP 2, 3
%endif
  ; BLOCK B STAGE 2 ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  mova                m13, m5 ; stp1_20
...
%else
  pxor                 m1, m1 ; in30
  BUTTERFLY_4X          0,     1,   1606, 16305,  m8,  9,  10 ; stp2_8, stp2_15
  pxor                 m7, m7 ; in26
  BUTTERFLY_4X          7,     6,  15679,  4756,  m8,  9,  10 ; stp2_11, stp2_12
%endif
  ; BLOCK C STAGE 3 ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  mova                 m3, m0 ; stp1_8
  mova                 m4, m7 ; stp1_11
...
%else
  pxor                 m7, m7
  BUTTERFLY_4X          0,     7,  11585, 11585,  m8,  9,  10 ; stp1_1, stp1_0
%endif
