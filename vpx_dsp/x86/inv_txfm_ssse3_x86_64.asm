...
%include "vpx_dsp/x86/bitdepth_conversions_sse2.asm"
...
cglobal idct8x8_64_add, 3, 5, 13, input, output, stride
  ...
  LOAD_TRAN_LOW 4, inputq, 4
  LOAD_TRAN_LOW 5, inputq, 5
  LOAD_TRAN_LOW 6, inputq, 6
  LOAD_TRAN_LOW 7, inputq, 7
...
idct32x32_34_transpose:
  LOAD_TRAN_LOW 0, inputq,  0
  LOAD_TRAN_LOW 1, inputq,  4
  LOAD_TRAN_LOW 2, inputq,  8
  LOAD_TRAN_LOW 3, inputq, 12
  LOAD_TRAN_LOW 4, inputq, 16
  LOAD_TRAN_LOW 5, inputq, 20
  LOAD_TRAN_LOW 6, inputq, 24
  LOAD_TRAN_LOW 7, inputq, 28
...
idct32x32_135_transpose:
  ...
  lea            stp, [stp + 16 * 8]
  INCREMENT_STRIDE_TRAN_LOW inputq, 32
  dec             r6
  jnz idct32x32_135
