...
static INLINE __m128i blend_2(uint8_t*src0, uint8_t *src1,
                              const __m128i v_m0_w, const __m128i v_m1_w) {
  const __m128i v_s0_b = xx_loadl_16(src0);
  const __m128i v_s1_b = xx_loadl_16(src1);
...
static void blend_vmask6_w2_sse4_1(
  ...
  do {
    ...
    const __m128i v_res_w = blend_2(src0, src1, v_m0_w, v_m1_w);

    const __m128i v_res_b = _mm_packus_epi16(v_res_w, v_res_w);

    xx_storel_16(dst, v_res_b);
...
static void blend_vmask6_w4_sse4_1(
    uint8_t *dst, uint32_t dst_stride,
    uint8_t *src0, uint32_t src0_stride,
    uint8_t *src1, uint32_t src1_stride,
    const uint8_t *mask, int h, int w) {
...
static void blend_vmask6_w8_sse4_1(
    uint8_t *dst, uint32_t dst_stride,
    uint8_t *src0, uint32_t src0_stride,
    uint8_t *src1, uint32_t src1_stride,
    const uint8_t *mask, int h, int w) {
...
static void blend_vmask6_w16n_sse4_1(
    uint8_t *dst, uint32_t dst_stride,
    uint8_t *src0, uint32_t src0_stride,
    uint8_t *src1, uint32_t src1_stride,
    const uint8_t *mask, int h, int w) {
...
void vpx_blend_vmask6_sse4_1(uint8_t *dst, uint32_t dst_stride,
                            uint8_t *src0, uint32_t src0_stride,
                            uint8_t *src1, uint32_t src1_stride,
                            const uint8_t *mask, int h, int w) {
  ...
  static blend_fn blend[5] = {  // width_index
    blend_vmask6_w16n_sse4_1,   // w % 16 == 0
    blend_vmask6_w2_sse4_1,     // w == 2
...
static INLINE __m128i blend_2_b10(uint16_t*src0, uint16_t *src1,
                                  const __m128i v_m0_w, const __m128i v_m1_w) {
  const __m128i v_s0_w = xx_loadl_32(src0);
  const __m128i v_s1_w = xx_loadl_32(src1);
...
static INLINE __m128i blend_2_b12(uint16_t*src0, uint16_t *src1,
                                  const __m128i v_m0_w, const __m128i v_m1_w) {
  const __m128i v_s0_w = xx_loadl_32(src0);
  const __m128i v_s1_w = xx_loadl_32(src1);
...
static INLINE void blend_vmask6_bn_w2_sse4_1(
...
static void blend_vmask6_b10_w2_sse4_1(
    uint16_t *dst, uint32_t dst_stride,
    uint16_t *src0, uint32_t src0_stride,
    uint16_t *src1, uint32_t src1_stride,
    const uint8_t *mask, int h, int w) {
  (void)w;
  blend_vmask6_bn_w2_sse4_1(dst, dst_stride, src0, src0_stride, src1,
                            src1_stride, mask, h,
                            blend_2_b10);
}

static void blend_vmask6_b12_w2_sse4_1(
    uint16_t *dst, uint32_t dst_stride,
    uint16_t *src0, uint32_t src0_stride,
    uint16_t *src1, uint32_t src1_stride,
    const uint8_t *mask, int h, int w) {
...
static INLINE void blend_vmask6_bn_w4_sse4_1(
    uint16_t *dst, uint32_t dst_stride,
    uint16_t *src0, uint32_t src0_stride,
    uint16_t *src1, uint32_t src1_stride,
    const uint8_t *mask, int h, blend_unit_fn blend) {
...
static void blend_vmask6_b10_w4_sse4_1(
    uint16_t *dst, uint32_t dst_stride,
    uint16_t *src0, uint32_t src0_stride,
    uint16_t *src1, uint32_t src1_stride,
    const uint8_t *mask, int h, int w) {
  (void)w;
  blend_vmask6_bn_w4_sse4_1(dst, dst_stride, src0, src0_stride, src1,
                            src1_stride, mask, h,
                            blend_4_b10);
}

static void blend_vmask6_b12_w4_sse4_1(
    uint16_t *dst, uint32_t dst_stride,
    uint16_t *src0, uint32_t src0_stride,
    uint16_t *src1, uint32_t src1_stride,
    const uint8_t *mask, int h, int w) {
...
static inline void blend_vmask6_bn_w8n_sse4_1(
    uint16_t *dst, uint32_t dst_stride,
    uint16_t *src0, uint32_t src0_stride,
    uint16_t *src1, uint32_t src1_stride,
...
static void blend_vmask6_b10_w8n_sse4_1(
    uint16_t *dst, uint32_t dst_stride,
    uint16_t *src0, uint32_t src0_stride,
    uint16_t *src1, uint32_t src1_stride,
    const uint8_t *mask, int h, int w) {
  blend_vmask6_bn_w8n_sse4_1(dst, dst_stride, src0, src0_stride, src1,
                             src1_stride, mask, h, w,
                             blend_8_b10);
}

static void blend_vmask6_b12_w8n_sse4_1(
    uint16_t *dst, uint32_t dst_stride,
    uint16_t *src0, uint32_t src0_stride,
    uint16_t *src1, uint32_t src1_stride,
    const uint8_t *mask, int h, int w) {
...
void vpx_highbd_blend_vmask6_sse4_1(uint8_t *dst_8, uint32_t dst_stride,
  ...
  static blend_fn blend[2][3] = {  // bd_index X width_index
    {     // bd == 8 or 10
      blend_vmask6_b10_w8n_sse4_1,  // w % 8 == 0
      blend_vmask6_b10_w2_sse4_1,   // w == 2
      blend_vmask6_b10_w4_sse4_1,   // w == 4
    }, {  // bd == 12
      blend_vmask6_b12_w8n_sse4_1,  // w % 8 == 0
      blend_vmask6_b12_w2_sse4_1,   // w == 2
      blend_vmask6_b12_w4_sse4_1,   // w == 4
    }
  };
  ...
  blend[bd == 12][(w >> 1) & 3](dst, dst_stride,
                                src0, src0_stride,
                                src1, src1_stride,
                                mask, h, w);
}
