...
cglobal hadamard_8x8, 3, 5, 11, input, stride, output
  ...
  STORE_TRAN_LOW 0, outputq,  0, 8, 9, 10
  STORE_TRAN_LOW 1, outputq,  1, 8, 9, 10
  STORE_TRAN_LOW 2, outputq,  2, 8, 9, 10
  STORE_TRAN_LOW 3, outputq,  3, 8, 9, 10
  STORE_TRAN_LOW 4, outputq,  4, 8, 9, 10
  STORE_TRAN_LOW 5, outputq,  5, 8, 9, 10
  STORE_TRAN_LOW 6, outputq,  6, 8, 9, 10
  STORE_TRAN_LOW 7, outputq,  7, 8, 9, 10
