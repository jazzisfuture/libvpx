...
static INLINE void load_u8_4x4(const uint8_t *const s, const ptrdiff_t stride,
                               __m128i *const d) {
...
static INLINE void load_u8_4x8(const uint8_t *const s, const ptrdiff_t stride,
                               __m128i *const d) {
  load_u8_4x4(s + 0 * stride, stride, &d[0]);
  load_u8_4x4(s + 4 * stride, stride, &d[4]);
}

static INLINE void load_u8_8x4(const uint8_t *const s, const ptrdiff_t stride,
                               __m128i *const d) {
...
static INLINE void load_u8_8x8(const uint8_t *const s, const ptrdiff_t stride,
                               __m128i *const d) {
  load_u8_8x4(s + 0 * stride, stride, &d[0]);
  load_u8_8x4(s + 4 * stride, stride, &d[4]);
}

static INLINE void load_u8_16x8(const uint8_t *const s, const ptrdiff_t stride,
                                __m128i *const d) {
...
static INLINE void loadu_u8_16x8(const uint8_t *const s, const ptrdiff_t stride,
                                 __m128i *const d) {
...
static INLINE void store_u8_4x4(const __m128i *const s, uint8_t *const d,
...
static INLINE void store_u8_8x8(const __m128i *const s, uint8_t *const d,
                                const ptrdiff_t stride) {
