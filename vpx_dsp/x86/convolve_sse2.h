...
static INLINE __m128i extract_quarter_2_epi16_sse2(const __m128i reg) {
...
static INLINE __m128i extract_quarter_3_epi16_sse2(const __m128i reg) {
...
static INLINE __m128i pad_multiply_add_add_epi8_sse2(const __m128i src_1,
                                                     const __m128i src_2,
                                                     const __m128i ker_1,
                                                     const __m128i ker_2) {
...
static INLINE __m128i multiply_add_packs_epi16_sse2(const __m128i src_0,
                                                    const __m128i src_1,
                                                    const __m128i ker) {
...
static INLINE __m128i combine_epi32_sse2(const __m128i src_1,
                                         const __m128i src_2) {
...
static INLINE __m128i round_epi16_sse2(const __m128i src,
                                       const __m128i half_depth,
                                       const int depth) {
