...
static INLINE void vpx_filter_block1d16_v8_x_avx2(
  ...
  for (i = output_height; i > 1; i -= 2) {
    ...
    srcRegTail1 = _mm256_inserti128_si256(
        srcRegTail1, _mm256_castsi256_si128(srcRegTail2), 1);
    srcRegTail3 = _mm256_castsi128_si256(
        _mm_loadu_si128((const __m128i *)(src_ptr + 8 * src_pitch)));
    srcRegTail2 = _mm256_inserti128_si256(
        srcRegTail2, _mm256_castsi256_si128(srcRegTail3), 1);
