...
static INLINE void vpx_filter_block1d16_v8_x_avx2(
  ...
  for (i = output_height; i > 1; i -= 2) {
    ...
    srcReg32b7 = _mm256_inserti128_si256(srcReg32b7, srcReg8, 1);
  ...
  if (i > 0) {
    ...
    s1[0] = _mm256_castsi128_si256(
        _mm_unpacklo_epi8(_mm256_castsi256_si128(srcReg32b7), srcReg8));
    s2[0] = _mm256_castsi128_si256(
        _mm_unpackhi_epi8(_mm256_castsi256_si128(srcReg32b7), srcReg8));
