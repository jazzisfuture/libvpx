...
static INLINE void vpx_filter_block1d16_v8_x_avx2(
...

  {
    ...
    s32b[5] = _mm256_inserti128_si256(_mm256_castsi128_si256(s[5]),
                                      _mm256_castsi256_si128(srcReg32b7),
                                      1);
  ...
  for (i = output_height; i > 1; i -= 2) {
    __m256i srcReg32b8, srcReg32b9;

    // load the last 2 loads of 16 bytes and have every two
    // consecutive loads in the same 256 bit register
    srcReg8 = _mm_loadu_si128((const __m128i *)(src_ptr + 7 * src_pitch));
    srcReg32b7 = _mm256_inserti128_si256(srcReg32b7,
                                         srcReg8, 1);
    srcReg32b9 = _mm256_castsi128_si256(
        _mm_loadu_si128((const __m128i *)(src_ptr + 8 * src_pitch)));
    srcReg32b8 = _mm256_inserti128_si256(_mm256_castsi128_si256(srcReg8),
                                         _mm256_castsi256_si128(srcReg32b9),
                                         1);

    // merge every two consecutive registers
    // save
    s1[3] = _mm256_unpacklo_epi8(srcReg32b7, srcReg32b8);
    s2[3] = _mm256_unpackhi_epi8(srcReg32b7, srcReg32b8);
  ...
  if (i > 0) {
    ...
    s1[0] =
        _mm256_castsi128_si256(_mm_unpacklo_epi8(_mm256_castsi256_si128(srcReg32b7), srcReg8));
    s2[0] =
        _mm256_castsi128_si256(_mm_unpackhi_epi8(_mm256_castsi256_si128(srcReg32b7), srcReg8));
