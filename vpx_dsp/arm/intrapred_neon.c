...
void vpx_d63_predictor_4x4_neon(uint8_t *dst, ptrdiff_t stride,
  ...
  zero = vdup_n_u32(0);
  a0 = vreinterpret_u8_u32(
      vld1_lane_u32((const uint32_t *)(above + 0), zero, 0));
  a1 = vreinterpret_u8_u32(
      vld1_lane_u32((const uint32_t *)(above + 1), zero, 0));
  a2 = vreinterpret_u8_u32(
      vld1_lane_u32((const uint32_t *)(above + 2), zero, 0));
  a3 = vreinterpret_u8_u32(
      vld1_lane_u32((const uint32_t *)(above + 3), zero, 0));
  ...
  vst1_lane_u32((uint32_t *)(dst + 0 * stride), vreinterpret_u32_u8(d0), 0);
  vst1_lane_u32((uint32_t *)(dst + 1 * stride), vreinterpret_u32_u8(d1), 0);
  vst1_lane_u32((uint32_t *)(dst + 2 * stride), vreinterpret_u32_u8(d2), 0);
  vst1_lane_u32((uint32_t *)(dst + 3 * stride), vreinterpret_u32_u8(d3), 0);
}
