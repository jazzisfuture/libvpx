...
void vpx_d63_predictor_8x8_neon(uint8_t *dst, ptrdiff_t stride,
  ...
  a0 = load_unaligned_u8_8x1(above + 0);
  a1 = load_unaligned_u8_8x1(above + 1);
  a2 = load_unaligned_u8_8x1(above + 2);
...
void vpx_d63_predictor_16x16_neon(uint8_t *dst, ptrdiff_t stride,
  ...
  a0 = load_unaligned_u8_16x1(above + 0);
  a1 = load_unaligned_u8_16x1(above + 1);
  a2 = load_unaligned_u8_16x1(above + 2);
...
void vpx_d63_predictor_32x32_neon(uint8_t *dst, ptrdiff_t stride,
  ...
  a1 = load_unaligned_u8_16x1(above + 1);
  a2 = load_unaligned_u8_16x1(above + 2);
  a16 = load_unaligned_u8_16x1(above + 16);
  a17 = load_unaligned_u8_16x1(above + 17);
  a18 = load_unaligned_u8_16x1(above + 18);
...
void vpx_d117_predictor_8x8_neon(uint8_t *dst, ptrdiff_t stride,
  ...
  az = load_unaligned_u8_8x1(above - 1);
  a0 = load_unaligned_u8_8x1(above + 0);
  // [ left[0], above[-1], ... , above[5] ]
  l0az = vext_u8(vld1_dup_u8(left), az, 7);

  l0 = load_unaligned_u8_8x1(left + 0);
  l1 = load_unaligned_u8_8x1(left + 1);
...
void vpx_d117_predictor_16x16_neon(uint8_t *dst, ptrdiff_t stride,
  ...
  az = load_unaligned_u8_16x1(above - 1);
  a0 = load_unaligned_u8_16x1(above + 0);
  // [ left[0], above[-1], ... , above[13] ]
  l0az = vextq_u8(vld1q_dup_u8(left), az, 15);

  l0 = load_unaligned_u8_16x1(left + 0);
  l1 = load_unaligned_u8_16x1(left + 1);
...
void vpx_d117_predictor_32x32_neon(uint8_t *dst, ptrdiff_t stride,
  ...
  az = load_unaligned_u8_16x1(above - 1);
  a0 = load_unaligned_u8_16x1(above + 0);
  a14 = load_unaligned_u8_16x1(above + 14);
  a15 = load_unaligned_u8_16x1(above + 15);
  a16 = load_unaligned_u8_16x1(above + 16);
  // [ left[0], above[-1], ... , above[13] ]
  l0az = vextq_u8(vld1q_dup_u8(left), az, 15);
  ...
  l0 = load_unaligned_u8_16x1(left + 0);
  l1 = load_unaligned_u8_16x1(left + 1);
  l15 = load_unaligned_u8_16x1(left + 15);
  l16 = load_unaligned_u8_16x1(left + 16);
  l17 = load_unaligned_u8_16x1(left + 17);
  // [ above[-1], left[0], ... , left[14] ]
  azl0 = vextq_u8(vld1q_dup_u8(above - 1), l0, 15);
