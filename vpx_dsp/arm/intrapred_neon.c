...
static INLINE void d135_store_32(uint8_t *dst, const ptrdiff_t stride,
                                 const uint8x16_t row_0, const uint8x16_t row_1,
...
void vpx_d135_predictor_32x32_neon(uint8_t *dst, ptrdiff_t stride,
...

  {
    ...
    d135_store_32(dst, stride, r_0, r_1, r_2);
  }

  {
    ...
    d135_store_32(dst + 1 * stride, stride, r_0, r_1, r_2);
  }

  {
    ...
    d135_store_32(dst + 2 * stride, stride, r_0, r_1, r_2);
  }

  {
    ...
    d135_store_32(dst + 3 * stride, stride, r_0, r_1, r_2);
  }

  {
    ...
    d135_store_32(dst + 4 * stride, stride, r_0, r_1, r_2);
  }

  {
    ...
    d135_store_32(dst + 5 * stride, stride, r_0, r_1, r_2);
  }

  {
    ...
    d135_store_32(dst + 6 * stride, stride, r_0, r_1, r_2);
  }

  {
    ...
    d135_store_32(dst + 7 * stride, stride, r_0, r_1, r_2);
  }

  {
    ...
    d135_store_32(dst + 8 * stride, stride, r_0, r_1, r_2);
  }

  {
    ...
    d135_store_32(dst + 9 * stride, stride, r_0, r_1, r_2);
  }

  {
    ...
    d135_store_32(dst + 10 * stride, stride, r_0, r_1, r_2);
  }

  {
    ...
    d135_store_32(dst + 11 * stride, stride, r_0, r_1, r_2);
  }

  {
    ...
    d135_store_32(dst + 12 * stride, stride, r_0, r_1, r_2);
  }

  {
    ...
    d135_store_32(dst + 13 * stride, stride, r_0, r_1, r_2);
  }

  {
    ...
    d135_store_32(dst + 14 * stride, stride, r_0, r_1, r_2);
  }

  d135_store_32(dst + 15 * stride, stride, row_0, row_1, row_2);
}
