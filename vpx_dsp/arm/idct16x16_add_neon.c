...
static void idct16x16_256_add_neon_pass1(
    int16x8_t *const s0, int16x8_t *const s1, int16x8_t *const s2,
    int16x8_t *const s3, int16x8_t *const s4, int16x8_t *const s5,
    int16x8_t *const s6, int16x8_t *const s7, int16_t *out) {
...
static void idct16x16_256_add_neon_pass2(
    int16x8_t *const s0, int16x8_t *const s1, int16x8_t *const s2,
    int16x8_t *const s3, int16x8_t *const s4, int16x8_t *const s5,
    int16x8_t *const s6, int16x8_t *const s7, int16_t *out,
    int16_t *pass1_output, int16_t skip_adding, uint8_t *dest,
    int dest_stride) {
  uint8_t *d;
...
void vpx_idct16x16_256_add_neon_pass2(const int16_t *src, int16_t *out,
  ...
  idct16x16_256_add_neon_pass2(&q8s16, &q9s16, &q10s16, &q11s16, &q12s16,
                               &q13s16, &q14s16, &q15s16, out, pass1_output,
                               skip_adding, dest, dest_stride);
}
