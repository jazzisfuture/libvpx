...
static INLINE void highbd_butterfly_one_coeff_s32(const int32x4_t a,
  ...
  const int64x2_t sum_lo = vmlal_n_s32(a64_lo, b_lo, (tran_low_t)c);
  const int64x2_t sum_hi = vmlal_n_s32(a64_hi, b_hi, (tran_low_t)c);
  const int64x2_t diff_lo = vmlsl_n_s32(a64_lo, b_lo, (tran_low_t)c);
  const int64x2_t diff_hi = vmlsl_n_s32(a64_hi, b_hi, (tran_low_t)c);
