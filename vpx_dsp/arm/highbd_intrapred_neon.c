...
void vpx_highbd_d63_predictor_4x4_neon(uint16_t *dst, ptrdiff_t stride,
  ...
  a0 = load_unaligned_u16_4x1(above + 0);
  a1 = load_unaligned_u16_4x1(above + 1);
  a2 = load_unaligned_u16_4x1(above + 2);
...
void vpx_highbd_d63_predictor_8x8_neon(uint16_t *dst, ptrdiff_t stride,
  ...
  a0 = load_unaligned_u16_8x1(above + 0);
  a1 = load_unaligned_u16_8x1(above + 1);
  a2 = load_unaligned_u16_8x1(above + 2);
...
void vpx_highbd_d63_predictor_16x16_neon(uint16_t *dst, ptrdiff_t stride,
  ...
  a1 = load_unaligned_u16_8x1(above + 1);
  a2 = load_unaligned_u16_8x1(above + 2);
  a8 = load_unaligned_u16_8x1(above + 8);
  a9 = load_unaligned_u16_8x1(above + 9);
  a10 = load_unaligned_u16_8x1(above + 10);
...
void vpx_highbd_d63_predictor_32x32_neon(uint16_t *dst, ptrdiff_t stride,
  ...
  a9 = load_unaligned_u16_8x1(above + 9);
  a10 = load_unaligned_u16_8x1(above + 10);
  a16 = load_unaligned_u16_8x1(above + 16);
  a17 = load_unaligned_u16_8x1(above + 17);
  a18 = load_unaligned_u16_8x1(above + 18);
  a24 = load_unaligned_u16_8x1(above + 24);
  a25 = load_unaligned_u16_8x1(above + 25);
  a26 = load_unaligned_u16_8x1(above + 26);
