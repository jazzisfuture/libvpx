...
void vpx_highbd_d45_predictor_32x32_neon(uint16_t *dst, ptrdiff_t stride,
  ...
  vst1q_u16(dst + 0 * stride + 0, vextq_u16(d0[0], d0[1], 1));
  vst1q_u16(dst + 0 * stride + 8, vextq_u16(d0[1], d0[2], 1));
  vst1q_u16(dst + 0 * stride + 16, vextq_u16(d0[2], d0[3], 1));
  vst1q_u16(dst + 0 * stride + 24, vextq_u16(d0[3], a31, 1));
  vst1q_u16(dst + 1 * stride + 0, vextq_u16(d0[0], d0[1], 2));
  vst1q_u16(dst + 1 * stride + 8, vextq_u16(d0[1], d0[2], 2));
  vst1q_u16(dst + 1 * stride + 16, vextq_u16(d0[2], d0[3], 2));
  vst1q_u16(dst + 1 * stride + 24, vextq_u16(d0[3], a31, 2));
  vst1q_u16(dst + 2 * stride + 0, vextq_u16(d0[0], d0[1], 3));
  vst1q_u16(dst + 2 * stride + 8, vextq_u16(d0[1], d0[2], 3));
  vst1q_u16(dst + 2 * stride + 16, vextq_u16(d0[2], d0[3], 3));
  vst1q_u16(dst + 2 * stride + 24, vextq_u16(d0[3], a31, 3));
  vst1q_u16(dst + 3 * stride + 0, vextq_u16(d0[0], d0[1], 4));
  vst1q_u16(dst + 3 * stride + 8, vextq_u16(d0[1], d0[2], 4));
  vst1q_u16(dst + 3 * stride + 16, vextq_u16(d0[2], d0[3], 4));
  vst1q_u16(dst + 3 * stride + 24, vextq_u16(d0[3], a31, 4));
  vst1q_u16(dst + 4 * stride + 0, vextq_u16(d0[0], d0[1], 5));
  vst1q_u16(dst + 4 * stride + 8, vextq_u16(d0[1], d0[2], 5));
  vst1q_u16(dst + 4 * stride + 16, vextq_u16(d0[2], d0[3], 5));
  vst1q_u16(dst + 4 * stride + 24, vextq_u16(d0[3], a31, 5));
  vst1q_u16(dst + 5 * stride + 0, vextq_u16(d0[0], d0[1], 6));
  vst1q_u16(dst + 5 * stride + 8, vextq_u16(d0[1], d0[2], 6));
  vst1q_u16(dst + 5 * stride + 16, vextq_u16(d0[2], d0[3], 6));
  vst1q_u16(dst + 5 * stride + 24, vextq_u16(d0[3], a31, 6));
  vst1q_u16(dst + 6 * stride + 0, vextq_u16(d0[0], d0[1], 7));
  vst1q_u16(dst + 6 * stride + 8, vextq_u16(d0[1], d0[2], 7));
  vst1q_u16(dst + 6 * stride + 16, vextq_u16(d0[2], d0[3], 7));
  vst1q_u16(dst + 6 * stride + 24, vextq_u16(d0[3], a31, 7));
  vst1q_u16(dst + 7 * stride + 0, d0[1]);
  vst1q_u16(dst + 7 * stride + 8, d0[2]);
  vst1q_u16(dst + 7 * stride + 16, d0[3]);
  vst1q_u16(dst + 7 * stride + 24, a31);

  vst1q_u16(dst + 8 * stride + 0, vextq_u16(d0[1], d0[2], 1));
  vst1q_u16(dst + 8 * stride + 8, vextq_u16(d0[2], d0[3], 1));
  vst1q_u16(dst + 8 * stride + 16, vextq_u16(d0[3], a31, 1));
  vst1q_u16(dst + 8 * stride + 24, a31);
  vst1q_u16(dst + 9 * stride + 0, vextq_u16(d0[1], d0[2], 2));
  vst1q_u16(dst + 9 * stride + 8, vextq_u16(d0[2], d0[3], 2));
  vst1q_u16(dst + 9 * stride + 16, vextq_u16(d0[3], a31, 2));
  vst1q_u16(dst + 9 * stride + 24, a31);
  vst1q_u16(dst + 10 * stride + 0, vextq_u16(d0[1], d0[2], 3));
  vst1q_u16(dst + 10 * stride + 8, vextq_u16(d0[2], d0[3], 3));
  vst1q_u16(dst + 10 * stride + 16, vextq_u16(d0[3], a31, 3));
  vst1q_u16(dst + 10 * stride + 24, a31);
  vst1q_u16(dst + 11 * stride + 0, vextq_u16(d0[1], d0[2], 4));
  vst1q_u16(dst + 11 * stride + 8, vextq_u16(d0[2], d0[3], 4));
  vst1q_u16(dst + 11 * stride + 16, vextq_u16(d0[3], a31, 4));
  vst1q_u16(dst + 11 * stride + 24, a31);
  vst1q_u16(dst + 12 * stride + 0, vextq_u16(d0[1], d0[2], 5));
  vst1q_u16(dst + 12 * stride + 8, vextq_u16(d0[2], d0[3], 5));
  vst1q_u16(dst + 12 * stride + 16, vextq_u16(d0[3], a31, 5));
  vst1q_u16(dst + 12 * stride + 24, a31);
  vst1q_u16(dst + 13 * stride + 0, vextq_u16(d0[1], d0[2], 6));
  vst1q_u16(dst + 13 * stride + 8, vextq_u16(d0[2], d0[3], 6));
  vst1q_u16(dst + 13 * stride + 16, vextq_u16(d0[3], a31, 6));
  vst1q_u16(dst + 13 * stride + 24, a31);
  vst1q_u16(dst + 14 * stride + 0, vextq_u16(d0[1], d0[2], 7));
  vst1q_u16(dst + 14 * stride + 8, vextq_u16(d0[2], d0[3], 7));
  vst1q_u16(dst + 14 * stride + 16, vextq_u16(d0[3], a31, 7));
  vst1q_u16(dst + 14 * stride + 24, a31);
  vst1q_u16(dst + 15 * stride + 0, d0[2]);
  vst1q_u16(dst + 15 * stride + 8, d0[3]);
  vst1q_u16(dst + 15 * stride + 16, a31);
  vst1q_u16(dst + 15 * stride + 24, a31);

  vst1q_u16(dst + 16 * stride + 0, vextq_u16(d0[2], d0[3], 1));
  vst1q_u16(dst + 16 * stride + 8, vextq_u16(d0[3], a31, 1));
  vst1q_u16(dst + 16 * stride + 16, a31);
  vst1q_u16(dst + 16 * stride + 24, a31);
  vst1q_u16(dst + 17 * stride + 0, vextq_u16(d0[2], d0[3], 2));
  vst1q_u16(dst + 17 * stride + 8, vextq_u16(d0[3], a31, 2));
  vst1q_u16(dst + 17 * stride + 16, a31);
  vst1q_u16(dst + 17 * stride + 24, a31);
  vst1q_u16(dst + 18 * stride + 0, vextq_u16(d0[2], d0[3], 3));
  vst1q_u16(dst + 18 * stride + 8, vextq_u16(d0[3], a31, 3));
  vst1q_u16(dst + 18 * stride + 16, a31);
  vst1q_u16(dst + 18 * stride + 24, a31);
  vst1q_u16(dst + 19 * stride + 0, vextq_u16(d0[2], d0[3], 4));
  vst1q_u16(dst + 19 * stride + 8, vextq_u16(d0[3], a31, 4));
  vst1q_u16(dst + 19 * stride + 16, a31);
  vst1q_u16(dst + 19 * stride + 24, a31);
  vst1q_u16(dst + 20 * stride + 0, vextq_u16(d0[2], d0[3], 5));
  vst1q_u16(dst + 20 * stride + 8, vextq_u16(d0[3], a31, 5));
  vst1q_u16(dst + 20 * stride + 16, a31);
  vst1q_u16(dst + 20 * stride + 24, a31);
  vst1q_u16(dst + 21 * stride + 0, vextq_u16(d0[2], d0[3], 6));
  vst1q_u16(dst + 21 * stride + 8, vextq_u16(d0[3], a31, 6));
  vst1q_u16(dst + 21 * stride + 16, a31);
  vst1q_u16(dst + 21 * stride + 24, a31);
  vst1q_u16(dst + 22 * stride + 0, vextq_u16(d0[2], d0[3], 7));
  vst1q_u16(dst + 22 * stride + 8, vextq_u16(d0[3], a31, 7));
  vst1q_u16(dst + 22 * stride + 16, a31);
  vst1q_u16(dst + 22 * stride + 24, a31);
  vst1q_u16(dst + 23 * stride + 0, d0[3]);
  vst1q_u16(dst + 23 * stride + 8, a31);
  vst1q_u16(dst + 23 * stride + 16, a31);
  vst1q_u16(dst + 23 * stride + 24, a31);

  vst1q_u16(dst + 24 * stride + 0, vextq_u16(d0[3], a31, 1));
  vst1q_u16(dst + 24 * stride + 8, a31);
  vst1q_u16(dst + 24 * stride + 16, a31);
  vst1q_u16(dst + 24 * stride + 24, a31);
  vst1q_u16(dst + 25 * stride + 0, vextq_u16(d0[3], a31, 2));
  vst1q_u16(dst + 25 * stride + 8, a31);
  vst1q_u16(dst + 25 * stride + 16, a31);
  vst1q_u16(dst + 25 * stride + 24, a31);
  vst1q_u16(dst + 26 * stride + 0, vextq_u16(d0[3], a31, 3));
  vst1q_u16(dst + 26 * stride + 8, a31);
  vst1q_u16(dst + 26 * stride + 16, a31);
  vst1q_u16(dst + 26 * stride + 24, a31);
  vst1q_u16(dst + 27 * stride + 0, vextq_u16(d0[3], a31, 4));
  vst1q_u16(dst + 27 * stride + 8, a31);
  vst1q_u16(dst + 27 * stride + 16, a31);
  vst1q_u16(dst + 27 * stride + 24, a31);
  vst1q_u16(dst + 28 * stride + 0, vextq_u16(d0[3], a31, 5));
  vst1q_u16(dst + 28 * stride + 8, a31);
  vst1q_u16(dst + 28 * stride + 16, a31);
  vst1q_u16(dst + 28 * stride + 24, a31);
  vst1q_u16(dst + 29 * stride + 0, vextq_u16(d0[3], a31, 6));
  vst1q_u16(dst + 29 * stride + 8, a31);
  vst1q_u16(dst + 29 * stride + 16, a31);
  vst1q_u16(dst + 29 * stride + 24, a31);
  vst1q_u16(dst + 30 * stride + 0, vextq_u16(d0[3], a31, 7));
  vst1q_u16(dst + 30 * stride + 8, a31);
  vst1q_u16(dst + 30 * stride + 16, a31);
  vst1q_u16(dst + 30 * stride + 24, a31);
  vst1q_u16(dst + 31 * stride + 0, a31);
  vst1q_u16(dst + 31 * stride + 8, a31);
