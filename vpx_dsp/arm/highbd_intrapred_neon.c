...
static INLINE void d135_store_32(uint16_t **dst, const uint16x8_t row_0,
                                 const uint16x8_t row_1, const uint16x8_t row_2,
                                 const uint16x8_t row_3) {
  vst1q_u16(*dst, row_0);
  *dst += 8;
  vst1q_u16(*dst, row_1);
  *dst += 8;
...
void vpx_highbd_d135_predictor_32x32_neon(uint16_t *dst, ptrdiff_t stride,
  ...
  const uint16x8_t row_0 = vrhaddq_u16(avg_0, LLedcba987);
  ...
  const uint16x8_t row_1 = vrhaddq_u16(avg_1, LL6543210Uf);
  ...
  const uint16x8_t row_2 = vrhaddq_u16(avg_2, LUedcba987);
  ...
  const uint16x8_t row_3 = vrhaddq_u16(avg_3, LU6543210X);
  ...
  const uint16x8_t row_4 = vrhaddq_u16(avg_4, AL01234567);
  ...
  const uint16x8_t row_5 = vrhaddq_u16(avg_5, AL89abcdef);
  ...
  const uint16x8_t row_6 = vrhaddq_u16(avg_6, AR01234567);
  ...
  const uint16x8_t row_7 = vrhaddq_u16(avg_7, AR89abcdef);
  (void)bd;

  {
    const uint16x8_t r_0 = vextq_u16(row_0, row_1, 7);
    const uint16x8_t r_1 = vextq_u16(row_1, row_2, 7);
    const uint16x8_t r_2 = vextq_u16(row_2, row_3, 7);
    const uint16x8_t r_3 = vextq_u16(row_3, row_4, 7);
    const uint16x8_t r_4 = vextq_u16(row_4, row_5, 7);
    const uint16x8_t r_5 = vextq_u16(row_5, row_6, 7);
    const uint16x8_t r_6 = vextq_u16(row_6, row_7, 7);
    uint16_t *d = dst;

    d135_store_32(&d, r_3, r_4, r_5, r_6);
    d += 8 * stride - 24;
    d135_store_32(&d, r_2, r_3, r_4, r_5);
    d += 8 * stride - 24;
    d135_store_32(&d, r_1, r_2, r_3, r_4);
    d += 8 * stride - 24;
    d135_store_32(&d, r_0, r_1, r_2, r_3);
  }

  {
    const uint16x8_t r_0 = vextq_u16(row_0, row_1, 6);
    const uint16x8_t r_1 = vextq_u16(row_1, row_2, 6);
    const uint16x8_t r_2 = vextq_u16(row_2, row_3, 6);
    const uint16x8_t r_3 = vextq_u16(row_3, row_4, 6);
    const uint16x8_t r_4 = vextq_u16(row_4, row_5, 6);
    const uint16x8_t r_5 = vextq_u16(row_5, row_6, 6);
    const uint16x8_t r_6 = vextq_u16(row_6, row_7, 6);
    uint16_t *d = dst + 1 * stride;
  ...
  {
    const uint16x8_t r_0 = vextq_u16(row_0, row_1, 5);
    const uint16x8_t r_1 = vextq_u16(row_1, row_2, 5);
    const uint16x8_t r_2 = vextq_u16(row_2, row_3, 5);
    const uint16x8_t r_3 = vextq_u16(row_3, row_4, 5);
    const uint16x8_t r_4 = vextq_u16(row_4, row_5, 5);
    const uint16x8_t r_5 = vextq_u16(row_5, row_6, 5);
    const uint16x8_t r_6 = vextq_u16(row_6, row_7, 5);
    uint16_t *d = dst + 2 * stride;
  ...
  {
    const uint16x8_t r_0 = vextq_u16(row_0, row_1, 4);
    const uint16x8_t r_1 = vextq_u16(row_1, row_2, 4);
    const uint16x8_t r_2 = vextq_u16(row_2, row_3, 4);
    const uint16x8_t r_3 = vextq_u16(row_3, row_4, 4);
    const uint16x8_t r_4 = vextq_u16(row_4, row_5, 4);
    const uint16x8_t r_5 = vextq_u16(row_5, row_6, 4);
    const uint16x8_t r_6 = vextq_u16(row_6, row_7, 4);
    uint16_t *d = dst + 3 * stride;
  ...
  {
    const uint16x8_t r_0 = vextq_u16(row_0, row_1, 3);
    const uint16x8_t r_1 = vextq_u16(row_1, row_2, 3);
    const uint16x8_t r_2 = vextq_u16(row_2, row_3, 3);
    const uint16x8_t r_3 = vextq_u16(row_3, row_4, 3);
    const uint16x8_t r_4 = vextq_u16(row_4, row_5, 3);
    const uint16x8_t r_5 = vextq_u16(row_5, row_6, 3);
    const uint16x8_t r_6 = vextq_u16(row_6, row_7, 3);
    uint16_t *d = dst + 4 * stride;
  ...
  {
    const uint16x8_t r_0 = vextq_u16(row_0, row_1, 2);
    const uint16x8_t r_1 = vextq_u16(row_1, row_2, 2);
    const uint16x8_t r_2 = vextq_u16(row_2, row_3, 2);
    const uint16x8_t r_3 = vextq_u16(row_3, row_4, 2);
    const uint16x8_t r_4 = vextq_u16(row_4, row_5, 2);
    const uint16x8_t r_5 = vextq_u16(row_5, row_6, 2);
    const uint16x8_t r_6 = vextq_u16(row_6, row_7, 2);
    uint16_t *d = dst + 5 * stride;
  ...
  {
    const uint16x8_t r_0 = vextq_u16(row_0, row_1, 1);
    const uint16x8_t r_1 = vextq_u16(row_1, row_2, 1);
    const uint16x8_t r_2 = vextq_u16(row_2, row_3, 1);
    const uint16x8_t r_3 = vextq_u16(row_3, row_4, 1);
    const uint16x8_t r_4 = vextq_u16(row_4, row_5, 1);
    const uint16x8_t r_5 = vextq_u16(row_5, row_6, 1);
    const uint16x8_t r_6 = vextq_u16(row_6, row_7, 1);
    uint16_t *d = dst + 6 * stride;
  ...
  {
    uint16_t *d = dst + 7 * stride;

    d135_store_32(&d, row_3, row_4, row_5, row_6);
    d += 8 * stride - 24;
    d135_store_32(&d, row_2, row_3, row_4, row_5);
    d += 8 * stride - 24;
    d135_store_32(&d, row_1, row_2, row_3, row_4);
    d += 8 * stride - 24;
    d135_store_32(&d, row_0, row_1, row_2, row_3);
  }
}
...
void vpx_highbd_tm_predictor_4x4_neon(uint16_t *dst, ptrdiff_t stride,
  ...
  const int16x8_t above_s16 =
      vreinterpretq_s16_s64(vld1q_dup_s64((const int64_t *)above));
