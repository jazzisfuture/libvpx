...
void vpx_convolve8_avg_horiz_neon(const uint8_t *src, ptrdiff_t src_stride,
  ...
  if (w == 4) {
    ...
    do {
      ...
      dd01 = vld1_lane_u32((uint32_t *)(dst + 0 * dst_stride),
                           vreinterpret_u32_u8(dd01), 0);
      dd01 = vld1_lane_u32((uint32_t *)(dst + 1 * dst_stride),
                           vreinterpret_u32_u8(dd01), 1);
      dd23 = vld1_lane_u32((uint32_t *)(dst + 2 * dst_stride),
                           vreinterpret_u32_u8(dd23), 0);
      dd23 = vld1_lane_u32((uint32_t *)(dst + 3 * dst_stride),
                           vreinterpret_u32_u8(dd23), 1);
