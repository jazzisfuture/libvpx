...
static INLINE void dct_const_round_shift_low_8dual(const int32x4_t *const t32,
                                                   int16x8_t *const d0,
                                                   int16x8_t *const d1) {
...
static INLINE void idct4x4_16_kernel_bd8(int16x8_t *const a) {
  ...
  dct_const_round_shift_low_8dual(c, &d[0], &d[1]);
...
static INLINE void idct8x8_12_pass2_bd8(const int16x4_t cospis0,
  ...
  dct_const_round_shift_low_8dual(t32, &step1[5], &step1[6]);
...
static INLINE void idct8x8_64_1d_bd8(const int16x4_t cospis0,
  ...
  dct_const_round_shift_low_8dual(&t32[0], &step1[4], &step1[5]);
  dct_const_round_shift_low_8dual(&t32[4], &step1[6], &step1[7]);
  ...
  dct_const_round_shift_low_8dual(&t32[0], &step2[0], &step2[1]);
  dct_const_round_shift_low_8dual(&t32[4], &step2[2], &step2[3]);
...
static INLINE void idct_cospi_8_24_q(const int16x8_t s0, const int16x8_t s1,
  ...
  dct_const_round_shift_low_8dual(t32, d0, d1);
}
