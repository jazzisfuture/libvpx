...
static INLINE void dct_const_round_shift_high_4dual(const int64x2x2_t *const in,
                                                    int32x4_t *const d0,
                                                    int32x4_t *const d1) {
...
dct_const_round_shift_high_4x2_in64x2x2(const int64x2x2_t *const in) {
  int32x4x2_t out;
...
static INLINE void dct_const_round_shift_high_4x2x2(const int64x2x2_t *const in,
  ...
  *d0 = dct_const_round_shift_high_4x2_in64x2x2(in + 0);
  *d1 = dct_const_round_shift_high_4x2_in64x2x2(in + 2);
}
...
static INLINE void highbd_idct_cospi_8_24_d(const int32x4_t s0,
  ...
  dct_const_round_shift_high_4dual(t, d0, d1);
}
...
static INLINE int32x4x2_t highbd_idct_cospi_lane0_dual(const int32x4x2_t s,
  ...
  return dct_const_round_shift_high_4x2_in64x2x2(t);
}
