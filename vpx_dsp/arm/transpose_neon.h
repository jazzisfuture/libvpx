...
static INLINE void transpose_u8_8x8(uint8x8_t *a0, uint8x8_t *a1, uint8x8_t *a2,
  ...
  const uint16x8x2_t c0 = vzipq_u16(vreinterpretq_u16_u8(b0),
                                    vreinterpretq_u16_u8(b1));
  const uint16x8x2_t c1 = vzipq_u16(vreinterpretq_u16_u8(b2),
                                    vreinterpretq_u16_u8(b3));
