...
static INLINE void transpose_s16_16x16(int16x8_t *in0, int16x8_t *in1) {
  ...
  transpose_s16_8x8(&in0[0], &in0[1], &in0[2],  &in0[3],  &in0[4],  &in0[5],  &in0[6],  &in0[7]);
  transpose_s16_8x8(&in0[8], &in0[9], &in0[10], &in0[11], &in0[12], &in0[13], &in0[14], &in0[15]);
  transpose_s16_8x8(&in1[0], &in1[1], &in1[2],  &in1[3],  &in1[4],  &in1[5],  &in1[6],  &in1[7]);
  transpose_s16_8x8(&in1[8], &in1[9], &in1[10], &in1[11], &in1[12], &in1[13], &in1[14], &in1[15]);
}
