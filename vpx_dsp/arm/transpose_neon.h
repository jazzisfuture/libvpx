...
static INLINE void transpose_u8_8x16(
  ...
  // to:
  // b0.val[0]: 00 01 02 03 04 05 06 07  80 81 82 83 84 85 86 87
  // b0.val[1]: 10 11 12 13 14 15 16 17  90 91 92 93 94 95 96 97
  // b1.val[0]: 20 21 22 23 24 25 26 27  A0 A1 A2 A3 A4 A5 A6 A7
  // b1.val[1]: 30 31 32 33 34 35 36 37  B0 B1 B2 B3 B4 B5 B6 B7
  // b2.val[0]: 40 41 42 43 44 45 46 47  C0 C1 C2 C3 C4 C5 C6 C7
  // b2.val[1]: 50 51 52 53 54 55 56 57  D0 D1 D2 D3 D4 D5 D6 D7
  // b3.val[0]: 60 61 62 63 64 65 66 67  E0 E1 E2 E3 E4 E5 E6 E7
  // b3.val[1]: 70 71 72 73 74 75 76 77  F0 F1 F2 F3 F4 F5 F6 F7
...
static INLINE void transpose_u8_16x16(
  ...
  const int16x8x2_t e0 = vpx_vtrnq_s64(vreinterpretq_s32_u32(d0.val[0]),
                                       vreinterpretq_s32_u32(d4.val[0]));
  const int16x8x2_t e1 = vpx_vtrnq_s64(vreinterpretq_s32_u32(d2.val[0]),
                                       vreinterpretq_s32_u32(d6.val[0]));
  const int16x8x2_t e2 = vpx_vtrnq_s64(vreinterpretq_s32_u32(d1.val[0]),
                                       vreinterpretq_s32_u32(d5.val[0]));
  const int16x8x2_t e3 = vpx_vtrnq_s64(vreinterpretq_s32_u32(d3.val[0]),
                                       vreinterpretq_s32_u32(d7.val[0]));
  const int16x8x2_t e4 = vpx_vtrnq_s64(vreinterpretq_s32_u32(d0.val[1]),
                                       vreinterpretq_s32_u32(d4.val[1]));
  const int16x8x2_t e5 = vpx_vtrnq_s64(vreinterpretq_s32_u32(d2.val[1]),
                                       vreinterpretq_s32_u32(d6.val[1]));
  const int16x8x2_t e6 = vpx_vtrnq_s64(vreinterpretq_s32_u32(d1.val[1]),
                                       vreinterpretq_s32_u32(d5.val[1]));
  const int16x8x2_t e7 = vpx_vtrnq_s64(vreinterpretq_s32_u32(d3.val[1]),
                                       vreinterpretq_s32_u32(d7.val[1]));
  ...
  *o0 = vreinterpretq_u8_s16(e0.val[0]);
  *o1 = vreinterpretq_u8_s16(e1.val[0]);
  *o2 = vreinterpretq_u8_s16(e2.val[0]);
  *o3 = vreinterpretq_u8_s16(e3.val[0]);
  *o4 = vreinterpretq_u8_s16(e4.val[0]);
  *o5 = vreinterpretq_u8_s16(e5.val[0]);
  *o6 = vreinterpretq_u8_s16(e6.val[0]);
  *o7 = vreinterpretq_u8_s16(e7.val[0]);
  *o8 = vreinterpretq_u8_s16(e0.val[1]);
  *o9 = vreinterpretq_u8_s16(e1.val[1]);
  *o10 = vreinterpretq_u8_s16(e2.val[1]);
  *o11 = vreinterpretq_u8_s16(e3.val[1]);
  *o12 = vreinterpretq_u8_s16(e4.val[1]);
  *o13 = vreinterpretq_u8_s16(e5.val[1]);
  *o14 = vreinterpretq_u8_s16(e6.val[1]);
  *o15 = vreinterpretq_u8_s16(e7.val[1]);
}
