...
static int16x8x2_t vtrnq_s64(int32x4_t a0, int32x4_t a1) {
  int16x8x2_t b0;
...
static void transpose_s16_8x8(int16x8_t *a0, int16x8_t *a1, int16x8_t *a2,
  ...
  const int16x8x2_t d0 = vtrnq_s64(c0.val[0], c2.val[0]);
  const int16x8x2_t d1 = vtrnq_s64(c1.val[0], c3.val[0]);
  const int16x8x2_t d2 = vtrnq_s64(c0.val[1], c2.val[1]);
  const int16x8x2_t d3 = vtrnq_s64(c1.val[1], c3.val[1]);
