...
void vpx_quantize_b_neon(const tran_low_t *coeff_ptr, intptr_t n_coeffs,
...

  {
    ...
    const uint32x4_t eob_max_1 = vmovl_u16(eob_max_0);
    const uint32x2_t eob_max_2 =
        vmax_u32(vget_low_u32(eob_max_1), vget_high_u32(eob_max_1));
    const uint32x2_t eob_max_3 = vpmax_u32(eob_max_2, eob_max_2);
    vst1_lane_u16(eob_ptr, vreinterpret_u16_u32(eob_max_3), 0);
  }
}
