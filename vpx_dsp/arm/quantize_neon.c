...
static INLINE int32x4_t single_sign_bit(int32x4_t a) {
...
void vpx_quantize_b_32x32_neon(
  ...
  // Process first 8 values which include a dc component.
  {
    ...
    dqcoeff_0 = vaddq_s32(dqcoeff_0, single_sign_bit(dqcoeff_0));
    dqcoeff_1 = vaddq_s32(dqcoeff_1, single_sign_bit(dqcoeff_1));
