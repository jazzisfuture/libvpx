...
static void add_and_store(int16x8_t *a0, int16x8_t *a1, int16x8_t *a2,
  ...
  *a0 = vrsraq_n_s16(vreinterpretq_s16_u16(vmovl_u8(b0)), *a0, 6);
  *a1 = vrsraq_n_s16(vreinterpretq_s16_u16(vmovl_u8(b1)), *a1, 6);
  *a2 = vrsraq_n_s16(vreinterpretq_s16_u16(vmovl_u8(b2)), *a2, 6);
  *a3 = vrsraq_n_s16(vreinterpretq_s16_u16(vmovl_u8(b3)), *a3, 6);
  *a4 = vrsraq_n_s16(vreinterpretq_s16_u16(vmovl_u8(b4)), *a4, 6);
  *a5 = vrsraq_n_s16(vreinterpretq_s16_u16(vmovl_u8(b5)), *a5, 6);
  *a6 = vrsraq_n_s16(vreinterpretq_s16_u16(vmovl_u8(b6)), *a6, 6);
  *a7 = vrsraq_n_s16(vreinterpretq_s16_u16(vmovl_u8(b7)), *a7, 6);
