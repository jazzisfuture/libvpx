...
static void add_and_store(int16x8_t *a0, int16x8_t *a1, int16x8_t *a2,
  ...
  transpose_u8_8x8(&b0, &b1, &b2, &b3, &b4, &b5, &b6, &b7);

  // Adding unsigned values to signed values. Urgh. Going to expand up first,
  // but maybe there is a way to use vaddw?
  // ohh, there is vrsra_n_s16 for shift round and accumulate
  *a0 = vqaddq_s16(*a0, vreinterpretq_s16_u16(vmovl_u8(b0)));
  *a1 = vqaddq_s16(*a1, vreinterpretq_s16_u16(vmovl_u8(b1)));
  *a2 = vqaddq_s16(*a2, vreinterpretq_s16_u16(vmovl_u8(b2)));
  *a3 = vqaddq_s16(*a3, vreinterpretq_s16_u16(vmovl_u8(b3)));
  *a4 = vqaddq_s16(*a4, vreinterpretq_s16_u16(vmovl_u8(b4)));
  *a5 = vqaddq_s16(*a5, vreinterpretq_s16_u16(vmovl_u8(b5)));
  *a6 = vqaddq_s16(*a6, vreinterpretq_s16_u16(vmovl_u8(b6)));
  *a7 = vqaddq_s16(*a7, vreinterpretq_s16_u16(vmovl_u8(b7)));

  // Not sure if this should be w/ or w/o rounding.
  b0 = vqrshrun_n_s16(*a0, 6);
  b1 = vqrshrun_n_s16(*a1, 6);
  b2 = vqrshrun_n_s16(*a2, 6);
  b3 = vqrshrun_n_s16(*a3, 6);
  b4 = vqrshrun_n_s16(*a4, 6);
  b5 = vqrshrun_n_s16(*a5, 6);
  b6 = vqrshrun_n_s16(*a6, 6);
  b7 = vqrshrun_n_s16(*a7, 6);
