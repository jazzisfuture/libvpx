...
static INLINE void IDCT8x8_1D(const int16x4_t cospis0, const int16x4_t cospis1,
  ...
  b2 = vmlsl_lane_s16(b2, a3l, cospis1, 2);
  b3 = vmlsl_lane_s16(b3, a3h, cospis1, 2);
  c0 = vqrshrn_n_s32(b0, 14);
  c1 = vqrshrn_n_s32(b1, 14);
  c2 = vqrshrn_n_s32(b2, 14);
  c3 = vqrshrn_n_s32(b3, 14);
  d4 = vcombine_s16(c0, c1);
  d5 = vcombine_s16(c2, c3);

  b0 = vmull_lane_s16(a1l, cospis1, 0);
  b1 = vmull_lane_s16(a1h, cospis1, 0);
  b2 = vmull_lane_s16(a5l, cospis1, 2);
  b3 = vmull_lane_s16(a5h, cospis1, 2);
  b0 = vmlal_lane_s16(b0, a7l, cospis1, 3);
  b1 = vmlal_lane_s16(b1, a7h, cospis1, 3);
  b2 = vmlal_lane_s16(b2, a3l, cospis1, 1);
  b3 = vmlal_lane_s16(b3, a3h, cospis1, 1);
  c0 = vqrshrn_n_s32(b0, 14);
  c1 = vqrshrn_n_s32(b1, 14);
  c2 = vqrshrn_n_s32(b2, 14);
  c3 = vqrshrn_n_s32(b3, 14);
...
void vpx_idct8x8_64_add_neon(const tran_low_t *input, uint8_t *dest,
                             int dest_stride) {
  const int16x8_t cospis = vld1q_s16(cospi);
  ...
  a2 = load_tran_low_to_s16(input + 16);
  a3 = load_tran_low_to_s16(input + 24);
  a4 = load_tran_low_to_s16(input + 32);
  a5 = load_tran_low_to_s16(input + 40);
  a6 = load_tran_low_to_s16(input + 48);
  a7 = load_tran_low_to_s16(input + 56);
...
void vpx_idct8x8_12_add_neon(const tran_low_t *input, uint8_t *dest,
  ...
  c0 = vmull_lane_s16(b9, cospis0, 2);
  c1 = vmull_lane_s16(b9, cospis0, 2);
  c0 = vmlsl_lane_s16(c0, b8, cospis0, 2);
  c1 = vmlal_lane_s16(c1, b8, cospis0, 2);

  b5 = vqrshrn_n_s32(c0, 14);
  b6 = vqrshrn_n_s32(c1, 14);
