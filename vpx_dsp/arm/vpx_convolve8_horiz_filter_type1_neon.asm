...
inner_loop_8
    ...
    vqmovun.s16     d20,    q4              ;right shift and saturating narrow
                                            ; result 1
    ...
    vqmovun.s16     d8,     q5              ;right shift and saturating narrow
                                            ; result 2
...
inner_loop_16
    ...
    vqmovun.s16     d8,     q4              ;right shift and saturating narrow
                                            ; result 1
    ...
    vqmovun.s16     d10,    q5              ;right shift and saturating narrow
                                            ; result 2
    beq             epilog_16
