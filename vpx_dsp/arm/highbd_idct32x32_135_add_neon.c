...
static INLINE void highbd_load_8x8_s16(
...
static INLINE void highbd_load_4x8_s16(
    const tran_low_t *input, int32x4_t *const in0, int32x4_t *const in1,
    int32x4_t *const in2, int32x4_t *const in3, int32x4_t *const in4,
    int32x4_t *const in5, int32x4_t *const in6, int32x4_t *const in7) {
  *in0 = vld1q_s32(input);
  input += 32;
  *in1 = vld1q_s32(input);
  input += 32;
...
static void highbd_idct32_12_neon(const tran_low_t *const input,
  ...
  highbd_load_8x8_s16(input, &in[0], &in[1], &in[2], &in[3], &in[4], &in[5],
                      &in[6], &in[7]);
  transpose_s32_8x8(&in[0], &in[1], &in[2], &in[3], &in[4], &in[5], &in[6],
                    &in[7]);

  highbd_load_4x8_s16(input + 8, &in[8].val[0], &in[8].val[1], &in[9].val[0],
...
static void highbd_idct32_16_neon(const int32_t *const input,
  ...
  highbd_load_and_transpose_s16_8x8(input, 16, &in[0], &in[1], &in[2], &in[3],
                                    &in[4], &in[5], &in[6], &in[7]);

  highbd_load_and_transpose_s16_8x8(input + 8, 16, &in[8], &in[9], &in[10],
