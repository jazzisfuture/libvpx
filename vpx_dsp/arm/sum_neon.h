...
static INLINE int32x2_t horizontal_add_int16x8(const int16x8_t v_16x8) {
  const int32x4_t a = vpaddlq_s16(v_16x8);
  const int64x2_t b = vpaddlq_s32(a);
  return vadd_s32(vreinterpret_s32_s64(vget_low_s64(b)),
                  vreinterpret_s32_s64(vget_high_s64(b)));
}

static INLINE uint32x2_t horizontal_add_uint16x8(const uint16x8_t vec_16x8) {
