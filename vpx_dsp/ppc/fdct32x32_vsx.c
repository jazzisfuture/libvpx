...
static INLINE void load(const int16_t *a, int stride, int16x8_t *b) {
  b[0] = vec_vsx_ld(0, a);
  b[1] = vec_vsx_ld(0, a + stride);
  b[2] = vec_vsx_ld(0, a + 2 * stride);
  b[3] = vec_vsx_ld(0, a + 3 * stride);
  b[4] = vec_vsx_ld(0, a + 4 * stride);
  b[5] = vec_vsx_ld(0, a + 5 * stride);
  b[6] = vec_vsx_ld(0, a + 6 * stride);
  b[7] = vec_vsx_ld(0, a + 7 * stride);

  b[0] = vec_sl(b[0], vec_dct_scale_log2);
  b[1] = vec_sl(b[1], vec_dct_scale_log2);
  b[2] = vec_sl(b[2], vec_dct_scale_log2);
  b[3] = vec_sl(b[3], vec_dct_scale_log2);
  b[4] = vec_sl(b[4], vec_dct_scale_log2);
  b[5] = vec_sl(b[5], vec_dct_scale_log2);
  b[6] = vec_sl(b[6], vec_dct_scale_log2);
  b[7] = vec_sl(b[7], vec_dct_scale_log2);

  b[8] = vec_vsx_ld(0, a + 8 * stride);
  b[9] = vec_vsx_ld(0, a + 9 * stride);
  b[10] = vec_vsx_ld(0, a + 10 * stride);
  b[11] = vec_vsx_ld(0, a + 11 * stride);
  b[12] = vec_vsx_ld(0, a + 12 * stride);
  b[13] = vec_vsx_ld(0, a + 13 * stride);
  b[14] = vec_vsx_ld(0, a + 14 * stride);
  b[15] = vec_vsx_ld(0, a + 15 * stride);

  b[8] = vec_sl(b[8], vec_dct_scale_log2);
  b[9] = vec_sl(b[9], vec_dct_scale_log2);
  b[10] = vec_sl(b[10], vec_dct_scale_log2);
  b[11] = vec_sl(b[11], vec_dct_scale_log2);
  b[12] = vec_sl(b[12], vec_dct_scale_log2);
  b[13] = vec_sl(b[13], vec_dct_scale_log2);
  b[14] = vec_sl(b[14], vec_dct_scale_log2);
  b[15] = vec_sl(b[15], vec_dct_scale_log2);

  b[16] = vec_vsx_ld(0, a + 16 * stride);
  b[17] = vec_vsx_ld(0, a + 17 * stride);
  b[18] = vec_vsx_ld(0, a + 18 * stride);
  b[19] = vec_vsx_ld(0, a + 19 * stride);
  b[20] = vec_vsx_ld(0, a + 20 * stride);
  b[21] = vec_vsx_ld(0, a + 21 * stride);
  b[22] = vec_vsx_ld(0, a + 22 * stride);
  b[23] = vec_vsx_ld(0, a + 23 * stride);

  b[16] = vec_sl(b[16], vec_dct_scale_log2);
  b[17] = vec_sl(b[17], vec_dct_scale_log2);
  b[18] = vec_sl(b[18], vec_dct_scale_log2);
  b[19] = vec_sl(b[19], vec_dct_scale_log2);
  b[20] = vec_sl(b[20], vec_dct_scale_log2);
  b[21] = vec_sl(b[21], vec_dct_scale_log2);
  b[22] = vec_sl(b[22], vec_dct_scale_log2);
  b[23] = vec_sl(b[23], vec_dct_scale_log2);

  b[24] = vec_vsx_ld(0, a + 24 * stride);
  b[25] = vec_vsx_ld(0, a + 25 * stride);
  b[26] = vec_vsx_ld(0, a + 26 * stride);
  b[27] = vec_vsx_ld(0, a + 27 * stride);
  b[28] = vec_vsx_ld(0, a + 28 * stride);
  b[29] = vec_vsx_ld(0, a + 29 * stride);
  b[30] = vec_vsx_ld(0, a + 30 * stride);
  b[31] = vec_vsx_ld(0, a + 31 * stride);

  b[24] = vec_sl(b[24], vec_dct_scale_log2);
  b[25] = vec_sl(b[25], vec_dct_scale_log2);
  b[26] = vec_sl(b[26], vec_dct_scale_log2);
  b[27] = vec_sl(b[27], vec_dct_scale_log2);
  b[28] = vec_sl(b[28], vec_dct_scale_log2);
  b[29] = vec_sl(b[29], vec_dct_scale_log2);
  b[30] = vec_sl(b[30], vec_dct_scale_log2);
  b[31] = vec_sl(b[31], vec_dct_scale_log2);
}
