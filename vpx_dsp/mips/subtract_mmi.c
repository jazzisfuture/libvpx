...
void vpx_subtract_block_mmi(int rows, int cols,
    ...
    switch (rows) {
      case 4:
        __asm__ volatile (
          ...
          PTR_ADDU   "%[diff],%[diff],        %[diff_stride]          \n\t"
          ...
          : [src_stride]"r"((mips_reg)src_stride),
            [pred_stride]"r"((mips_reg)pred_stride),      [diff_stride]"r"((mips_reg)(diff_stride*2))
          : "memory"
        );
        break;
      case 8:
      ...
      case 16:
        ...
        break;
      case 32:
        vpx_subtract_block_c(rows, cols, diff, diff_stride, src,
