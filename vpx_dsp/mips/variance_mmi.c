...
static const uint8_t bilinear_filters[8][2] = {{128, 0},
                                               {112, 16},
                                               {96, 32},
                                               {80, 48},
                                               {64, 64},
...
#define SUBPIX_VAR16XN(n)                                            \
  uint32_t vpx_sub_pixel_variance16x##n##_mmi(                       \
      const uint8_t *a, int a_stride, int xoffset, int yoffset,      \
      const uint8_t *b, int b_stride, uint32_t *sse) {               \
    uint8_t temp2[16 * n];                                           \
    var_filter_block2d_bil_16x(a, a_stride, xoffset, yoffset, temp2, \
                               (n-2)/2);                             \
                                                                     \
    return vpx_variance16x##n##_mmi(temp2, 16, b, b_stride, sse);    \
  }
...
#define SUBPIX_VAR8XN(n)                                            \
  uint32_t vpx_sub_pixel_variance8x##n##_mmi(                       \
      const uint8_t *a, int a_stride, int xoffset, int yoffset,     \
      const uint8_t *b, int b_stride, uint32_t *sse) {              \
    uint8_t temp2[8 * n];                                           \
    var_filter_block2d_bil_8x(a, a_stride, xoffset, yoffset, temp2, \
                              (n-2)/2);                             \
                                                                    \
    return vpx_variance8x##n##_mmi(temp2, 8, b, b_stride, sse);     \
  }
...
#define SUBPIX_VAR4XN(n)                                            \
  uint32_t vpx_sub_pixel_variance4x##n##_mmi(                       \
      const uint8_t *a, int a_stride, int xoffset, int yoffset,     \
      const uint8_t *b, int b_stride, uint32_t *sse) {              \
    uint8_t temp2[4 * n];                                           \
    var_filter_block2d_bil_4x(a, a_stride, xoffset, yoffset, temp2, \
                              (n-2)/2);                             \
                                                                    \
    return vpx_variance4x##n##_mmi(temp2, 4, b, b_stride, sse);     \
  }
