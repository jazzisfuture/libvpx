...
uint32_t vpx_mse16x16_mmi(const uint8_t *a, int a_stride, const uint8_t *b,
...
uint32_t vpx_mse16x8_mmi(const uint8_t *a, int a_stride, const uint8_t *b,
                         int b_stride, uint32_t *sse) {
  double ftmp[12];
  uint32_t tmp[1];
...
uint32_t vpx_mse8x16_mmi(const uint8_t *a, int a_stride, const uint8_t *b,
                         int b_stride, uint32_t *sse) {
  double ftmp[12];
  uint32_t tmp[1];
...
uint32_t vpx_mse8x8_mmi(const uint8_t *a, int a_stride, const uint8_t *b,
                        int b_stride, uint32_t *sse) {
  double ftmp[12];
  uint32_t tmp[1];
