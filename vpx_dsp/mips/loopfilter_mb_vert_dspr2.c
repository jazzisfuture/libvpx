...
void vpx_lpf_vertical_16_dspr2(uint8_t *s,
  ...
  for (i = 0; i < 2; i++) {
    ...
    */
    ...
    vpx_filter_hev_mask_flatmask4_dspr2(limit_vec, flimit_vec, thresh_vec,
                                        p1, p0, p3, p2, q0, q1, q2, q3,
                                        &hev, &mask, &flat);

    vpx_flatmask5(p7, p6, p5, p4, p0, q0, q4, q5, q6, q7, &flat2);

    /* f0 */
    if (((flat2 == 0) && (flat == 0) && (mask != 0)) ||
        ((flat2 != 0) && (flat == 0) && (mask != 0))) {
      vpx_filter1_dspr2(mask, hev, p1, p0, q0, q1,
      ...
      PACK_LEFT_0TO3()
      PACK_LEFT_4TO7()
      vpx_wide_mbfilter_dspr2(&p7_l, &p6_l, &p5_l, &p4_l,
                              &p3_l, &p2_l, &p1_l, &p0_l,
                              &q0_l, &q1_l, &q2_l, &q3_l,
                              &q4_l, &q5_l, &q6_l, &q7_l);
      ...
      PACK_RIGHT_0TO3()
      PACK_RIGHT_4TO7()
      vpx_wide_mbfilter_dspr2(&p7_r, &p6_r, &p5_r, &p4_r,
                              &p3_r, &p2_r, &p1_r, &p0_r,
                              &q0_r, &q1_r, &q2_r, &q3_r,
                              &q4_r, &q5_r, &q6_r, &q7_r);
      ...
      /* f1 */
      PACK_LEFT_0TO3()
      vpx_mbfilter_dspr2(&p3_l, &p2_l, &p1_l, &p0_l,
                         &q0_l, &q1_l, &q2_l, &q3_l);

      PACK_RIGHT_0TO3()
      vpx_mbfilter_dspr2(&p3_r, &p2_r, &p1_r, &p0_r,
                         &q0_r, &q1_r, &q2_r, &q3_r);
      ...
      PACK_LEFT_0TO3()
      vpx_mbfilter1_dspr2(p3_l, p2_l, p1_l, p0_l,
                          q0_l, q1_l, q2_l, q3_l,
                          &p2_l_f1, &p1_l_f1, &p0_l_f1,
                          &q0_l_f1, &q1_l_f1, &q2_l_f1);

      PACK_RIGHT_0TO3()
      vpx_mbfilter1_dspr2(p3_r, p2_r, p1_r, p0_r,
                          q0_r, q1_r, q2_r, q3_r,
