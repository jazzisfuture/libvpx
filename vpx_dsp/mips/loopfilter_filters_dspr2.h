...
static INLINE void vpx_filter_dspr2(uint32_t mask, uint32_t hev,
...
static INLINE void vpx_filter1_dspr2(uint32_t mask, uint32_t hev,
                                     uint32_t ps1, uint32_t ps0,
                                     uint32_t qs0, uint32_t qs1,
...
static INLINE void vpx_mbfilter_dspr2(uint32_t *op3, uint32_t *op2,
...
static INLINE void vpx_mbfilter1_dspr2(uint32_t p3, uint32_t p2,
...
static INLINE void vpx_wide_mbfilter_dspr2(uint32_t *op7, uint32_t *op6,
