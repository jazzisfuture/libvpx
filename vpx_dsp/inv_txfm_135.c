...
static void idct32_135_pass1_c(const tran_low_t *input,
                               tran_low_t *step1) {
  tran_low_t step2[32];
...
static void idct32_135_pass2_c(const tran_low_t *input,
                               tran_low_t *step1) {
  tran_low_t step2[32];
  tran_high_t temp1, temp2;
...
static void idct32_135_c(const tran_low_t *input, tran_low_t *output) {
  tran_low_t step1[32];

  idct32_135_pass1_c(input, step1);
  idct32_135_pass2_c(input, step1);
