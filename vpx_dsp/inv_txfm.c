...
void idct4(const tran_low_t *input, tran_low_t *output) {
  tran_low_t step[4];
...
void idct8(const tran_low_t *input, tran_low_t *output) {
...
void iadst4(const tran_low_t *input, tran_low_t *output) {
...
void iadst8(const tran_low_t *input, tran_low_t *output) {
...
void idct16(const tran_low_t *input, tran_low_t *output) {
...
void iadst16(const tran_low_t *input, tran_low_t *output) {
...
void idct32(const tran_low_t *input, tran_low_t *output) {
...
void highbd_iadst4(const tran_low_t *input, tran_low_t *output, int bd) {
  tran_high_t s0, s1, s2, s3, s4, s5, s6, s7;
...
void highbd_iadst8(const tran_low_t *input, tran_low_t *output, int bd) {
  tran_high_t s0, s1, s2, s3, s4, s5, s6, s7;
...
void highbd_iadst16(const tran_low_t *input, tran_low_t *output, int bd) {
  tran_high_t s0, s1, s2, s3, s4, s5, s6, s7, s8;
  tran_high_t s9, s10, s11, s12, s13, s14, s15;
...
void highbd_idct32(const tran_low_t *input, tran_low_t *output, int bd) {
  tran_low_t step1[32], step2[32];
  tran_high_t temp1, temp2;
  (void) bd;
