  ...
  for (pass = 0; pass < 2; ++pass) {
    ...
    for (i = 0; i < 8; i++) {
      ...
      if (pass == 0) {
        ...
        s0 = input[0 * 8] + input[7 * 8];
        s1 = input[1 * 8] + input[6 * 8];
        s2 = input[2 * 8] + input[5 * 8];
        s3 = input[3 * 8] + input[4 * 8];
        s4 = input[3 * 8] - input[4 * 8];
        s5 = input[2 * 8] - input[5 * 8];
        s6 = input[1 * 8] - input[6 * 8];
        s7 = input[0 * 8] - input[7 * 8];
      }
