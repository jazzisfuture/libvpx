...
int main(int argc, const char **argv_)
{
    ...
    /* Open output file */
    if (use_y4m)
        vpxio_open_y4m_dst(&output_ctx, outfile_pattern, vpxio_get_width(&input_ctx), vpxio_get_height(&input_ctx), vpxio_get_framerate(&input_ctx).den, vpxio_get_framerate(&input_ctx).num);
    else
        vpxio_open_i420_dst(&output_ctx, outfile_pattern, vpxio_get_width(&input_ctx), vpxio_get_height(&input_ctx));
